...
3. Describe your commit and use your common sense. Example Commit messages:
``Fixes #123; refs #124``

indicates that issue ``123`` is completely fixed (github may automatically close
it when the PR is committed), wheres 124 is referenced (eg: partially fixed) and
won't close the issue when committed.
