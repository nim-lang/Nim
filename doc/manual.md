...
iterator in which case the overloading resolution takes place:
  ...
  ```
Modules can share their name, however, when trying to qualify a identifier with the module name the compiler will fail with ambiguous identifier error. You can qualify the identifier by aliasing the module. 
