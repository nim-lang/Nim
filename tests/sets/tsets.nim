...
block:
  ...
  type
    FakeMsgKind2 = range[k200..high(FakeMsgKind)]
    FakeMsgKind2s = set[FakeMsgKind2]

  const
    a1: array[0..0, FakeMsgKind2s] = [{low(FakeMsgKind2)..high(FakeMsgKind2)} - {k274}]
    a2 = a1[0]
  ...
  doAssert k274 notin s1
  doAssert k274 notin s2
