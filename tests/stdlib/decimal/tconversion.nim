...
block: # string tests
    ...
    assertEquals(testAThree.significance, 3)
    ...
    assertEquals(testANine.significance, 9)
    ...
    assertEquals(testBThree.significance, 3)
    ...
    assertEquals(testBNine.significance, 9)
    ...
    assertEquals(testCThree.significance, 3)
    ...
    assertEquals(testCNine.significance, 9)
...
#     let testANine = newDecimal(199, significance=9)
...
#     let testCThree = newDecimal(567000000, significance=3)
...
#     assertEquals(testA.significance, 3)
...
#     assertEquals(testB.significance, 3)
...
#     assertEquals(testC.significance, 9)
...
#     assertEquals(testD.significance, 16)
...
#     assertEquals(testE.significance, 4)
...
#     assertEquals(testF.significance, 4)
