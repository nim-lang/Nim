...
if [ $# -eq 1 ] ; then
  ...
  mkdir -p $libdir/oldwrappers
  mkdir -p $libdir/oldwrappers/cairo
  mkdir -p $libdir/oldwrappers/gtk
  mkdir -p $libdir/oldwrappers/lua
  mkdir -p $libdir/oldwrappers/opengl
  mkdir -p $libdir/oldwrappers/pcre
  mkdir -p $libdir/oldwrappers/sdl
  mkdir -p $libdir/oldwrappers/x11
  mkdir -p $libdir/oldwrappers/zip
  ...
  cp lib/pure/yamllexer.nim $libdir/pure/yamllexer.nim
  ...
  cp lib/oldwrappers/iup.nim $libdir/oldwrappers/iup.nim
  chmod 644 $libdir/oldwrappers/iup.nim
  cp lib/oldwrappers/libcurl.nim $libdir/oldwrappers/libcurl.nim
  chmod 644 $libdir/oldwrappers/libcurl.nim
  cp lib/oldwrappers/mysql.nim $libdir/oldwrappers/mysql.nim
  chmod 644 $libdir/oldwrappers/mysql.nim
  cp lib/oldwrappers/odbcsql.nim $libdir/oldwrappers/odbcsql.nim
  chmod 644 $libdir/oldwrappers/odbcsql.nim
  cp lib/oldwrappers/postgres.nim $libdir/oldwrappers/postgres.nim
  chmod 644 $libdir/oldwrappers/postgres.nim
  cp lib/oldwrappers/python.nim $libdir/oldwrappers/python.nim
  chmod 644 $libdir/oldwrappers/python.nim
  cp lib/oldwrappers/sqlite3.nim $libdir/oldwrappers/sqlite3.nim
  chmod 644 $libdir/oldwrappers/sqlite3.nim
  cp lib/oldwrappers/tcl.nim $libdir/oldwrappers/tcl.nim
  chmod 644 $libdir/oldwrappers/tcl.nim
  cp lib/oldwrappers/cairo/cairo.nim $libdir/oldwrappers/cairo/cairo.nim
  chmod 644 $libdir/oldwrappers/cairo/cairo.nim
  cp lib/oldwrappers/cairo/cairoft.nim $libdir/oldwrappers/cairo/cairoft.nim
  chmod 644 $libdir/oldwrappers/cairo/cairoft.nim
  cp lib/oldwrappers/cairo/cairowin32.nim $libdir/oldwrappers/cairo/cairowin32.nim
  chmod 644 $libdir/oldwrappers/cairo/cairowin32.nim
  cp lib/oldwrappers/cairo/cairoxlib.nim $libdir/oldwrappers/cairo/cairoxlib.nim
  chmod 644 $libdir/oldwrappers/cairo/cairoxlib.nim
  cp lib/oldwrappers/gtk/atk.nim $libdir/oldwrappers/gtk/atk.nim
  chmod 644 $libdir/oldwrappers/gtk/atk.nim
  cp lib/oldwrappers/gtk/gdk2.nim $libdir/oldwrappers/gtk/gdk2.nim
  chmod 644 $libdir/oldwrappers/gtk/gdk2.nim
  cp lib/oldwrappers/gtk/gdk2pixbuf.nim $libdir/oldwrappers/gtk/gdk2pixbuf.nim
  chmod 644 $libdir/oldwrappers/gtk/gdk2pixbuf.nim
  cp lib/oldwrappers/gtk/gdkglext.nim $libdir/oldwrappers/gtk/gdkglext.nim
  chmod 644 $libdir/oldwrappers/gtk/gdkglext.nim
  cp lib/oldwrappers/gtk/glib2.nim $libdir/oldwrappers/gtk/glib2.nim
  chmod 644 $libdir/oldwrappers/gtk/glib2.nim
  cp lib/oldwrappers/gtk/gtk2.nim $libdir/oldwrappers/gtk/gtk2.nim
  chmod 644 $libdir/oldwrappers/gtk/gtk2.nim
  cp lib/oldwrappers/gtk/gtkglext.nim $libdir/oldwrappers/gtk/gtkglext.nim
  chmod 644 $libdir/oldwrappers/gtk/gtkglext.nim
  cp lib/oldwrappers/gtk/gtkhtml.nim $libdir/oldwrappers/gtk/gtkhtml.nim
  chmod 644 $libdir/oldwrappers/gtk/gtkhtml.nim
  cp lib/oldwrappers/gtk/libglade2.nim $libdir/oldwrappers/gtk/libglade2.nim
  chmod 644 $libdir/oldwrappers/gtk/libglade2.nim
  cp lib/oldwrappers/gtk/pango.nim $libdir/oldwrappers/gtk/pango.nim
  chmod 644 $libdir/oldwrappers/gtk/pango.nim
  cp lib/oldwrappers/gtk/pangoutils.nim $libdir/oldwrappers/gtk/pangoutils.nim
  chmod 644 $libdir/oldwrappers/gtk/pangoutils.nim
  cp lib/oldwrappers/lua/lauxlib.nim $libdir/oldwrappers/lua/lauxlib.nim
  chmod 644 $libdir/oldwrappers/lua/lauxlib.nim
  cp lib/oldwrappers/lua/lua.nim $libdir/oldwrappers/lua/lua.nim
  chmod 644 $libdir/oldwrappers/lua/lua.nim
  cp lib/oldwrappers/lua/lualib.nim $libdir/oldwrappers/lua/lualib.nim
  chmod 644 $libdir/oldwrappers/lua/lualib.nim
  cp lib/oldwrappers/opengl/gl.nim $libdir/oldwrappers/opengl/gl.nim
  chmod 644 $libdir/oldwrappers/opengl/gl.nim
  cp lib/oldwrappers/opengl/glext.nim $libdir/oldwrappers/opengl/glext.nim
  chmod 644 $libdir/oldwrappers/opengl/glext.nim
  cp lib/oldwrappers/opengl/glu.nim $libdir/oldwrappers/opengl/glu.nim
  chmod 644 $libdir/oldwrappers/opengl/glu.nim
  cp lib/oldwrappers/opengl/glut.nim $libdir/oldwrappers/opengl/glut.nim
  chmod 644 $libdir/oldwrappers/opengl/glut.nim
  cp lib/oldwrappers/opengl/glx.nim $libdir/oldwrappers/opengl/glx.nim
  chmod 644 $libdir/oldwrappers/opengl/glx.nim
  cp lib/oldwrappers/opengl/wingl.nim $libdir/oldwrappers/opengl/wingl.nim
  chmod 644 $libdir/oldwrappers/opengl/wingl.nim
  cp lib/oldwrappers/pcre/pcre.nim $libdir/oldwrappers/pcre/pcre.nim
  chmod 644 $libdir/oldwrappers/pcre/pcre.nim
  cp lib/oldwrappers/pcre/pcre_all.c $libdir/oldwrappers/pcre/pcre_all.c
  chmod 644 $libdir/oldwrappers/pcre/pcre_all.c
  cp lib/oldwrappers/sdl/sdl.nim $libdir/oldwrappers/sdl/sdl.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl.nim
  cp lib/oldwrappers/sdl/sdl_gfx.nim $libdir/oldwrappers/sdl/sdl_gfx.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl_gfx.nim
  cp lib/oldwrappers/sdl/sdl_image.nim $libdir/oldwrappers/sdl/sdl_image.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl_image.nim
  cp lib/oldwrappers/sdl/sdl_mixer.nim $libdir/oldwrappers/sdl/sdl_mixer.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl_mixer.nim
  cp lib/oldwrappers/sdl/sdl_mixer_nosmpeg.nim $libdir/oldwrappers/sdl/sdl_mixer_nosmpeg.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl_mixer_nosmpeg.nim
  cp lib/oldwrappers/sdl/sdl_net.nim $libdir/oldwrappers/sdl/sdl_net.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl_net.nim
  cp lib/oldwrappers/sdl/sdl_ttf.nim $libdir/oldwrappers/sdl/sdl_ttf.nim
  chmod 644 $libdir/oldwrappers/sdl/sdl_ttf.nim
  cp lib/oldwrappers/sdl/smpeg.nim $libdir/oldwrappers/sdl/smpeg.nim
  chmod 644 $libdir/oldwrappers/sdl/smpeg.nim
  cp lib/oldwrappers/x11/cursorfont.nim $libdir/oldwrappers/x11/cursorfont.nim
  chmod 644 $libdir/oldwrappers/x11/cursorfont.nim
  cp lib/oldwrappers/x11/keysym.nim $libdir/oldwrappers/x11/keysym.nim
  chmod 644 $libdir/oldwrappers/x11/keysym.nim
  cp lib/oldwrappers/x11/x.nim $libdir/oldwrappers/x11/x.nim
  chmod 644 $libdir/oldwrappers/x11/x.nim
  cp lib/oldwrappers/x11/xatom.nim $libdir/oldwrappers/x11/xatom.nim
  chmod 644 $libdir/oldwrappers/x11/xatom.nim
  cp lib/oldwrappers/x11/xcms.nim $libdir/oldwrappers/x11/xcms.nim
  chmod 644 $libdir/oldwrappers/x11/xcms.nim
  cp lib/oldwrappers/x11/xf86dga.nim $libdir/oldwrappers/x11/xf86dga.nim
  chmod 644 $libdir/oldwrappers/x11/xf86dga.nim
  cp lib/oldwrappers/x11/xf86vmode.nim $libdir/oldwrappers/x11/xf86vmode.nim
  chmod 644 $libdir/oldwrappers/x11/xf86vmode.nim
  cp lib/oldwrappers/x11/xi.nim $libdir/oldwrappers/x11/xi.nim
  chmod 644 $libdir/oldwrappers/x11/xi.nim
  cp lib/oldwrappers/x11/xinerama.nim $libdir/oldwrappers/x11/xinerama.nim
  chmod 644 $libdir/oldwrappers/x11/xinerama.nim
  cp lib/oldwrappers/x11/xkb.nim $libdir/oldwrappers/x11/xkb.nim
  chmod 644 $libdir/oldwrappers/x11/xkb.nim
  cp lib/oldwrappers/x11/xkblib.nim $libdir/oldwrappers/x11/xkblib.nim
  chmod 644 $libdir/oldwrappers/x11/xkblib.nim
  cp lib/oldwrappers/x11/xlib.nim $libdir/oldwrappers/x11/xlib.nim
  chmod 644 $libdir/oldwrappers/x11/xlib.nim
  cp lib/oldwrappers/x11/xrandr.nim $libdir/oldwrappers/x11/xrandr.nim
  chmod 644 $libdir/oldwrappers/x11/xrandr.nim
  cp lib/oldwrappers/x11/xrender.nim $libdir/oldwrappers/x11/xrender.nim
  chmod 644 $libdir/oldwrappers/x11/xrender.nim
  cp lib/oldwrappers/x11/xresource.nim $libdir/oldwrappers/x11/xresource.nim
  chmod 644 $libdir/oldwrappers/x11/xresource.nim
  cp lib/oldwrappers/x11/xshm.nim $libdir/oldwrappers/x11/xshm.nim
  chmod 644 $libdir/oldwrappers/x11/xshm.nim
  cp lib/oldwrappers/x11/xutil.nim $libdir/oldwrappers/x11/xutil.nim
  chmod 644 $libdir/oldwrappers/x11/xutil.nim
  cp lib/oldwrappers/x11/xv.nim $libdir/oldwrappers/x11/xv.nim
  chmod 644 $libdir/oldwrappers/x11/xv.nim
  cp lib/oldwrappers/x11/xvlib.nim $libdir/oldwrappers/x11/xvlib.nim
  chmod 644 $libdir/oldwrappers/x11/xvlib.nim
  cp lib/oldwrappers/zip/libzip.nim $libdir/oldwrappers/zip/libzip.nim
  chmod 644 $libdir/oldwrappers/zip/libzip.nim
  cp lib/oldwrappers/zip/zlib.nim $libdir/oldwrappers/zip/zlib.nim
  chmod 644 $libdir/oldwrappers/zip/zlib.nim
  cp lib/oldwrappers/zip/zzip.nim $libdir/oldwrappers/zip/zzip.nim
  chmod 644 $libdir/oldwrappers/zip/zzip.nim
  cp lib/oldwrappers/zip/libzip_all.c $libdir/oldwrappers/zip/libzip_all.c
