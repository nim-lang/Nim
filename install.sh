...
if [ $# -eq 1 ] ; then
  ...
  if [ -f doc/sdl.html ]; then
    cp doc/sdl.html $docdir/sdl.html
    chmod 644 $docdir/sdl.html
  fi
  if [ -f doc/sdl_gfx.html ]; then
    cp doc/sdl_gfx.html $docdir/sdl_gfx.html
    chmod 644 $docdir/sdl_gfx.html
  fi
  if [ -f doc/sdl_image.html ]; then
    cp doc/sdl_image.html $docdir/sdl_image.html
    chmod 644 $docdir/sdl_image.html
  fi
  if [ -f doc/sdl_mixer.html ]; then
    cp doc/sdl_mixer.html $docdir/sdl_mixer.html
    chmod 644 $docdir/sdl_mixer.html
  fi
  if [ -f doc/sdl_mixer_nosmpeg.html ]; then
    cp doc/sdl_mixer_nosmpeg.html $docdir/sdl_mixer_nosmpeg.html
    chmod 644 $docdir/sdl_mixer_nosmpeg.html
  fi
  if [ -f doc/sdl_net.html ]; then
    cp doc/sdl_net.html $docdir/sdl_net.html
    chmod 644 $docdir/sdl_net.html
  fi
  if [ -f doc/sdl_ttf.html ]; then
    cp doc/sdl_ttf.html $docdir/sdl_ttf.html
    chmod 644 $docdir/sdl_ttf.html
  fi
  ...
  if [ -f doc/smpeg.html ]; then
    cp doc/smpeg.html $docdir/smpeg.html
    chmod 644 $docdir/smpeg.html
  fi
