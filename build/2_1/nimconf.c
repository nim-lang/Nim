...
STRING_LITERAL(TMP197676, "/usr", 4);
STRING_LITERAL(TMP197677, "/usr/lib/nimrod", 15);
STRING_LITERAL(TMP197678, "/usr/local", 10);
STRING_LITERAL(TMP197679, "/usr/local/lib/nimrod", 21);
STRING_LITERAL(TMP197680, "lib", 3);
STRING_LITERAL(TMP197708, "@", 1);
STRING_LITERAL(TMP197709, "\')\'", 3);
STRING_LITERAL(TMP197710, "\':\'", 3);
STRING_LITERAL(TMP197711, "@if", 3);
STRING_LITERAL(TMP197712, "@end", 4);
STRING_LITERAL(TMP197714, "-", 1);
STRING_LITERAL(TMP197715, "--", 2);
STRING_LITERAL(TMP197716, "", 0);
STRING_LITERAL(TMP197717, "\']\'", 3);
STRING_LITERAL(TMP197718, "&", 1);
STRING_LITERAL(TMP197720, "config", 6);
STRING_LITERAL(TMP197721, "/etc/", 5);
STRING_LITERAL(TMP197722, "nimrod.cfg", 10);
STRING_LITERAL(TMP197723, "cfg", 3);
...
goto LA4;
LA5: ;
Lexmessage_78326(&(*L_81061), ((NU8) 21), ((NimStringDesc*) &TMP197709));
LA4: ;
goto LA1;
LA2: ;
...
goto LA1;
LA2: ;
Lexmessage_78326(&(*L_81120), ((NU8) 21), ((NimStringDesc*) &TMP197710));
LA1: ;
return Result_81122;
}
N_NIMCALL(void, Doelse_81181)(TY78267* L_81184, TY78263* Tok_81185) {
if (!((Condstack_81133->Sup.len-1) < 0)) goto LA2;
Lexmessage_78326(&(*L_81184), ((NU8) 21), ((NimStringDesc*) &TMP197711));
LA2: ;
...
Res_81204 = 0;
if (!((Condstack_81133->Sup.len-1) < 0)) goto LA2;
Lexmessage_78326(&(*L_81202), ((NU8) 21), ((NimStringDesc*) &TMP197711));
LA2: ;
...
N_NIMCALL(void, Doend_81150)(TY78267* L_81153, TY78263* Tok_81154) {
if (!((Condstack_81133->Sup.len-1) < 0)) goto LA2;
Lexmessage_78326(&(*L_81153), ((NU8) 21), ((NimStringDesc*) &TMP197711));
LA2: ;
...
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*(*Tok_81179).Ident).S, ((NimStringDesc*) &TMP197708));
LA4: ;
if (!LOC3) goto LA5;
...
Lexmessage_78326(&(*L_81178), ((NU8) 21), ((NimStringDesc*) &TMP197712));
goto LA2;
LA24: ;
Ppgettok_81010(L_81178, Tok_81179);
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*(*Tok_81321).Ident).S, ((NimStringDesc*) &TMP197708));
LA3: ;
if (!LOC2) goto LA1;
...
LOC3 = 0;
LOC3 = Getident_55016(((NimStringDesc*) &TMP197714));
LOC2 = ((*(*Tok_81362).Ident).Sup.Id == (*LOC3).Sup.Id);
if (LOC2) goto LA4;
LOC5 = 0;
LOC5 = Getident_55016(((NimStringDesc*) &TMP197715));
...
Conftok_81317(L_81361, Tok_81362);
Val_81364 = copyString(((NimStringDesc*) &TMP197716));
while (1) {
...
goto LA14;
LA15: ;
Lexmessage_78326(&(*L_81361), ((NU8) 21), ((NimStringDesc*) &TMP197717));
LA14: ;
...
if (!(LOC27)) goto LA28;
LOC29 = 0;
LOC29 = Getident_55016(((NimStringDesc*) &TMP197718));
...
Lexmessage_78326(&L_81437, ((NU8) 21), ((NimStringDesc*) &TMP197712));
LA6: ;
...
LOC6[1] = copyString(((NimStringDesc*) &TMP197720));
...
appendString(LOC11, ((NimStringDesc*) &TMP197721));
...
if (!eqStrings(Prefix_81521, ((NimStringDesc*) &TMP197676))) goto LA5;
asgnRefNoCycle((void**) &Libpath_47117, copyString(((NimStringDesc*) &TMP197677)));
goto LA4;
LA5: ;
if (!eqStrings(Prefix_81521, ((NimStringDesc*) &TMP197678))) goto LA7;
asgnRefNoCycle((void**) &Libpath_47117, copyString(((NimStringDesc*) &TMP197679)));
goto LA4;
LA7: ;
asgnRefNoCycle((void**) &Libpath_47117, nosJoinPath(Prefix_81521, ((NimStringDesc*) &TMP197680)));
LA4: ;
LA2: ;
Loadspecialconfig_81007(((NimStringDesc*) &TMP197722));
LOC10 = !(((Gglobaloptions_47084 &(1<<((((NU8) 17))&31)))!=0));
if (!(LOC10)) goto LA11;
LOC10 = !(((Project_81006) && (Project_81006)->Sup.len == 0));
LA11: ;
if (!LOC10) goto LA12;
Conffile_81520 = nosChangeFileExt(Project_81006, ((NimStringDesc*) &TMP197723));
