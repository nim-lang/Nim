...
STRING_LITERAL(TMP195678, "/usr", 4);
STRING_LITERAL(TMP195679, "/usr/lib/nimrod", 15);
STRING_LITERAL(TMP195680, "/usr/local", 10);
STRING_LITERAL(TMP195681, "/usr/local/lib/nimrod", 21);
STRING_LITERAL(TMP195682, "lib", 3);
STRING_LITERAL(TMP195710, "@", 1);
STRING_LITERAL(TMP195711, "\')\'", 3);
STRING_LITERAL(TMP195712, "\':\'", 3);
STRING_LITERAL(TMP195713, "@if", 3);
STRING_LITERAL(TMP195714, "@end", 4);
STRING_LITERAL(TMP195716, "-", 1);
STRING_LITERAL(TMP195717, "--", 2);
STRING_LITERAL(TMP195718, "", 0);
STRING_LITERAL(TMP195719, "\']\'", 3);
STRING_LITERAL(TMP195720, "&", 1);
STRING_LITERAL(TMP195722, "config", 6);
STRING_LITERAL(TMP195723, "/etc/", 5);
STRING_LITERAL(TMP195724, "nimrod.cfg", 10);
STRING_LITERAL(TMP195725, "cfg", 3);
...
goto LA4;
LA5: ;
Lexmessage_77326(&(*L_80061), ((NU8) 21), ((NimStringDesc*) &TMP195711));
LA4: ;
goto LA1;
LA2: ;
...
goto LA1;
LA2: ;
Lexmessage_77326(&(*L_80120), ((NU8) 21), ((NimStringDesc*) &TMP195712));
LA1: ;
return Result_80122;
}
N_NIMCALL(void, Doelse_80181)(TY77267* L_80184, TY77263* Tok_80185) {
if (!((Condstack_80133->Sup.len-1) < 0)) goto LA2;
Lexmessage_77326(&(*L_80184), ((NU8) 21), ((NimStringDesc*) &TMP195713));
LA2: ;
...
Res_80204 = 0;
if (!((Condstack_80133->Sup.len-1) < 0)) goto LA2;
Lexmessage_77326(&(*L_80202), ((NU8) 21), ((NimStringDesc*) &TMP195713));
LA2: ;
...
N_NIMCALL(void, Doend_80150)(TY77267* L_80153, TY77263* Tok_80154) {
if (!((Condstack_80133->Sup.len-1) < 0)) goto LA2;
Lexmessage_77326(&(*L_80153), ((NU8) 21), ((NimStringDesc*) &TMP195713));
LA2: ;
...
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*(*Tok_80179).Ident).S, ((NimStringDesc*) &TMP195710));
LA4: ;
if (!LOC3) goto LA5;
...
Lexmessage_77326(&(*L_80178), ((NU8) 21), ((NimStringDesc*) &TMP195714));
goto LA2;
LA24: ;
Ppgettok_80010(L_80178, Tok_80179);
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*(*Tok_80321).Ident).S, ((NimStringDesc*) &TMP195710));
LA3: ;
if (!LOC2) goto LA1;
...
LOC3 = 0;
LOC3 = Getident_54016(((NimStringDesc*) &TMP195716));
LOC2 = ((*(*Tok_80362).Ident).Sup.Id == (*LOC3).Sup.Id);
if (LOC2) goto LA4;
LOC5 = 0;
LOC5 = Getident_54016(((NimStringDesc*) &TMP195717));
...
Conftok_80317(L_80361, Tok_80362);
Val_80364 = copyString(((NimStringDesc*) &TMP195718));
while (1) {
...
goto LA14;
LA15: ;
Lexmessage_77326(&(*L_80361), ((NU8) 21), ((NimStringDesc*) &TMP195719));
LA14: ;
...
if (!(LOC27)) goto LA28;
LOC29 = 0;
LOC29 = Getident_54016(((NimStringDesc*) &TMP195720));
...
Lexmessage_77326(&L_80437, ((NU8) 21), ((NimStringDesc*) &TMP195714));
LA6: ;
...
LOC6[1] = copyString(((NimStringDesc*) &TMP195722));
...
appendString(LOC11, ((NimStringDesc*) &TMP195723));
...
if (!eqStrings(Prefix_80521, ((NimStringDesc*) &TMP195678))) goto LA5;
asgnRefNoCycle((void**) &Libpath_46112, copyString(((NimStringDesc*) &TMP195679)));
goto LA4;
LA5: ;
if (!eqStrings(Prefix_80521, ((NimStringDesc*) &TMP195680))) goto LA7;
asgnRefNoCycle((void**) &Libpath_46112, copyString(((NimStringDesc*) &TMP195681)));
goto LA4;
LA7: ;
asgnRefNoCycle((void**) &Libpath_46112, nosJoinPath(Prefix_80521, ((NimStringDesc*) &TMP195682)));
LA4: ;
LA2: ;
Loadspecialconfig_80007(((NimStringDesc*) &TMP195724));
LOC10 = !(((Gglobaloptions_46079 &(1<<((((NU8) 17))&31)))!=0));
if (!(LOC10)) goto LA11;
LOC10 = !(((Project_80006) && (Project_80006)->Sup.len == 0));
LA11: ;
if (!LOC10) goto LA12;
Conffile_80520 = nosChangeFileExt(Project_80006, ((NimStringDesc*) &TMP195725));
