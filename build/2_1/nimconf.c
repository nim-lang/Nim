...
STRING_LITERAL(TMP196684, "/usr", 4);
STRING_LITERAL(TMP196685, "/usr/lib/nimrod", 15);
STRING_LITERAL(TMP196686, "/usr/local", 10);
STRING_LITERAL(TMP196687, "/usr/local/lib/nimrod", 21);
STRING_LITERAL(TMP196688, "lib", 3);
STRING_LITERAL(TMP196714, "@", 1);
STRING_LITERAL(TMP196715, "\')\'", 3);
STRING_LITERAL(TMP196716, "\':\'", 3);
STRING_LITERAL(TMP196717, "@if", 3);
STRING_LITERAL(TMP196718, "@end", 4);
STRING_LITERAL(TMP196720, "-", 1);
STRING_LITERAL(TMP196721, "--", 2);
STRING_LITERAL(TMP196722, "", 0);
STRING_LITERAL(TMP196723, "\']\'", 3);
STRING_LITERAL(TMP196724, "&", 1);
STRING_LITERAL(TMP196727, "config", 6);
STRING_LITERAL(TMP196728, "/etc/", 5);
STRING_LITERAL(TMP196729, "nimrod.cfg", 10);
STRING_LITERAL(TMP196730, "cfg", 3);
...
goto LA4;
LA5: ;
Lexmessage_76326(&(*L_79062), ((NU8) 21), ((NimStringDesc*) &TMP196715));
LA4: ;
goto LA1;
LA2: ;
...
goto LA1;
LA2: ;
Lexmessage_76326(&(*L_79123), ((NU8) 21), ((NimStringDesc*) &TMP196716));
LA1: ;
return Result_79125;
}
N_NIMCALL(void, Doelse_79182)(TY76267* L_79185, TY76263* Tok_79186) {
if (!((Condstack_79136->Sup.len-1) < 0)) goto LA2;
Lexmessage_76326(&(*L_79185), ((NU8) 21), ((NimStringDesc*) &TMP196717));
LA2: ;
...
Res_79203 = 0;
if (!((Condstack_79136->Sup.len-1) < 0)) goto LA2;
Lexmessage_76326(&(*L_79201), ((NU8) 21), ((NimStringDesc*) &TMP196717));
LA2: ;
...
N_NIMCALL(void, Doend_79153)(TY76267* L_79156, TY76263* Tok_79157) {
if (!((Condstack_79136->Sup.len-1) < 0)) goto LA2;
Lexmessage_76326(&(*L_79156), ((NU8) 21), ((NimStringDesc*) &TMP196717));
LA2: ;
...
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*(*Tok_79180).Ident).S, ((NimStringDesc*) &TMP196714));
LA4: ;
if (!LOC3) goto LA5;
...
Lexmessage_76326(&(*L_79179), ((NU8) 21), ((NimStringDesc*) &TMP196718));
goto LA2;
LA24: ;
Ppgettok_79010(L_79179, Tok_79180);
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*(*Tok_79333).Ident).S, ((NimStringDesc*) &TMP196714));
LA3: ;
if (!LOC2) goto LA1;
...
LOC3 = 0;
LOC3 = Getident_54016(((NimStringDesc*) &TMP196720));
LOC2 = ((*(*Tok_79375).Ident).Sup.Id == (*LOC3).Sup.Id);
if (LOC2) goto LA4;
LOC5 = 0;
LOC5 = Getident_54016(((NimStringDesc*) &TMP196721));
...
Conftok_79329(L_79374, Tok_79375);
Val_79377 = copyString(((NimStringDesc*) &TMP196722));
while (1) {
...
goto LA14;
LA15: ;
Lexmessage_76326(&(*L_79374), ((NU8) 21), ((NimStringDesc*) &TMP196723));
LA14: ;
...
if (!(LOC27)) goto LA28;
LOC29 = 0;
LOC29 = Getident_54016(((NimStringDesc*) &TMP196724));
...
Lexmessage_76326(&L_79450, ((NU8) 21), ((NimStringDesc*) &TMP196718));
LA6: ;
...
LOC6[1] = copyString(((NimStringDesc*) &TMP196727));
...
if (!eqStrings(Prefix_79541, ((NimStringDesc*) &TMP196684))) goto LA5;
asgnRefNoCycle((void**) &Libpath_46110, copyString(((NimStringDesc*) &TMP196685)));
goto LA4;
LA5: ;
if (!eqStrings(Prefix_79541, ((NimStringDesc*) &TMP196686))) goto LA7;
asgnRefNoCycle((void**) &Libpath_46110, copyString(((NimStringDesc*) &TMP196687)));
goto LA4;
LA7: ;
asgnRefNoCycle((void**) &Libpath_46110, nosJoinPath(Prefix_79541, ((NimStringDesc*) &TMP196688)));
LA4: ;
LA2: ;
Loadspecialconfig_79007(((NimStringDesc*) &TMP196729));
LOC10 = !(((Gglobaloptions_46077 &(1<<((((NU8) 17))&31)))!=0));
if (!(LOC10)) goto LA11;
LOC10 = !(((Project_79006) && (Project_79006)->Sup.len == 0));
LA11: ;
if (!LOC10) goto LA12;
Conffile_79540 = nosChangeFileExt(Project_79006, ((NimStringDesc*) &TMP196730));
