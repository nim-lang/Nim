...
STRING_LITERAL(TMP194293, "c\"", 2);
STRING_LITERAL(TMP194294, "\\00\"", 4);
STRING_LITERAL(TMP194296, "\"", 1);
STRING_LITERAL(TMP194297, "\012", 1);
...
Res_157202 = copyString(((NimStringDesc*) &TMP194293));
I_157212 = 0;
HEX3Atmp_157222 = 0;
...
appendString(Res_157202, ((NimStringDesc*) &TMP194294));
LOC7 = 0;
...
Res_157179 = copyString(((NimStringDesc*) &TMP194296));
I_157189 = 0;
HEX3Atmp_157194 = 0;
...
appendString(Res_157179, ((NimStringDesc*) &TMP194297));
LOC5 = 0;
