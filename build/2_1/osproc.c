...
STRING_LITERAL(TMP198908, "failed to create a pipe", 23);
STRING_LITERAL(TMP198909, "failed to fork process", 22);
STRING_LITERAL(TMP198910, "", 0);
STRING_LITERAL(TMP198911, "=", 1);
STRING_LITERAL(TMP198912, " ", 1);
STRING_LITERAL(TMP198914, "sh", 2);
STRING_LITERAL(TMP198915, "-c", 2);
NIM_CONST TY118997 TMP198913 = {((NimStringDesc*) &TMP198914),
((NimStringDesc*) &TMP198915)}
;
STRING_LITERAL(TMP198916, "execve call failed: ", 20);
STRING_LITERAL(TMP198917, "\012", 1);
...
appendString(LOC7, ((NimStringDesc*) &TMP198911));
...
appendString(Result_70208, ((NimStringDesc*) &TMP198912));
LOC2 = 0;
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3866(stdout, ((NimStringDesc*) &TMP198917));
}
N_NIMCALL(TY69202*, nospstartProcess)(NimStringDesc* Command_69238, NimStringDesc* Workingdir_69239, NimStringDesc** Args_69244, NI Args_69244Len0, TY67408* Env_69245, NU8 Options_69248) {
...
A_70433 = Tocstringarray_70218(TMP198913, 2, LOC53, 1);
...
appendString(LOC60, ((NimStringDesc*) &TMP198916));
...
LOC66 = 0;
LOC67 = 0;
LOC67 = nsuJoinSep(Args_69244, Args_69244Len0, ((NimStringDesc*) &TMP198912));
LOC66 = rawNewString(Command_69238->Sup.len + LOC67->Sup.len + 1);
appendString(LOC66, Command_69238);
appendString(LOC66, ((NimStringDesc*) &TMP198912));
...
Result_69608 = nospstartProcess(C_69609->data[0], ((NimStringDesc*) &TMP198910), A_69627->data, A_69627->Sup.len, NIM_NIL, Options_69607);
return Result_69608;
}
N_NIMCALL(NIM_BOOL, nosprunning)(TY69202* P_69260) {
