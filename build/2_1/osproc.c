...
STRING_LITERAL(TMP196862, "failed to create a pipe", 23);
STRING_LITERAL(TMP196863, "failed to fork process", 22);
STRING_LITERAL(TMP196864, "", 0);
STRING_LITERAL(TMP196865, "=", 1);
STRING_LITERAL(TMP196866, " ", 1);
STRING_LITERAL(TMP196868, "sh", 2);
STRING_LITERAL(TMP196869, "-c", 2);
NIM_CONST TY115159 TMP196867 = {((NimStringDesc*) &TMP196868),
((NimStringDesc*) &TMP196869)}
;
STRING_LITERAL(TMP196870, "execve call failed: ", 20);
STRING_LITERAL(TMP196871, "\012", 1);
...
appendString(LOC7, ((NimStringDesc*) &TMP196865));
...
appendString(Result_69208, ((NimStringDesc*) &TMP196866));
LOC2 = 0;
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3866(stdout, ((NimStringDesc*) &TMP196871));
}
N_NIMCALL(TY68202*, nospstartProcess)(NimStringDesc* Command_68238, NimStringDesc* Workingdir_68239, NimStringDesc** Args_68244, NI Args_68244Len0, TY66408* Env_68245, NU8 Options_68248) {
...
A_69433 = Tocstringarray_69218(TMP196867, 2, LOC53, 1);
...
appendString(LOC60, ((NimStringDesc*) &TMP196870));
...
LOC66 = 0;
LOC67 = 0;
LOC67 = nsuJoinSep(Args_68244, Args_68244Len0, ((NimStringDesc*) &TMP196866));
LOC66 = rawNewString(Command_68238->Sup.len + LOC67->Sup.len + 1);
appendString(LOC66, Command_68238);
appendString(LOC66, ((NimStringDesc*) &TMP196866));
...
Result_68608 = nospstartProcess(C_68609->data[0], ((NimStringDesc*) &TMP196864), A_68627->data, A_68627->Sup.len, NIM_NIL, Options_68607);
return Result_68608;
}
N_NIMCALL(NIM_BOOL, nosprunning)(TY68202* P_68260) {
