...
STRING_LITERAL(TMP198481, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP198482, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP198483, "", 0);
STRING_LITERAL(TMP198484, "dot", 3);
...
Appf_52074(&Gdotgraph_187015, ((NimStringDesc*) &TMP198481), LOC1, 2);
}
N_NIMCALL(TY55525*, Adddotdependency_187025)(TY104002* C_187027, TY55525* N_187028) {
...
LOC3 = 0;
LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP198483));
LOC1[0] = Torope_52046(LOC3);
LOC1[1] = Gdotgraph_187015;
LOC4 = 0;
LOC4 = Ropef_52069(((NimStringDesc*) &TMP198482), LOC1, 2);
LOC5 = 0;
LOC5 = nosChangeFileExt(Project_187008, ((NimStringDesc*) &TMP198484));
