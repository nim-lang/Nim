...
STRING_LITERAL(TMP197484, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP197485, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP197486, "", 0);
STRING_LITERAL(TMP197487, "dot", 3);
...
Appf_52071(&Gdotgraph_186015, ((NimStringDesc*) &TMP197484), LOC1, 2);
}
N_NIMCALL(TY55526*, Adddotdependency_186025)(TY105002* C_186027, TY55526* N_186028) {
...
LOC3 = 0;
LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP197486));
LOC1[0] = Torope_52046(LOC3);
LOC1[1] = Gdotgraph_186015;
LOC4 = 0;
LOC4 = Ropef_52066(((NimStringDesc*) &TMP197485), LOC1, 2);
LOC5 = 0;
LOC5 = nosChangeFileExt(Project_186008, ((NimStringDesc*) &TMP197487));
