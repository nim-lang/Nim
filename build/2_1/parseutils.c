...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP195655, "overflow", 8);
...
LOC2 = (0 <= (NI32)(Result_6605 ^ A_6603));
if (LOC2) goto LA3;
LOC2 = (0 <= (NI32)(Result_6605 ^ (NI32)((NU32) ~(B_6604))));
LA3: ;
if (!LOC2) goto LA4;
goto BeforeRet;
LA4: ;
...
NI64 Sign_22952;
NI I_22953;
NI64 TMP195650;NI TMP195651;NI64 TMP195652;NI64 TMP195653;NI TMP195654;Result_22951 = 0;
Sign_22952 = 0;
Sign_22952 = -1;
I_22953 = 0;
I_22953 = Start_22950;
...
TMP195650 = mulInt64((*B_22949), 10);TMP195651 = subInt(((NU8)(S_22947->data[I_22953])), 48);TMP195652 = subInt64((NI64)(TMP195650), ((NI64) ((NI32)(TMP195651))));(*B_22949) = (NI64)(TMP195652);
I_22953 = addInt(I_22953, 1);
while (1) {
...
TMP195653 = mulInt64((*B_22949), Sign_22952);(*B_22949) = (NI64)(TMP195653);
TMP195654 = subInt(I_22953, Start_22950);Result_22951 = (NI32)(TMP195654);
LA7: ;
return Result_22951;
}
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* S_23044, NI64* Number_23046, NI Start_23047) {
...
asgnRefNoCycle((void**) &(*E_23069).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP195655)));
