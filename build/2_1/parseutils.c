...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP196662, "overflow", 8);
...
NI64 Sign_22955;
NI I_22956;
NI64 TMP196657;NI TMP196658;NI64 TMP196659;NI64 TMP196660;NI TMP196661;Result_22954 = 0;
Sign_22955 = 0;
Sign_22955 = -1;
I_22956 = 0;
I_22956 = Start_22953;
...
TMP196657 = mulInt64((*B_22952), 10);TMP196658 = subInt(((NU8)(S_22950->data[I_22956])), 48);TMP196659 = subInt64((NI64)(TMP196657), ((NI64) ((NI32)(TMP196658))));(*B_22952) = (NI64)(TMP196659);
I_22956 = addInt(I_22956, 1);
while (1) {
...
TMP196660 = mulInt64((*B_22952), Sign_22955);(*B_22952) = (NI64)(TMP196660);
TMP196661 = subInt(I_22956, Start_22953);Result_22954 = (NI32)(TMP196661);
LA7: ;
return Result_22954;
}
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* S_23049, NI64* Number_23051, NI Start_23052) {
...
asgnRefNoCycle((void**) &(*E_23070).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP196662)));
