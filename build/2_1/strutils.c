...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP197656, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP197704, "invalid float: ", 15);
STRING_LITERAL(TMP197754, "0123456789ABCDEF", 16);
...
appendString(LOC7, ((NimStringDesc*) &TMP197656));
...
appendString(LOC7, ((NimStringDesc*) &TMP197704));
...
J_25421 = Res_25424;
Result_25411->data[J_25421] = ((NimStringDesc*) &TMP197754)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_25409) >> (NU64)(Shift_25413)))) & ((NI32) 15))];
