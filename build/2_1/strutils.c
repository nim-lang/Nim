...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP195656, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP195703, "invalid float: ", 15);
STRING_LITERAL(TMP195744, "0123456789ABCDEF", 16);
...
appendString(LOC5, ((NimStringDesc*) &TMP195656));
...
appendString(LOC5, ((NimStringDesc*) &TMP195703));
...
J_25422 = Res_25425;
Result_25412->data[J_25422] = ((NimStringDesc*) &TMP195744)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_25410) >> (NU64)(Shift_25414)))) & ((NI32) 15))];
