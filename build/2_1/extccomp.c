...
STRING_LITERAL(TMP193654, "crc", 3);
STRING_LITERAL(TMP193655, "0", 1);
STRING_LITERAL(TMP193668, " ", 1);
STRING_LITERAL(TMP193674, ".options.always", 15);
STRING_LITERAL(TMP193675, ".options.linker", 15);
STRING_LITERAL(TMP193676, ".path", 5);
STRING_LITERAL(TMP193724, ".cpp", 4);
STRING_LITERAL(TMP194785, ".debug", 6);
STRING_LITERAL(TMP194786, ".options.debug", 14);
STRING_LITERAL(TMP194787, ".speed", 6);
STRING_LITERAL(TMP194788, ".options.speed", 14);
STRING_LITERAL(TMP194789, ".size", 5);
STRING_LITERAL(TMP194790, ".options.size", 13);
STRING_LITERAL(TMP194791, ".always", 7);
STRING_LITERAL(TMP194792, ".exe", 4);
STRING_LITERAL(TMP194793, "exe", 3);
extern NIM_CONST TY49054 Os_49053;
STRING_LITERAL(TMP194794, "file", 4);
STRING_LITERAL(TMP194795, "objfile", 7);
STRING_LITERAL(TMP194796, "options", 7);
STRING_LITERAL(TMP194797, "include", 7);
STRING_LITERAL(TMP194798, "nimrod", 6);
STRING_LITERAL(TMP194799, "lib", 3);
STRING_LITERAL(TMP194809, "[C_Files]\012", 10);
STRING_LITERAL(TMP194810, "--file:r\"$1\"$n", 14);
STRING_LITERAL(TMP194811, "[Symbols]$n$1", 13);
STRING_LITERAL(TMP194812, "mapping.txt", 11);
STRING_LITERAL(TMP194873, ".linkerexe", 10);
STRING_LITERAL(TMP194874, "builddll", 8);
STRING_LITERAL(TMP194875, "buildgui", 8);
STRING_LITERAL(TMP194876, "objfiles", 8);
STRING_LITERAL(TMP194877, "exefile", 7);
STRING_LITERAL(TMP194878, "compile_", 8);
...
Result_67607 = 0;
Crcfile_67608 = 0;
Crcfile_67608 = Togeneratedfile_44103(Filename_67606, ((NimStringDesc*) &TMP193654));
Currentcrc_67609 = 0;
...
LA8: ;
if (!LOC7) goto LA9;
Line_67612 = copyString(((NimStringDesc*) &TMP193655));
LA9: ;
fclose(F_67610);
Oldcrc_67617 = 0;
...
if (LOC2) goto LA3;
LOC2 = !(((NU8)((*Dest_67574)->data[(NI32)((NI32)((*Dest_67574)->Sup.len - 1) + 0)]) == (NU8)(32)));
LA3: ;
if (!LOC2) goto LA4;
(*Dest_67574) = resizeString((*Dest_67574), 1);
appendString((*Dest_67574), ((NimStringDesc*) &TMP193668));
LA4: ;
...
appendString(LOC4, ((NimStringDesc*) &TMP193674));
...
appendString(LOC6, ((NimStringDesc*) &TMP193676));
...
asgnRefNoCycle((void**) &Cext_67342, copyString(((NimStringDesc*) &TMP193724)));
LA3: ;
LOC5 = rawNewString(Cc_67041[(Ccompiler_67340)-1].Name->Sup.len + 15);
appendString(LOC5, Cc_67041[(Ccompiler_67340)-1].Name);
appendString(LOC5, ((NimStringDesc*) &TMP193674));
...
appendString(LOC7, ((NimStringDesc*) &TMP193675));
...
appendString(LOC12, ((NimStringDesc*) &TMP193676));
...
appendString(LOC1, ((NimStringDesc*) &TMP194786));
...
appendString(LOC1, ((NimStringDesc*) &TMP194788));
...
appendString(LOC1, ((NimStringDesc*) &TMP194790));
...
appendString(LOC5, ((NimStringDesc*) &TMP194785));
Key_67732 = LOC5;
...
appendString(LOC15, ((NimStringDesc*) &TMP194787));
Key_67732 = LOC15;
...
appendString(LOC24, ((NimStringDesc*) &TMP194789));
Key_67732 = LOC24;
...
appendString(LOC31, ((NimStringDesc*) &TMP194791));
Key_67732 = LOC31;
...
appendString(LOC37, ((NimStringDesc*) &TMP194792));
Key_67732 = LOC37;
...
Exe_67734 = nosaddFileExt(Exe_67734, ((NimStringDesc*) &TMP194793));
LA43: ;
...
LOC65[0] = copyString(((NimStringDesc*) &TMP194794));
LOC65[1] = copyString(Cfile_67727);
LOC65[2] = copyString(((NimStringDesc*) &TMP194795));
LOC65[3] = copyString(Objfile_67728);
LOC65[4] = copyString(((NimStringDesc*) &TMP194796));
LOC65[5] = copyString(Options_67729);
LOC65[6] = copyString(((NimStringDesc*) &TMP194797));
LOC65[7] = copyString(Includecmd_67730);
LOC65[8] = copyString(((NimStringDesc*) &TMP194798));
LOC65[9] = Getprefixdir_44107();
LOC65[10] = copyString(((NimStringDesc*) &TMP194799));
...
LOC67[0] = copyString(((NimStringDesc*) &TMP194794));
LOC67[1] = copyString(Cfile_67727);
LOC67[2] = copyString(((NimStringDesc*) &TMP194795));
LOC67[3] = copyString(Objfile_67728);
LOC67[4] = copyString(((NimStringDesc*) &TMP194796));
LOC67[5] = copyString(Options_67729);
LOC67[6] = copyString(((NimStringDesc*) &TMP194797));
LOC67[7] = copyString(Includecmd_67730);
LOC67[8] = copyString(((NimStringDesc*) &TMP194798));
LOC68 = Getprefixdir_44107();
LOC67[9] = Quoteifcontainswhite_24283(LOC68);
LOC67[10] = copyString(((NimStringDesc*) &TMP194799));
...
Appf_50074(&Result_68228, ((NimStringDesc*) &TMP194810), LOC2, 1);
...
LA2: ;
Code_68261 = 0;
Code_68261 = Torope_50046(((NimStringDesc*) &TMP194809));
...
Appf_50074(&Code_68261, ((NimStringDesc*) &TMP194811), LOC6, 1);
LOC7 = nosJoinPath(Projectpath_44111, ((NimStringDesc*) &TMP194812));
...
appendString(LOC2, ((NimStringDesc*) &TMP194878));
...
appendString(LOC26, ((NimStringDesc*) &TMP194873));
...
Linkerexe_68096 = nosaddFileExt(Linkerexe_68096, ((NimStringDesc*) &TMP194793));
LA31: ;
...
LOC60[0] = copyString(((NimStringDesc*) &TMP194874));
LOC60[1] = copyString(Builddll_67966);
LOC60[2] = copyString(((NimStringDesc*) &TMP194875));
LOC60[3] = copyString(Buildgui_67965);
LOC60[4] = copyString(((NimStringDesc*) &TMP194796));
LOC60[5] = copyString(Linkoptions_67390);
LOC60[6] = copyString(((NimStringDesc*) &TMP194876));
LOC60[7] = copyString(Objfiles_68164);
LOC60[8] = copyString(((NimStringDesc*) &TMP194877));
LOC60[9] = copyString(Exefile_68130);
LOC60[10] = copyString(((NimStringDesc*) &TMP194798));
LOC60[11] = Getprefixdir_44107();
LOC60[12] = copyString(((NimStringDesc*) &TMP194799));
...
LOC62[0] = copyString(((NimStringDesc*) &TMP194874));
LOC62[1] = copyString(Builddll_67966);
LOC62[2] = copyString(((NimStringDesc*) &TMP194875));
LOC62[3] = copyString(Buildgui_67965);
LOC62[4] = copyString(((NimStringDesc*) &TMP194796));
LOC62[5] = copyString(Linkoptions_67390);
LOC62[6] = copyString(((NimStringDesc*) &TMP194876));
LOC62[7] = copyString(Objfiles_68164);
LOC62[8] = copyString(((NimStringDesc*) &TMP194877));
LOC62[9] = copyString(Exefile_68130);
LOC62[10] = copyString(((NimStringDesc*) &TMP194798));
LOC63 = Getprefixdir_44107();
LOC62[11] = Quoteifcontainswhite_24283(LOC63);
LOC62[12] = copyString(((NimStringDesc*) &TMP194799));
...
Write_3658(F_67629, ((NimStringDesc*) &TMP195495));
}
