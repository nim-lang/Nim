...
STRING_LITERAL(TMP197128, "owner is nil", 12);
STRING_LITERAL(TMP197130, "popOwner", 8);
STRING_LITERAL(TMP197138, "makeVarType", 11);
STRING_LITERAL(TMP197216, "makePtrType", 11);
...
Limessage_47562((*Sym_106068).Info, ((NU8) 26), ((NimStringDesc*) &TMP197110));
LA2: ;
...
Internalerror_47571(((NimStringDesc*) &TMP197128));
LA2: ;
...
Internalerror_47571(((NimStringDesc*) &TMP197130));
LA2: ;
Gowners_106131 = (TY55527*) setLengthSeq(&(Gowners_106131)->Sup, sizeof(TY55547*), (NI32)(Length_106168 - 1));
}
...
Internalerror_47571(((NimStringDesc*) &TMP197138));
LA2: ;
...
I_106315 = 0;
HEX3Atmp_106331 = 0;
HEX3Atmp_106331 = (NI32)(L_106292 - 1);
Res_106333 = 0;
Res_106333 = 0;
while (1) {
...
(*C_106060).Converters = (TY55527*) setLengthSeq(&((*C_106060).Converters)->Sup, sizeof(TY55547*), (NI32)(L_106292 + 1));
...
Internalerror_47571(((NimStringDesc*) &TMP197216));
LA2: ;
