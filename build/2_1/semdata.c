...
STRING_LITERAL(TMP196121, "owner is nil", 12);
STRING_LITERAL(TMP196123, "popOwner", 8);
STRING_LITERAL(TMP196131, "makeVarType", 11);
STRING_LITERAL(TMP196205, "makePtrType", 11);
...
Limessage_47569((*Sym_107068).Info, ((NU8) 26), ((NimStringDesc*) &TMP196103));
LA2: ;
...
Internalerror_47578(((NimStringDesc*) &TMP196121));
LA2: ;
...
LA2: ;
Gowners_107131 = (TY55528*) setLengthSeq(&(Gowners_107131)->Sup, sizeof(TY55548*), (NI32)(Length_107168 - 1));
}
...
Internalerror_47578(((NimStringDesc*) &TMP196131));
LA2: ;
...
I_107316 = 0;
HEX3Atmp_107331 = 0;
HEX3Atmp_107331 = (NI32)(L_107292 - 1);
Res_107333 = 0;
Res_107333 = 0;
while (1) {
...
(*C_107060).Converters = (TY55528*) setLengthSeq(&((*C_107060).Converters)->Sup, sizeof(TY55548*), (NI32)(L_107292 + 1));
...
Internalerror_47578(((NimStringDesc*) &TMP196205));
LA2: ;
