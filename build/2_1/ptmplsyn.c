...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP197841, "", 0);
STRING_LITERAL(TMP197842, "subschar", 8);
STRING_LITERAL(TMP197843, "metachar", 8);
STRING_LITERAL(TMP197844, "emit", 4);
STRING_LITERAL(TMP197845, "result.add", 10);
STRING_LITERAL(TMP197846, "conc", 4);
STRING_LITERAL(TMP197847, " & ", 3);
STRING_LITERAL(TMP197848, "tostring", 8);
STRING_LITERAL(TMP197849, "$", 1);
STRING_LITERAL(TMP197850, "\012", 1);
STRING_LITERAL(TMP197852, "end", 3);
STRING_LITERAL(TMP197853, "#end", 4);
STRING_LITERAL(TMP197854, "\"", 1);
STRING_LITERAL(TMP197855, "(\"", 2);
STRING_LITERAL(TMP197856, "\\x", 2);
STRING_LITERAL(TMP197857, "\\\\", 2);
STRING_LITERAL(TMP197858, "\\\'", 2);
STRING_LITERAL(TMP197859, "\\\"", 2);
STRING_LITERAL(TMP197860, "}", 1);
STRING_LITERAL(TMP197861, "\\n\"", 3);
...
Llstreamwrite_76246((*P_92033).Outp, ((NimStringDesc*) &TMP197850));
LA3: ;
...
D_92148 = J_92149;
Keyw_92151 = copyString(((NimStringDesc*) &TMP197841));
while (1) {
...
Localerror_49193((*P_92147).Info, ((NU8) 159), ((NimStringDesc*) &TMP197852));
LA14: ;
LOC17 = 0;
...
case ((NU8) 22):
LOC20 = 0;
LOC20 = nsuRepeatChar((NI32)((*P_92147).Indent - 2), 32);
...
Llstreamwrite_76246((*P_92147).Outp, ((NimStringDesc*) &TMP197850));
LOC24 = 0;
LOC24 = nsuRepeatChar((NI32)((*P_92147).Indent + 2), 32);
...
switch (((NU8)((*P_92147).X->data[J_92149]))) {
case 0:
Localerror_49193((*P_92147).Info, ((NU8) 183), ((NimStringDesc*) &TMP197860));
goto LA31;
break;
case 123:
J_92149 += 1;
...
LA40: ;
(*P_92147).Info.Col = ((NI16) (J_92149));
Localerror_49193((*P_92147).Info, ((NU8) 164), ((NimStringDesc*) &TMP197849));
LA39: ;
break;
}
goto LA28;
...
Llstreamwrite_76246((*P_92147).Outp, ((NimStringDesc*) &TMP197861));
LA2: ;
}
...
P_92459.Outp = Llstreamopen_76217(((NimStringDesc*) &TMP197841));
P_92459.Inp = Stdin_92003;
P_92459.Subschar = Chararg_91014(Call_92005, ((NimStringDesc*) &TMP197842), 1, 36);
P_92459.Nimdirective = Chararg_91014(Call_92005, ((NimStringDesc*) &TMP197843), 2, 35);
P_92459.Emit = Strarg_91020(Call_92005, ((NimStringDesc*) &TMP197844), 3, ((NimStringDesc*) &TMP197845));
P_92459.Conc = Strarg_91020(Call_92005, ((NimStringDesc*) &TMP197846), 4, ((NimStringDesc*) &TMP197847));
P_92459.Tostr = Strarg_91020(Call_92005, ((NimStringDesc*) &TMP197848), 5, ((NimStringDesc*) &TMP197849));
while (1) {
