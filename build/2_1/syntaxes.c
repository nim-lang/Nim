...
STRING_LITERAL(TMP193856, "parser to implement", 19);
...
LOC5 = LOC6;
if (!(LOC5)) goto LA8;
LOC5 = Identeq_53028((*(*N_91376).KindU.S6.Sons->data[0]).KindU.S5.Ident, ((NimStringDesc*) &TMP193733));
LA8: ;
if (!LOC5) goto LA9;
I_91467 = 0;
Res_91535 = 0;
...
break;
case ((NU8) 2):
Internalerror_46575(((NimStringDesc*) &TMP193856));
break;
}
return Result_91067;
}
