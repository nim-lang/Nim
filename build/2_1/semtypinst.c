...
STRING_LITERAL(TMP198037, "substitution with generic parameter", 35);
STRING_LITERAL(TMP198038, "no generic body", 15);
STRING_LITERAL(TMP198041, "acyclic", 7);
STRING_LITERAL(TMP198044, "", 0);
STRING_LITERAL(TMP198045, "ReplaceTypeVarsT: tyGenericBody", 31);
...
Result_126054 = 0;
Result_126054 = ((*T_126052).Kind == ((NU8) 9) || (*T_126052).Kind == ((NU8) 10) || (*T_126052).Kind == ((NU8) 12));
...
Internalerror_49208((*Cl_126303).Info, ((NimStringDesc*) &TMP198037));
goto LA2;
LA6: ;
LA2: ;
...
I_126232 = 0;
HEX3Atmp_126257 = 0;
HEX3Atmp_126257 = (NI32)(Length_126219 - 1);
Res_126259 = 0;
Res_126259 = 0;
while (1) {
...
LA3: ;
if (!LOC2) goto LA5;
Localerror_49193(Info_126006, ((NU8) 158), ((NimStringDesc*) &TMP198041));
goto LA1;
LA5: ;
...
LA12: ;
if (!LOC11) goto LA13;
Localerror_49193(Info_126006, ((NU8) 191), ((NimStringDesc*) &TMP198044));
goto LA1;
LA13: ;
LA1: ;
}
...
Internalerror_49208((*Cl_126153).Info, ((NimStringDesc*) &TMP198038));
LA5: ;
Header_126335 = NIM_NIL;
I_126364 = 0;
HEX3Atmp_126438 = 0;
LOC7 = Sonslen_56807(T_126154);
HEX3Atmp_126438 = (NI32)(LOC7 - 1);
Res_126440 = 0;
Res_126440 = 1;
while (1) {
...
LA9: ;
Idtableput_61166(&(*Cl_126153).Typemap, &(*Body_126332).Sons->data[(NI32)(I_126364 - 1)]->Sup, &X_126334->Sup.Sup);
Res_126440 += 1;
} LA8: ;
...
break;
case ((NU8) 10):
Internalerror_49208((*Cl_126153).Info, ((NimStringDesc*) &TMP198045));
LOC25 = 0;
...
if (!((*Result_126331).Kind == ((NU8) 9) || (*Result_126331).Kind == ((NU8) 10) || (*Result_126331).Kind == ((NU8) 12))) goto LA33;
LOC35 = 0;
