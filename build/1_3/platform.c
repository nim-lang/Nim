...
;
STRING_LITERAL(TMP46696, "windows", 7);
NU8 Targetcpu_46560;
NU8 Hostcpu_46561;
NU8 Targetos_46562;
NU8 Hostos_46563;
...
internalAssert("rod/platform.nim", 185, !((C_46577 == ((NU8) 0))));
F.line = 186;F.filename = "platform.nim";
internalAssert("rod/platform.nim", 186, !((O_46576 == ((NU8) 0))));
...
if (C_46577 < 1 || C_46577 > 12) raiseIndexError();
Intsize_46570 = divInt(Cpu_46460[(C_46577)-1].Intsize, 8);
F.line = 191;F.filename = "platform.nim";
if (C_46577 < 1 || C_46577 > 12) raiseIndexError();
Floatsize_46571 = divInt(Cpu_46460[(C_46577)-1].Floatsize, 8);
F.line = 192;F.filename = "platform.nim";
if (C_46577 < 1 || C_46577 > 12) raiseIndexError();
Ptrsize_46572 = divInt(Cpu_46460[(C_46577)-1].Bit, 8);
F.line = 193;F.filename = "platform.nim";
if (O_46576 < 1 || O_46576 > 21) raiseIndexError();
...
while (1) {
if (!(Res_46643 <= ((NU8) 21))) goto LA1;
F.line = 1021;F.filename = "system.nim";
I_46638 = Res_46643;
F.line = 197;F.filename = "platform.nim";
if (I_46638 < 1 || I_46638 > 21) raiseIndexError();
...
F.line = 1022;F.filename = "system.nim";
while (1) {
if (!(Res_46693 <= ((NU8) 12))) goto LA1;
F.line = 1021;F.filename = "system.nim";
I_46688 = Res_46693;
F.line = 203;F.filename = "platform.nim";
if (I_46688 < 1 || I_46688 > 12) raiseIndexError();
LOC3 = nsuCmpIgnoreStyle(Name_46569, Cpu_46460[(I_46688)-1].Name);
if (!(LOC3 == 0)) goto LA4;
F.line = 204;F.filename = "platform.nim";
F.line = 204;F.filename = "platform.nim";
Result_46649 = I_46688;
goto BeforeRet;
LA4: ;
F.line = 1024;F.filename = "system.nim";
Res_46693 = addInt(Res_46693, 1);
} LA1: ;
...
Hostcpu_46561 = Nametocpu_46567(((NimStringDesc*) &TMP46551));
F.line = 208;F.filename = "platform.nim";
Hostos_46563 = Nametoos_46564(((NimStringDesc*) &TMP46696));
