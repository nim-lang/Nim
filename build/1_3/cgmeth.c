...
while (1) {
Aa_156164 = Skiptypes_93087(Aa_156164, IL64(2251799813685248));
Bb_156165 = Skiptypes_93087(Bb_156165, IL64(2251799813685248));
LOC17 = ((*Aa_156164).Kind == (*Bb_156165).Kind);
if (!(LOC17)) goto LA18;
LOC17 = ((IL64(246290604621824) &(IL64(1)<<(((*Aa_156164).Kind)&IL64(63))))!=0);
LA18: ;
if (!LOC17) goto LA19;
...
Source_156011 = 0;
Diff_156012 = 0;
Dest_156010 = Skiptypes_93087(D_156007, IL64(47534086692012032));
Source_156011 = Skiptypes_93087((*N_156006).Typ, IL64(47534086692012032));
...
LOC2 = 0;
LOC2 = Skiptypes_93087(T_156390, IL64(2498090418307072));
...
if (!LOC4) goto LA5;
Aa_156419 = Skiptypes_93087((*(*A_156414).Typ).Sons->data[Col_156429], IL64(2498090418307072));
Bb_156420 = Skiptypes_93087((*(*B_156415).Typ).Sons->data[Col_156429], IL64(2498090418307072));
