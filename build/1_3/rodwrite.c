...
(*W_104274).Sstack = (TY49525*) setLengthSeq(&((*W_104274).Sstack)->Sup, sizeof(TY49545*), (NI32)(L_104288 + 1));
...
TY46008* LOC4;
TY169860 LOC5;
if (!((NI32)(Key_105077 - (*W_105076).Lastidxkey) == 1)) goto LA2;
LOC4 = Encodeint_86073(((NI64) ((NI32)(Val_105078 - (*W_105076).Lastidxval))));
App_46031(&(*W_105076).R, LOC4);
App_46036(&(*W_105076).R, ((NimStringDesc*) &TMP191823));
goto LA1;
LA2: ;
LOC5[0] = Encodeint_86073(((NI64) ((NI32)(Key_105077 - (*W_105076).Lastidxkey))));
LOC5[1] = Encodeint_86073(((NI64) ((NI32)(Val_105078 - (*W_105076).Lastidxval))));
...
(*W_104245).Tstack = (TY49547*) setLengthSeq(&((*W_104245).Tstack)->Sup, sizeof(TY49549*), (NI32)(L_104259 + 1));
...
(*W_104092).Files = (TY33221*) setLengthSeq(&((*W_104092).Files)->Sup, sizeof(NimStringDesc*), (NI32)(Result_104094 + 1));
