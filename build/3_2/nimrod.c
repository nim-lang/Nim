...
STRING_LITERAL(TMP195489, "\012", 1);
STRING_LITERAL(TMP195490, "./", 2);
...
Key_193215 = 0;
Key_193215 = copyStrLast(P_193210.Key, 0, (NI64)(Bracketle_193212 - 1));
Val_193228 = 0;
LOC6 = copyStr(P_193210.Key, (NI64)(Bracketle_193212 + 1));
...
rawEchoNL();
LA10: ;
LOC14 = !(((131104 &(1<<((Gcmd_44082)&31)))!=0));
if (!(LOC14)) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP195490));
