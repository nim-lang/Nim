...
STRING_LITERAL(TMP199561, "\012", 1);
STRING_LITERAL(TMP199562, "./", 2);
...
Key_197215 = NIM_NIL;
Key_197215 = copyStrLast(P_197210.Key, 0, (NI64)(Bracketle_197212 - 1));
Val_197216 = NIM_NIL;
LOC5 = 0;
LOC6 = 0;
LOC6 = copyStr(P_197210.Key, (NI64)(Bracketle_197212 + 1));
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3866(stdout, ((NimStringDesc*) &TMP199561));
}
N_NIMCALL(void, Handlecmdline_197245)(void) {
NI Start_197247;
NI LOC2;
...
appendString(LOC25, ((NimStringDesc*) &TMP199562));
