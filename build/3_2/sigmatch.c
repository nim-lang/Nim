...
STRING_LITERAL(TMP198029, "forward type in typeRel()", 25);
STRING_LITERAL(TMP198030, "tupleRel", 8);
STRING_LITERAL(TMP198031, "typeRel: tyGenericInvokation -> tyGenericInvokation", 51);
STRING_LITERAL(TMP198032, "wrong instantiated type!", 24);
STRING_LITERAL(TMP198033, "has constraints: ", 17);
STRING_LITERAL(TMP198034, "typeRel(", 8);
STRING_LITERAL(TMP198045, "getInstantiatedType", 19);
STRING_LITERAL(TMP198046, "implicitConv", 12);
STRING_LITERAL(TMP198047, "x.state is not csMatch", 22);
STRING_LITERAL(TMP198048, "", 0);
STRING_LITERAL(TMP198067, "matches", 7);
STRING_LITERAL(TMP198246, ": ", 2);
STRING_LITERAL(TMP198247, ", ", 2);
STRING_LITERAL(TMP198248, "\012", 1);
...
Internalerror_49208((*(*F_127491).N).Info, ((NimStringDesc*) &TMP198030));
LA19: ;
if (!!(((*(*(*A_127492).N).KindU.S6.Sons->data[I_127547]).Kind == ((NU8) 3)))) goto LA22;
Internalerror_49208((*(*A_127492).N).Info, ((NimStringDesc*) &TMP198030));
LA22: ;
X_127614 = NIM_NIL;
...
break;
case ((NU8) 30):
Internalerror_49212(((NimStringDesc*) &TMP198029));
break;
case ((NU8) 5):
...
appendString(LOC249, ((NimStringDesc*) &TMP198033));
...
appendString(LOC266, ((NimStringDesc*) &TMP198034));
...
Internalerror_49208((*Arg_128455).Info, ((NimStringDesc*) &TMP198045));
LA6: ;
...
Internalerror_49208((*Arg_128485).Info, ((NimStringDesc*) &TMP198046));
LA6: ;
...
Internalerror_49208((*Arg_128719).Info, ((NimStringDesc*) &TMP198047));
LA28: ;
Result_128720 = NIM_NIL;
goto LA19;
LA25: ;
...
Localerror_49193((*(*N_128980).KindU.S6.Sons->data[A_128986]).Info, ((NU8) 155), ((NimStringDesc*) &TMP198048));
...
Internalerror_49208((*(*N_128980).KindU.S6.Sons->data[A_128986]).Info, ((NimStringDesc*) &TMP198067));
LA50: ;
...
appendString(Result_127179, ((NimStringDesc*) &TMP198246));
LA4: ;
LOC7 = 0;
...
Candidates_127248 = copyString(((NimStringDesc*) &TMP198048));
...
appendString(Candidates_127248, ((NimStringDesc*) &TMP198248));
LA14: ;
...
appendString(LOC20, ((NimStringDesc*) &TMP198248));
