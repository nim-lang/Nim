...
TMP197649 = mulInt64((*B_22949), 10);TMP197650 = subInt(((NU8)(S_22947->data[I_22953])), 48);TMP197651 = subInt64((NI64)(TMP197649), ((NI64) ((NI64)(TMP197650))));(*B_22949) = (NI64)(TMP197651);
I_22953 = addInt(I_22953, 1);
while (1) {
...
TMP197653 = subInt(I_22953, Start_22950);Result_22951 = (NI64)(TMP197653);
LA7: ;
return Result_22951;
}
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* S_23044, NI64* Number_23046, NI Start_23047) {
