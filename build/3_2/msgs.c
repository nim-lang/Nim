...
STRING_LITERAL(TMP197667, "Error: $1", 9);
STRING_LITERAL(TMP197668, "Warning: $1", 11);
STRING_LITERAL(TMP197669, "Hint: $1", 8);
...
Frmt_49025 = copyString(((NimStringDesc*) &TMP197667));
break;
case ((NU8) 208) ... ((NU8) 222):
...
goto BeforeRet;
LA6: ;
Frmt_49025 = copyString(((NimStringDesc*) &TMP197668));
Gwarncounter_48567 += 1;
break;
case ((NU8) 223) ... ((NU8) 236):
...
Write_3866(F_48792, ((NimStringDesc*) &TMP199563));
}
