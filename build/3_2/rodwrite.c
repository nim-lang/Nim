...
STRING_LITERAL(TMP197819, "rodwrite: module ID not set", 27);
STRING_LITERAL(TMP197821, " ", 1);
STRING_LITERAL(TMP197822, "symStack: module nil: ", 22);
STRING_LITERAL(TMP197823, "\012", 1);
STRING_LITERAL(TMP197824, "$1 $2\012", 6);
STRING_LITERAL(TMP197825, "{}", 2);
STRING_LITERAL(TMP197826, "+$1", 3);
STRING_LITERAL(TMP197827, "&$1", 3);
STRING_LITERAL(TMP197828, "^$1", 3);
STRING_LITERAL(TMP197829, "?$1,$2,$3", 9);
STRING_LITERAL(TMP197830, "*$1", 3);
STRING_LITERAL(TMP197831, "$$$1", 4);
STRING_LITERAL(TMP197832, "@$1", 3);
STRING_LITERAL(TMP197833, "()", 2);
STRING_LITERAL(TMP197834, "(", 1);
STRING_LITERAL(TMP197835, "?$1,$2", 6);
STRING_LITERAL(TMP197836, "?$1", 3);
STRING_LITERAL(TMP197837, "!$1", 3);
STRING_LITERAL(TMP197838, ")", 1);
STRING_LITERAL(TMP197839, "%$1", 3);
STRING_LITERAL(TMP197840, "`$1", 3);
STRING_LITERAL(TMP197841, "<$1>", 4);
STRING_LITERAL(TMP197842, "|$1", 3);
STRING_LITERAL(TMP197843, "[]", 2);
STRING_LITERAL(TMP197844, "encodeType: tyForward", 21);
STRING_LITERAL(TMP197845, "/$1", 3);
STRING_LITERAL(TMP197846, "=$1", 3);
STRING_LITERAL(TMP197847, "^()", 3);
STRING_LITERAL(TMP197848, "NIM:", 4);
STRING_LITERAL(TMP197849, "1012", 4);
STRING_LITERAL(TMP197850, "ID:", 3);
STRING_LITERAL(TMP197851, "CRC:", 4);
STRING_LITERAL(TMP197852, "OPTIONS:", 8);
STRING_LITERAL(TMP197853, "DEFINES:", 8);
STRING_LITERAL(TMP197854, "FILES(\012", 7);
STRING_LITERAL(TMP197855, ")\012", 2);
STRING_LITERAL(TMP197856, "INCLUDES(\012", 10);
STRING_LITERAL(TMP197857, "DEPS:", 5);
STRING_LITERAL(TMP197858, "INTERF(\012", 8);
STRING_LITERAL(TMP197859, "COMPILERPROCS(\012", 15);
STRING_LITERAL(TMP197860, "INDEX(\012", 7);
STRING_LITERAL(TMP197861, "IMPORTS(\012", 9);
STRING_LITERAL(TMP197862, "CONVERTERS:", 11);
STRING_LITERAL(TMP197863, "INIT(\012", 6);
STRING_LITERAL(TMP197864, "DATA(\012", 6);
STRING_LITERAL(TMP197865, "rod", 3);
STRING_LITERAL(TMP197866, "rodwrite.process", 16);
...
App_52036(&Result_110058, ((NimStringDesc*) &TMP197821));
LA6: ;
...
App_52036(&(*W_111076).R, ((NimStringDesc*) &TMP197823));
goto LA1;
LA2: ;
...
Appf_52074(&(*W_111076).R, ((NimStringDesc*) &TMP197824), LOC5, 2);
LA1: ;
...
Result_110306 = Torope_52046(((NimStringDesc*) &TMP197833));
goto BeforeRet;
LA2: ;
...
Appf_52074(&Result_110306, ((NimStringDesc*) &TMP197829), LOC8, 3);
goto LA5;
LA6: ;
...
Appf_52074(&Result_110306, ((NimStringDesc*) &TMP197835), LOC13, 2);
goto LA5;
LA11: ;
...
Appf_52074(&Result_110306, ((NimStringDesc*) &TMP197836), LOC16, 1);
goto LA5;
LA14: ;
LA5: ;
...
Appf_52074(&Result_110306, ((NimStringDesc*) &TMP197837), LOC28, 1);
LA26: ;
break;
case ((NU8) 11) ... ((NU8) 13):
...
Appf_52074(&Result_110306, ((NimStringDesc*) &TMP197837), LOC32, 1);
LA30: ;
break;
case ((NU8) 14) ... ((NU8) 16):
...
App_52036(&Result_110306, ((NimStringDesc*) &TMP197838));
BeforeRet: ;
...
Appf_52074(&Result_110557, ((NimStringDesc*) &TMP197830), LOC8, 1);
LA6: ;
if (!!(((*Loc_110556).Flags == 0))) goto LA10;
memset((void*)&LOC12, 0, sizeof(LOC12));
LOC12[0] = Encodeint_92073(((NI64) (((int) ((*Loc_110556).Flags)))));
Appf_52074(&Result_110557, ((NimStringDesc*) &TMP197831), LOC12, 1);
LA10: ;
if (!!(((*Loc_110556).T == NIM_NIL))) goto LA14;
memset((void*)&LOC16, 0, sizeof(LOC16));
LOC16[0] = Encodeint_92073(((NI64) ((*(*Loc_110556).T).Sup.Id)));
Appf_52074(&Result_110557, ((NimStringDesc*) &TMP197828), LOC16, 1);
...
Appf_52074(&Result_110839, ((NimStringDesc*) &TMP197842), LOC1, 1);
memset((void*)&LOC2, 0, sizeof(LOC2));
LOC3 = 0;
LOC3 = Ropetostr_52066((*Lib_110837).Name);
LOC2[0] = Encodestr_110048(W_110836, LOC3);
Appf_52074(&Result_110839, ((NimStringDesc*) &TMP197842), LOC2, 1);
memset((void*)&LOC4, 0, sizeof(LOC4));
LOC4[0] = Encodenode_110301(W_110836, Info_110838, (*Lib_110837).Path);
Appf_52074(&Result_110839, ((NimStringDesc*) &TMP197842), LOC4, 1);
...
Result_110864 = Torope_52046(((NimStringDesc*) &TMP197825));
goto BeforeRet;
LA2: ;
...
Appf_52074(&Result_110864, ((NimStringDesc*) &TMP197826), LOC5, 1);
memset((void*)&LOC6, 0, sizeof(LOC6));
LOC6[0] = Encodestr_110048(W_110862, (*(*S_110863).Name).S);
Appf_52074(&Result_110864, ((NimStringDesc*) &TMP197827), LOC6, 1);
if (!!(((*S_110863).Typ == NIM_NIL))) goto LA8;
memset((void*)&LOC10, 0, sizeof(LOC10));
LOC10[0] = Encodeint_92073(((NI64) ((*(*S_110863).Typ).Sup.Id)));
Appf_52074(&Result_110864, ((NimStringDesc*) &TMP197828), LOC10, 1);
...
Appf_52074(&Result_110864, ((NimStringDesc*) &TMP197831), LOC27, 1);
LA25: ;
if (!!(((*S_110863).Magic == ((NU8) 0)))) goto LA29;
memset((void*)&LOC31, 0, sizeof(LOC31));
LOC31[0] = Encodeint_92073(((NI64) ((*S_110863).Magic)));
Appf_52074(&Result_110864, ((NimStringDesc*) &TMP197832), LOC31, 1);
LA29: ;
...
appendString(LOC9, ((NimStringDesc*) &TMP197822));
...
App_52036(&(*W_111100).Data, ((NimStringDesc*) &TMP197823));
...
Appf_52074(&(*W_111100).Interf, ((NimStringDesc*) &TMP197824), LOC19, 2);
LA17: ;
...
Appf_52074(&(*W_111100).Compilerprocs, ((NimStringDesc*) &TMP197824), LOC23, 2);
LA21: ;
if (!((*S_111103).Kind == ((NU8) 12))) goto LA25;
if (!!(((*W_111100).Converters == NIM_NIL))) goto LA28;
App_52036(&(*W_111100).Converters, ((NimStringDesc*) &TMP197821));
LA28: ;
LOC30 = 0;
...
Result_110668 = Torope_52046(((NimStringDesc*) &TMP197843));
goto BeforeRet;
LA2: ;
Result_110668 = NIM_NIL;
if (!((*T_110667).Kind == ((NU8) 30))) goto LA5;
Internalerror_47571(((NimStringDesc*) &TMP197844));
LA5: ;
LOC7 = 0;
...
Appf_52074(&Result_110668, ((NimStringDesc*) &TMP197826), LOC8, 1);
...
App_52036(&Result_110668, ((NimStringDesc*) &TMP197847));
goto LA45;
LA46: ;
memset((void*)&LOC48, 0, sizeof(LOC48));
LOC48[0] = Encodeint_92073(((NI64) ((*(*T_110667).Sons->data[I_110810]).Sup.Id)));
Appf_52074(&Result_110668, ((NimStringDesc*) &TMP197828), LOC48, 1);
...
App_52036(&(*W_111254).Data, ((NimStringDesc*) &TMP197823));
LA4: ;
I_111255 += 1;
} LA1: ;
...
Internalerror_47571(((NimStringDesc*) &TMP197819));
LA2: ;
W_111975 = 0;
...
Content_111381 = 0;
Content_111381 = Torope_52046(((NimStringDesc*) &TMP197848));
LOC1 = 0;
LOC1 = Torope_52046(((NimStringDesc*) &TMP197849));
App_52031(&Content_111381, LOC1);
App_52036(&Content_111381, ((NimStringDesc*) &TMP197823));
LOC2 = 0;
LOC2 = Torope_52046(((NimStringDesc*) &TMP197850));
...
App_52036(&Content_111381, ((NimStringDesc*) &TMP197823));
LOC4 = 0;
LOC4 = Torope_52046(((NimStringDesc*) &TMP197851));
...
App_52036(&Content_111381, ((NimStringDesc*) &TMP197823));
LOC6 = 0;
LOC6 = Torope_52046(((NimStringDesc*) &TMP197852));
...
App_52036(&Content_111381, ((NimStringDesc*) &TMP197823));
LOC8 = 0;
LOC8 = Torope_52046(((NimStringDesc*) &TMP197853));
App_52031(&Content_111381, LOC8);
App_52031(&Content_111381, (*W_110047).Defines);
App_52036(&Content_111381, ((NimStringDesc*) &TMP197823));
LOC9 = 0;
LOC9 = Torope_52046(((NimStringDesc*) &TMP197854));
...
App_52036(&(*W_110031).Moddeps, ((NimStringDesc*) &TMP197821));
LA2: ;
...
App_52036(&(*W_110035).Incldeps, ((NimStringDesc*) &TMP197821));
...
Internalerror_47567((*N_111540).Info, ((NimStringDesc*) &TMP197866));
LA8: ;
...
Internalerror_47567((*A_111698).Info, ((NimStringDesc*) &TMP197866));
LA24: ;
...
Internalerror_47567((*A_111761).Info, ((NimStringDesc*) &TMP197866));
LA33: ;
...
Internalerror_47567((*A_111824).Info, ((NimStringDesc*) &TMP197866));
LA42: ;
S_111879 = 0;
