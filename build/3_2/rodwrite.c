...
STRING_LITERAL(TMP194805, "rodwrite: module ID not set", 27);
STRING_LITERAL(TMP194807, " ", 1);
STRING_LITERAL(TMP194808, "symStack: module nil: ", 22);
STRING_LITERAL(TMP194809, "\012", 1);
STRING_LITERAL(TMP194810, "$1 $2\012", 6);
STRING_LITERAL(TMP194811, "{}", 2);
STRING_LITERAL(TMP194812, "+$1", 3);
STRING_LITERAL(TMP194813, "&$1", 3);
STRING_LITERAL(TMP194814, "^$1", 3);
STRING_LITERAL(TMP194815, "?$1,$2,$3", 9);
STRING_LITERAL(TMP194816, "*$1", 3);
STRING_LITERAL(TMP194817, "$$$1", 4);
STRING_LITERAL(TMP194818, "@$1", 3);
STRING_LITERAL(TMP194819, "()", 2);
STRING_LITERAL(TMP194820, "(", 1);
STRING_LITERAL(TMP194821, "?$1,$2", 6);
STRING_LITERAL(TMP194822, "?$1", 3);
STRING_LITERAL(TMP194823, "!$1", 3);
STRING_LITERAL(TMP194824, ")", 1);
STRING_LITERAL(TMP194825, "%$1", 3);
STRING_LITERAL(TMP194826, "`$1", 3);
STRING_LITERAL(TMP194827, "<$1>", 4);
STRING_LITERAL(TMP194828, "|$1", 3);
STRING_LITERAL(TMP194829, "[]", 2);
STRING_LITERAL(TMP194830, "encodeType: tyForward", 21);
STRING_LITERAL(TMP194831, "/$1", 3);
STRING_LITERAL(TMP194832, "=$1", 3);
STRING_LITERAL(TMP194833, "^()", 3);
STRING_LITERAL(TMP194834, "NIM:", 4);
STRING_LITERAL(TMP194835, "1012", 4);
STRING_LITERAL(TMP194836, "ID:", 3);
STRING_LITERAL(TMP194837, "CRC:", 4);
STRING_LITERAL(TMP194838, "OPTIONS:", 8);
STRING_LITERAL(TMP194839, "DEFINES:", 8);
STRING_LITERAL(TMP194840, "FILES(\012", 7);
STRING_LITERAL(TMP194841, ")\012", 2);
STRING_LITERAL(TMP194842, "INCLUDES(\012", 10);
STRING_LITERAL(TMP194843, "DEPS:", 5);
STRING_LITERAL(TMP194844, "INTERF(\012", 8);
STRING_LITERAL(TMP194845, "COMPILERPROCS(\012", 15);
STRING_LITERAL(TMP194846, "INDEX(\012", 7);
STRING_LITERAL(TMP194847, "IMPORTS(\012", 9);
STRING_LITERAL(TMP194848, "CONVERTERS:", 11);
STRING_LITERAL(TMP194849, "INIT(\012", 6);
STRING_LITERAL(TMP194850, "DATA(\012", 6);
STRING_LITERAL(TMP194851, "rod", 3);
STRING_LITERAL(TMP194852, "rodwrite.process", 16);
...
App_51036(&Result_110058, ((NimStringDesc*) &TMP194807));
LA6: ;
...
App_51036(&(*W_111066).R, ((NimStringDesc*) &TMP194809));
goto LA1;
LA2: ;
...
Appf_51071(&(*W_111066).R, ((NimStringDesc*) &TMP194810), LOC5, 2);
LA1: ;
...
Result_110302 = Torope_51046(((NimStringDesc*) &TMP194819));
goto BeforeRet;
LA2: ;
...
Appf_51071(&Result_110302, ((NimStringDesc*) &TMP194815), LOC8, 3);
goto LA5;
LA6: ;
...
Appf_51071(&Result_110302, ((NimStringDesc*) &TMP194821), LOC13, 2);
goto LA5;
LA11: ;
...
Appf_51071(&Result_110302, ((NimStringDesc*) &TMP194822), LOC16, 1);
goto LA5;
LA14: ;
LA5: ;
...
Appf_51071(&Result_110302, ((NimStringDesc*) &TMP194823), LOC28, 1);
LA26: ;
break;
case ((NU8) 11) ... ((NU8) 13):
...
Appf_51071(&Result_110302, ((NimStringDesc*) &TMP194823), LOC32, 1);
LA30: ;
break;
case ((NU8) 14) ... ((NU8) 16):
...
App_51036(&Result_110302, ((NimStringDesc*) &TMP194824));
BeforeRet: ;
...
Appf_51071(&Result_110550, ((NimStringDesc*) &TMP194816), LOC8, 1);
LA6: ;
if (!!(((*Loc_110549).Flags == 0))) goto LA10;
memset((void*)&LOC12, 0, sizeof(LOC12));
LOC12[0] = Encodeint_92073(((NI64) (((int) ((*Loc_110549).Flags)))));
Appf_51071(&Result_110550, ((NimStringDesc*) &TMP194817), LOC12, 1);
LA10: ;
if (!!(((*Loc_110549).T == NIM_NIL))) goto LA14;
memset((void*)&LOC16, 0, sizeof(LOC16));
LOC16[0] = Encodeint_92073(((NI64) ((*(*Loc_110549).T).Sup.Id)));
Appf_51071(&Result_110550, ((NimStringDesc*) &TMP194814), LOC16, 1);
...
Appf_51071(&Result_110829, ((NimStringDesc*) &TMP194828), LOC1, 1);
memset((void*)&LOC2, 0, sizeof(LOC2));
LOC3 = 0;
LOC3 = Ropetostr_51063((*Lib_110827).Name);
LOC2[0] = Encodestr_110048(W_110826, LOC3);
Appf_51071(&Result_110829, ((NimStringDesc*) &TMP194828), LOC2, 1);
memset((void*)&LOC4, 0, sizeof(LOC4));
LOC4[0] = Encodenode_110297(W_110826, Info_110828, (*Lib_110827).Path);
Appf_51071(&Result_110829, ((NimStringDesc*) &TMP194828), LOC4, 1);
...
Result_110854 = Torope_51046(((NimStringDesc*) &TMP194811));
goto BeforeRet;
LA2: ;
...
Appf_51071(&Result_110854, ((NimStringDesc*) &TMP194812), LOC5, 1);
memset((void*)&LOC6, 0, sizeof(LOC6));
LOC6[0] = Encodestr_110048(W_110852, (*(*S_110853).Name).S);
Appf_51071(&Result_110854, ((NimStringDesc*) &TMP194813), LOC6, 1);
if (!!(((*S_110853).Typ == NIM_NIL))) goto LA8;
memset((void*)&LOC10, 0, sizeof(LOC10));
LOC10[0] = Encodeint_92073(((NI64) ((*(*S_110853).Typ).Sup.Id)));
Appf_51071(&Result_110854, ((NimStringDesc*) &TMP194814), LOC10, 1);
...
Appf_51071(&Result_110854, ((NimStringDesc*) &TMP194817), LOC27, 1);
LA25: ;
if (!!(((*S_110853).Magic == ((NU8) 0)))) goto LA29;
memset((void*)&LOC31, 0, sizeof(LOC31));
LOC31[0] = Encodeint_92073(((NI64) ((*S_110853).Magic)));
Appf_51071(&Result_110854, ((NimStringDesc*) &TMP194818), LOC31, 1);
LA29: ;
...
App_51036(&(*W_111082).Data, ((NimStringDesc*) &TMP194809));
...
Appf_51071(&(*W_111082).Interf, ((NimStringDesc*) &TMP194810), LOC19, 2);
LA17: ;
...
Appf_51071(&(*W_111082).Compilerprocs, ((NimStringDesc*) &TMP194810), LOC23, 2);
LA21: ;
if (!((*S_111085).Kind == ((NU8) 13))) goto LA25;
if (!!(((*W_111082).Converters == NIM_NIL))) goto LA28;
App_51036(&(*W_111082).Converters, ((NimStringDesc*) &TMP194807));
LA28: ;
LOC30 = 0;
...
Result_110661 = Torope_51046(((NimStringDesc*) &TMP194829));
goto BeforeRet;
LA2: ;
Result_110661 = NIM_NIL;
if (!((*T_110660).Kind == ((NU8) 30))) goto LA5;
Internalerror_46575(((NimStringDesc*) &TMP194830));
LA5: ;
LOC7 = 0;
...
Appf_51071(&Result_110661, ((NimStringDesc*) &TMP194812), LOC8, 1);
...
App_51036(&Result_110661, ((NimStringDesc*) &TMP194833));
goto LA45;
LA46: ;
memset((void*)&LOC48, 0, sizeof(LOC48));
LOC48[0] = Encodeint_92073(((NI64) ((*(*T_110660).Sons->data[I_110803]).Sup.Id)));
Appf_51071(&Result_110661, ((NimStringDesc*) &TMP194814), LOC48, 1);
...
App_51036(&(*W_111211).Data, ((NimStringDesc*) &TMP194809));
LA4: ;
I_111212 += 1;
} LA1: ;
...
Internalerror_46575(((NimStringDesc*) &TMP194805));
LA2: ;
W_111816 = 0;
...
Content_111336 = 0;
Content_111336 = Torope_51046(((NimStringDesc*) &TMP194834));
LOC1 = 0;
LOC1 = Torope_51046(((NimStringDesc*) &TMP194835));
App_51031(&Content_111336, LOC1);
App_51036(&Content_111336, ((NimStringDesc*) &TMP194809));
LOC2 = 0;
LOC2 = Torope_51046(((NimStringDesc*) &TMP194836));
...
App_51036(&Content_111336, ((NimStringDesc*) &TMP194809));
LOC4 = 0;
LOC4 = Torope_51046(((NimStringDesc*) &TMP194837));
...
App_51036(&Content_111336, ((NimStringDesc*) &TMP194809));
LOC6 = 0;
LOC6 = Torope_51046(((NimStringDesc*) &TMP194838));
...
App_51036(&Content_111336, ((NimStringDesc*) &TMP194809));
LOC8 = 0;
LOC8 = Torope_51046(((NimStringDesc*) &TMP194839));
App_51031(&Content_111336, LOC8);
App_51031(&Content_111336, (*W_110047).Defines);
App_51036(&Content_111336, ((NimStringDesc*) &TMP194809));
LOC9 = 0;
LOC9 = Torope_51046(((NimStringDesc*) &TMP194840));
...
App_51036(&(*W_110031).Moddeps, ((NimStringDesc*) &TMP194807));
LA2: ;
...
App_51036(&(*W_110035).Incldeps, ((NimStringDesc*) &TMP194807));
...
Internalerror_46571((*N_111396).Info, ((NimStringDesc*) &TMP194852));
LA8: ;
...
Internalerror_46571((*A_111554).Info, ((NimStringDesc*) &TMP194852));
LA24: ;
...
Internalerror_46571((*A_111617).Info, ((NimStringDesc*) &TMP194852));
LA33: ;
...
Internalerror_46571((*A_111680).Info, ((NimStringDesc*) &TMP194852));
LA42: ;
S_111735 = 0;
