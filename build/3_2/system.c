...
STRING_LITERAL(TMP193759, " (invalid data!)", 16);
STRING_LITERAL(TMP193862, "cannot retrieve file position", 29);
STRING_LITERAL(TMP193863, "cannot set file position", 24);
STRING_LITERAL(TMP195480, "[GC] total memory: ", 19);
STRING_LITERAL(TMP195481, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP195482, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP195483, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP195484, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP195485, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP195486, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP195487, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP195488, "\012[GC] max stack size: ", 22);
...
Result_15203 = (NI64)abs((NI64)(((NI) (&Stacktop_15206[(0)-0])) - ((NI) (Stackbottom_10807))));
return Result_15203;
}
static N_INLINE(TY10402*, Usrtocell_10822)(void* Usr_10824) {
...
while (1) {
if (!((NU64)(Sp_15229) <= (NU64)(Max_15227))) goto LA5;
Gcmark_14403((*((void**) (Sp_15229))));
Sp_15229 = (NI64)((NU64)(Sp_15229) + (NU64)(8));
} LA5: ;
LA3: ;
}
N_NIMCALL(void, Markthreadstacks_14411)(TY10790* Gch_14414) {
...
void* Result_10821;
Result_10821 = 0;
Result_10821 = ((void*) ((NI64)((NU64)(((NI) (Cell_10820))) + (NU64)(((NI) (((NI)sizeof(TY10402))))))));
return Result_10821;
}
N_NIMCALL(void, Preparedealloc_11425)(TY10402* Cell_11427) {
void* LOC4;
...
N_NOINLINE(void, Addzct_10811)(TY10418* S_10814, TY10402* C_10815) {
if (!((NI64)((*C_10815).Refcount & 4) == 0)) goto LA2;
(*C_10815).Refcount = (NI64)((NI64)((*C_10815).Refcount & -8) | 4);
...
switch (Op_11419) {
case ((NU8) 0):
(*C_13405).Refcount = (NI64)((NU64)((*C_13405).Refcount) - (NU64)(8));
if (!((NU64)((*C_13405).Refcount) < (NU64)(8))) goto LA5;
...
zeroMem(((void*) (Res_12123)), (NI64)(Size_12108 + ((NI)sizeof(TY10402))));
...
memcpy(((NCSTRING) ((*Result_17109).data)), ((NCSTRING) ((*Src_17108).data)), ((int) ((NI64)((NI64)((*Src_17108).Sup.len + 1) * 1))));
BeforeRet: ;
return Result_17109;
}
N_NIMCALL(void, Gcdisable_2663)(void) {
...
X_15218 = 0;
X_15218 = ((NI) (P_11411));
LOC1 = ((NU64)(A_15217) <= (NU64)(X_15218));
if (!(LOC1)) goto LA2;
LOC1 = ((NU64)(X_15218) <= (NU64)(B_15215));
LA2: ;
Result_15211 = LOC1;
return Result_15211;
}
...
Res_12636 = 0;
LOC1 = Rawalloc_9395(&Allocator_8529, (NI64)(Newsize_12609 + ((NI)sizeof(TY10402))));
...
LA3: ;
Oldsize_12647 = 0;
Oldsize_12647 = (NI64)((NI64)((*((TGenericSeq*) (Old_12608))).len * Elemsize_12637) + 16);
memcpy(((void*) (Res_12636)), ((void*) (Ol_12611)), (NI64)(Oldsize_12647 + ((NI)sizeof(TY10402))));
zeroMem(((void*) ((NI64)((NU64)((NI64)((NU64)(((NI) (Res_12636))) + (NU64)(Oldsize_12647))) + (NU64)(((NI)sizeof(TY10402)))))), (NI64)(Newsize_12609 - Oldsize_12647));
if (!((NI64)((*Ol_12611).Refcount & 7) == 4)) goto LA6;
J_12652 = 0;
J_12652 = (NI64)(Gch_10808.Zct.Len - 1);
D_12653 = 0;
...
LOC5 = Growobj_12606(((void*) (Dest_17182)), (NI64)(((NI)sizeof(TGenericSeq)) + (NI64)((NI64)(Sp_17189 + 1) * 1)));
...
LOC4 = Growobj_12606(((void*) (Result_17165)), (NI64)(((NI)sizeof(TGenericSeq)) + (NI64)((NI64)((*Result_17165).Sup.space + 1) * 1)));
...
J_4761 = 0;
HEX3Atmp_19621 = 0;
HEX3Atmp_19621 = (NI64)((NI64)(Total_4692 - I_4691) - 31);
Res_19623 = 0;
Res_19623 = 1;
while (1) {
...
LOC19 = nimIntToStr((NI64)((NI64)(Total_4692 - I_4691) - 1));
...
K_4866 = 0;
HEX3Atmp_19628 = 0;
HEX3Atmp_19628 = ((1 >= (NI64)(25 - (NI64)((*S_4688)->Sup.len - Oldlen_4850))) ? 1 : (NI64)(25 - (NI64)((*S_4688)->Sup.len - Oldlen_4850)));
Res_19630 = 0;
Res_19630 = 1;
while (1) {
...
memcpy(((NCSTRING) ((*Result_17101).data)), Str_17099, ((int) ((NI64)((NI64)(Len_17100 + 1) * 1))));
...
Result_10848 = (NI64)((NU64)(((NI) ((*LOC1).Refcount))) >> (NU64)(3));
return Result_10848;
}
N_NIMCALL(NimStringDesc*, mnewString)(NI Len_17095) {
...
memcpy(((NCSTRING) ((*Result_17146).data)), ((NCSTRING) (&(*S_17143).data[(Start_17149)-0])), ((int) ((NI64)(Len_17152 * 1))));
...
LOC5 = Growobj_12606(((void*) (Result_17406)), (NI64)((NI64)(Elemsize_17404 * (*Result_17406).space) + 16));
...
LOC4 = Growobj_12606(((void*) (Result_17237)), (NI64)((NI64)(Elemsize_17236 * (*Result_17237).space) + 16));
...
asgnRefNoCycle((void**) &(*E_4309).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193862)));
...
asgnRefNoCycle((void**) &(*E_4286).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193863)));
...
FILE* F_4058;
TSafePoint TMP193861;
NIM_BOOL LOC2;
NI64 volatile Len_4060;
NI LOC9;
Result_4057 = 0;
F_4058 = 0;
TMP193861.prev = excHandler;
excHandler = &TMP193861;
TMP193861.status = setjmp(TMP193861.context);
if (TMP193861.status == 0) {
...
if ((TMP193861.exc->Sup.m_type == NTI420)) {
Result_4057 = copyString(NIM_NIL);
TMP193861.status = 0;}
}
excHandler = excHandler->prev;
if (TMP193861.status != 0) { raiseException(TMP193861.exc, TMP193861.exc->name); }
return Result_4057;
}
N_NIMCALL(void, Genericassignaux_17968)(void* Dest_17970, void* Src_17971, TNimNode* N_17973) {
NI D_17974;
...
appendString(LOC1, ((NimStringDesc*) &TMP195480));
