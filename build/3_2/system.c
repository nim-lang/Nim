...
STRING_LITERAL(TMP196654, "", 0);
STRING_LITERAL(TMP196665, "no exception to reraise", 23);
STRING_LITERAL(TMP196766, " (invalid data!)", 16);
STRING_LITERAL(TMP196870, "cannot retrieve file position", 29);
STRING_LITERAL(TMP196871, "cannot set file position", 24);
STRING_LITERAL(TMP198490, "[GC] total memory: ", 19);
STRING_LITERAL(TMP198491, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP198492, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP198493, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP198494, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP198495, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP198496, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP198497, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP198498, "\012[GC] max stack size: ", 22);
...
Result_3806 = 0;
Result_3806 = copyString(((NimStringDesc*) &TMP196654));
...
asgnRefNoCycle((void**) &(*E_5434).Sup.Sup.message, copyString(((NimStringDesc*) &TMP196665)));
...
appendString(LOC4, ((NimStringDesc*) &TMP196766));
Result_19781 = LOC4;
LA1: ;
return Result_19781;
}
...
asgnRefNoCycle((void**) &(*E_4309).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP196870)));
...
asgnRefNoCycle((void**) &(*E_4286).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP196871)));
...
FILE* F_4058;
TSafePoint TMP196869;
NIM_BOOL LOC2;
NI64 volatile Len_4060;
NI LOC9;
Result_4057 = 0;
F_4058 = 0;
pushSafePoint(&TMP196869);
TMP196869.status = setjmp(TMP196869.context);
if (TMP196869.status == 0) {
...
Result_4057 = copyString(NIM_NIL);
TMP196869.status = 0;popCurrentException();}
}
if (TMP196869.status != 0) reraiseException();
return Result_4057;
}
N_NIMCALL(void, Genericassignaux_19568)(void* Dest_19570, void* Src_19571, TNimNode* N_19573) {
NI D_19574;
...
appendString(LOC1, ((NimStringDesc*) &TMP198490));
