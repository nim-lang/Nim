...
N_NIMCALL(void, Auxwritestacktracewithbacktrace_4665)(NimStringDesc** S_4668);
N_NIMCALL(void, Add_2733)(NimStringDesc** X_2736, NCSTRING Y_2737);
...
STRING_LITERAL(TMP20725, "cannot write string to file", 27);
STRING_LITERAL(TMP20726, "Traceback from system (most recent call last)", 45);
STRING_LITERAL(TMP20727, "Error: unhandled exception: ", 28);
STRING_LITERAL(TMP20728, "Error: unhandled exception", 26);
STRING_LITERAL(TMP20729, " [", 2);
STRING_LITERAL(TMP20730, "]\012", 2);
STRING_LITERAL(TMP20731, "\012", 1);
STRING_LITERAL(TMP20732, "out of memory; cannot even throw an exception", 45);
STRING_LITERAL(TMP20733, "out of memory", 13);
STRING_LITERAL(TMP20734, "rb", 2);
STRING_LITERAL(TMP20735, "wb", 2);
STRING_LITERAL(TMP20736, "w+b", 3);
STRING_LITERAL(TMP20737, "r+b", 3);
STRING_LITERAL(TMP20738, "ab", 2);
NIM_CONST TY4102 Formatopen_4101 = {((NimStringDesc*) &TMP20734),
((NimStringDesc*) &TMP20735),
((NimStringDesc*) &TMP20736),
((NimStringDesc*) &TMP20737),
((NimStringDesc*) &TMP20738)}
;
STRING_LITERAL(TMP20739, "SIGINT: Interrupted by Ctrl-C.\012", 31);
STRING_LITERAL(TMP20740, "SIGSEGV: Illegal storage access. (Attempt to read from nil?)\012", 61);
STRING_LITERAL(TMP20741, "SIGABRT: Abnormal termination.\012", 31);
STRING_LITERAL(TMP20742, "SIGFPE: Arithmetic error.\012", 26);
STRING_LITERAL(TMP20743, "SIGILL: Illegal operation.\012", 27);
STRING_LITERAL(TMP20744, "SIGBUS: Illegal storage access. (Attempt to read from nil?)\012", 60);
STRING_LITERAL(TMP20745, "unknown signal\012", 15);
STRING_LITERAL(TMP38239, "over- or underflow", 18);
STRING_LITERAL(TMP193642, "", 0);
STRING_LITERAL(TMP193653, "no exception to reraise", 23);
STRING_LITERAL(TMP193755, " (invalid data!)", 16);
STRING_LITERAL(TMP193859, "cannot retrieve file position", 29);
STRING_LITERAL(TMP193860, "cannot set file position", 24);
STRING_LITERAL(TMP195490, "[GC] total memory: ", 19);
STRING_LITERAL(TMP195491, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP195492, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP195493, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP195494, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP195495, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP195496, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP195497, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP195498, "\012[GC] max stack size: ", 22);
...
TY4661 Tempaddresses_4663;
Dl_info Tempdlinfo_4664;
...
Result_16603 = 0;
Stacktop_16604 = 0;
Result_16603 = (NI64)abs((NI64)(((NI) (&Stacktop_16604)) - ((NI) (Stackbottom_10807))));
return Result_16603;
}
static N_INLINE(TY10402*, Usrtocell_11212)(void* Usr_11214) {
...
void* X_10028;
X_10028 = 0;
X_10028 = ((void*) ((NI64)((NU64)(((NI) (P_1962))) - (NU64)(((NI)sizeof(TY8422))))));
...
D_10465 = 0;
LOC4 = Alloc_1950((NI64)((*S_10461).Cap * 8));
...
void* Result_11211;
Result_11211 = 0;
Result_11211 = ((void*) ((NI64)((NU64)(((NI) (Cell_11210))) + (NU64)(((NI) (((NI)sizeof(TY10402))))))));
return Result_11211;
}
N_NIMCALL(void, Preparedealloc_11825)(TY10402* Cell_11827) {
void* LOC4;
...
N_NOINLINE(void, Addzct_11201)(TY10418* S_11204, TY10402* C_11205) {
if (!((NI64)((*C_11205).Refcount & 4) == 0)) goto LA2;
(*C_11205).Refcount = (NI64)((NI64)((*C_11205).Refcount & -8) | 4);
...
break;
case ((NU8) 1):
Forallchildrenaux_11820(((void*) ((NI64)((NU64)(D_13407) + (NU64)((*N_13405).offset)))), (*N_13405).typ, Op_13406);
break;
case ((NU8) 2):
I_13415 = 0;
HEX3Atmp_20629 = 0;
HEX3Atmp_20629 = (NI64)((*N_13405).len - 1);
Res_20631 = 0;
Res_20631 = 0;
while (1) {
if (!(Res_20631 <= HEX3Atmp_20629)) goto LA1;
I_13415 = Res_20631;
...
I_13452 = 0;
HEX3Atmp_20632 = 0;
HEX3Atmp_20632 = (NI64)((NI64)((*Mt_11823).size / (*(*Mt_11823).base).size) - 1);
Res_20634 = 0;
Res_20634 = 0;
while (1) {
if (!(Res_20634 <= HEX3Atmp_20632)) goto LA7;
I_13452 = Res_20634;
Forallchildrenaux_11820(((void*) ((NI64)((NU64)(D_13433) + (NU64)((NI64)((NU64)(I_13452) * (NU64)((*(*Mt_11823).base).size)))))), (*Mt_11823).base, Op_11824);
Res_20634 += 1;
} LA7: ;
break;
case ((NU8) 22):
...
I_13499 = 0;
HEX3Atmp_20635 = 0;
HEX3Atmp_20635 = (NI64)((*S_13480).len - 1);
Res_20637 = 0;
Res_20637 = 0;
while (1) {
if (!(Res_20637 <= HEX3Atmp_20635)) goto LA6;
I_13499 = Res_20637;
Forallchildrenaux_11820(((void*) ((NI64)((NU64)((NI64)((NU64)(D_13479) + (NU64)((NI64)((NU64)(I_13499) * (NU64)((*(*(*Cell_11814).Typ).base).size))))) + (NU64)(16)))), (*(*Cell_11814).Typ).base, Op_11815);
Res_20637 += 1;
} LA6: ;
LA4: ;
break;
...
N_10575 = 0;
LOC1 = Alloc0_1953((NI64)((NI64)((*T_10573).Max + 1) * 8));
N_10575 = ((TY10410**) (LOC1));
I_10583 = 0;
Res_20628 = 0;
Res_20628 = 0;
while (1) {
if (!(Res_20628 <= Oldmax_10574)) goto LA2;
I_10583 = Res_20628;
...
Tabsize_15007 = 0;
C_15008 = 0;
memset((void*)&HEX3Atmp_20642, 0, sizeof(HEX3Atmp_20642));
HEX3Atmp_20642 = (*Gch_15006).Cycleroots;
R_20644 = 0;
R_20644 = HEX3Atmp_20642.Head;
while (1) {
if (!!((R_20644 == NIM_NIL))) goto LA1;
I_20646 = 0;
I_20646 = 0;
while (1) {
if (!(I_20646 <= 7)) goto LA2;
W_20648 = 0;
W_20648 = (*R_20644).Bits[(I_20646)-0];
J_20650 = 0;
J_20650 = 0;
while (1) {
if (!!((W_20648 == 0))) goto LA3;
if (!!(((NI64)(W_20648 & 1) == 0))) goto LA5;
C_15008 = ((TY10402*) ((NI64)((NI64)((NU64)((*R_20644).Key) << (NU64)(12)) | (NI64)((NU64)((NI64)((NU64)((NI64)((NU64)(I_20646) << (NU64)(6))) + (NU64)(J_20650))) * (NU64)(8)))));
Tabsize_15007 += 1;
Forallchildren_11812(C_15008, ((NU8) 2));
LA5: ;
J_20650 += 1;
W_20648 = (NI64)((NU64)(W_20648) >> (NU64)(1));
} LA3: ;
I_20646 += 1;
} LA2: ;
R_20644 = (*R_20644).Next;
} LA1: ;
...
C_15025 = 0;
memset((void*)&HEX3Atmp_20651, 0, sizeof(HEX3Atmp_20651));
HEX3Atmp_20651 = (*Gch_15006).Cycleroots;
R_20653 = 0;
R_20653 = HEX3Atmp_20651.Head;
while (1) {
if (!!((R_20653 == NIM_NIL))) goto LA7;
I_20655 = 0;
I_20655 = 0;
while (1) {
if (!(I_20655 <= 7)) goto LA8;
W_20657 = 0;
W_20657 = (*R_20653).Bits[(I_20655)-0];
J_20659 = 0;
J_20659 = 0;
while (1) {
if (!!((W_20657 == 0))) goto LA9;
if (!!(((NI64)(W_20657 & 1) == 0))) goto LA11;
C_15025 = ((TY10402*) ((NI64)((NI64)((NU64)((*R_20653).Key) << (NU64)(12)) | (NI64)((NU64)((NI64)((NU64)((NI64)((NU64)(I_20655) << (NU64)(6))) + (NU64)(J_20659))) * (NU64)(8)))));
...
LA11: ;
J_20659 += 1;
W_20657 = (NI64)((NU64)(W_20657) >> (NU64)(1));
} LA9: ;
I_20655 += 1;
} LA8: ;
R_20653 = (*R_20653).Next;
} LA7: ;
C_15045 = 0;
memset((void*)&HEX3Atmp_20660, 0, sizeof(HEX3Atmp_20660));
HEX3Atmp_20660 = (*Gch_15006).Cycleroots;
R_20662 = 0;
R_20662 = HEX3Atmp_20660.Head;
while (1) {
if (!!((R_20662 == NIM_NIL))) goto LA27;
I_20664 = 0;
I_20664 = 0;
while (1) {
if (!(I_20664 <= 7)) goto LA28;
W_20666 = 0;
W_20666 = (*R_20662).Bits[(I_20664)-0];
J_20668 = 0;
J_20668 = 0;
while (1) {
if (!!((W_20666 == 0))) goto LA29;
if (!!(((NI64)(W_20666 & 1) == 0))) goto LA31;
C_15045 = ((TY10402*) ((NI64)((NI64)((NU64)((*R_20662).Key) << (NU64)(12)) | (NI64)((NU64)((NI64)((NU64)((NI64)((NU64)(I_20664) << (NU64)(6))) + (NU64)(J_20668))) * (NU64)(8)))));
...
LA31: ;
J_20668 += 1;
W_20666 = (NI64)((NU64)(W_20666) >> (NU64)(1));
} LA29: ;
I_20664 += 1;
} LA28: ;
R_20662 = (*R_20662).Next;
} LA27: ;
...
I_17413 = 0;
HEX3Atmp_20669 = 0;
HEX3Atmp_20669 = (NI64)((*Gch_17404).Decstack.Len - 1);
Res_20671 = 0;
Res_20671 = 0;
while (1) {
if (!(Res_20671 <= HEX3Atmp_20669)) goto LA1;
I_17413 = Res_20671;
...
Cyclethreshold_10809 = ((4194304 >= (NI64)(LOC18 * 2)) ? 4194304 : (NI64)(LOC18 * 2));
...
Res_13524 = 0;
LOC1 = Rawalloc_9395(&Allocator_8529, (NI64)(Size_13508 + ((NI)sizeof(TY10402))));
Res_13524 = ((TY10402*) (LOC1));
zeroMem(((void*) (Res_13524)), (NI64)(Size_13508 + ((NI)sizeof(TY10402))));
...
HEX3Atmp_20638 = 0;
HEX3Atmp_20639 = 0;
HEX3Atmp_20638 = (NI64)(L_13602 - 1);
HEX3Atmp_20639 = ((0 >= (NI64)(L_13602 - 8)) ? 0 : (NI64)(L_13602 - 8));
Res_20641 = 0;
Res_20641 = HEX3Atmp_20638;
while (1) {
if (!(HEX3Atmp_20639 <= Res_20641)) goto LA3;
I_13613 = Res_20641;
C_13614 = 0;
...
S_18289 = 7;
LA2: ;
LOC4 = newObj(&Strdesc_3017, (NI64)(((NI)sizeof(TGenericSeq)) + (NI64)((NI64)(S_18289 + 1) * 1)));
...
memcpy(((NCSTRING) ((*Result_18309).data)), ((NCSTRING) ((*Src_18308).data)), ((int) ((NI64)((NI64)((*Src_18308).Sup.len + 1) * 1))));
BeforeRet: ;
return Result_18309;
}
N_NIMCALL(void, Gcdisable_2663)(void) {
...
Result_18204 = (NI64)(Old_18203 * 2);
goto BeforeRet;
goto LA1;
LA4: ;
Result_18204 = (NI64)((NI64)(Old_18203 * 3) / 2);
goto BeforeRet;
LA1: ;
BeforeRet: ;
return Result_18204;
...
Res_14038 = 0;
LOC1 = Rawalloc_9395(&Allocator_8529, (NI64)(Newsize_14010 + ((NI)sizeof(TY10402))));
...
memcpy(((void*) (Res_14038)), ((void*) (Ol_14013)), (NI64)(Oldsize_14049 + ((NI)sizeof(TY10402))));
zeroMem(((void*) ((NI64)((NU64)((NI64)((NU64)(((NI) (Res_14038))) + (NU64)(Oldsize_14049))) + (NU64)(((NI)sizeof(TY10402)))))), (NI64)(Newsize_14010 - Oldsize_14049));
if (!((NI64)((*Ol_14013).Refcount & 7) == 4)) goto LA6;
J_14054 = 0;
J_14054 = (NI64)(Gch_10808.Zct.Len - 1);
D_14055 = 0;
...
void* LOC5;
Result_18384 = 0;
if (!((NI64)((NI64)((*Dest_18382).Sup.len + Addlen_18383) + 1) <= (*Dest_18382).Sup.space)) goto LA2;
Result_18384 = Dest_18382;
goto LA1;
LA2: ;
Sp_18389 = 0;
LOC4 = Resize_18201((*Dest_18382).Sup.space);
Sp_18389 = ((LOC4 >= (NI64)((NI64)((*Dest_18382).Sup.len + Addlen_18383) + 1)) ? LOC4 : (NI64)((NI64)((*Dest_18382).Sup.len + Addlen_18383) + 1));
LOC5 = Growobj_14007(((void*) (Dest_18382)), (NI64)(((NI)sizeof(TGenericSeq)) + (NI64)((NI64)(Sp_18389 + 1) * 1)));
...
LOC4 = Growobj_14007(((void*) (Result_18365)), (NI64)(((NI)sizeof(TGenericSeq)) + (NI64)((NI64)((*Result_18365).Sup.space + 1) * 1)));
Result_18365 = ((NimStringDesc*) (LOC4));
LA2: ;
(*Result_18365).data[((*Result_18365).Sup.len)-0] = C_1604;
(*Result_18365).data[((NI64)((*Result_18365).Sup.len + 1))-0] = 0;
...
I_2738 = 0;
while (1) {
if (!!(((NU8)(Y_2737[I_2738]) == (NU8)(0)))) goto LA1;
(*X_2736) = addChar((*X_2736), Y_2737[I_2738]);
I_2738 += 1;
} LA1: ;
}
N_NIMCALL(void, Auxwritestacktracewithbacktrace_4665)(NimStringDesc** S_4668) {
NI Size_4682;
NIM_BOOL Enabled_4683;
NI I_4691;
NI HEX3Atmp_20609;
NI Res_20611;
NI Dlresult_4693;
...
int LOC17;
Size_4682 = 0;
Size_4682 = backtrace(((void**) (Tempaddresses_4663)), 128);
Enabled_4683 = 0;
Enabled_4683 = NIM_FALSE;
I_4691 = 0;
HEX3Atmp_20609 = 0;
HEX3Atmp_20609 = (NI64)(Size_4682 - 1);
Res_20611 = 0;
Res_20611 = 0;
while (1) {
if (!(Res_20611 <= HEX3Atmp_20609)) goto LA1;
I_4691 = Res_20611;
Dlresult_4693 = 0;
Dlresult_4693 = dladdr(Tempaddresses_4663[(I_4691)-0], &Tempdlinfo_4664);
if (!Enabled_4683) goto LA3;
if (!!((Dlresult_4693 == 0))) goto LA6;
Oldlen_4698 = 0;
Oldlen_4698 = (*S_4668)->Sup.len;
Add_2733(S_4668, Tempdlinfo_4664.dli_fname);
if (!!((Tempdlinfo_4664.dli_sname == NIM_NIL))) goto LA9;
K_4710 = 0;
HEX3Atmp_20606 = 0;
HEX3Atmp_20606 = ((1 >= (NI64)(25 - (NI64)((*S_4668)->Sup.len - Oldlen_4698))) ? 1 : (NI64)(25 - (NI64)((*S_4668)->Sup.len - Oldlen_4698)));
Res_20608 = 0;
Res_20608 = 1;
while (1) {
if (!(Res_20608 <= HEX3Atmp_20606)) goto LA11;
K_4710 = Res_20608;
(*S_4668) = addChar((*S_4668), 32);
Res_20608 += 1;
} LA11: ;
Add_2733(S_4668, Tempdlinfo_4664.dli_sname);
LA9: ;
goto LA5;
LA6: ;
(*S_4668) = addChar((*S_4668), 63);
LA5: ;
(*S_4668) = resizeString((*S_4668), Stacktracenewline_4416->Sup.len + 0);
appendString((*S_4668), Stacktracenewline_4416);
goto LA2;
LA3: ;
LOC14 = !((Dlresult_4693 == 0));
if (!(LOC14)) goto LA15;
LOC14 = !((Tempdlinfo_4664.dli_sname == NIM_NIL));
LA15: ;
LOC13 = LOC14;
if (!(LOC13)) goto LA16;
LOC17 = strcmp(Tempdlinfo_4664.dli_sname, "signalHandler");
LOC13 = (LOC17 == ((NI32) 0));
LA16: ;
if (!LOC13) goto LA18;
Enabled_4683 = NIM_TRUE;
LA18: ;
LA2: ;
Res_20611 += 1;
} LA1: ;
...
N_NIMCALL(void, Rawwritestacktrace_4989)(NimStringDesc** S_4992) {
(*S_4992) = resizeString((*S_4992), 45);
appendString((*S_4992), ((NimStringDesc*) &TMP20726));
(*S_4992) = resizeString((*S_4992), Stacktracenewline_4416->Sup.len + 0);
appendString((*S_4992), Stacktracenewline_4416);
Auxwritestacktracewithbacktrace_4665(S_4992);
}
N_NIMCALL(NimStringDesc*, toNimStr)(NCSTRING Str_18299, NI Len_18300) {
...
memcpy(((NCSTRING) ((*Result_18301).data)), Str_18299, ((int) ((NI64)((NI64)(Len_18300 + 1) * 1))));
...
appendString(Buf_4801, ((NimStringDesc*) &TMP20727));
...
asgnRefNoCycle((void**) &(*E_4255).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP20725)));
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3658(stdout, ((NimStringDesc*) &TMP20731));
}
N_NIMCALL(void, Quit_2821)(NimStringDesc* Errormsg_2823) {
...
Quit_2821(((NimStringDesc*) &TMP20732));
LA2: ;
asgnRefNoCycle((void**) &(*Goutofmem_7840).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP20733)));
...
NIM_BOOL LOC2;
Result_8016 = 0;
Result_8016 = mmap(NIM_NIL, Size_8015, ((NI32) 3), ((NI32) 4098), ((NI32) -1), 0);
...
void* Result_10018;
Result_10018 = 0;
Result_10018 = Rawalloc_9395(&Allocator_8529, (NI64)(Size_1952 + ((NI)sizeof(TY8422))));
...
LOC1 = Alloc0_1953((NI64)(Cap_10482 * 8));
...
appendString(Buf_4801, ((NimStringDesc*) &TMP20740));
goto LA1;
LA4: ;
...
LA9: ;
Buf_4801 = resizeString(Buf_4801, 31);
appendString(Buf_4801, ((NimStringDesc*) &TMP20741));
goto LA1;
LA6: ;
if (!(S_5279 == SIGFPE)) goto LA11;
Buf_4801 = resizeString(Buf_4801, 26);
appendString(Buf_4801, ((NimStringDesc*) &TMP20742));
goto LA1;
LA11: ;
if (!(S_5279 == SIGILL)) goto LA13;
Buf_4801 = resizeString(Buf_4801, 27);
appendString(Buf_4801, ((NimStringDesc*) &TMP20743));
goto LA1;
LA13: ;
if (!(S_5279 == SIGBUS)) goto LA15;
Buf_4801 = resizeString(Buf_4801, 60);
appendString(Buf_4801, ((NimStringDesc*) &TMP20744));
goto LA1;
LA15: ;
Buf_4801 = resizeString(Buf_4801, 15);
appendString(Buf_4801, ((NimStringDesc*) &TMP20745));
LA1: ;
Writetostderr_4417(Buf_4801->data);
...
Result_11238 = (NI64)((NU64)(((NI) ((*LOC1).Refcount))) >> (NU64)(3));
return Result_11238;
}
N_NIMCALL(NimStringDesc*, mnewString)(NI Len_18295) {
...
Len_18352 = 0;
Len_18352 = (NI64)((NI64)(((Last_18345 <= (NI64)((*S_18343).Sup.len - 1)) ? Last_18345 : (NI64)((*S_18343).Sup.len - 1)) - Start_18349) + 1);
if (!(0 < Len_18352)) goto LA2;
Result_18346 = rawNewString(Len_18352);
(*Result_18346).Sup.len = Len_18352;
memcpy(((NCSTRING) ((*Result_18346).data)), ((NCSTRING) (&(*S_18343).data[(Start_18349)-0])), ((int) ((NI64)(Len_18352 * 1))));
...
Result_18360 = 0;
Result_18360 = copyStrLast(S_18358, Start_18359, (NI64)((*S_18358).Sup.len - 1));
goto BeforeRet;
BeforeRet: ;
return Result_18360;
}
...
LOC5 = Growobj_14007(((void*) (Result_18606)), (NI64)((NI64)(Elemsize_18604 * (*Result_18606).space) + 16));
...
I_18620 = 0;
HEX3Atmp_20675 = 0;
HEX3Atmp_20675 = (NI64)((*Result_18606).len - 1);
Res_20677 = 0;
Res_20677 = Newlen_18605;
while (1) {
if (!(Res_20677 <= HEX3Atmp_20675)) goto LA8;
I_18620 = Res_20677;
LOC9 = extGetCellType(((void*) (Result_18606)));
Forallchildrenaux_11820(((void*) ((NI64)((NU64)((NI64)((NU64)(((NI) (Result_18606))) + (NU64)(16))) + (NU64)((NI64)((NU64)(I_18620) * (NU64)(Elemsize_18604)))))), (*LOC9).base, ((NU8) 0));
Res_20677 += 1;
} LA8: ;
zeroMem(((void*) ((NI64)((NU64)((NI64)((NU64)(((NI) (Result_18606))) + (NU64)(16))) + (NU64)((NI64)((NU64)(Newlen_18605) * (NU64)(Elemsize_18604)))))), (NI64)((NU64)((NI64)((NU64)((*Result_18606).len) - (NU64)(Newlen_18605))) * (NU64)(Elemsize_18604)));
goto LA1;
LA6: ;
LA1: ;
...
break;
case ((NU8) 1):
objectInit(((void*) ((NI64)((NU64)(D_19269) + (NU64)((*N_19268).offset)))), (*N_19268).typ);
break;
case ((NU8) 2):
I_19277 = 0;
HEX3Atmp_20696 = 0;
HEX3Atmp_20696 = (NI64)((*N_19268).len - 1);
Res_20698 = 0;
Res_20698 = 0;
while (1) {
if (!(Res_20698 <= HEX3Atmp_20696)) goto LA1;
I_19277 = Res_20698;
...
I_19304 = 0;
HEX3Atmp_20699 = 0;
HEX3Atmp_20699 = (NI64)((NI64)((*Typ_19263).size / (*(*Typ_19263).base).size) - 1);
Res_20701 = 0;
Res_20701 = 0;
while (1) {
if (!(Res_20701 <= HEX3Atmp_20699)) goto LA1;
I_19304 = Res_20701;
objectInit(((void*) ((NI64)((NU64)(D_19294) + (NU64)((NI64)(I_19304 * (*(*Typ_19263).base).size))))), (*Typ_19263).base);
Res_20701 += 1;
} LA1: ;
break;
default:
...
while (1) {
D_19007 = 0;
D_19007 = (NI64)(Y_19006 / 10);
Result_19004->data[I_19005] = ((NIM_CHAR) (((NI) ((NI64)((NI64)abs(((NI) ((NI64)(Y_19006 - (NI64)(D_19007 * 10))))) + 48)))));
I_19005 += 1;
Y_19006 = D_19007;
...
J_19048 = 0;
HEX3Atmp_20678 = 0;
HEX3Atmp_20678 = (NI64)((NI64)(I_19005 / 2) - 1);
Res_20680 = 0;
Res_20680 = 0;
while (1) {
if (!(Res_20680 <= HEX3Atmp_20678)) goto LA8;
J_19048 = Res_20680;
LOC9 = Result_19004->data[J_19048];
Result_19004->data[J_19048] = Result_19004->data[(NI64)((NI64)(I_19005 - J_19048) - 1)];
Result_19004->data[(NI64)((NI64)(I_19005 - J_19048) - 1)] = LOC9;
Res_20680 += 1;
} LA8: ;
return Result_19004;
}
...
asgnRefNoCycle((void**) &(*E_4119).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP20733)));
...
Result_3806 = 0;
Result_3806 = copyString(((NimStringDesc*) &TMP193642));
...
asgnRefNoCycle((void**) &(*E_5234).Sup.Sup.message, copyString(((NimStringDesc*) &TMP193653)));
...
LOC4 = Growobj_14007(((void*) (Result_18437)), (NI64)((NI64)(Elemsize_18436 * (*Result_18437).space) + 16));
...
Result_19068->data[I_19069] = ((NIM_CHAR) (((NI) ((NI64)((NI64)abs(((NI) ((NI64)(Y_19070 - (NI64)(D_19071 * 10))))) + 48)))));
I_19069 += 1;
Y_19070 = D_19071;
...
J_19112 = 0;
HEX3Atmp_20681 = 0;
HEX3Atmp_20681 = (NI64)((NI64)(I_19069 / 2) - 1);
Res_20683 = 0;
Res_20683 = 0;
while (1) {
if (!(Res_20683 <= HEX3Atmp_20681)) goto LA8;
J_19112 = Res_20683;
LOC9 = Result_19068->data[J_19112];
Result_19068->data[J_19112] = Result_19068->data[(NI64)((NI64)(I_19069 - J_19112) - 1)];
Result_19068->data[(NI64)((NI64)(I_19069 - J_19112) - 1)] = LOC9;
Res_20683 += 1;
} LA8: ;
return Result_19068;
}
...
NimStringDesc* LOC5;
Result_19357 = 0;
if (!((NU64)(E_19355) < (NU64)((*(*Typ_19356).node).len))) goto LA2;
...
asgnRefNoCycle((void**) &(*E_4301).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193859)));
...
asgnRefNoCycle((void**) &(*E_4278).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193860)));
...
FILE* F_4058;
TSafePoint TMP193858;
NIM_BOOL LOC2;
NI64 volatile Len_4060;
NI LOC9;
Result_4057 = 0;
F_4058 = 0;
pushSafePoint(&TMP193858);
TMP193858.status = setjmp(TMP193858.context);
if (TMP193858.status == 0) {
...
Result_4057 = copyString(NIM_NIL);
TMP193858.status = 0;popCurrentException();}
}
if (TMP193858.status != 0) reraiseException();
return Result_4057;
}
N_NIMCALL(void, Genericassignaux_19168)(void* Dest_19170, void* Src_19171, TNimNode* N_19173) {
NI D_19174;
...
break;
case ((NU8) 1):
genericAssign(((void*) ((NI64)((NU64)(D_19174) + (NU64)((*N_19173).offset)))), ((void*) ((NI64)((NU64)(S_19175) + (NU64)((*N_19173).offset)))), (*N_19173).typ);
break;
case ((NU8) 2):
I_19183 = 0;
HEX3Atmp_20684 = 0;
HEX3Atmp_20684 = (NI64)((*N_19173).len - 1);
Res_20686 = 0;
Res_20686 = 0;
while (1) {
if (!(Res_20686 <= HEX3Atmp_20684)) goto LA1;
I_19183 = Res_20686;
...
break;
case ((NU8) 3):
memcpy(((void*) ((NI64)((NU64)(D_19174) + (NU64)((*N_19173).offset)))), ((void*) ((NI64)((NU64)(S_19175) + (NU64)((*N_19173).offset)))), (*(*N_19173).typ).size);
M_19184 = 0;
...
goto BeforeRet;
LA2: ;
LOC4 = newObj(Mt_19167, (NI64)((NI64)((*Seq_19215).len * (*(*Mt_19167).base).size) + 16));
unsureAsgnRef(((void**) (Dest_19165)), LOC4);
Dst_19217 = 0;
Dst_19217 = ((NI) ((*((void**) (Dest_19165)))));
I_19225 = 0;
HEX3Atmp_20687 = 0;
HEX3Atmp_20687 = (NI64)((*Seq_19215).len - 1);
Res_20689 = 0;
Res_20689 = 0;
while (1) {
if (!(Res_20689 <= HEX3Atmp_20687)) goto LA5;
I_19225 = Res_20689;
genericAssign(((void*) ((NI64)((NU64)((NI64)((NU64)(Dst_19217) + (NU64)((NI64)((NU64)(I_19225) * (NU64)((*(*Mt_19167).base).size))))) + (NU64)(16)))), ((void*) ((NI64)((NU64)((NI64)((NU64)(((NI) (S2_19214))) + (NU64)((NI64)((NU64)(I_19225) * (NU64)((*(*Mt_19167).base).size))))) + (NU64)(16)))), (*Mt_19167).base);
Res_20689 += 1;
} LA5: ;
Dstseq_19226 = 0;
...
I_19234 = 0;
HEX3Atmp_20690 = 0;
HEX3Atmp_20690 = (NI64)((NI64)((*Mt_19167).size / (*(*Mt_19167).base).size) - 1);
Res_20692 = 0;
Res_20692 = 0;
while (1) {
if (!(Res_20692 <= HEX3Atmp_20690)) goto LA6;
I_19234 = Res_20692;
genericAssign(((void*) ((NI64)((NU64)(D_19201) + (NU64)((NI64)((NU64)(I_19234) * (NU64)((*(*Mt_19167).base).size)))))), ((void*) ((NI64)((NU64)(S_19202) + (NU64)((NI64)((NU64)(I_19234) * (NU64)((*(*Mt_19167).base).size)))))), (*Mt_19167).base);
Res_20692 += 1;
} LA6: ;
break;
case ((NU8) 28):
...
appendString(LOC1, ((NimStringDesc*) &TMP195490));
...
Initgc_3011();
asgnRefNoCycle((void**) &Stacktracenewline_4416, copyString(((NimStringDesc*) &TMP20731)));
excHandler = NIM_NIL;
