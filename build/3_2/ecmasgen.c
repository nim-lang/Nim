...
LOC8[0] = X_176423.Res;
LOC8[1] = Y_176424.Res;
unsureAsgnRef((void**) &(*R_176421).Res, Ropef_50069(Ops_175960[(Op_176422)-26][((NI64)(I_176425 + 2))-0], LOC8, 2));
...
LOC9[0] = (*R_176421).Res;
unsureAsgnRef((void**) &(*R_176421).Res, Ropef_50069(Ops_175960[(Op_176422)-26][((NI64)(I_176425 + 2))-0], LOC9, 1));
LA4: ;
}
N_NIMCALL(void, Genswap_178459)(TY175021* P_178462, TY53523* N_178463, TY175013* R_178465) {
TY175013 A_178466;
...
LA6: ;
Gen_175841(P_180437, (*N_180438).KindU.S6.Sons->data[(NI64)(I_180442 + 1)], &A_180441);
...
if (!(LOC9)) goto LA10;
LOC9 = ((851968 &(IL64(1)<<(((*(*C_179860).Typ).Kind)&IL64(63))))!=0);
LA10: ;
LOC8 = LOC9;
if (!(LOC8)) goto LA11;
