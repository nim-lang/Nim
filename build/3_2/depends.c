...
STRING_LITERAL(TMP195470, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP195471, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP195472, "", 0);
STRING_LITERAL(TMP195473, "dot", 3);
...
Appf_50074(&Gdotgraph_184015, ((NimStringDesc*) &TMP195470), LOC1, 2);
}
N_NIMCALL(TY53523*, Adddotdependency_184025)(TY101002* C_184027, TY53523* N_184028) {
...
LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP195472));
LOC1[0] = Torope_50046(LOC3);
LOC1[1] = Gdotgraph_184015;
LOC4 = Ropef_50069(((NimStringDesc*) &TMP195471), LOC1, 2);
LOC5 = nosChangeFileExt(Project_184008, ((NimStringDesc*) &TMP195473));
