...
STRING_LITERAL(TMP197646, "crc", 3);
extern NIM_CONST TY52054 Os_52053;
extern NIM_CONST TY52462 Cpu_52461;
STRING_LITERAL(TMP197648, "0", 1);
STRING_LITERAL(TMP197665, " ", 1);
STRING_LITERAL(TMP197671, ".options.always", 15);
STRING_LITERAL(TMP197672, ".options.linker", 15);
STRING_LITERAL(TMP197673, ".path", 5);
STRING_LITERAL(TMP197723, ".cpp", 4);
STRING_LITERAL(TMP197724, ".m", 2);
STRING_LITERAL(TMP198829, ".debug", 6);
STRING_LITERAL(TMP198830, ".options.debug", 14);
STRING_LITERAL(TMP198831, ".speed", 6);
STRING_LITERAL(TMP198832, ".options.speed", 14);
STRING_LITERAL(TMP198833, ".size", 5);
STRING_LITERAL(TMP198834, ".options.size", 13);
STRING_LITERAL(TMP198835, ".always", 7);
STRING_LITERAL(TMP198836, ".exe", 4);
STRING_LITERAL(TMP198837, "exe", 3);
STRING_LITERAL(TMP198838, "file", 4);
STRING_LITERAL(TMP198839, "objfile", 7);
STRING_LITERAL(TMP198840, "options", 7);
STRING_LITERAL(TMP198841, "include", 7);
STRING_LITERAL(TMP198842, "nimrod", 6);
STRING_LITERAL(TMP198843, "lib", 3);
STRING_LITERAL(TMP198853, "[C_Files]\012", 10);
STRING_LITERAL(TMP198854, "--file:r\"$1\"$n", 14);
STRING_LITERAL(TMP198855, "[Symbols]$n$1", 13);
STRING_LITERAL(TMP198856, "mapping.txt", 11);
STRING_LITERAL(TMP198917, ".linkerexe", 10);
STRING_LITERAL(TMP198918, "builddll", 8);
STRING_LITERAL(TMP198919, "buildgui", 8);
STRING_LITERAL(TMP198920, "objfiles", 8);
STRING_LITERAL(TMP198921, "exefile", 7);
STRING_LITERAL(TMP198922, "compile_", 8);
...
Crcfile_71528 = Togeneratedfile_47110(Filename_71526, ((NimStringDesc*) &TMP197646));
Currentcrc_71529 = 0;
...
LA8: ;
if (!LOC7) goto LA9;
Line_71532 = copyString(((NimStringDesc*) &TMP197648));
LA9: ;
fclose(F_71530);
Oldcrc_71537 = 0;
...
appendString((*Dest_71446), ((NimStringDesc*) &TMP197665));
LA4: ;
...
appendString(LOC4, ((NimStringDesc*) &TMP197671));
...
appendString(LOC5, ((NimStringDesc*) &TMP197672));
...
appendString(LOC6, ((NimStringDesc*) &TMP197673));
...
asgnRefNoCycle((void**) &Cext_71342, copyString(((NimStringDesc*) &TMP197723)));
goto LA2;
LA3: ;
...
appendString(LOC7, ((NimStringDesc*) &TMP197671));
LOC8 = 0;
...
appendString(LOC9, ((NimStringDesc*) &TMP197672));
LOC10 = 0;
...
appendString(LOC14, ((NimStringDesc*) &TMP197673));
...
appendString(LOC1, ((NimStringDesc*) &TMP198830));
...
appendString(LOC5, ((NimStringDesc*) &TMP198829));
Key_71622 = LOC5;
...
appendString(LOC15, ((NimStringDesc*) &TMP198831));
Key_71622 = LOC15;
...
appendString(LOC24, ((NimStringDesc*) &TMP198833));
Key_71622 = LOC24;
...
appendString(LOC31, ((NimStringDesc*) &TMP198835));
Key_71622 = LOC31;
...
appendString(LOC37, ((NimStringDesc*) &TMP198836));
Key_71622 = LOC37;
...
Exe_71624 = nosaddFileExt(Exe_71624, ((NimStringDesc*) &TMP198837));
LA43: ;
...
LOC65[0] = copyString(((NimStringDesc*) &TMP198838));
LOC65[1] = copyString(Cfile_71617);
LOC65[2] = copyString(((NimStringDesc*) &TMP198839));
LOC65[3] = copyString(Objfile_71618);
LOC65[4] = copyString(((NimStringDesc*) &TMP198840));
LOC65[5] = copyString(Options_71619);
LOC65[6] = copyString(((NimStringDesc*) &TMP198841));
LOC65[7] = copyString(Includecmd_71620);
LOC65[8] = copyString(((NimStringDesc*) &TMP198842));
LOC65[9] = Getprefixdir_47114();
LOC65[10] = copyString(((NimStringDesc*) &TMP198843));
...
LOC67[0] = copyString(((NimStringDesc*) &TMP198838));
LOC67[1] = copyString(Cfile_71617);
LOC67[2] = copyString(((NimStringDesc*) &TMP198839));
LOC67[3] = copyString(Objfile_71618);
LOC67[4] = copyString(((NimStringDesc*) &TMP198840));
LOC67[5] = copyString(Options_71619);
LOC67[6] = copyString(((NimStringDesc*) &TMP198841));
LOC67[7] = copyString(Includecmd_71620);
LOC67[8] = copyString(((NimStringDesc*) &TMP198842));
LOC68 = 0;
LOC68 = Getprefixdir_47114();
LOC67[9] = Quoteifcontainswhite_26268(LOC68);
LOC67[10] = copyString(((NimStringDesc*) &TMP198843));
...
Appf_53071(&Result_72056, ((NimStringDesc*) &TMP198854), LOC2, 1);
...
LA2: ;
Code_72088 = NIM_NIL;
Code_72088 = Torope_53046(((NimStringDesc*) &TMP198853));
LOC4 = 0;
...
Appf_53071(&Code_72088, ((NimStringDesc*) &TMP198855), LOC6, 1);
LOC7 = 0;
LOC7 = nosJoinPath(Projectpath_47118, ((NimStringDesc*) &TMP198856));
...
appendString(LOC2, ((NimStringDesc*) &TMP198922));
...
appendString(LOC26, ((NimStringDesc*) &TMP198917));
...
Linkerexe_71936 = nosaddFileExt(Linkerexe_71936, ((NimStringDesc*) &TMP198837));
LA31: ;
...
LOC59[0] = copyString(((NimStringDesc*) &TMP198918));
LOC59[1] = copyString(Builddll_71811);
LOC59[2] = copyString(((NimStringDesc*) &TMP198919));
LOC59[3] = copyString(Buildgui_71810);
LOC59[4] = copyString(((NimStringDesc*) &TMP198840));
LOC59[5] = copyString(Linkoptions_71347);
LOC59[6] = copyString(((NimStringDesc*) &TMP198920));
LOC59[7] = copyString(Objfiles_71996);
LOC59[8] = copyString(((NimStringDesc*) &TMP198921));
LOC59[9] = copyString(Exefile_71970);
LOC59[10] = copyString(((NimStringDesc*) &TMP198842));
LOC59[11] = Getprefixdir_47114();
LOC59[12] = copyString(((NimStringDesc*) &TMP198843));
...
LOC61[0] = copyString(((NimStringDesc*) &TMP198918));
LOC61[1] = copyString(Builddll_71811);
LOC61[2] = copyString(((NimStringDesc*) &TMP198919));
LOC61[3] = copyString(Buildgui_71810);
LOC61[4] = copyString(((NimStringDesc*) &TMP198840));
LOC61[5] = copyString(Linkoptions_71347);
LOC61[6] = copyString(((NimStringDesc*) &TMP198920));
LOC61[7] = copyString(Objfiles_71996);
LOC61[8] = copyString(((NimStringDesc*) &TMP198921));
LOC61[9] = copyString(Exefile_71970);
LOC61[10] = copyString(((NimStringDesc*) &TMP198842));
LOC62 = 0;
LOC62 = Getprefixdir_47114();
LOC61[11] = Quoteifcontainswhite_26268(LOC62);
LOC61[12] = copyString(((NimStringDesc*) &TMP198843));
...
Write_3866(F_71549, ((NimStringDesc*) &TMP199565));
}
