...
STRING_LITERAL(TMP195646, "crc", 3);
extern NIM_CONST TY51054 Os_51053;
extern NIM_CONST TY51462 Cpu_51461;
STRING_LITERAL(TMP195648, "0", 1);
STRING_LITERAL(TMP195667, " ", 1);
STRING_LITERAL(TMP195673, ".options.always", 15);
STRING_LITERAL(TMP195674, ".options.linker", 15);
STRING_LITERAL(TMP195675, ".path", 5);
STRING_LITERAL(TMP195725, ".cpp", 4);
STRING_LITERAL(TMP195726, ".m", 2);
STRING_LITERAL(TMP196783, ".debug", 6);
STRING_LITERAL(TMP196784, ".options.debug", 14);
STRING_LITERAL(TMP196785, ".speed", 6);
STRING_LITERAL(TMP196786, ".options.speed", 14);
STRING_LITERAL(TMP196787, ".size", 5);
STRING_LITERAL(TMP196788, ".options.size", 13);
STRING_LITERAL(TMP196789, ".always", 7);
STRING_LITERAL(TMP196790, ".exe", 4);
STRING_LITERAL(TMP196791, "exe", 3);
STRING_LITERAL(TMP196792, "file", 4);
STRING_LITERAL(TMP196793, "objfile", 7);
STRING_LITERAL(TMP196794, "options", 7);
STRING_LITERAL(TMP196795, "include", 7);
STRING_LITERAL(TMP196796, "nimrod", 6);
STRING_LITERAL(TMP196797, "lib", 3);
STRING_LITERAL(TMP196807, "[C_Files]\012", 10);
STRING_LITERAL(TMP196808, "--file:r\"$1\"$n", 14);
STRING_LITERAL(TMP196809, "[Symbols]$n$1", 13);
STRING_LITERAL(TMP196810, "mapping.txt", 11);
STRING_LITERAL(TMP196871, ".linkerexe", 10);
STRING_LITERAL(TMP196872, "builddll", 8);
STRING_LITERAL(TMP196873, "buildgui", 8);
STRING_LITERAL(TMP196874, "objfiles", 8);
STRING_LITERAL(TMP196875, "exefile", 7);
STRING_LITERAL(TMP196876, "compile_", 8);
...
LOC2 = HEX3EHEX3C_50092(LOC1, Os_51053[(Targetos_51570)-1].Name);
LOC3 = HEX3EHEX3C_50092(LOC2, Cpu_51461[(Targetcpu_51568)-1].Name);
...
Result_70527 = 0;
Crcfile_70528 = 0;
Crcfile_70528 = Togeneratedfile_46105(Filename_70526, ((NimStringDesc*) &TMP195646));
Currentcrc_70529 = 0;
...
LA8: ;
if (!LOC7) goto LA9;
Line_70532 = copyString(((NimStringDesc*) &TMP195648));
LA9: ;
fclose(F_70530);
Oldcrc_70537 = 0;
...
if (LOC2) goto LA3;
LOC2 = !(((NU8)((*Dest_70446)->data[(NI64)((NI64)((*Dest_70446)->Sup.len - 1) + 0)]) == (NU8)(32)));
LA3: ;
if (!LOC2) goto LA4;
(*Dest_70446) = resizeString((*Dest_70446), 1);
appendString((*Dest_70446), ((NimStringDesc*) &TMP195667));
LA4: ;
...
appendString(LOC5, ((NimStringDesc*) &TMP195674));
...
appendString(LOC6, ((NimStringDesc*) &TMP195675));
...
asgnRefNoCycle((void**) &Cext_70342, copyString(((NimStringDesc*) &TMP195726)));
goto LA2;
LA5: ;
LA2: ;
LOC7 = 0;
...
appendString(LOC7, ((NimStringDesc*) &TMP195673));
LOC8 = 0;
...
appendString(LOC9, ((NimStringDesc*) &TMP195674));
LOC10 = 0;
...
appendString(LOC14, ((NimStringDesc*) &TMP195675));
...
appendString(LOC1, ((NimStringDesc*) &TMP196784));
...
appendString(LOC1, ((NimStringDesc*) &TMP196786));
...
appendString(LOC1, ((NimStringDesc*) &TMP196788));
...
appendString(LOC5, ((NimStringDesc*) &TMP196783));
Key_70622 = LOC5;
...
appendString(LOC15, ((NimStringDesc*) &TMP196785));
Key_70622 = LOC15;
...
appendString(LOC24, ((NimStringDesc*) &TMP196787));
Key_70622 = LOC24;
...
appendString(LOC31, ((NimStringDesc*) &TMP196789));
Key_70622 = LOC31;
...
appendString(LOC37, ((NimStringDesc*) &TMP196790));
Key_70622 = LOC37;
...
Exe_70624 = nosaddFileExt(Exe_70624, ((NimStringDesc*) &TMP196791));
LA43: ;
...
LOC65[0] = copyString(((NimStringDesc*) &TMP196792));
LOC65[1] = copyString(Cfile_70617);
LOC65[2] = copyString(((NimStringDesc*) &TMP196793));
LOC65[3] = copyString(Objfile_70618);
LOC65[4] = copyString(((NimStringDesc*) &TMP196794));
LOC65[5] = copyString(Options_70619);
LOC65[6] = copyString(((NimStringDesc*) &TMP196795));
LOC65[7] = copyString(Includecmd_70620);
LOC65[8] = copyString(((NimStringDesc*) &TMP196796));
LOC65[9] = Getprefixdir_46109();
LOC65[10] = copyString(((NimStringDesc*) &TMP196797));
...
LOC67[0] = copyString(((NimStringDesc*) &TMP196792));
LOC67[1] = copyString(Cfile_70617);
LOC67[2] = copyString(((NimStringDesc*) &TMP196793));
LOC67[3] = copyString(Objfile_70618);
LOC67[4] = copyString(((NimStringDesc*) &TMP196794));
LOC67[5] = copyString(Options_70619);
LOC67[6] = copyString(((NimStringDesc*) &TMP196795));
LOC67[7] = copyString(Includecmd_70620);
LOC67[8] = copyString(((NimStringDesc*) &TMP196796));
LOC68 = 0;
LOC68 = Getprefixdir_46109();
LOC67[9] = Quoteifcontainswhite_26268(LOC68);
LOC67[10] = copyString(((NimStringDesc*) &TMP196797));
...
Appf_52071(&Result_71056, ((NimStringDesc*) &TMP196808), LOC2, 1);
...
LA2: ;
Code_71088 = 0;
Code_71088 = Torope_52046(((NimStringDesc*) &TMP196807));
LOC4 = 0;
...
Appf_52071(&Code_71088, ((NimStringDesc*) &TMP196809), LOC6, 1);
LOC7 = 0;
LOC7 = nosJoinPath(Projectpath_46113, ((NimStringDesc*) &TMP196810));
...
LA3: ;
if (!LOC2) goto LA4;
Messageout_47775(Cmd_70572);
LA4: ;
LOC7 = nospexecCmd(Cmd_70572);
if (!!((LOC7 == 0))) goto LA8;
Rawmessage_48045(((NU8) 62), ((NimStringDesc*) &TMP70271));
LA8: ;
}
N_NIMCALL(void, Generatescript_70590)(NimStringDesc* Projectfile_70592, TY52008* Script_70593) {
TY38661 LOC1;
...
appendString(LOC2, ((NimStringDesc*) &TMP196876));
...
appendString(LOC26, ((NimStringDesc*) &TMP196871));
...
Linkerexe_70936 = nosaddFileExt(Linkerexe_70936, ((NimStringDesc*) &TMP196791));
LA31: ;
...
LOC59[0] = copyString(((NimStringDesc*) &TMP196872));
LOC59[1] = copyString(Builddll_70811);
LOC59[2] = copyString(((NimStringDesc*) &TMP196873));
LOC59[3] = copyString(Buildgui_70810);
LOC59[4] = copyString(((NimStringDesc*) &TMP196794));
LOC59[5] = copyString(Linkoptions_70347);
LOC59[6] = copyString(((NimStringDesc*) &TMP196874));
LOC59[7] = copyString(Objfiles_70996);
LOC59[8] = copyString(((NimStringDesc*) &TMP196875));
LOC59[9] = copyString(Exefile_70970);
LOC59[10] = copyString(((NimStringDesc*) &TMP196796));
LOC59[11] = Getprefixdir_46109();
LOC59[12] = copyString(((NimStringDesc*) &TMP196797));
...
LOC61[0] = copyString(((NimStringDesc*) &TMP196872));
LOC61[1] = copyString(Builddll_70811);
LOC61[2] = copyString(((NimStringDesc*) &TMP196873));
LOC61[3] = copyString(Buildgui_70810);
LOC61[4] = copyString(((NimStringDesc*) &TMP196794));
LOC61[5] = copyString(Linkoptions_70347);
LOC61[6] = copyString(((NimStringDesc*) &TMP196874));
LOC61[7] = copyString(Objfiles_70996);
LOC61[8] = copyString(((NimStringDesc*) &TMP196875));
LOC61[9] = copyString(Exefile_70970);
LOC61[10] = copyString(((NimStringDesc*) &TMP196796));
LOC62 = 0;
LOC62 = Getprefixdir_46109();
LOC61[11] = Quoteifcontainswhite_26268(LOC62);
LOC61[12] = copyString(((NimStringDesc*) &TMP196797));
...
static N_INLINE(void, Writeln_70546)(FILE* F_70549, NimStringDesc* X_70550) {
Write_3866(F_70549, X_70550);
Write_3866(F_70549, ((NimStringDesc*) &TMP197512));
}
