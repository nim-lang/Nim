...
Limessage_45562((*(*N_127440).KindU.S6.Sons->data[(NI64)(Length_127664 - 1)]).Info, ((NU8) 172), ((NimStringDesc*) &TMP193926));
LA41: ;
...
Limessage_45562((*(*A_126759).KindU.S6.Sons->data[(NI64)(Length_126755 - 1)]).Info, ((NU8) 172), ((NimStringDesc*) &TMP193926));
LA10: ;
J_126868 = 0;
HEX3Atmp_141809 = 0;
...
LA12: ;
if (!LOC9) goto LA13;
Limessage_45562((*(*N_138787).KindU.S6.Sons->data[(NI64)(Length_138789 - 2)]).Info, ((NU8) 205), ((NimStringDesc*) &TMP193926));
LA13: ;
