...
Limessage_47562((*(*N_130440).KindU.S6.Sons->data[(NI64)(Length_130664 - 1)]).Info, ((NU8) 172), ((NimStringDesc*) &TMP196934));
LA41: ;
...
Limessage_47562((*(*A_129759).KindU.S6.Sons->data[(NI64)(Length_129755 - 1)]).Info, ((NU8) 172), ((NimStringDesc*) &TMP196934));
LA10: ;
J_129868 = 0;
HEX3Atmp_144844 = 0;
...
LA12: ;
if (!LOC9) goto LA13;
Limessage_47562((*(*N_141787).KindU.S6.Sons->data[(NI64)(Length_141789 - 2)]).Info, ((NU8) 205), ((NimStringDesc*) &TMP196934));
LA13: ;
