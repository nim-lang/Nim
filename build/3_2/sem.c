...
Limessage_46566((*(*N_130322).KindU.S6.Sons->data[(NI64)(Length_130546 - 1)]).Info, ((NU8) 173), ((NimStringDesc*) &TMP193923));
LA41: ;
...
Limessage_46566((*(*A_129641).KindU.S6.Sons->data[(NI64)(Length_129637 - 1)]).Info, ((NU8) 173), ((NimStringDesc*) &TMP193923));
LA10: ;
J_129750 = 0;
HEX3Atmp_144884 = 0;
...
LA12: ;
if (!LOC9) goto LA13;
Limessage_46566((*(*N_141787).KindU.S6.Sons->data[(NI64)(Length_141789 - 2)]).Info, ((NU8) 207), ((NimStringDesc*) &TMP193923));
LA13: ;
