...
STRING_LITERAL(TMP193888, "", 0);
STRING_LITERAL(TMP194226, "$", 1);
STRING_LITERAL(TMP194227, "ropes: invalid format string $", 30);
...
Result_51490 = copyString(((NimStringDesc*) &TMP193888));
goto LA1;
LA2: ;
...
case 36:
App_51036(&Result_51707, ((NimStringDesc*) &TMP194226));
I_51708 += 1;
break;
case 35:
I_51708 += 1;
...
appendString(LOC14, ((NimStringDesc*) &TMP194227));
...
appendString(LOC16, ((NimStringDesc*) &TMP194227));
