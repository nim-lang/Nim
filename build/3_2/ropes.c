...
STRING_LITERAL(TMP195895, "", 0);
STRING_LITERAL(TMP196231, "$", 1);
STRING_LITERAL(TMP196232, "ropes: invalid format string $", 30);
...
Result_52500 = copyString(((NimStringDesc*) &TMP195895));
goto LA1;
LA2: ;
...
case 36:
App_52036(&Result_52720, ((NimStringDesc*) &TMP196231));
I_52721 += 1;
break;
case 35:
I_52721 += 1;
...
appendString(LOC14, ((NimStringDesc*) &TMP196232));
...
appendString(LOC16, ((NimStringDesc*) &TMP196232));
