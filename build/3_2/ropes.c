...
STRING_LITERAL(TMP195892, "", 0);
STRING_LITERAL(TMP196225, "$", 1);
STRING_LITERAL(TMP196226, "ropes: invalid format string $", 30);
...
Result_52500 = copyString(((NimStringDesc*) &TMP195892));
goto LA1;
LA2: ;
...
case 36:
App_52036(&Result_52720, ((NimStringDesc*) &TMP196225));
I_52721 += 1;
break;
case 35:
I_52721 += 1;
...
appendString(LOC14, ((NimStringDesc*) &TMP196226));
...
appendString(LOC16, ((NimStringDesc*) &TMP196226));
