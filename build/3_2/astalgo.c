...
STRING_LITERAL(TMP196061, "getSymFromList", 14);
STRING_LITERAL(TMP196681, "lookupInRecord", 14);
STRING_LITERAL(TMP196682, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP196683, "lookupInRecord()", 16);
...
I_63098 = Res_63100;
(*X_60223).Data->data[I_63098].Key = (IL64(-9223372036854775807) - IL64(1));
Res_63100 += 1;
} LA1: ;
}
N_NIMCALL(NI, Nexttry_60205)(NI H_60207, NI Maxhash_60208) {
NI Result_61824;
Result_61824 = 0;
Result_61824 = (NI64)((NI64)((NI64)(5 * H_60207) + 1) & Maxhash_60208);
return Result_61824;
}
N_NIMCALL(TY55548*, Strtableget_60066)(TY55530* T_60068, TY54011* Name_60069) {
...
Result_62440 = 0;
H_62441 = 0;
H_62441 = (NI64)((*Name_60069).H & ((*T_60068).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_60521 = 0;
LOC1 = ((NI64)(Length_60203 * 2) < (NI64)(Counter_60204 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI64)(Length_60203 - Counter_60204) < 4);
LA2: ;
Result_60521 = LOC1;
return Result_60521;
}
...
NimStringDesc* LOC5;
H_62261 = 0;
H_62261 = (NI64)((*(*N_62260).Name).H & ((*Data_62259)->Sup.len-1));
while (1) {
...
TY55528* LOC5;
N_62297 = 0;
N_62297 = (TY55528*) newSeq(NTI55528, (NI64)((*T_62296).Data->Sup.len * 2));
I_62328 = 0;
HEX3Atmp_62350 = 0;
...
Result_63105 = 0;
H_63106 = 0;
H_63106 = (NI64)(Key_63104 & (T_63103.Data->Sup.len-1));
while (1) {
if (!!((T_63103.Data->data[H_63106].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
NI H_63125;
H_63125 = 0;
H_63125 = (NI64)(Key_63123 & ((*Data_63122)->Sup.len-1));
while (1) {
if (!!(((*Data_63122)->data[H_63125].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
if (!LOC5) goto LA6;
N_63153 = 0;
N_63153 = (TY60213*) newSeq(NTI60213, (NI64)((*T_60231).Data->Sup.len * 2));
I_63184 = 0;
HEX3Atmp_63219 = 0;
...
I_63184 = Res_63221;
N_63153->data[I_63184].Key = (IL64(-9223372036854775807) - IL64(1));
Res_63221 += 1;
} LA8: ;
I_63193 = 0;
HEX3Atmp_63222 = 0;
...
I_63193 = Res_63224;
if (!!(((*T_60231).Data->data[I_63193].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA11;
...
Result_62736 = 0;
H_62737 = 0;
H_62737 = (NI64)(Key_62735 & (T_62734.Data->Sup.len-1));
while (1) {
...
NI H_62790;
H_62790 = 0;
H_62790 = (NI64)((*Key_62788).Id & ((*Data_62787)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_62822 = (TY55562*) newSeq(NTI55562, (NI64)((*T_60169).Data->Sup.len * 2));
I_62876 = 0;
HEX3Atmp_62911 = 0;
...
goto LA1;
LA2: ;
Result_63115 = (IL64(-9223372036854775807) - IL64(1));
LA1: ;
return Result_63115;
}
...
I_62566 = 0;
HEX3Atmp_62578 = 0;
HEX3Atmp_62578 = (NI64)(((NI) (Tab_60113.Tos)) - 1);
Res_62580 = 0;
...
H_62470 = 0;
Start_62471 = 0;
H_62470 = (NI64)((*Ti_60096).H & ((*Tab_60097).Data->Sup.len-1));
Start_62471 = H_62470;
...
Result_62921 = 0;
H_62922 = 0;
H_62922 = (NI64)((*Key_62920).Id & (T_62919.Data->Sup.len-1));
while (1) {
...
NI H_62950;
H_62950 = 0;
H_62950 = (NI64)((*Key_62948).Id & ((*Data_62947)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_63005 = 0;
N_63005 = (TY55568*) newSeq(NTI55568, (NI64)((*T_60183).Data->Sup.len * 2));
I_63036 = 0;
HEX3Atmp_63071 = 0;
...
Internalerror_48159((*List_60191).Info, ((NimStringDesc*) &TMP196061));
LA4: ;
...
(*Tab_60144).Stack = (TY60101*) setLengthSeq(&((*Tab_60144).Stack)->Sup, sizeof(TY55530), (NI64)(((NI) ((*Tab_60144).Tos)) + 1));
LA2: ;
...
H_62387 = 0;
It_62388 = 0;
H_62387 = (NI64)((*(*N_62385).Name).H & ((*T_62384).Data->Sup.len-1));
while (1) {
...
NU8 Result_62607;
Result_62607 = 0;
Result_62607 = Symtabadduniqueat_60135(Tab_60133, E_60134, ((NI) ((NI64)(((NI) ((*Tab_60133).Tos)) - 1))));
return Result_62607;
}
...
Result_62538 = 0;
Result_62538 = Strtableget_60066(&Tab_60117.Stack->data[(NI64)(((NI) (Tab_60117.Tos)) - 1)], S_60118);
return Result_62538;
}
N_NIMCALL(void, Symtabadd_60119)(TY60099* Tab_60122, TY55548* E_60123) {
Strtableadd_60061(&(*Tab_60122).Stack->data[(NI64)(((NI) ((*Tab_60122).Tos)) - 1)], E_60123);
}
...
Internalerror_48159((*N_60196).Info, ((NimStringDesc*) &TMP196681));
LA7: ;
...
break;
default:
Internalerror_48159((*N_60196).Info, ((NimStringDesc*) &TMP196682));
break;
}
Res_60405 += 1;
} LA13: ;
