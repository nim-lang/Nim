...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193656, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP193702, "invalid float: ", 15);
STRING_LITERAL(TMP193743, "0123456789ABCDEF", 16);
...
appendString(LOC5, ((NimStringDesc*) &TMP193656));
...
appendString(LOC5, ((NimStringDesc*) &TMP193702));
...
J_23462 = Res_23466;
Result_23452->data[J_23462] = ((NimStringDesc*) &TMP193743)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_23450) >> (NU64)(Shift_23454)))) & ((NI32) 15))];
