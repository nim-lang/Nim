...
STRING_LITERAL(TMP195863, "nim", 3);
STRING_LITERAL(TMP195916, "handleSymbolFile should have set the module\'s ID", 48);
STRING_LITERAL(TMP195918, "command line", 12);
STRING_LITERAL(TMP195919, "", 0);
STRING_LITERAL(TMP196859, "system", 6);
STRING_LITERAL(TMP196877, ".cpp", 4);
STRING_LITERAL(TMP196878, ".m", 2);
STRING_LITERAL(TMP197081, "pretty.nim", 10);
STRING_LITERAL(TMP197082, "nimdoc.cfg", 10);
STRING_LITERAL(TMP197485, "nimdoc.tex.cfg", 14);
STRING_LITERAL(TMP197493, "dot -Tpng -o", 12);
STRING_LITERAL(TMP197494, "png", 3);
STRING_LITERAL(TMP197495, "dot", 3);
STRING_LITERAL(TMP197497, "Beware: Indentation tokens depend on the parser\'s state!", 56);
STRING_LITERAL(TMP197498, "stdin", 5);
...
Rd_191357 = NIM_NIL;
F_191358 = 0;
F_191358 = nosaddFileExt(Filename_191322, ((NimStringDesc*) &TMP195863));
...
Internalerror_48163(((NimStringDesc*) &TMP195916));
LA13: ;
goto LA7;
LA10: ;
...
LOC4 = Newlineinfo_47712(((NimStringDesc*) &TMP195918), 1, 1);
Fatal_48134(LOC4, ((NU8) 182), ((NimStringDesc*) &TMP195919));
LA2: ;
}
N_NIMCALL(void, Semanticpasses_191408)(void) {
TY105006 LOC1;
...
TY55548* LOC5;
LOC1 = 0;
LOC1 = nosaddFileExt(((NimStringDesc*) &TMP196859), ((NimStringDesc*) &TMP195863));
LOC2 = 0;
LOC2 = nosJoinPath(Libpath_46112, LOC1);
LOC3 = 0;
LOC3 = Compilemodule_191320(LOC2, NIM_FALSE, NIM_TRUE);
LOC4 = 0;
LOC4 = nosaddFileExt(Filename_191407, ((NimStringDesc*) &TMP195863));
LOC5 = 0;
...
LOC6 = 0;
LOC6 = nosChangeFileExt(Filename_191418, ((NimStringDesc*) &TMP195919));
...
Module_191646 = 0;
LOC1 = 0;
LOC1 = nosaddFileExt(Filename_191645, ((NimStringDesc*) &TMP195863));
Module_191646 = Parsefile_92031(LOC1);
if (!!((Module_191646 == NIM_NIL))) goto LA3;
LOC5 = 0;
LOC5 = Getoutfile_46145(Filename_191645, ((NimStringDesc*) &TMP197081));
...
LOC3 = 0;
LOC4 = 0;
LOC4 = nosChangeFileExt(Filename_191412, ((NimStringDesc*) &TMP197494));
LOC5 = 0;
LOC5 = nosChangeFileExt(Filename_191412, ((NimStringDesc*) &TMP197495));
LOC3 = rawNewString(LOC4->Sup.len + LOC5->Sup.len + 13);
appendString(LOC3, ((NimStringDesc*) &TMP197493));
...
TY77263* Tok_191675;
F_191661 = 0;
F_191661 = nosaddFileExt(Filename_191660, ((NimStringDesc*) &TMP195863));
Stream_191662 = 0;
...
LOC5 = 0;
LOC5 = nosaddFileExt(((NimStringDesc*) &TMP196859), ((NimStringDesc*) &TMP195863));
LOC6 = 0;
LOC6 = nosJoinPath(Libpath_46112, LOC5);
LOC7 = 0;
LOC7 = Compilemodule_191320(LOC6, NIM_FALSE, NIM_TRUE);
M_191630 = 0;
M_191630 = Newmodule_191287(((NimStringDesc*) &TMP197498));
(*M_191630).Sup.Id = Getid_55694();
(*M_191630).Flags |=(1<<((NI32)(((NU8) 15))%(sizeof(NI32)*8)));
LOC8 = 0;
LOC8 = Llstreamopenstdin_75230();
Processmodule_105035(M_191630, ((NimStringDesc*) &TMP197498), LOC8, NIM_NIL);
}
N_NIMCALL(void, Commandsuggest_191704)(NimStringDesc* Filename_191706) {
Gerrormax_47568 = IL64(9223372036854775807);
Semanticpasses_191408();
...
break;
case ((NU8) 201):
asgnRefNoCycle((void**) &Cext_70342, copyString(((NimStringDesc*) &TMP196877)));
Gcmd_46084 = ((NU8) 2);
Wantfile_191707(Filename_191204);
Commandcompiletoc_191416(Filename_191204);
break;
...
case ((NU8) 206):
Gcmd_46084 = ((NU8) 8);
Loadspecialconfig_80007(((NimStringDesc*) &TMP197082));
Wantfile_191707(Filename_191204);
...
case ((NU8) 215):
Gcmd_46084 = ((NU8) 16);
Loadspecialconfig_80007(((NimStringDesc*) &TMP197485));
Wantfile_191707(Filename_191204);
...
Wantfile_191707(Filename_191204);
LOC6 = 0;
LOC6 = nosaddFileExt(Filename_191204, ((NimStringDesc*) &TMP195863));
LOC7 = 0;
...
Messageout_47775(((NimStringDesc*) &TMP197497));
break;
case ((NU8) 216):
Gcmd_46084 = ((NU8) 17);
