...
STRING_LITERAL(TMP196451, "NAN", 3);
STRING_LITERAL(TMP196452, "0.0", 3);
STRING_LITERAL(TMP196453, "INF", 3);
STRING_LITERAL(TMP196454, "-INF", 4);
N_NIMCALL(NimStringDesc*, Tostrmaxprecision_59011)(NF64 F_59013) {
NimStringDesc* Result_59014;
TY59015 Buf_59017;
Result_59014 = 0;
if (!!((((NF) (F_59013)) == ((NF) (F_59013))))) goto LA2;
Result_59014 = copyString(((NimStringDesc*) &TMP196451));
goto LA1;
LA2: ;
if (!(((NF) (F_59013)) == 0.0)) goto LA4;
Result_59014 = copyString(((NimStringDesc*) &TMP196452));
goto LA1;
LA4: ;
