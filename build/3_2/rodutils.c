...
STRING_LITERAL(TMP198502, "NAN", 3);
STRING_LITERAL(TMP198503, "0.0", 3);
STRING_LITERAL(TMP198504, "INF", 3);
STRING_LITERAL(TMP198505, "-INF", 4);
...
Result_60014 = copyString(((NimStringDesc*) &TMP198502));
goto LA1;
LA2: ;
