...
NIM_CONST TY45252 TMP154246 = {((NimStringDesc*) &TMP154247),
...
NIM_CONST TY45252 TMP155704 = {((NimStringDesc*) &TMP155705),
...
if ((*(*D_154777).Tocpart->data[(*J_154779)].N).Level == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
A_154784 = (NI64)abs((*(*D_154777).Tocpart->data[(*J_154779)].N).Level);
