...
NIM_CONST TY45252 TMP155246 = {((NimStringDesc*) &TMP155247),
...
NIM_CONST TY45252 TMP156704 = {((NimStringDesc*) &TMP156705),
...
LOC9 = 0;
LOC9 = Readfile_3447(Gindexfile_45081);
...
if ((*(*D_155777).Tocpart->data[(*J_155779)].N).Level == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
A_155784 = (NI64)abs((*(*D_155777).Tocpart->data[(*J_155779)].N).Level);
...
LOC1 = 0;
LOC1 = Readfile_3447(Filen_156884);
