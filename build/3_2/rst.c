...
;
static NIM_CONST TY22602 TMP198107 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x07, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP198109, "\012", 1);
STRING_LITERAL(TMP198110, "#", 1);
static NIM_CONST TY22602 TMP198111 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP198112, "ii", 2);
STRING_LITERAL(TMP198113, " a", 2);
STRING_LITERAL(TMP198114, "i", 1);
STRING_LITERAL(TMP198115, "ai", 2);
STRING_LITERAL(TMP198116, "::", 2);
STRING_LITERAL(TMP198117, "+", 1);
STRING_LITERAL(TMP198118, "*", 1);
STRING_LITERAL(TMP198119, "-", 1);
STRING_LITERAL(TMP198120, "|", 1);
STRING_LITERAL(TMP198121, "..", 2);
STRING_LITERAL(TMP198122, ":", 1);
STRING_LITERAL(TMP198123, "(e) ", 4);
STRING_LITERAL(TMP198124, "+a+", 3);
STRING_LITERAL(TMP198125, "-w", 2);
STRING_LITERAL(TMP198126, "--w", 3);
STRING_LITERAL(TMP198127, "/w", 2);
STRING_LITERAL(TMP198128, "//w", 3);
STRING_LITERAL(TMP198129, "e) ", 3);
STRING_LITERAL(TMP198130, "e. ", 3);
static NIM_CONST TY22602 TMP198131 = {
0x00, 0x00, 0x00, 0x00, 0x84, 0xA1, 0x00, 0x14,
0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x08,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP198132, "\\", 1);
STRING_LITERAL(TMP198133, "**", 2);
static NIM_CONST TY22602 TMP198134 = {
0x00, 0x00, 0x00, 0x00, 0x86, 0xF2, 0x00, 0xCC,
0x00, 0x00, 0x00, 0xB0, 0x00, 0x00, 0x00, 0x20,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP198135, "``", 2);
STRING_LITERAL(TMP198136, "\\\\", 2);
STRING_LITERAL(TMP198137, " ", 1);
STRING_LITERAL(TMP198138, "`", 1);
STRING_LITERAL(TMP198139, "_", 1);
STRING_LITERAL(TMP198140, ">", 1);
STRING_LITERAL(TMP198141, "<", 1);
STRING_LITERAL(TMP198142, ":w:", 3);
STRING_LITERAL(TMP198143, "idx", 3);
STRING_LITERAL(TMP198144, "literal", 7);
STRING_LITERAL(TMP198145, "strong", 6);
STRING_LITERAL(TMP198146, "emphasis", 8);
STRING_LITERAL(TMP198147, "sub", 3);
STRING_LITERAL(TMP198148, "subscript", 9);
STRING_LITERAL(TMP198149, "sup", 3);
STRING_LITERAL(TMP198150, "supscript", 9);
STRING_LITERAL(TMP198151, "//", 2);
STRING_LITERAL(TMP198152, ".", 1);
STRING_LITERAL(TMP198153, "getFieldValue (2): ", 19);
STRING_LITERAL(TMP198154, "\001\001", 2);
STRING_LITERAL(TMP198155, "\000\001\002", 3);
STRING_LITERAL(TMP198156, "Too many binary zeros in include file", 37);
STRING_LITERAL(TMP198157, "html", 4);
STRING_LITERAL(TMP198158, "file", 4);
STRING_LITERAL(TMP198159, "latex", 5);
STRING_LITERAL(TMP198160, " _", 2);
STRING_LITERAL(TMP198161, " |", 2);
STRING_LITERAL(TMP198162, "replace", 7);
STRING_LITERAL(TMP198163, " [", 2);
STRING_LITERAL(TMP198164, "]", 1);
NIM_CONST TY149839 Wildcards_149838 = {((NimStringDesc*) &TMP198123),
((NimStringDesc*) &TMP198129),
...
STRING_LITERAL(TMP198165, "rst.parseSection()", 18);
...
if (!((NU8)(Buf_146244[(NI64)(Pos_146243 + 1)]) == (NU8)(10))) goto LA5;
Pos_146243 += 2;
goto LA4;
LA5: ;
Pos_146243 += 1;
...
case 9:
Pos_146243 += 1;
Result_146242 = (NI64)((NI64)(Result_146242 - (NI64)(Result_146242 % 8)) + 8);
break;
default:
goto LA18;
break;
...
(*Tok_146363).Ival = (((NI64)((*Tok_146363).Ival - (*L_146361).Baseindent) >= 0) ? (NI64)((*Tok_146363).Ival - (*L_146361).Baseindent) : 0);
LOC1 = 0;
LOC2 = 0;
LOC2 = nsuRepeatChar((*Tok_146363).Ival, 32);
LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, ((NimStringDesc*) &TMP198109));
...
(*L_146205).Col += (NI64)(Pos_146208 - (*L_146205).Bufpos);
...
case 128 ... 255:
case 48 ... 57:
Getthing_146158(L_146389, Tok_146391, TMP198107);
break;
case 32:
case 9:
case 11:
...
(*Tok_146391).Col = (((NI64)((*Tok_146391).Col - (*L_146389).Baseindent) >= 0) ? (NI64)((*Tok_146391).Col - (*L_146389).Baseindent) : 0);
}
N_NIMCALL(void, Gettokens_146438)(NimStringDesc* Buffer_146440, NIM_BOOL Skippounds_146441, TY146137** Tokens_146443) {
TY146139 L_146444;
NI Length_146455;
...
Rawgettok_146386(&L_146444, &(*Tokens_146443)->data[(NI64)(Length_146455 - 1)]);
if (!((*Tokens_146443)->data[(NI64)(Length_146455 - 1)].Kind == ((NU8) 0))) goto LA20;
goto LA18;
LA20: ;
} LA18: ;
...
Result_146764 = Newlineinfo_47574((*P_146762).Filename, (NI64)((*P_146762).Line + (*Tok_146763).Line), (NI64)((*P_146762).Col + (*Tok_146763).Col));
...
I_146947 = 0;
HEX3Atmp_146980 = 0;
HEX3Atmp_146980 = (NI64)((NI64)((*N_146924).Text->Sup.len + 0) - 1);
Res_146982 = 0;
Res_146982 = 0;
while (1) {
...
(*B_146928) = NIM_FALSE;
LA15: ;
(*R_146926) = addChar((*R_146926), ((NIM_CHAR) (((NI) ((NI64)((NI64)(((NU8)((*N_146924).Text->data[I_146947])) - 65) + 97))))));
break;
default:
...
(*P_146804).Indentstack = (TY76281*) setLengthSeq(&((*P_146804).Indentstack)->Sup, sizeof(NI), (NI64)((*P_146804).Indentstack->Sup.len - 1));
LA2: ;
}
N_NIMCALL(NIM_BOOL, Match_147762)(TY146690* P_147764, NI Start_147765, NimStringDesc* Expr_147766) {
...
Last_147772 = 0;
Last_147772 = (NI64)((NI64)(Expr_147766->Sup.len + 0) - 1);
while (1) {
...
if (LOC2) goto LA3;
LOC2 = eqStrings((*P_147764).Tok->data[J_147769].Symbol, ((NimStringDesc*) &TMP198110));
LA3: ;
Result_147767 = LOC2;
...
break;
case 48 ... 57:
Result_147767 = Allcharsinset_25830((*P_147764).Tok->data[J_147769].Symbol, TMP198111);
break;
default:
break;
}
...
LOC4 = ((*P_148824).Tok->data[(NI64)((*P_148824).Idx - 1)].Kind == ((NU8) 1));
if (!(LOC4)) goto LA5;
LOC6 = Currind_146774(P_148824);
LOC4 = ((*P_148824).Tok->data[(NI64)((*P_148824).Idx - 1)].Ival == LOC6);
LA5: ;
Result_148825 = LOC4;
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*P_148815).Tok->data[J_148817].Symbol, ((NimStringDesc*) &TMP198120));
LA3: ;
LOC1 = LOC2;
if (LOC1) goto LA4;
...
LOC1 = LOC2;
if (!(LOC1)) goto LA4;
LOC1 = !(eqStrings((*P_148841).Tok->data[(NI64)(J_148843 - 2)].Symbol, ((NimStringDesc*) &TMP198116)));
LA4: ;
Result_148842 = LOC1;
...
NIM_BOOL LOC3;
Result_148861 = 0;
LOC3 = Match_147762(P_148860, (*P_148860).Idx, ((NimStringDesc*) &TMP198125));
if (LOC3) goto LA4;
LOC3 = Match_147762(P_148860, (*P_148860).Idx, ((NimStringDesc*) &TMP198126));
LA4: ;
LOC2 = LOC3;
if (LOC2) goto LA5;
LOC2 = Match_147762(P_148860, (*P_148860).Idx, ((NimStringDesc*) &TMP198127));
LA5: ;
LOC1 = LOC2;
if (LOC1) goto LA6;
LOC1 = Match_147762(P_148860, (*P_148860).Idx, ((NimStringDesc*) &TMP198128));
LA6: ;
Result_148861 = LOC1;
...
case ((NU8) 4):
LOC2 = Match_147762(P_148864, (NI64)((*P_148864).Idx + 1), ((NimStringDesc*) &TMP198112));
if (!LOC2) goto LA3;
Result_148865 = ((NU8) 3);
goto LA1;
LA3: ;
LOC5 = Match_147762(P_148864, (NI64)((*P_148864).Idx + 1), ((NimStringDesc*) &TMP198113));
if (!LOC5) goto LA6;
Result_148865 = ((NU8) 29);
goto LA1;
LA6: ;
LOC8 = Match_147762(P_148864, (NI64)((*P_148864).Idx + 1), ((NimStringDesc*) &TMP198114));
if (!LOC8) goto LA9;
Result_148865 = ((NU8) 2);
goto LA1;
LA9: ;
...
LOC13 = Match_147762(P_148864, LOC12, ((NimStringDesc*) &TMP198115));
if (!LOC13) goto LA14;
Result_148865 = ((NU8) 1);
goto LA11;
LA14: ;
if (!eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198116))) goto LA16;
Result_148865 = ((NU8) 24);
goto LA11;
LA16: ;
LOC19 = Prednl_148822(P_148864);
if (!(LOC19)) goto LA20;
LOC22 = eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198117));
if (LOC22) goto LA23;
LOC22 = eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198118));
LA23: ;
LOC21 = LOC22;
if (LOC21) goto LA24;
LOC21 = eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198119));
LA24: ;
LOC19 = LOC21;
LA20: ;
LOC18 = LOC19;
if (!(LOC18)) goto LA25;
LOC18 = ((*P_148864).Tok->data[(NI64)((*P_148864).Idx + 1)].Kind == ((NU8) 2));
LA25: ;
if (!LOC18) goto LA26;
Result_148865 = ((NU8) 5);
goto LA11;
LA26: ;
LOC28 = eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198120));
if (!(LOC28)) goto LA29;
...
goto LA11;
LA30: ;
LOC32 = eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198121));
if (!(LOC32)) goto LA33;
...
goto LA11;
LA34: ;
LOC36 = eqStrings((*P_148864).Tok->data[(*P_148864).Idx].Symbol, ((NimStringDesc*) &TMP198122));
if (!(LOC36)) goto LA37;
...
goto LA11;
LA38: ;
LOC40 = Match_147762(P_148864, (*P_148864).Idx, ((NimStringDesc*) &TMP198123));
if (!LOC40) goto LA41;
Result_148865 = ((NU8) 7);
goto LA11;
LA41: ;
LOC43 = Match_147762(P_148864, (*P_148864).Idx, ((NimStringDesc*) &TMP198124));
if (!LOC43) goto LA44;
...
LOC54 = Match_147762(P_148864, LOC53, ((NimStringDesc*) &TMP198115));
if (!LOC54) goto LA55;
Result_148865 = ((NU8) 1);
goto LA52;
LA55: ;
...
goto LA52;
LA58: ;
LOC60 = Match_147762(P_148864, (*P_148864).Idx, ((NimStringDesc*) &TMP198129));
if (LOC60) goto LA61;
...
appendString((*N_148687).Text, ((NimStringDesc*) &TMP198109));
LOC8 = 0;
LOC8 = nsuRepeatChar((NI64)((*P_148685).Tok->data[(*P_148685).Idx].Ival - Indent_148697), 32);
...
if (!((*P_149574).Tok->data[(NI64)((*P_149574).Idx + 1)].Kind == ((NU8) 2))) goto LA2;
Bullet_149585 = 0;
...
Pushind_146778(P_149574, (*P_149574).Tok->data[(NI64)((*P_149574).Idx + 2)].Col);
(*P_149574).Idx += 2;
while (1) {
Item_149599 = 0;
...
LOC7 = LOC8;
if (!(LOC7)) goto LA10;
LOC7 = eqStrings((*P_149574).Tok->data[(NI64)((*P_149574).Idx + 1)].Symbol, Bullet_149585);
LA10: ;
LOC6 = LOC7;
if (!(LOC6)) goto LA11;
LOC6 = ((*P_149574).Tok->data[(NI64)((*P_149574).Idx + 2)].Kind == ((NU8) 2));
LA11: ;
if (!LOC6) goto LA12;
(*P_149574).Idx += 3;
goto LA5;
...
if (!((*P_148878).Tok->data[(NI64)((*P_148878).Idx + 1)].Kind == ((NU8) 2))) goto LA2;
Col_148889 = 0;
Col_148889 = (*P_148878).Tok->data[(*P_148878).Idx].Col;
Result_148879 = Newrstnode_146094(((NU8) 26));
Pushind_146778(P_148878, (*P_148878).Tok->data[(NI64)((*P_148878).Idx + 2)].Col);
(*P_148878).Idx += 2;
while (1) {
Item_148902 = 0;
...
LOC7 = LOC8;
if (!(LOC7)) goto LA10;
LOC7 = eqStrings((*P_148878).Tok->data[(NI64)((*P_148878).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198120));
LA10: ;
LOC6 = LOC7;
if (!(LOC6)) goto LA11;
LOC6 = ((*P_148878).Tok->data[(NI64)((*P_148878).Idx + 2)].Kind == ((NU8) 2));
LA11: ;
if (!LOC6) goto LA12;
(*P_148878).Idx += 3;
goto LA5;
...
if (!(LOC2)) goto LA3;
LOC2 = ((*P_148273).Tok->data[(NI64)((*P_148273).Idx + 1)].Kind == ((NU8) 3));
LA3: ;
if (!LOC2) goto LA4;
J_148293 = 0;
...
if (!eqStrings((*P_148273).Tok->data[(*P_148273).Idx].Symbol, ((NimStringDesc*) &TMP198116))) goto LA8;
goto LA6;
LA8: ;
...
(*P_148273).Idx += 1;
LA11: ;
if (!eqStrings((*P_148273).Tok->data[(*P_148273).Idx].Symbol, ((NimStringDesc*) &TMP198116))) goto LA14;
(*P_148273).Idx += 1;
...
LOC5 = ((*P_147642).Idx == 0);
if (LOC5) goto LA6;
LOC5 = ((6 &(1<<(((*P_147642).Tok->data[(NI64)((*P_147642).Idx - 1)].Kind)&7)))!=0);
LA6: ;
LOC4 = LOC5;
if (LOC4) goto LA7;
LOC4 = ((TMP198131[((NU8)((*P_147642).Tok->data[(NI64)((*P_147642).Idx - 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*P_147642).Tok->data[(NI64)((*P_147642).Idx - 1)].Symbol->data[0]))%8)))!=0);
LA7: ;
Result_147644 = LOC4;
if (!!(Result_147644)) goto LA9;
goto BeforeRet;
LA9: ;
Result_147644 = !(((7 &(1<<(((*P_147642).Tok->data[(NI64)((*P_147642).Idx + 1)].Kind)&7)))!=0));
if (!!(Result_147644)) goto LA12;
goto BeforeRet;
LA12: ;
if (!(0 < (*P_147642).Idx)) goto LA15;
if (!eqStrings((*P_147642).Tok->data[(NI64)((*P_147642).Idx - 1)].Symbol, ((NimStringDesc*) &TMP198132))) goto LA18;
Result_147644 = NIM_FALSE;
goto LA17;
LA18: ;
C_147686 = 0;
C_147686 = (*P_147642).Tok->data[(NI64)((*P_147642).Idx - 1)].Symbol->data[0];
switch (((NU8)(C_147686))) {
case 39:
case 34:
D_147645 = C_147686;
...
Result_147644 = !(((NU8)((*P_147642).Tok->data[(NI64)((*P_147642).Idx + 1)].Symbol->data[0]) == (NU8)(D_147645)));
LA21: ;
LA17: ;
LA15: ;
BeforeRet: ;
...
goto BeforeRet;
LA2: ;
Result_147601 = !(((6 &(1<<(((*P_147599).Tok->data[(NI64)((*P_147599).Idx - 1)].Kind)&7)))!=0));
if (!!(Result_147601)) goto LA5;
goto BeforeRet;
LA5: ;
LOC7 = ((7 &(1<<(((*P_147599).Tok->data[(NI64)((*P_147599).Idx + 1)].Kind)&7)))!=0);
if (LOC7) goto LA8;
LOC7 = ((TMP198134[((NU8)((*P_147599).Tok->data[(NI64)((*P_147599).Idx + 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*P_147599).Tok->data[(NI64)((*P_147599).Idx + 1)].Symbol->data[0]))%8)))!=0);
LA8: ;
Result_147601 = LOC7;
...
LOC16 = !(eqStrings(Markup_147600, ((NimStringDesc*) &TMP198135)));
if (!(LOC16)) goto LA17;
LOC16 = eqStrings((*P_147599).Tok->data[(NI64)((*P_147599).Idx - 1)].Symbol, ((NimStringDesc*) &TMP198132));
LA17: ;
if (!LOC16) goto LA18;
...
TY146077* LOC10;
TY146077* LOC11;
if (!eqStrings((*P_147694).Tok->data[(*P_147694).Idx].Symbol, ((NimStringDesc*) &TMP198136))) goto LA2;
LOC4 = 0;
LOC4 = Newrstnode_146097(((NU8) 62), ((NimStringDesc*) &TMP198132));
Addson_146101(Father_147695, LOC4);
(*P_147694).Idx += 1;
goto LA1;
LA2: ;
if (!eqStrings((*P_147694).Tok->data[(*P_147694).Idx].Symbol, ((NimStringDesc*) &TMP198132))) goto LA5;
(*P_147694).Idx += 1;
...
case ((NU8) 1):
LOC10 = 0;
LOC10 = Newrstnode_146097(((NU8) 62), ((NimStringDesc*) &TMP198137));
...
case ((NU8) 2):
LOC14 = 0;
LOC14 = Newrstnode_146097(((NU8) 62), ((NimStringDesc*) &TMP198137));
...
HEX3Atmp_147992 = (NI64)(LOC1 - 2);
Res_147994 = 0;
Res_147994 = HEX3Atmp_147992;
while (1) {
if (!(0 <= Res_147994)) goto LA2;
I_147969 = Res_147994;
if (!eqStrings((*(*N_147943).Sons->data[I_147969]).Text, ((NimStringDesc*) &TMP198141))) goto LA4;
Sep_147946 = I_147969;
goto LA2;
LA4: ;
Res_147994 -= 1;
...
LOC8 = (0 < Sep_147946);
if (!(LOC8)) goto LA9;
LOC8 = ((NU8)((*(*N_147943).Sons->data[(NI64)(Sep_147946 - 1)]).Text->data[0]) == (NU8)(32));
LA9: ;
if (!LOC8) goto LA10;
LOC6 = 2;
goto LA7;
...
I_147982 = 0;
HEX3Atmp_147998 = 0;
HEX3Atmp_147998 = (NI64)(Sep_147946 - Incr_147974);
Res_148000 = 0;
Res_148000 = 0;
while (1) {
...
HEX3Atmp_148004 = 0;
HEX3Atmp_148005 = 0;
HEX3Atmp_148004 = (NI64)(Sep_147946 + 1);
LOC12 = Rsonslen_146091(N_147943);
HEX3Atmp_148005 = (NI64)(LOC12 - 2);
Res_148007 = 0;
...
I_147102 = 0;
HEX3Atmp_147116 = 0;
HEX3Atmp_147116 = (NI64)(Length_147094 - 1);
Res_147118 = 0;
Res_147118 = 0;
while (1) {
...
(*(*P_147081).S).Refs = (TY146695*) setLengthSeq(&((*(*P_147081).S).Refs)->Sup, sizeof(TY146684), (NI64)(Length_147094 + 1));
...
LOC2 = Isinlinemarkupend_147597(&(*P_148013), ((NimStringDesc*) &TMP198139));
if (!LOC2) goto LA3;
(*P_148013).Idx += 1;
LOC6 = eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx - 2)].Symbol, ((NimStringDesc*) &TMP198138));
if (!(LOC6)) goto LA7;
LOC6 = eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx - 3)].Symbol, ((NimStringDesc*) &TMP198140));
LA7: ;
if (!LOC6) goto LA8;
A_148028 = 0;
...
goto LA1;
LA3: ;
LOC17 = Match_147762(&(*P_148013), (*P_148013).Idx, ((NimStringDesc*) &TMP198142));
if (!LOC17) goto LA18;
if (!eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198143))) goto LA21;
(*N_148014).Kind = ((NU8) 56);
goto LA20;
LA21: ;
if (!eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198144))) goto LA23;
(*N_148014).Kind = ((NU8) 60);
goto LA20;
LA23: ;
if (!eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198145))) goto LA25;
(*N_148014).Kind = ((NU8) 58);
goto LA20;
LA25: ;
if (!eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198146))) goto LA27;
(*N_148014).Kind = ((NU8) 57);
goto LA20;
LA27: ;
LOC29 = eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198147));
if (LOC29) goto LA30;
LOC29 = eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198148));
LA30: ;
if (!LOC29) goto LA31;
(*N_148014).Kind = ((NU8) 54);
goto LA20;
LA31: ;
LOC33 = eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198149));
if (LOC33) goto LA34;
LOC33 = eqStrings((*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198150));
LA34: ;
if (!LOC33) goto LA35;
...
Addson_146101(Result_148015, N_148014);
LOC37 = 0;
LOC37 = Newrstnode_146097(((NU8) 62), (*P_148013).Tok->data[(NI64)((*P_148013).Idx + 1)].Symbol);
...
NIM_BOOL LOC3;
Result_148057 = 0;
LOC3 = eqStrings((*P_148055).Tok->data[(NI64)(I_148056 + 1)].Symbol, ((NimStringDesc*) &TMP198122));
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*P_148055).Tok->data[(NI64)(I_148056 + 2)].Symbol, ((NimStringDesc*) &TMP198151));
LA4: ;
LOC2 = LOC3;
if (!(LOC2)) goto LA5;
LOC2 = ((*P_148055).Tok->data[(NI64)(I_148056 + 3)].Kind == ((NU8) 3));
LA5: ;
LOC1 = LOC2;
if (!(LOC1)) goto LA6;
LOC1 = eqStrings((*P_148055).Tok->data[(NI64)(I_148056 + 4)].Symbol, ((NimStringDesc*) &TMP198152));
LA6: ;
Result_148057 = LOC1;
...
break;
case ((NU8) 5):
if (!!(((120 &(1<<(((*P_148070).Tok->data[(NI64)((*P_148070).Idx + 1)].Kind)&7)))!=0))) goto LA7;
goto LA5;
LA7: ;
break;
default:
...
(*P_148070).Idx += 1;
if (!eqStrings((*P_148070).Tok->data[(*P_148070).Idx].Symbol, ((NimStringDesc*) &TMP198139))) goto LA11;
...
case ((NU8) 5):
LOC2 = Isinlinemarkupstart_147640(&(*P_148191), ((NimStringDesc*) &TMP198133));
if (!LOC2) goto LA3;
(*P_148191).Idx += 1;
N_148205 = 0;
N_148205 = Newrstnode_146094(((NU8) 58));
Parseuntil_148111(P_148191, N_148205, ((NimStringDesc*) &TMP198133), NIM_TRUE);
Addson_146101(Father_148192, N_148205);
goto LA1;
LA3: ;
LOC5 = Isinlinemarkupstart_147640(&(*P_148191), ((NimStringDesc*) &TMP198118));
if (!LOC5) goto LA6;
(*P_148191).Idx += 1;
N_148218 = 0;
N_148218 = Newrstnode_146094(((NU8) 57));
Parseuntil_148111(P_148191, N_148218, ((NimStringDesc*) &TMP198118), NIM_TRUE);
Addson_146101(Father_148192, N_148218);
goto LA1;
LA6: ;
LOC8 = Isinlinemarkupstart_147640(&(*P_148191), ((NimStringDesc*) &TMP198135));
if (!LOC8) goto LA9;
(*P_148191).Idx += 1;
N_148231 = 0;
N_148231 = Newrstnode_146094(((NU8) 60));
Parseuntil_148111(P_148191, N_148231, ((NimStringDesc*) &TMP198135), NIM_FALSE);
Addson_146101(Father_148192, N_148231);
goto LA1;
LA9: ;
LOC11 = Isinlinemarkupstart_147640(&(*P_148191), ((NimStringDesc*) &TMP198138));
if (!LOC11) goto LA12;
(*P_148191).Idx += 1;
N_148244 = 0;
N_148244 = Newrstnode_146094(((NU8) 59));
Parseuntil_148111(P_148191, N_148244, ((NimStringDesc*) &TMP198138), NIM_TRUE);
N_148244 = Parsepostfix_148010(P_148191, N_148244);
Addson_146101(Father_148192, N_148244);
goto LA1;
LA12: ;
LOC14 = Isinlinemarkupstart_147640(&(*P_148191), ((NimStringDesc*) &TMP198120));
if (!LOC14) goto LA15;
(*P_148191).Idx += 1;
N_148257 = 0;
N_148257 = Newrstnode_146094(((NU8) 61));
Parseuntil_148111(P_148191, N_148257, ((NimStringDesc*) &TMP198120), NIM_FALSE);
...
Parseuntil_148111(P_148516, Fieldname_148531, ((NimStringDesc*) &TMP198122), NIM_FALSE);
Fieldbody_148532 = 0;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*P_148557).Tok->data[(NI64)((*P_148557).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198122));
LA3: ;
if (!LOC2) goto LA4;
Col_148568 = 0;
...
LOC9 = LOC10;
if (!(LOC9)) goto LA12;
LOC9 = eqStrings((*P_148557).Tok->data[(NI64)((*P_148557).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198122));
LA12: ;
if (!LOC9) goto LA13;
(*P_148557).Idx += 1;
goto LA8;
...
LOC20 = LOC21;
if (!(LOC20)) goto LA23;
LOC20 = eqStrings((*P_150082).Tok->data[(NI64)((*P_150082).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198122));
LA23: ;
if (!LOC20) goto LA24;
...
appendString(LOC7, ((NimStringDesc*) &TMP198153));
...
Result_148609 = copyString(((NimStringDesc*) &TMP198154));
LA16: ;
goto BeforeRet;
LA13: ;
Res_148660 += 1;
...
LA3: ;
LOC6 = 0;
LOC6 = Getfieldvalue_146111(N_150233, ((NimStringDesc*) &TMP198144));
...
LOC13 = nsuFindStr(Q_150236.Tok->data[(Q_150236.Tok->Sup.len-1)].Symbol, ((NimStringDesc*) &TMP198155), 0);
if (!(0 < LOC13)) goto LA14;
Internalerror_47571(((NimStringDesc*) &TMP198156));
LA14: ;
...
TY146077* LOC8;
Filename_150307 = 0;
Filename_150307 = Getfieldvalue_146111((*Result_150304), ((NimStringDesc*) &TMP198158));
...
LOC5 = nsuCmpIgnoreCase((*(*(*Result_150322).Sons->data[0]).Sons->data[0]).Text, ((NimStringDesc*) &TMP198157));
if (!(LOC5 == 0)) goto LA6;
Dirrawaux_150299(P_150321, &Result_150322, ((NU8) 48), Parseliteralblock_148682);
goto LA4;
LA6: ;
LOC8 = nsuCmpIgnoreCase((*(*(*Result_150322).Sons->data[0]).Sons->data[0]).Text, ((NimStringDesc*) &TMP198159));
if (!(LOC8 == 0)) goto LA9;
...
Filename_150248 = 0;
LOC1 = 0;
LOC1 = Getfieldvalue_146111(Result_150246, ((NimStringDesc*) &TMP198158));
...
I_147059 = 0;
HEX3Atmp_147073 = 0;
HEX3Atmp_147073 = (NI64)(Length_147051 - 1);
Res_147075 = 0;
Res_147075 = 0;
while (1) {
...
(*(*P_147038).S).Subs = (TY146695*) setLengthSeq(&((*(*P_147038).S).Subs)->Sup, sizeof(TY146684), (NI64)(Length_147051 + 1));
...
case ((NU8) 1):
case ((NU8) 0):
if (!((*P_148400).Tok->data[(NI64)((*P_148400).Idx + 1)].Kind == ((NU8) 1))) goto LA2;
(*P_148400).Idx += 1;
goto LA1;
LA2: ;
Indent_148423 = 0;
...
goto LA1;
LA2: ;
LOC5 = Match_147762(&(*P_148681), (*P_148681).Idx, ((NimStringDesc*) &TMP198160));
if (!LOC5) goto LA6;
(*P_148681).Idx += 2;
A_150373 = 0;
A_150373 = Getreferencename_147518(P_148681, ((NimStringDesc*) &TMP198122));
...
goto LA1;
LA6: ;
LOC12 = Match_147762(&(*P_148681), (*P_148681).Idx, ((NimStringDesc*) &TMP198161));
if (!LOC12) goto LA13;
(*P_148681).Idx += 2;
A_150408 = 0;
A_150408 = Getreferencename_147518(P_148681, ((NimStringDesc*) &TMP198120));
B_150409 = 0;
if (!((*P_148681).Tok->data[(*P_148681).Idx].Kind == ((NU8) 2))) goto LA16;
(*P_148681).Idx += 1;
LA16: ;
LOC19 = nsuCmpIgnoreStyle((*P_148681).Tok->data[(*P_148681).Idx].Symbol, ((NimStringDesc*) &TMP198162));
if (!(LOC19 == 0)) goto LA20;
(*P_148681).Idx += 1;
Expect_147580(P_148681, ((NimStringDesc*) &TMP198116));
...
goto LA1;
LA13: ;
LOC26 = Match_147762(&(*P_148681), (*P_148681).Idx, ((NimStringDesc*) &TMP198163));
if (!LOC26) goto LA27;
(*P_148681).Idx += 2;
A_150471 = 0;
A_150471 = Getreferencename_147518(P_148681, ((NimStringDesc*) &TMP198164));
...
(*P_149836).Idx += (NI64)(Wildpos_149843[(W_149848)-0] + 3);
J_149878 = 0;
...
LOC16 = LOC17;
if (!(LOC16)) goto LA19;
LOC16 = Match_147762(&(*P_149836), (NI64)((*P_149836).Idx + 1), Wildcards_149838[(W_149848)-0]);
LA19: ;
if (!LOC16) goto LA20;
(*P_149836).Idx += (NI64)(Wildpos_149843[(W_149848)-0] + 4);
goto LA15;
LA20: ;
goto LA14;
LA15: ;
...
LOC3 = LOC4;
if (!(LOC3)) goto LA9;
LOC3 = !(eqStrings((*P_149742).Tok->data[(NI64)(J_149744 - 1)].Symbol, ((NimStringDesc*) &TMP198116)));
LA9: ;
if (!LOC3) goto LA10;
Col_149758 = 0;
...
LOC15 = LOC16;
if (!(LOC15)) goto LA19;
LOC15 = !(eqStrings((*P_149742).Tok->data[(NI64)((*P_149742).Idx + 1)].Symbol, ((NimStringDesc*) &TMP198116)));
LA19: ;
LOC14 = LOC15;
if (!(LOC14)) goto LA20;
LOC14 = !(((3 &(1<<(((*P_149742).Tok->data[(NI64)((*P_149742).Idx + 1)].Kind)&7)))!=0));
LA20: ;
if (!LOC14) goto LA21;
...
LOC31 = LOC32;
if (!(LOC31)) goto LA36;
LOC31 = !(eqStrings((*P_149742).Tok->data[(NI64)(J_149744 - 1)].Symbol, ((NimStringDesc*) &TMP198116)));
LA36: ;
LOC30 = LOC31;
if (!(LOC30)) goto LA37;
LOC30 = !(((*P_149742).Tok->data[(NI64)(J_149744 + 1)].Kind == ((NU8) 1)));
LA37: ;
if (!LOC30) goto LA38;
goto LA29;
LA38: ;
...
C_149028 = 0;
C_149028 = (*P_149008).Tok->data[(NI64)((*P_149008).Idx + 1)].Symbol->data[0];
(*P_149008).Idx += 2;
...
if (!(LOC6 < (*P_149488).Tok->data[(NI64)((*P_149488).Idx - 1)].Ival)) goto LA7;
LOC9 = 0;
LOC9 = Newrstnode_146097(((NU8) 62), ((NimStringDesc*) &TMP198137));
...
NI Result_149048;
Result_149048 = 0;
Result_149048 = (NI64)((NI64)((*P_149047).Tok->data[(*P_149047).Idx].Col + (*P_149047).Tok->data[(*P_149047).Idx].Symbol->Sup.len) - 1);
...
(*Cols_149056)->data[(NI64)(L_149057 - 1)] = Tokend_149045(&(*P_149054));
(*P_149054).Idx += 1;
...
(*P_149054).Idx += 1;
LA9: ;
(*Cols_149056)->data[(NI64)(L_149057 - 1)] = 32000;
}
N_NIMCALL(TY146077*, Parsesimpletable_149159)(TY146690* P_149162) {
...
Q_149171.Line = (NI64)(Line_149169 - 1);
...
LOC7 = Match_147762(&(*P_149636), (*P_149636).Idx, ((NimStringDesc*) &TMP198128));
if (!LOC7) goto LA8;
(*P_149636).Idx += 1;
LA8: ;
while (1) {
...
LOC19 = (0 < J_149702);
if (!(LOC19)) goto LA20;
LOC19 = ((*P_149636).Tok->data[(NI64)(J_149702 - 1)].Kind == ((NU8) 1));
LA20: ;
LOC18 = LOC19;
if (!(LOC18)) goto LA21;
LOC22 = Currind_146774(&(*P_149636));
LOC18 = (LOC22 < (*P_149636).Tok->data[(NI64)(J_149702 - 1)].Ival);
LA21: ;
if (!LOC18) goto LA23;
Pushind_146778(P_149636, (*P_149636).Tok->data[(NI64)(J_149702 - 1)].Ival);
...
case ((NU8) 1):
if (!((*P_148939).Tok->data[(NI64)((*P_148939).Idx + 1)].Kind == ((NU8) 1))) goto LA3;
(*P_148939).Idx += 1;
goto LA1;
goto LA2;
LA3: ;
...
break;
case ((NU8) 5):
LOC13 = eqStrings((*P_148939).Tok->data[(*P_148939).Idx].Symbol, ((NimStringDesc*) &TMP198116));
if (!(LOC13)) goto LA14;
LOC13 = ((*P_148939).Tok->data[(NI64)((*P_148939).Idx + 1)].Kind == ((NU8) 1));
LA14: ;
LOC12 = LOC13;
if (!(LOC12)) goto LA15;
LOC16 = Currind_146774(&(*P_148939));
LOC12 = (LOC16 < (*P_148939).Tok->data[(NI64)((*P_148939).Idx + 1)].Ival);
LA15: ;
if (!LOC12) goto LA17;
LOC19 = 0;
LOC19 = Newrstnode_146097(((NU8) 62), ((NimStringDesc*) &TMP198122));
...
break;
default:
Internalerror_47571(((NimStringDesc*) &TMP198165));
break;
}
...
if (!(LOC7)) goto LA8;
LOC7 = ((NU8)(S_147275->data[(NI64)(Filename_147253->Sup.len + 0)]) == (NU8)(35));
LA8: ;
if (!LOC7) goto LA9;
...
Result_146670 = 0;
Result_146670 = (*N_146669).Sons->data[(NI64)((*N_146669).Sons->Sup.len - 1)];
...
H_147179 = 1;
while (1) {
H_147179 = (NI64)((NI64)(3 * H_147179) + 1);
if (!(N_147178 < H_147179)) goto LA3;
goto LA1;
LA3: ;
} LA1: ;
while (1) {
H_147179 = (NI64)(H_147179 / 3);
I_147189 = 0;
HEX3Atmp_147201 = 0;
HEX3Atmp_147201 = (NI64)(N_147178 - 1);
Res_147203 = 0;
Res_147203 = H_147179;
while (1) {
...
J_147191 = I_147189;
while (1) {
LOC8 = Cmpnodes_147141((*A_146125).Sons->data[(NI64)(J_147191 - H_147179)], V_147190);
if (!(0 <= LOC8)) goto LA7;
asgnRefNoCycle((void**) &(*A_146125).Sons->data[J_147191], (*A_146125).Sons->data[(NI64)(J_147191 - H_147179)]);
J_147191 = (NI64)(J_147191 - H_147179);
