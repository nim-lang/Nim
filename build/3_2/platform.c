...
;
STRING_LITERAL(TMP49696, "macosx", 6);
NU8 Targetcpu_49560;
NU8 Hostcpu_49561;
NU8 Targetos_49562;
NU8 Hostos_49563;
...
Intsize_49570 = (NI64)(Cpu_49460[(C_49577)-1].Intsize / 8);
Floatsize_49571 = (NI64)(Cpu_49460[(C_49577)-1].Floatsize / 8);
Ptrsize_49572 = (NI64)(Cpu_49460[(C_49577)-1].Bit / 8);
asgnRefNoCycle((void**) &Tnl_49573, copyString(Os_49053[(O_49576)-1].Newline));
}
N_NOINLINE(void, platformInit)(void) {
Hostcpu_49561 = Nametocpu_49567(((NimStringDesc*) &TMP49555));
