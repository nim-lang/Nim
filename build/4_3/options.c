...
STRING_LITERAL(TMP193654, "nimcache", 8);
STRING_LITERAL(TMP193660, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP193654));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP193654));
LOC7[2] = copyString(Head_44259);
Subdir_44273 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_44102) goto LA9;
TMP193659.prev = excHandler;
excHandler = &TMP193659;
TMP193659.status = setjmp(TMP193659.context);
if (TMP193659.status == 0) {
noscreateDir(Subdir_44273);
} else {
if ((TMP193659.exc->Sup.m_type == NTI422)) {
LOC11 = rawNewString(Subdir_44273->Sup.len + 25);
appendString(LOC11, ((NimStringDesc*) &TMP193660));
...
if (TMP193659.status != 0) { raiseException(TMP193659.exc, TMP193659.exc->name); }
LA9: ;
...
Write_3658(F_44288, ((NimStringDesc*) &TMP195494));
}
