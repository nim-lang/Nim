...
NIM_CONST NU32 Checksoptions_46072 = IL64(4261609472);
STRING_LITERAL(TMP46087, "", 0);
STRING_LITERAL(TMP196654, "nimcache", 8);
STRING_LITERAL(TMP196666, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP196654));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP196654));
LOC7[2] = copyString(Head_46259);
Subdir_46273 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_46102) goto LA9;
pushSafePoint(&TMP196665);
TMP196665.status = setjmp(TMP196665.context);
if (TMP196665.status == 0) {
...
appendString(LOC11, ((NimStringDesc*) &TMP196666));
appendString(LOC11, Subdir_46273);
Writeln_46285(stdout, LOC11);
exit(1);
TMP196665.status = 0;popCurrentException();}
}
if (TMP196665.status != 0) reraiseException();
LA9: ;
...
Write_3658(F_46288, ((NimStringDesc*) &TMP198504));
}
N_NOINLINE(void, optionsInit)(void) {
TY46349 LOC1;
Goptions_46075 = 1050280192;
Gglobaloptions_46077 = 134217728;
