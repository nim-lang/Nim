...
NIM_CONST NU32 Checksoptions_46074 = IL64(4261609472);
STRING_LITERAL(TMP46089, "", 0);
STRING_LITERAL(TMP195647, "nimcache", 8);
STRING_LITERAL(TMP195659, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP195647));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP195647));
LOC7[2] = copyString(Head_46249);
Subdir_46261 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_46104) goto LA9;
pushSafePoint(&TMP195658);
TMP195658.status = setjmp(TMP195658.context);
if (TMP195658.status == 0) {
...
appendString(LOC11, ((NimStringDesc*) &TMP195659));
appendString(LOC11, Subdir_46261);
Writeln_46265(stdout, LOC11);
exit(1);
TMP195658.status = 0;popCurrentException();}
}
if (TMP195658.status != 0) reraiseException();
LA9: ;
...
Gimplicitmods_46131 = (TY39221*) setLengthSeq(&(Gimplicitmods_46131)->Sup, sizeof(NimStringDesc*), (NI64)(Length_46174 + 1));
...
Write_3866(F_46268, ((NimStringDesc*) &TMP197513));
}
N_NOINLINE(void, optionsInit)(void) {
TY46331 LOC1;
Goptions_46077 = 1050280192;
Gglobaloptions_46079 = 134217728;
