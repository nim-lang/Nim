...
Result_97061 = !(((NI8)(X_97047->data[divInt64(E_97048, 8)] & ((NI8)(NU8)(NU)(((NI) ((NI64)((NU64)(1) << (NU64)(modInt64(E_97048, 8)))))))) == ((NI8) 0)));
...
if ((NU)(divInt64(Elem_97039, 8)) >= (NU)((*X_97038)->Sup.len)) raiseIndexError();
(*X_97038)->data[divInt64(Elem_97039, 8)] = (NI8)((*X_97038)->data[divInt64(Elem_97039, 8)] | ((NI8)(NU8)(NU)(((NI) ((NI64)((NU64)(1) << (NU64)(modInt64(Elem_97039, 8))))))));
framePtr = framePtr->prev;
}
N_NIMCALL(void, Bitsetexcl_97040)(TY97008** X_97043, NI64 Elem_97044) {
volatile struct {TFrame* prev;NCSTRING procname;NI line;NCSTRING filename;NI len;
...
if ((NU)(divInt64(Elem_97044, 8)) >= (NU)((*X_97043)->Sup.len)) raiseIndexError();
(*X_97043)->data[divInt64(Elem_97044, 8)] = (NI8)((*X_97043)->data[divInt64(Elem_97044, 8)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)(((NI) ((NI64)((NU64)(1) << (NU64)(modInt64(Elem_97044, 8))))))))));
framePtr = framePtr->prev;
}
N_NIMCALL(void, Bitsetinit_97010)(TY97008** B_97013, NI Length_97014) {
volatile struct {TFrame* prev;NCSTRING procname;NI line;NCSTRING filename;NI len;
