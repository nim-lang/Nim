...
LA2: ;
S_104079 = Inittabiter_55081(&It_104078, &(*Tab_104020).Stack->data[(NI64)(((NI) ((*Tab_104020).Tos)) - 1)]);
while (1) {
...
LA11: ;
LA5: ;
S_104079 = Nextiter_55086(&It_104078, &(*Tab_104020).Stack->data[(NI64)(((NI) ((*Tab_104020).Tos)) - 1)]);
} LA4: ;
