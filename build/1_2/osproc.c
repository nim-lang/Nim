...
N_NIMCALL(TY4177*, HEX26_62435)(NimStringDesc** X_62439, NI X_62439Len0, NimStringDesc** Y_62440, NI Y_62440Len0);
...
A_61630 = (TY4177*) newSeq(NTI4177, 0);
I_61663 = 0;
HEX3Atmp_61683 = 0;
...
A_61630 = (TY4177*) incrSeq(&(A_61630)->Sup, sizeof(NimStringDesc*));
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3458(stdout, ((NimStringDesc*) &TMP62002));
}
N_NIMCALL(TY61202*, nospstartProcess)(NimStringDesc* Command_61239, NimStringDesc* Workingdir_61240, NimStringDesc** Args_61245, NI Args_61245Len0, TY59408* Env_61246, NU8 Options_61249) {
...
F.len = 0;
Result_62442 = 0;
F.line = 1110;F.filename = "system.nim";
Result_62442 = (TY4177*) newSeq(NTI4177, addInt(X_62439Len0, Y_62440Len0));
I_62492 = 0;
HEX3Atmp_62802 = 0;
F.line = 1111;F.filename = "system.nim";
