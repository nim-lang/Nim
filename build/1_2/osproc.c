...
LOC3 = Alloc0_1777((NI64)(Res_62264->Sup.len + 1));
...
L_62281 += (NI64)((NI64)(Key_62282->Sup.len + Val_62283->Sup.len) + 2);
LA3: ;
Res_62825 += 1;
} LA1: ;
LOC5 = Alloc0_1777((NI64)(L_62281 + 2));
...
X_62318 = LOC10;
memcpy(((void*) (&Result_62280[L_62281])), ((void*) (X_62318->data)), (NI64)(X_62318->Sup.len + 1));
L_62281 += (NI64)(X_62318->Sup.len + 1);
LA8: ;
Res_62836 += 1;
} LA6: ;
return Result_62280;
...
I_61660 = 0;
HEX3Atmp_61680 = 0;
HEX3Atmp_61680 = (NI64)(C_61609->Sup.len - 1);
Res_61682 = 0;
Res_61682 = 1;
while (1) {
...
NI Res_62810;
Result_62442 = 0;
Result_62442 = (TY33221*) newSeq(NTI33221, (NI64)(X_62439Len0 + Y_62440Len0));
I_62492 = 0;
HEX3Atmp_62802 = 0;
HEX3Atmp_62802 = (NI64)(X_62439Len0 - 1);
Res_62804 = 0;
Res_62804 = 0;
while (1) {
...
I_62510 = 0;
HEX3Atmp_62808 = 0;
HEX3Atmp_62808 = (NI64)(Y_62440Len0 - 1);
Res_62810 = 0;
Res_62810 = 0;
while (1) {
if (!(Res_62810 <= HEX3Atmp_62808)) goto LA2;
I_62510 = Res_62810;
asgnRefNoCycle((void**) &Result_62442->data[(NI64)(I_62510 + X_62439Len0)], copyString(Y_62440[I_62510]));
Res_62810 += 1;
} LA2: ;
return Result_62442;
}
