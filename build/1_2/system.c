...
break;
case 4:
D_7859 = ((NI) ((*((NI32*) ((NI64)((NU64)(A_7860) + (NU64)((*N_7848).offset)))))));
break;
default:
break;
}
...
S_18691 = 7;
LA2: ;
LOC4 = newObj(&Strdesc_3417, (NI64)(((NI)sizeof(TGenericSeq)) + (NI64)((NI64)(S_18691 + 1) * 1)));
...
memcpy(((NCSTRING) ((*Result_18713).data)), ((NCSTRING) ((*Src_18712).data)), ((NI32) ((NI64)((NI64)((*Src_18712).Sup.len + 1) * 1))));
BeforeRet: ;
return Result_18713;
}
N_NIMCALL(void, Gcdisable_3063)(void) {
...
memcpy(((NCSTRING) ((*Result_18705).data)), Str_18703, ((NI32) ((NI64)((NI64)(Len_18704 + 1) * 1))));
...
memcpy(((NCSTRING) ((*Result_18751).data)), ((NCSTRING) (&(*S_18748).data[(Start_18754)-0])), ((NI32) ((NI64)(Len_18757 * 1))));
