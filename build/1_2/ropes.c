...
(*Result_46558).Length = (NI64)((*A_46017).Length + (*B_46018).Length);
...
Num_46770 = 0;
while (1) {
if (!(I_46766 <= (NI64)(Length_46768 - 1))) goto LA1;
...
J_46767 = 0;
while (1) {
J_46767 = (NI64)((NI64)((NI64)(J_46767 * 10) + ((NU8)(Frmt_46071->data[I_46766]))) - 48);
I_46766 += 1;
LOC7 = ((NI64)((NI64)(Length_46768 + 0) - 1) < I_46766);
if (LOC7) goto LA8;
...
Num_46770 = J_46767;
if (!((NI64)((Args_46073Len0-1) + 1) < J_46767)) goto LA12;
...
LA12: ;
App_46031(&Result_46765, Args_46073[(NI64)(J_46767 - 1)]);
break;
case 78:
case 110:
...
Start_46769 = I_46766;
while (1) {
if (!(I_46766 <= (NI64)(Length_46768 - 1))) goto LA17;
...
if (!(Start_46769 <= (NI64)(I_46766 - 1))) goto LA22;
LOC24 = copyStrLast(Frmt_46071, Start_46769, (NI64)(I_46766 - 1));
...
Result_46472 = 0;
L_46483 = 0;
L_46483 = (NI64)((*S_46471)->Sup.len - 1);
