...
Num_48709 = 0;
while (1) {
if (!(I_48705 <= (NI64)(Length_48708 - 1))) goto LA1;
...
J_48764 = 0;
while (1) {
J_48764 = (NI64)((NI64)((NI64)(J_48764 * 10) + ((NU8)(Frmt_48068->data[I_48705]))) - 48);
I_48705 += 1;
LOC7 = ((NI64)((NI64)(Length_48708 + 0) - 1) < I_48705);
if (LOC7) goto LA8;
...
Num_48709 = J_48764;
if (!((NI64)((Args_48070Len0-1) + 1) < J_48764)) goto LA12;
LOC14 = 0;
LOC15 = 0;
...
LA12: ;
App_48031(&Result_48704, Args_48070[(NI64)(J_48764 - 1)]);
break;
case 78:
case 110:
...
Start_48823 = I_48705;
while (1) {
if (!(I_48705 <= (NI64)(Length_48708 - 1))) goto LA17;
...
if (!(Start_48823 <= (NI64)(I_48705 - 1))) goto LA22;
LOC24 = 0;
LOC24 = copyStrLast(Frmt_48068, Start_48823, (NI64)(I_48705 - 1));
