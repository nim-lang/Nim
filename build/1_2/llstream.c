...
Result_71406 = 0;
I_71409 = 0;
I_71409 = (NI64)(X_71403->Sup.len - 1);
while (1) {
LOC2 = (0 <= I_71409);
if (!(LOC2)) goto LA3;
...
break;
case ((NU8) 1):
Result_71519 = ((Buflen_71239 <= (NI64)((*S_71237).S->Sup.len - (*S_71237).Rd)) ? Buflen_71239 : (NI64)((*S_71237).S->Sup.len - (*S_71237).Rd));
if (!(0 < Result_71519)) goto LA2;
memcpy(Buf_71238, ((void*) (&(*S_71237).S->data[(NI64)(0 + (*S_71237).Rd)])), Result_71519);
...
switch (((NU8)((*S_71242).S->data[(NI64)((*S_71242).Rd + 0)]))) {
case 13:
(*S_71242).Rd += 1;
if (!((NU8)((*S_71242).S->data[(NI64)((*S_71242).Rd + 0)]) == (NU8)(10))) goto LA3;
(*S_71242).Rd += 1;
LA3: ;
goto LA1;
break;
...
break;
default:
Result_71544 = addChar(Result_71544, (*S_71242).S->data[(NI64)((*S_71242).Rd + 0)]);
(*S_71242).Rd += 1;
break;
}
} LA1: ;
