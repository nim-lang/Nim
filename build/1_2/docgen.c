...
(*D_149182).Tocpart = (TY148034*) setLengthSeq(&((*D_149182).Tocpart)->Sup, sizeof(TY148011), (NI64)(Length_149205 + 1));
...
LOC9 = rawNewString(1);
appendChar(LOC9, ((NIM_CHAR) (((NI) ((NI64)((NI64)((*N_149183).Level - 1) + 65))))));
...
appendChar(LOC11, ((NIM_CHAR) (((NI) ((NI64)((NI64)((*N_149183).Level - 1) + 65))))));
...
LOC9[2] = T_149255;
LOC11 = rawNewString(1);
appendChar(LOC11, ((NIM_CHAR) (((NI) ((NI64)((NI64)((*N_149253).Level - 1) + 65))))));
appendString(LOC11, ((NimStringDesc*) &TMP192164));
...
while (1) {
if (!(Result_148459 < (NI64)(S_148457->Sup.len + 0))) goto LA1;
switch (((NU8)(S_148457->data[Result_148459]))) {
case 95:
goto BeforeRet;
break;
case 97 ... 122:
if (!((NI64)(Result_148459 + 1) < (NI64)(S_148457->Sup.len + 0))) goto LA3;
if (!(((NU8)(S_148457->data[(NI64)(Result_148459 + 1)])) >= ((NU8)(65)) && ((NU8)(S_148457->data[(NI64)(Result_148459 + 1)])) <= ((NU8)(90)))) goto LA6;
goto BeforeRet;
LA6: ;
LA3: ;
break;
...
if (LOC6) goto LA7;
LOC6 = (Splitafter_148508 < (NI64)((NI64)((NI64)(Partlen_148512 + K_148518) - J_148513) + 1));
LA7: ;
if (!LOC6) goto LA8;
Partlen_148512 = 0;
...
Partlen_148512 += (NI64)((NI64)(K_148518 - J_148513) + 1);
J_148513 = (NI64)(K_148518 + 1);
} LA4: ;
goto LA1;
LA2: ;
I_148551 = 0;
HEX3Atmp_148560 = 0;
HEX3Atmp_148560 = (NI64)((NI64)(S_148507->Sup.len + 0) - 1);
Res_148562 = 0;
Res_148562 = 0;
while (1) {
...
case ((NU8) 1):
case ((NU8) 2):
LOC15 = copyStrLast((*M_149783).Text, (NI64)(G_149804.Start + 0), (NI64)((NI64)((NI64)(G_149804.Length + G_149804.Start) - 1) + 0));
App_46036(&Result_149771, LOC15);
break;
default:
LOC17 = copyStrLast((*M_149783).Text, (NI64)(G_149804.Start + 0), (NI64)((NI64)((NI64)(G_149804.Length + G_149804.Start) - 1) + 0));
...
J_148287 = 0;
while (1) {
J_148287 = (NI64)((NI64)((NI64)(J_148287 * 10) + ((NU8)(Frmt_148222->data[I_148228]))) - 48);
I_148228 += 1;
LOC7 = ((NI64)((NI64)(L_148231 + 0) - 1) < I_148228);
if (LOC7) goto LA8;
...
if (!((NI64)((Varvalues_148226Len0-1) + 1) < J_148287)) goto LA12;
Internalerror_41571(((NimStringDesc*) &TMP192412));
LA12: ;
Num_148232 = J_148287;
App_46031(&Result_148227, Varvalues_148226[(NI64)(J_148287 - 1)]);
break;
case 65 ... 90:
case 97 ... 122:
case 128 ... 255:
...
if (!(Start_148401 <= (NI64)(I_148228 - 1))) goto LA33;
LOC35 = copyStrLast(Frmt_148222, Start_148401, (NI64)(I_148228 - 1));
...
A_149683 = 0;
A_149683 = (NI64)abs((*(*D_149676).Tocpart->data[(*J_149678)].N).Level);
...
LOC7[1] = Title_150474;
LOC7[2] = Torope_46052(((NI64) ((NI64)(Kind_150450 + 50))));
...
LOC9[1] = Title_150474;
LOC9[2] = Torope_46052(((NI64) ((NI64)(Kind_150450 + 50))));
...
case ((NU8) 3):
LOC9[0] = Ind_149351;
LOC10 = nsuRepeatChar((NI64)(78 - (*D_149308).Indent), 45);
LOC9[1] = Torope_46046(LOC10);
...
L_149491 = (((NI64)(LOC25 + 3) >= 30) ? (NI64)(LOC25 + 3) : 30);
(*D_149308).Indent += L_149491;
LOC26[0] = Ind_149351;
LOC26[1] = Result_149334;
LOC27 = Ropelen_46055(Result_149334);
LOC28 = nsuRepeatChar((NI64)((NI64)(L_149491 - LOC27) - 2), 32);
