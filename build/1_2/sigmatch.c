...
if (!(LOC8)) goto LA9;
LOC8 = ((IL64(32212254720) &(IL64(1)<<((K_123351)&IL64(63))))!=0);
LA9: ;
if (!LOC8) goto LA10;
Result_123340 = ((NU8) 2);
goto LA5;
...
goto LA52;
LA57: ;
if (!((5632 &(IL64(1)<<(((*(*F_123307).Sons->data[0]).Kind)&IL64(63))))!=0)) goto LA59;
...
I_124323 = Res_124440;
LOC232 = 0;
LOC232 = Idtableget_56158((*Mapping_123306), &(*(*F_123307).Sons->data[0]).Sons->data[(NI64)(I_124323 - 1)]->Sup);
...
I_124527 = 0;
HEX3Atmp_124563 = 0;
HEX3Atmp_124563 = (NI64)((*C_124502).Converters->Sup.len - 1);
Res_124565 = 0;
Res_124565 = 0;
while (1) {
...
NI Result_123113;
Result_123113 = 0;
Result_123113 = (NI64)((*A_123111).Exactmatches - (*B_123112).Exactmatches);
if (!!((Result_123113 == 0))) goto LA2;
goto BeforeRet;
LA2: ;
Result_123113 = (NI64)((*A_123111).Genericmatches - (*B_123112).Genericmatches);
if (!!((Result_123113 == 0))) goto LA5;
goto BeforeRet;
LA5: ;
Result_123113 = (NI64)((*A_123111).Subtypematches - (*B_123112).Subtypematches);
if (!!((Result_123113 == 0))) goto LA8;
goto BeforeRet;
LA8: ;
Result_123113 = (NI64)((*A_123111).Intconvmatches - (*B_123112).Intconvmatches);
if (!!((Result_123113 == 0))) goto LA11;
goto BeforeRet;
LA11: ;
Result_123113 = (NI64)((*A_123111).Convmatches - (*B_123112).Convmatches);
BeforeRet: ;
...
HEX3Atmp_123100 = ((LOC4 <= (NI64)(LOC5 - 1)) ? LOC4 : (NI64)(LOC5 - 1));
Res_123102 = 0;
Res_123102 = 1;
while (1) {
...
Formaltypeparam_123098 = (*(*Typeparams_123059).KindU.S6.Sons->data[(NI64)(I_123085 - 1)]).Typ;
LOC7 = 0;
...
(*Father_124936).KindU.S6.Sons = (TY51520*) setLengthSeq(&((*Father_124936).KindU.S6.Sons)->Sup, sizeof(TY51526*), (NI64)(At_124937 + 1));
LA3: ;
...
Setson_124934((*M_124982).Call, (NI64)((*Formal_125001).Position + 1), Container_125000);
if (!!((F_124985 == (NI64)(Formallen_124987 - 1)))) goto LA24;
Container_125000 = NIM_NIL;
LA24: ;
goto LA20;
LA21: ;
Setson_124934((*M_124982).Call, (NI64)((*Formal_125001).Position + 1), Arg_125167);
LA20: ;
goto LA4;
LA5: ;
...
Setson_124934((*M_124982).Call, (NI64)((*Formal_125001).Position + 1), LOC62);
if (!!((F_124985 == (NI64)(Formallen_124987 - 1)))) goto LA64;
Container_125000 = NIM_NIL;
LA64: ;
goto LA59;
LA60: ;
Setson_124934((*M_124982).Call, (NI64)((*Formal_125001).Position + 1), Arg_125413);
LA59: ;
LA26: ;
LA4: ;
A_124986 += 1;
...
Setson_124934((*M_125488).Call, (NI64)((*Formal_125530).Position + 1), LOC17);
LA10: ;
LA8: ;
F_125501 += 1;
} LA4: ;
...
if (!!((I_123188 == (NI64)(LOC9 - 1)))) goto LA10;
Result_123179 = resizeString(Result_123179, 2);
