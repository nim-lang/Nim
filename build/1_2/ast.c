...
;
NIM_CONST NU32 Overloadablesyms_51671 = 269824;
NIM_CONST NU64 Generictypes_51673 = 5632;
NIM_CONST NU64 Structuralequivtypes_51675 = 201130032;
NIM_CONST NU64 Concretetypes_51677 = IL64(1098437836806);
NIM_CONST NU64 Constantdatatypes_51679 = 851968;
NIM_CONST NU32 Exportablesymkinds_51681 = 1081280;
...
Gid_51692 = ((Gid_51692 >= (NI64)(Id_51697 + 1)) ? Gid_51692 : (NI64)(Id_51697 + 1));
}
...
Result_53701 = (*N_51811).KindU.S6.Sons->data[(NI64)(LOC1 - 1)];
return Result_53701;
}
N_NIMCALL(NI, Getid_51693)(void) {
NI Result_51956;
...
NI Result_54068;
Result_54068 = 0;
Result_54068 = (NI64)((NI64)((NI64)(5 * H_54066) + 1) & Maxhash_54067);
return Result_54068;
}
N_NIMCALL(TY51896*, Intsetget_54085)(TY51900* T_54087, NI Key_54088) {
...
Result_54089 = 0;
H_54090 = 0;
H_54090 = (NI64)(Key_54088 & (*T_54087).Max);
while (1) {
...
NIM_BOOL LOC1;
Result_54057 = 0;
LOC1 = ((NI64)(Length_54055 * 2) < (NI64)(Counter_54056 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI64)(Length_54055 - Counter_54056) < 4);
LA2: ;
Result_54057 = LOC1;
return Result_54057;
}
...
NI H_54111;
H_54111 = 0;
H_54111 = (NI64)((*Desc_54110).Key & (*T_54107).Max);
while (1) {
...
(*T_54147).Max = (NI64)((NI64)((NI64)((*T_54147).Max + 1) * 2) - 1);
N_54148 = (TY51898*) newSeq(NTI51898, (NI64)((*T_54147).Max + 1));
I_54169 = 0;
Res_54193 = 0;
Res_54193 = 0;
while (1) {
...
Result_54201 = 0;
H_54202 = 0;
H_54202 = (NI64)(Key_54200 & (*T_54199).Max);
while (1) {
...
LOC6 = Mustrehash_54053((NI64)((*T_54199).Max + 1), (*T_54199).Counter);
if (!LOC6) goto LA7;
...
U_54292 = 0;
T_54293 = 0;
T_54293 = Intsetput_54196(S_51917, (NI64)((NU64)(Key_51918) >> (NU64)(9)));
U_54292 = (NI64)(Key_51918 & 511);
(*T_54293).Bits[((NI64)((NU64)(U_54292) >> (NU64)(6)))-0] = (NI64)((*T_54293).Bits[((NI64)((NU64)(U_54292) >> (NU64)(6)))-0] | (NI64)((NU64)(1) << (NU64)((NI64)(U_54292 & 63))));
}
N_NIMCALL(NIM_BOOL, Intsetcontainsorincl_51928)(TY51900* S_51931, NI Key_51932) {
...
U_54318 = 0;
T_54319 = 0;
T_54319 = Intsetget_54085(&(*S_51931), (NI64)((NU64)(Key_51932) >> (NU64)(9)));
if (!!((T_54319 == NIM_NIL))) goto LA2;
U_54318 = (NI64)(Key_51932 & 511);
Result_54317 = !(((NI64)((*T_54319).Bits[((NI64)((NU64)(U_54318) >> (NU64)(6)))-0] & (NI64)((NU64)(1) << (NU64)((NI64)(U_54318 & 63)))) == 0));
if (!!(Result_54317)) goto LA5;
(*T_54319).Bits[((NI64)((NU64)(U_54318) >> (NU64)(6)))-0] = (NI64)((*T_54319).Bits[((NI64)((NU64)(U_54318) >> (NU64)(6)))-0] | (NI64)((NU64)(1) << (NU64)((NI64)(U_54318 & 63))));
LA5: ;
goto LA1;
LA2: ;
...
Gid_51692 = (NI64)((NI64)((NI64)((NI64)(Gid_51692 / Idrange_51700) + 1) * Idrange_51700) + 1);
}
...
U_54272 = 0;
T_54273 = 0;
T_54273 = Intsetget_54085(S_51912, (NI64)((NU64)(Key_51913) >> (NU64)(9)));
if (!!((T_54273 == NIM_NIL))) goto LA2;
U_54272 = (NI64)(Key_51913 & 511);
Result_54271 = !(((NI64)((*T_54273).Bits[((NI64)((NU64)(U_54272) >> (NU64)(6)))-0] & (NI64)((NU64)(1) << (NU64)((NI64)(U_54272 & 63)))) == 0));
goto LA1;
LA2: ;
...
LA2: ;
(*Father_51817).KindU.S6.Sons = (TY51519*) setLengthSeq(&((*Father_51817).KindU.S6.Sons)->Sup, sizeof(TY51525*), (NI64)((*Father_51817).KindU.S6.Sons->Sup.len + Length_51818));
}
N_NIMCALL(TY51525*, Copytree_51858)(TY51525* Src_51860) {
...
Result_53717 = (*N_51814).Sons->data[(NI64)(LOC1 - 1)];
return Result_53717;
}
N_NIMCALL(TY51525*, Newintnode_51713)(NU8 Kind_51715, NI64 Intval_51716) {
...
I_53303 = 0;
HEX3Atmp_53353 = 0;
HEX3Atmp_53353 = (NI64)(Length_53295 - 2);
Res_53355 = 0;
Res_53355 = Idx_51838;
while (1) {
if (!(Res_53355 <= HEX3Atmp_53353)) goto LA4;
I_53303 = Res_53355;
asgnRefNoCycle((void**) &(*Father_51837).KindU.S6.Sons->data[I_53303], (*Father_51837).KindU.S6.Sons->data[(NI64)(I_53303 + 1)]);
Res_53355 += 1;
} LA4: ;
(*Father_51837).KindU.S6.Sons = (TY51519*) setLengthSeq(&((*Father_51837).KindU.S6.Sons)->Sup, sizeof(TY51525*), (NI64)(Length_53295 - 1));
BeforeRet: ;
}
...
LA2: ;
(*Father_51821).Sons = (TY51549*) setLengthSeq(&((*Father_51821).Sons)->Sup, sizeof(TY51551*), (NI64)((*Father_51821).Sons->Sup.len + Length_51822));
}
N_NIMCALL(void, Assigntype_51779)(TY51551* Dest_51781, TY51551* Src_51782) {
NI LOC1;
NI I_52626;
...
U_54299 = 0;
T_54300 = 0;
T_54300 = Intsetget_54085(&(*S_51922), (NI64)((NU64)(Key_51923) >> (NU64)(9)));
if (!!((T_54300 == NIM_NIL))) goto LA2;
U_54299 = (NI64)(Key_51923 & 511);
(*T_54300).Bits[((NI64)((NU64)(U_54299) >> (NU64)(6)))-0] = (NI64)((*T_54300).Bits[((NI64)((NU64)(U_54299) >> (NU64)(6)))-0] & (NI64)((NU64) ~((NI64)((NU64)(1) << (NU64)((NI64)(U_54299 & 63))))));
LA2: ;
}
