...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP190615, "invalid format string", 21);
static NIM_CONST TY20402 TMP190649 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP190663, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP190709, "invalid float: ", 15);
STRING_LITERAL(TMP190750, "0123456789ABCDEF", 16);
...
Result_22418 = ((NIM_CHAR) (((NI) ((NI64)(((NU8)(C_22417)) + 32)))));
goto LA1;
LA2: ;
...
Result_22597 = (NI64)(((NU8)(LOC4)) - ((NU8)(LOC5)));
if (!!((Result_22597 == 0))) goto LA7;
goto BeforeRet;
LA7: ;
I_22598 += 1;
} LA1: ;
Result_22597 = (NI64)(A_22595->Sup.len - B_22596->Sup.len);
BeforeRet: ;
return Result_22597;
}
N_NIMCALL(NI, nsuCmpIgnoreStyle)(NimStringDesc* A_22638, NimStringDesc* B_22639) {
...
switch (((NU8)(Formatstr_22742->data[(NI64)(I_22747 + 1)]))) {
case 35:
...
J_22791 = (NI64)((NI64)((NI64)(J_22791 * 10) + ((NU8)(Formatstr_22742->data[I_22747]))) - 48);
I_22747 += 1;
} LA5: ;
Num_22748 = J_22791;
(*S_22741) = resizeString((*S_22741), A_22744[(NI64)(J_22791 - 1)]->Sup.len + 0);
appendString((*S_22741), A_22744[(NI64)(J_22791 - 1)]);
break;
case 123:
J_22837 = 0;
J_22837 = (NI64)(I_22747 + 1);
while (1) {
if (!!((((NU8)(Formatstr_22742->data[J_22837])) == ((NU8)(0)) || ((NU8)(Formatstr_22742->data[J_22837])) == ((NU8)(125))))) goto LA6;
J_22837 += 1;
} LA6: ;
X_22862 = 0;
LOC7 = copyStrLast(Formatstr_22742, (NI64)(I_22747 + 2), (NI64)(J_22837 - 1));
...
LA10: ;
if (!LOC9) goto LA11;
(*S_22741) = resizeString((*S_22741), A_22744[(NI64)(X_22862 + 1)]->Sup.len + 0);
appendString((*S_22741), A_22744[(NI64)(X_22862 + 1)]);
goto LA8;
LA11: ;
E_22868 = 0;
E_22868 = (TY440*) newObj(NTI22867, sizeof(TY440));
(*E_22868).Sup.Sup.Sup.m_type = NTI440;
asgnRefNoCycle((void**) &(*E_22868).Sup.Sup.message, copyString(((NimStringDesc*) &TMP190615)));
raiseException((E_Base*)E_22868, "EInvalidValue");
LA8: ;
I_22747 = (NI64)(J_22837 + 1);
break;
case 97 ... 122:
case 65 ... 90:
case 128 ... 255:
...
X_22908 = 0;
LOC15 = copyStrLast(Formatstr_22742, (NI64)(I_22747 + 1), (NI64)(J_22884 - 1));
...
LA18: ;
if (!LOC17) goto LA19;
(*S_22741) = resizeString((*S_22741), A_22744[(NI64)(X_22908 + 1)]->Sup.len + 0);
appendString((*S_22741), A_22744[(NI64)(X_22908 + 1)]);
goto LA16;
LA19: ;
E_22914 = 0;
E_22914 = (TY440*) newObj(NTI22867, sizeof(TY440));
(*E_22914).Sup.Sup.Sup.m_type = NTI440;
asgnRefNoCycle((void**) &(*E_22914).Sup.Sup.message, copyString(((NimStringDesc*) &TMP190615)));
...
asgnRefNoCycle((void**) &(*E_22931).Sup.Sup.message, copyString(((NimStringDesc*) &TMP190615)));
...
Result_22968 = 0;
Result_22968 = copyString(((NimStringDesc*) &TMP190614));
...
NI Res_22590;
Result_22547 = 0;
Result_22547 = copyString(((NimStringDesc*) &TMP190614));
I_22557 = 0;
HEX3Atmp_22588 = 0;
HEX3Atmp_22588 = (NI64)(S_22546->Sup.len - 1);
Res_22590 = 0;
Res_22590 = 0;
while (1) {
...
Result_22547 = addChar(Result_22547, ((NIM_CHAR) (((NI) ((NI64)(((NU8)(S_22546->data[I_22557])) + 32))))));
goto LA2;
LA3: ;
...
I_24265 = 0;
HEX3Atmp_24278 = 0;
HEX3Atmp_24278 = (NI64)(S_24251->Sup.len - 1);
Res_24280 = 0;
...
NimStringDesc* LOC7;
Result_24286 = 0;
LOC3 = nsuFindCharSet(S_24285, TMP190649, 0);
LOC2 = (0 <= LOC3);
if (!(LOC2)) goto LA4;
...
I_24240 = 0;
HEX3Atmp_24244 = 0;
HEX3Atmp_24244 = (NI64)(S_24227->Sup.len - 1);
Res_24246 = 0;
...
I_22476 = 0;
HEX3Atmp_22478 = 0;
HEX3Atmp_22478 = (NI64)(S_22448->Sup.len - 1);
Res_22480 = 0;
Res_22480 = 0;
while (1) {
...
appendString(LOC5, ((NimStringDesc*) &TMP190663));
...
I_24151 = Res_24162;
A_24140[(((NU8)(((NIM_CHAR) (((NI) (I_24151)))))))-0] = (NI64)(M_24143 + 1);
Res_24162 += 1;
} LA1: ;
I_24159 = 0;
HEX3Atmp_24166 = 0;
HEX3Atmp_24166 = (NI64)(M_24143 - 1);
Res_24168 = 0;
Res_24168 = 0;
while (1) {
if (!(Res_24168 <= HEX3Atmp_24166)) goto LA2;
I_24159 = Res_24168;
A_24140[(((NU8)(Sub_24138->data[I_24159])))-0] = (NI64)(M_24143 - I_24159);
Res_24168 += 1;
} LA2: ;
}
N_NIMCALL(NI, Findaux_24171)(NimStringDesc* S_24173, NimStringDesc* Sub_24174, NI Start_24175, TY24135 A_24176) {
...
J_24184 = Start_24175;
while (1) {
if (!(J_24184 <= (NI64)(N_24183 - M_24180))) goto LA1;
K_24195 = 0;
HEX3Atmp_24211 = 0;
HEX3Atmp_24211 = (NI64)(M_24180 - 1);
Res_24213 = 0;
Res_24213 = 0;
while (1) {
if (!(Res_24213 <= HEX3Atmp_24211)) goto LA3;
K_24195 = Res_24213;
if (!!(((NU8)(Sub_24174->data[K_24195]) == (NU8)(S_24173->data[(NI64)(K_24195 + J_24184)])))) goto LA5;
goto LA2;
LA5: ;
Res_24213 += 1;
} LA3: ;
...
goto BeforeRet;
LA2: ;
J_24184 += A_24176[(((NU8)(S_24173->data[(NI64)(J_24184 + M_24180)])))-0];
} LA1: ;
Result_24177 = -1;
goto BeforeRet;
BeforeRet: ;
...
First_22987 = 0;
Last_22990 = 0;
Last_22990 = (NI64)(S_22981->Sup.len - 1);
...
appendString(LOC5, ((NimStringDesc*) &TMP190709));
...
I_23760 = 0;
HEX3Atmp_23762 = 0;
HEX3Atmp_23762 = (NI64)(Count_23750 - 1);
Res_23764 = 0;
Res_23764 = 0;
while (1) {
...
J_23462 = 0;
HEX3Atmp_23464 = 0;
HEX3Atmp_23464 = (NI64)(Len_23451 - 1);
Res_23466 = 0;
Res_23466 = HEX3Atmp_23464;
while (1) {
if (!(0 <= Res_23466)) goto LA1;
J_23462 = Res_23466;
Result_23452->data[J_23462] = ((NimStringDesc*) &TMP190750)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_23450) >> (NU64)(Shift_23454)))) & ((NI32) 15))];
...
Result_24327 = copyString(((NimStringDesc*) &TMP190614));
...
goto LA1;
LA3: ;
LOC5 = copyStrLast(S_24324, I_24330, (NI64)(J_24331 - 1));
...
I_24330 = (NI64)(J_24331 + Sub_24325->Sup.len);
} LA1: ;
...
J_24530 = 0;
HEX3Atmp_24537 = 0;
HEX3Atmp_24537 = (NI64)(Len_24517 - 1);
Res_24539 = 0;
Res_24539 = HEX3Atmp_24537;
while (1) {
if (!(0 <= Res_24539)) goto LA1;
J_24530 = Res_24539;
Result_24518->data[J_24530] = ((NIM_CHAR) (((NI) ((NI64)(((NI) ((NI64)((NU64)((X_24516 & Mask_24519)) >> (NU64)(Shift_24520)))) + 48)))));
...
J_24502 = 0;
HEX3Atmp_24509 = 0;
HEX3Atmp_24509 = (NI64)(Len_24489 - 1);
Res_24511 = 0;
Res_24511 = HEX3Atmp_24509;
while (1) {
if (!(0 <= Res_24511)) goto LA1;
J_24502 = Res_24511;
Result_24490->data[J_24502] = ((NIM_CHAR) (((NI) ((NI64)(((NI) ((NI64)((NU64)((X_24488 & Mask_24491)) >> (NU64)(Shift_24492)))) + 48)))));
...
I_23485 = 0;
HEX3Atmp_23497 = 0;
HEX3Atmp_23497 = (NI64)(Minchars_23472 - Result_23473->Sup.len);
Res_23499 = 0;
Res_23499 = 1;
while (1) {
...
I_23073 = Res_23081;
Result_23044->data[I_23073] = ((NIM_CHAR) (((NI) ((NI64)((NI64)(Val_23050 % 8) + 48)))));
Val_23050 = (NI64)(Val_23050 / 8);
Res_23081 -= 1;
} LA1: ;
return Result_23044;
}
