...
LA9: ;
Ifs_187330 = 0;
Ifs_187330 = Newnodei_51737(((NU8) 82), (*(*N_187194).KindU.S6.Sons->data[(NI64)(I_187197 + 1)]).Info);
Elsen_187331 = 0;
...
(*N_187194).KindU.S6.Sons = (TY51519*) setLengthSeq(&((*N_187194).KindU.S6.Sons)->Sup, sizeof(TY51525*), (NI64)(I_187197 + 2));
