...
Intsize_47570 = (NI64)(Cpu_47460[(C_47577)-1].Intsize / 8);
Floatsize_47571 = (NI64)(Cpu_47460[(C_47577)-1].Floatsize / 8);
Ptrsize_47572 = (NI64)(Cpu_47460[(C_47577)-1].Bit / 8);
asgnRefNoCycle((void**) &Tnl_47573, copyString(Os_47053[(O_47576)-1].Newline));
}
N_NOINLINE(void, platformInit)(void) {
Hostcpu_47561 = Nametocpu_47567(((NimStringDesc*) &TMP47555));
