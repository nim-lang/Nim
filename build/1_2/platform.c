...
Intsize_46570 = (NI64)(Cpu_46460[(C_46577)-1].Intsize / 8);
Floatsize_46571 = (NI64)(Cpu_46460[(C_46577)-1].Floatsize / 8);
Ptrsize_46572 = (NI64)(Cpu_46460[(C_46577)-1].Bit / 8);
asgnRefNoCycle((void**) &Tnl_46573, copyString(Os_46053[(O_46576)-1].Newline));
}
N_NOINLINE(void, platformInit)(void) {
Hostcpu_46561 = Nametocpu_46567(((NimStringDesc*) &TMP46555));
