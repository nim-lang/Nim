...
K_36498 = 0;
HEX3Atmp_36622 = 0;
HEX3Atmp_36622 = (NI64)((NI64)(J_36474 - I_36453) / 2);
Res_36624 = 0;
Res_36624 = 1;
while (1) {
...
if (!((NI64)((NI64)(J_36474 - I_36453) % 2) == 0)) goto LA15;
I_36453 = J_36474;
goto LA14;
LA15: ;
A_36454 = addChar(A_36454, 34);
I_36453 = (NI64)(J_36474 + 1);
LA14: ;
goto LA10;
LA11: ;
...
LA2: ;
Result_37405 = (NI64)(Ownargv_37402->Sup.len - 1);
return Result_37405;
}
...
I_34392 = 0;
HEX3Atmp_34408 = 0;
HEX3Atmp_34408 = (NI64)(Path_34377->Sup.len - 1);
Res_34410 = 0;
...
unsureAsgnRef((void**) &(*Result).Head, copyStrLast(Path_34377, 0, (NI64)(Seppos_34382 - 1)));
unsureAsgnRef((void**) &(*Result).Tail, copyStr(Path_34377, (NI64)(Seppos_34382 + 1)));
goto LA5;
LA6: ;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_34514->data[(NI64)(Path_34514->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Path_34514->data[(NI64)(Path_34514->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_34552 = 0;
HEX3Atmp_34574 = 0;
HEX3Atmp_34574 = (NI64)(Path_34514->Sup.len - 1);
Res_34576 = 0;
...
unsureAsgnRef((void**) &(*Result).Dir, copyStrLast(Path_34514, 0, (NI64)(Seppos_34539 - 1)));
unsureAsgnRef((void**) &(*Result).Name, copyStrLast(Path_34514, (NI64)(Seppos_34539 + 1), (NI64)(Dotpos_34542 - 1)));
...
I_34491 = 0;
HEX3Atmp_34507 = 0;
HEX3Atmp_34507 = (NI64)(S_34480->Sup.len - 1);
Res_34509 = 0;
...
LOC6 = 0;
LOC7 = 0;
LOC7 = copyStrLast(Filename_34820, 0, (NI64)(Extpos_34823 - 1));
LOC8 = 0;
...
I_36413 = 0;
HEX3Atmp_36427 = 0;
HEX3Atmp_36427 = (NI64)(Dir_36403->Sup.len - 1);
Res_36429 = 0;
Res_36429 = 1;
while (1) {
...
LOC5 = 0;
LOC5 = copyStrLast(Dir_36403, 0, (NI64)(I_36413 - 1));
...
E_35247 = ((NCSTRING) ((NI64)(((NI) (Eend_35248)) + 1)));
...
Result_35428 = copyStr(Environment_35238->data[I_35429], (NI64)(LOC4 + 1));
goto BeforeRet;
goto LA1;
LA2: ;
Env_35432 = 0;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_34585->data[(NI64)(Path_34585->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Path_34585->data[(NI64)(Path_34585->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
