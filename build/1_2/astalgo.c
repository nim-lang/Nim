...
I_59098 = Res_59100;
(*X_56223).Data->data[I_59098].Key = (IL64(-9223372036854775807) - IL64(1));
Res_59100 += 1;
} LA1: ;
}
N_NIMCALL(NI, Nexttry_56205)(NI H_56207, NI Maxhash_56208) {
NI Result_57824;
Result_57824 = 0;
Result_57824 = (NI64)((NI64)((NI64)(5 * H_56207) + 1) & Maxhash_56208);
return Result_57824;
}
N_NIMCALL(TY51548*, Strtableget_56066)(TY51530* T_56068, TY50011* Name_56069) {
...
H_58441 = 0;
H_58441 = (NI64)((*Name_56069).H & ((*T_56068).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_56521 = 0;
LOC1 = ((NI64)(Length_56203 * 2) < (NI64)(Counter_56204 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI64)(Length_56203 - Counter_56204) < 4);
LA2: ;
Result_56521 = LOC1;
return Result_56521;
}
...
NimStringDesc* LOC5;
H_58261 = 0;
H_58261 = (NI64)((*(*N_58260).Name).H & ((*Data_58259)->Sup.len-1));
while (1) {
...
N_58297 = 0;
N_58297 = NIM_NIL;
N_58297 = (TY51528*) newSeq(NTI51528, (NI64)((*T_58296).Data->Sup.len * 2));
I_58328 = 0;
HEX3Atmp_58350 = 0;
...
Result_59105 = 0;
H_59106 = 0;
H_59106 = (NI64)(Key_59104 & (T_59103.Data->Sup.len-1));
while (1) {
if (!!((T_59103.Data->data[H_59106].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
NI H_59125;
H_59125 = 0;
H_59125 = (NI64)(Key_59123 & ((*Data_59122)->Sup.len-1));
while (1) {
if (!!(((*Data_59122)->data[H_59125].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
if (!LOC5) goto LA6;
N_59153 = NIM_NIL;
N_59153 = (TY56213*) newSeq(NTI56213, (NI64)((*T_56231).Data->Sup.len * 2));
I_59184 = 0;
HEX3Atmp_59219 = 0;
...
I_59184 = Res_59221;
N_59153->data[I_59184].Key = (IL64(-9223372036854775807) - IL64(1));
Res_59221 += 1;
} LA8: ;
I_59193 = 0;
HEX3Atmp_59222 = 0;
...
I_59193 = Res_59224;
if (!!(((*T_56231).Data->data[I_59193].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA11;
...
Result_58736 = 0;
H_58737 = 0;
H_58737 = (NI64)(Key_58735 & (T_58734.Data->Sup.len-1));
while (1) {
...
NI H_58790;
H_58790 = 0;
H_58790 = (NI64)((*Key_58788).Id & ((*Data_58787)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_58822 = (TY51562*) newSeq(NTI51562, (NI64)((*T_56169).Data->Sup.len * 2));
I_58876 = 0;
HEX3Atmp_58911 = 0;
...
goto LA1;
LA2: ;
Result_59115 = (IL64(-9223372036854775807) - IL64(1));
LA1: ;
return Result_59115;
}
...
I_58566 = 0;
HEX3Atmp_58578 = 0;
HEX3Atmp_58578 = (NI64)(((NI) (Tab_56113.Tos)) - 1);
Res_58580 = 0;
...
H_58470 = 0;
Start_58471 = 0;
H_58470 = (NI64)((*Ti_56096).H & ((*Tab_56097).Data->Sup.len-1));
Start_58471 = H_58470;
...
Result_58921 = 0;
H_58922 = 0;
H_58922 = (NI64)((*Key_58920).Id & (T_58919.Data->Sup.len-1));
while (1) {
...
NI H_58950;
H_58950 = 0;
H_58950 = (NI64)((*Key_58948).Id & ((*Data_58947)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_59005 = NIM_NIL;
N_59005 = (TY51568*) newSeq(NTI51568, (NI64)((*T_56183).Data->Sup.len * 2));
I_59036 = 0;
HEX3Atmp_59071 = 0;
...
(*Tab_56144).Stack = (TY56101*) setLengthSeq(&((*Tab_56144).Stack)->Sup, sizeof(TY51530), (NI64)(((NI) ((*Tab_56144).Tos)) + 1));
LA2: ;
...
H_58387 = 0;
It_58388 = NIM_NIL;
H_58387 = (NI64)((*(*N_58385).Name).H & ((*T_58384).Data->Sup.len-1));
while (1) {
...
NU8 Result_58607;
Result_58607 = 0;
Result_58607 = Symtabadduniqueat_56135(Tab_56133, E_56134, ((NI) ((NI64)(((NI) ((*Tab_56133).Tos)) - 1))));
return Result_58607;
}
...
Result_58538 = Strtableget_56066(&Tab_56117.Stack->data[(NI64)(((NI) (Tab_56117.Tos)) - 1)], S_56118);
return Result_58538;
}
N_NIMCALL(void, Symtabadd_56119)(TY56099* Tab_56122, TY51548* E_56123) {
Strtableadd_56061(&(*Tab_56122).Stack->data[(NI64)(((NI) ((*Tab_56122).Tos)) - 1)], E_56123);
}
