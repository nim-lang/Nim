...
N_NIMCALL(NI, Parseword_191607)(NimStringDesc* S_191609, NI I_191610, NimStringDesc** W_191612, TY22602 Delim_191614);
...
STRING_LITERAL(TMP193646, "", 0);
static NIM_CONST TY22602 TMP193648 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;static NIM_CONST TY22602 TMP193649 = {
...
goto LA1;
LA2: ;
unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP193646)));
I_191441 = 0;
HEX3Atmp_191602 = 0;
...
LA1: ;
(*Result).Kind = ((NU8) 0);
unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP193646)));
unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP193646)));
}
N_NIMCALL(NI, Parseword_191607)(NimStringDesc* S_191609, NI I_191610, NimStringDesc** W_191612, TY22602 Delim_191614) {
NI Result_191615;
Result_191615 = 0;
...
I_191697 = Parseword_191607((*P_191696).Cmd, I_191697, &(*P_191696).Val, TMP193648);
LA3: ;
...
(*P_191790).Kind = ((NU8) 2);
I_191791 += 1;
I_191791 = Parseword_191607((*P_191790).Cmd, I_191791, &(*P_191790).Key, TMP193649);
while (1) {
...
(*P_191790).Pos = Parseword_191607((*P_191790).Cmd, I_191791, &(*P_191790).Val, TMP193648);
goto LA9;
LA10: ;
(*P_191790).Pos = I_191791;
LA9: ;
...
default:
(*P_191790).Kind = ((NU8) 1);
(*P_191790).Pos = Parseword_191607((*P_191790).Cmd, I_191791, &(*P_191790).Key, TMP193648);
break;
}
BeforeRet: ;
}
