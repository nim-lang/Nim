...
if (!(LOC2)) goto LA3;
LOC2 = ((NU8)(Path_42223->data[(NI64)(Path_42223->Sup.len - 1)]) == (NU8)(92));
LA3: ;
if (!LOC2) goto LA4;
Result_42224 = copyStrLast(Path_42223, 0, (NI64)(Path_42223->Sup.len - 2));
goto LA1;
LA4: ;
...
Gimplicitmods_42129 = (TY35221*) setLengthSeq(&(Gimplicitmods_42129)->Sup, sizeof(NimStringDesc*), (NI64)(Length_42172 + 1));
