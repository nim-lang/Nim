...
LA2: ;
if (!((6291456 &(IL64(1)<<(((*T_133302).Kind)&IL64(63))))!=0)) goto LA5;
A_133325 = 0;
...
HEX3Atmp_126848 = ((LOC4 <= (NI64)(LOC5 - 1)) ? LOC4 : (NI64)(LOC5 - 1));
Res_126850 = 0;
Res_126850 = 1;
while (1) {
...
Formaltypeparam_124098 = (*(*Typeparams_124074).KindU.S6.Sons->data[(NI64)(I_124085 - 1)]).Typ;
LOC7 = 0;
...
if (!(LOC8)) goto LA9;
LOC8 = ((IL64(32212254720) &(IL64(1)<<((K_124345)&IL64(63))))!=0);
LA9: ;
if (!LOC8) goto LA10;
Result_124334 = ((NU8) 2);
goto LA5;
...
goto LA52;
LA57: ;
if (!((5632 &(IL64(1)<<(((*(*F_124301).Sons->data[0]).Kind)&IL64(63))))!=0)) goto LA59;
...
I_125311 = Res_126868;
LOC232 = 0;
LOC232 = Idtableget_56163((*Mapping_124300), &(*(*F_124301).Sons->data[0]).Sons->data[(NI64)(I_125311 - 1)]->Sup);
...
Result_123209 = 0;
Result_123209 = ((5632 &(IL64(1)<<(((*T_123207).Kind)&IL64(63))))!=0);
...
I_123795 = 0;
HEX3Atmp_126836 = 0;
HEX3Atmp_126836 = (NI64)(Length_123782 - 1);
Res_126838 = 0;
Res_126838 = 0;
while (1) {
...
LA9: ;
Idtableput_56171(&(*Cl_123716).Typemap, &(*Body_123892).Sons->data[(NI64)(I_123924 - 1)]->Sup, &X_123894->Sup.Sup);
Res_126841 += 1;
} LA8: ;
...
if (!((5632 &(IL64(1)<<(((*Result_123891).Kind)&IL64(63))))!=0)) goto LA33;
LOC35 = 0;
...
I_125503 = 0;
HEX3Atmp_126872 = 0;
HEX3Atmp_126872 = (NI64)((*C_125478).Converters->Sup.len - 1);
Res_126874 = 0;
Res_126874 = 0;
while (1) {
...
NI Result_124110;
Result_124110 = 0;
Result_124110 = (NI64)((*A_124108).Exactmatches - (*B_124109).Exactmatches);
if (!!((Result_124110 == 0))) goto LA2;
goto BeforeRet;
LA2: ;
Result_124110 = (NI64)((*A_124108).Genericmatches - (*B_124109).Genericmatches);
if (!!((Result_124110 == 0))) goto LA5;
goto BeforeRet;
LA5: ;
Result_124110 = (NI64)((*A_124108).Subtypematches - (*B_124109).Subtypematches);
if (!!((Result_124110 == 0))) goto LA8;
goto BeforeRet;
LA8: ;
Result_124110 = (NI64)((*A_124108).Intconvmatches - (*B_124109).Intconvmatches);
if (!!((Result_124110 == 0))) goto LA11;
goto BeforeRet;
LA11: ;
Result_124110 = (NI64)((*A_124108).Convmatches - (*B_124109).Convmatches);
BeforeRet: ;
...
(*Father_125886).KindU.S6.Sons = (TY51520*) setLengthSeq(&((*Father_125886).KindU.S6.Sons)->Sup, sizeof(TY51526*), (NI64)(At_125887 + 1));
LA3: ;
...
Setson_125884((*M_125932).Call, (NI64)((*Formal_125951).Position + 1), Container_125950);
if (!!((F_125933 == (NI64)(Formallen_125935 - 1)))) goto LA24;
Container_125950 = NIM_NIL;
LA24: ;
goto LA20;
LA21: ;
Setson_125884((*M_125932).Call, (NI64)((*Formal_125951).Position + 1), Arg_126118);
LA20: ;
goto LA4;
LA5: ;
...
Setson_125884((*M_125932).Call, (NI64)((*Formal_125951).Position + 1), LOC62);
if (!!((F_125933 == (NI64)(Formallen_125935 - 1)))) goto LA64;
Container_125950 = NIM_NIL;
LA64: ;
goto LA59;
LA60: ;
Setson_125884((*M_125932).Call, (NI64)((*Formal_125951).Position + 1), Arg_126365);
LA59: ;
LA26: ;
LA4: ;
A_125934 += 1;
...
Setson_125884((*M_125932).Call, (NI64)((*Formal_125951).Position + 1), LOC79);
LA72: ;
LA70: ;
F_125933 += 1;
} LA66: ;
...
if (!!(((4352 &(IL64(1)<<(((*(*Q_123282).Typ).Kind)&IL64(63))))!=0))) goto LA11;
goto LA6;
LA11: ;
S_123295 = 0;
LOC13 = 0;
...
LA11: ;
if (!!(((IL64(1097364160518) &(IL64(1)<<(((*(*A_127483).Typ).Kind)&IL64(63))))!=0))) goto LA14;
...
I_128198 = 0;
HEX3Atmp_142849 = 0;
HEX3Atmp_142849 = (NI64)(Branchindex_128189 - 1);
Res_142851 = 0;
Res_142851 = 1;
while (1) {
...
Delson_51836(B_128456, (NI64)(LOC18 - 1));
LOC19 = 0;
...
A_128667 = NIM_NIL;
LA35: ;
if (!!(((*N_128436).KindU.S6.Sons->data[(NI64)(Length_128665 - 1)] == NIM_NIL))) goto LA41;
Limessage_43569((*(*N_128436).KindU.S6.Sons->data[(NI64)(Length_128665 - 1)]).Info, ((NU8) 173), ((NimStringDesc*) &TMP192933));
LA41: ;
if (!((*N_128436).KindU.S6.Sons->data[(NI64)(Length_128665 - 2)] == NIM_NIL)) goto LA44;
Limessage_43569((*N_128436).Info, ((NU8) 60), ((NimStringDesc*) &TMP192933));
LA44: ;
Typ_128671 = Semtypenode_122138(C_128435, (*N_128436).KindU.S6.Sons->data[(NI64)(Length_128665 - 2)], NIM_NIL);
I_128944 = 0;
HEX3Atmp_142864 = 0;
LOC46 = Sonslen_51804(N_128436);
HEX3Atmp_142864 = (NI64)(LOC46 - 3);
Res_142866 = 0;
Res_142866 = 0;
while (1) {
...
if (!!(((*A_127749).KindU.S6.Sons->data[(NI64)(Length_127745 - 2)] == NIM_NIL))) goto LA7;
Typ_127747 = Semtypenode_122138(C_127741, (*A_127749).KindU.S6.Sons->data[(NI64)(Length_127745 - 2)], NIM_NIL);
goto LA6;
LA7: ;
Limessage_43569((*A_127749).Info, ((NU8) 60), ((NimStringDesc*) &TMP192933));
LA6: ;
if (!!(((*A_127749).KindU.S6.Sons->data[(NI64)(Length_127745 - 1)] == NIM_NIL))) goto LA10;
Limessage_43569((*(*A_127749).KindU.S6.Sons->data[(NI64)(Length_127745 - 1)]).Info, ((NU8) 173), ((NimStringDesc*) &TMP192933));
LA10: ;
J_127860 = 0;
HEX3Atmp_142837 = 0;
HEX3Atmp_142837 = (NI64)(Length_127745 - 3);
Res_142839 = 0;
Res_142839 = 0;
while (1) {
...
Adddeclat_105128(C_126959, E_126965, ((NI) ((NI64)(((NI) ((*C_126959).Tab.Tos)) - 1))));
Counter_126963 += 1;
Res_142836 += 1;
} LA9: ;
...
I_129711 = 0;
HEX3Atmp_142888 = 0;
HEX3Atmp_142888 = (NI64)(Length_129702 - 2);
Res_142890 = 0;
Res_142890 = 0;
while (1) {
...
Result_129701 = Semtypenode_122138(C_129698, (*N_129699).KindU.S6.Sons->data[(NI64)(Length_129702 - 1)], Prev_129700);
asgnRef((void**) &(*N_129699).Typ, Result_129701);
asgnRef((void**) &(*(*N_129699).KindU.S6.Sons->data[(NI64)(Length_129702 - 1)]).Typ, Result_129701);
goto LA2;
LA3: ;
...
if (!!(((*A_129497).KindU.S6.Sons->data[(NI64)(Length_129507 - 2)] == NIM_NIL))) goto LA14;
Typ_129457 = Paramtype_129427(C_129450, (*A_129497).KindU.S6.Sons->data[(NI64)(Length_129507 - 2)], Genericparams_129452, &Cl_129459);
goto LA13;
LA14: ;
Typ_129457 = NIM_NIL;
LA13: ;
if (!!(((*A_129497).KindU.S6.Sons->data[(NI64)(Length_129507 - 1)] == NIM_NIL))) goto LA17;
Def_129455 = Semexprwithtype_122122(C_129450, (*A_129497).KindU.S6.Sons->data[(NI64)(Length_129507 - 1)], 0);
if (!!((Typ_129457 == NIM_NIL))) goto LA20;
LOC23 = Cmptypes_125420(Typ_129457, (*Def_129455).Typ);
if (!(LOC23 < ((NU8) 1))) goto LA24;
Typemismatch_126905((*A_129497).KindU.S6.Sons->data[(NI64)(Length_129507 - 1)], Typ_129457, (*Def_129455).Typ);
LA24: ;
...
J_129621 = 0;
HEX3Atmp_142882 = 0;
HEX3Atmp_142882 = (NI64)(Length_129507 - 3);
Res_142884 = 0;
Res_142884 = 0;
while (1) {
...
asgnRef((void**) &(*(*Result_131187).Typ).Sons->data[0], Makerangetype_104086(C_131185, 0, ((NI64) ((NI64)(LOC20 - 1))), (*N_131186).Info));
...
if (!!(((*A_139236).KindU.S6.Sons->data[(NI64)(Length_139235 - 2)] == NIM_NIL))) goto LA13;
Typ_139239 = Semtypenode_122138(C_139232, (*A_139236).KindU.S6.Sons->data[(NI64)(Length_139235 - 2)], NIM_NIL);
goto LA12;
LA13: ;
Typ_139239 = NIM_NIL;
LA12: ;
if (!!(((*A_139236).KindU.S6.Sons->data[(NI64)(Length_139235 - 1)] == NIM_NIL))) goto LA16;
Def_139238 = Semexprwithtype_122122(C_139232, (*A_139236).KindU.S6.Sons->data[(NI64)(Length_139235 - 1)], 0);
...
if (!!(((NI64)(Length_139235 - 2) == LOC33))) goto LA34;
...
asgnRefNoCycle((void**) &(*B_139237).KindU.S6.Sons->data[(NI64)(Length_139235 - 2)], NIM_NIL);
asgnRefNoCycle((void**) &(*B_139237).KindU.S6.Sons->data[(NI64)(Length_139235 - 1)], Def_139238);
Addson_51824(Result_139234, B_139237);
LA27: ;
J_139424 = 0;
HEX3Atmp_143046 = 0;
HEX3Atmp_143046 = (NI64)(Length_139235 - 3);
Res_143048 = 0;
Res_143048 = 0;
while (1) {
...
Def_140468 = 0;
Def_140468 = (*A_140445).KindU.S6.Sons->data[(NI64)(L_140455 - 1)];
Typ_140469 = 0;
if (!!(((*A_140445).KindU.S6.Sons->data[(NI64)(L_140455 - 2)] == NIM_NIL))) goto LA10;
Typ_140469 = Semtypenode_122138(C_140411, (*A_140445).KindU.S6.Sons->data[(NI64)(L_140455 - 2)], NIM_NIL);
goto LA9;
LA10: ;
...
J_140524 = 0;
HEX3Atmp_143065 = 0;
HEX3Atmp_143065 = (NI64)(L_140455 - 3);
Res_143067 = 0;
Res_143067 = 0;
while (1) {
...
asgnRef((void**) &(*(*S_140642).Typ).Sons->data[(NI64)(LOC48 - 1)], Body_140644);
Popowner_104112();
...
if (!((147456 &(IL64(1)<<(((*T_140643).Kind)&IL64(63))))!=0)) goto LA74;
...
J_140283 = 0;
HEX3Atmp_143059 = 0;
HEX3Atmp_143059 = (NI64)(Length_140265 - 2);
Res_143061 = 0;
Res_143061 = 0;
while (1) {
...
LA17: ;
LA3: ;
asgnRefNoCycle((void**) &(*A_140264).KindU.S6.Sons->data[(NI64)(Length_140265 - 1)], Semstmtscope_122104(C_140214, (*A_140264).KindU.S6.Sons->data[(NI64)(Length_140265 - 1)]));
Res_143064 += 1;
} LA2: ;
...
if (!((*(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)]).Kind == ((NU8) 35))) goto LA2;
Checksonslen_104099((*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)], 2);
Countupnode_139730 = Newnodei_51738(((NU8) 21), (*(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)]).Info);
LOC4 = 0;
...
asgnRefNoCycle((void**) &(*Countupnode_139730).KindU.S6.Sons->data[1], (*(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)]).KindU.S6.Sons->data[0]);
asgnRefNoCycle((void**) &(*Countupnode_139730).KindU.S6.Sons->data[2], (*(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)]).KindU.S6.Sons->data[1]);
asgnRefNoCycle((void**) &(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)], Countupnode_139730);
LA2: ;
asgnRefNoCycle((void**) &(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)], Semexprwithtype_122122(C_139723, (*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)], 4));
Call_139731 = (*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)];
...
LA12: ;
if (!LOC9) goto LA13;
Limessage_43569((*(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)]).Info, ((NU8) 207), ((NimStringDesc*) &TMP192933));
LA13: ;
Iter_139729 = Skiptypes_94087((*(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 2)]).Typ, 2048);
...
if (!!(((NI64)(Length_139726 - 2) == LOC22))) goto LA23;
Limessage_43569((*N_139724).Info, ((NU8) 109), ((NimStringDesc*) &TMP192933));
LA23: ;
I_140055 = 0;
HEX3Atmp_143056 = 0;
HEX3Atmp_143056 = (NI64)(Length_139726 - 3);
Res_143058 = 0;
Res_143058 = 0;
while (1) {
...
asgnRefNoCycle((void**) &(*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 1)], Semstmt_122143(C_139723, (*N_139724).KindU.S6.Sons->data[(NI64)(Length_139726 - 1)]));
...
asgnRefNoCycle((void**) &(*X_138559).KindU.S6.Sons->data[(NI64)(Length_138561 - 1)], Semstmtscope_122104(C_138496, (*X_138559).KindU.S6.Sons->data[(NI64)(Length_138561 - 1)]));
break;
case ((NU8) 76):
Chckcovered_138524 = NIM_FALSE;
...
I_122448 = 0;
HEX3Atmp_123076 = 0;
HEX3Atmp_123076 = (NI64)(F_122433 - 1);
Res_123078 = 0;
Res_123078 = 1;
while (1) {
...
Limessage_43569((*N_122430).Info, ((NU8) 130), ((NimStringDesc*) &TMP192933));
LA9: ;
if (!!(((448 &(IL64(1)<<(((*(*(*S_122431).Typ).Sons->data[I_122448]).Kind)&IL64(63))))!=0))) goto LA12;
LOC14 = 0;
...
J_136580 = 0;
HEX3Atmp_142984 = 0;
HEX3Atmp_142984 = (NI64)(L_136209 - 2);
Res_142986 = 0;
Res_142986 = 0;
while (1) {
...
asgnRefNoCycle((void**) &(*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], Semgenericstmtscope_136125(C_136120, (*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], 0));
Res_142989 += 1;
} LA31: ;
Closescope_105018(&(*C_136120).Tab);
break;
...
Openscope_56146(&(*C_136120).Tab);
asgnRefNoCycle((void**) &(*N_136121).KindU.S6.Sons->data[(NI64)(L_136209 - 2)], Semgenericstmt_136118(C_136120, (*N_136121).KindU.S6.Sons->data[(NI64)(L_136209 - 2)], 0));
I_136663 = 0;
HEX3Atmp_142990 = 0;
HEX3Atmp_142990 = (NI64)(L_136209 - 3);
Res_142992 = 0;
Res_142992 = 0;
while (1) {
...
asgnRefNoCycle((void**) &(*N_136121).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], Semgenericstmt_136118(C_136120, (*N_136121).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], 0));
Closescope_105018(&(*C_136120).Tab);
break;
case ((NU8) 99):
case ((NU8) 107):
...
J_136815 = 0;
HEX3Atmp_142993 = 0;
HEX3Atmp_142993 = (NI64)(L_136209 - 2);
Res_142995 = 0;
Res_142995 = 0;
while (1) {
...
L_136209 = Sonslen_51804(A_136210);
asgnRefNoCycle((void**) &(*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 2)], Semgenericstmt_136118(C_136120, (*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 2)], 2));
asgnRefNoCycle((void**) &(*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], Semgenericstmt_136118(C_136120, (*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], 0));
J_136970 = 0;
HEX3Atmp_143000 = 0;
HEX3Atmp_143000 = (NI64)(L_136209 - 3);
Res_143002 = 0;
Res_143002 = 0;
while (1) {
...
J_137046 = 0;
HEX3Atmp_143006 = 0;
HEX3Atmp_143006 = (NI64)(L_136209 - 3);
Res_143008 = 0;
Res_143008 = 0;
while (1) {
...
Adddeclat_105128(C_136120, LOC104, ((NI) ((NI64)(((NI) ((*C_136120).Tab.Tos)) - 1))));
Res_143026 += 1;
} LA102: ;
break;
case ((NU8) 111):
...
Checkminsonslen_104103(A_136210, 3);
L_136209 = Sonslen_51804(A_136210);
asgnRefNoCycle((void**) &(*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], Semgenericstmt_136118(C_136120, (*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 2)], 2));
asgnRefNoCycle((void**) &(*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], Semgenericstmt_136118(C_136120, (*A_136210).KindU.S6.Sons->data[(NI64)(L_136209 - 1)], 0));
J_137600 = 0;
HEX3Atmp_143027 = 0;
HEX3Atmp_143027 = (NI64)(L_136209 - 3);
Res_143029 = 0;
Res_143029 = 0;
while (1) {
...
TY51548* B_141320;
B_141320 = 0;
B_141320 = Searchforborrowproc_118009(C_141317, S_141319, (NI64)(((NI) ((*C_141317).Tab.Tos)) - 2));
...
LA10: ;
Proto_141617 = Searchforproc_118004(C_141611, S_141616, (NI64)(((NI) ((*C_141611).Tab.Tos)) - 2));
...
Addinterfaceoverloadablesymat_105240(C_141611, S_141616, (NI64)(((NI) ((*C_141611).Tab.Tos)) - 2));
goto LA27;
LA28: ;
Addinterfacedeclat_105191(C_141611, S_141616, ((NI) ((NI64)(((NI) ((*C_141611).Tab.Tos)) - 2))));
LA27: ;
...
if (!!(((384 &(IL64(1)<<(((*(*(*S_122767).Typ).Sons->data[0]).Kind)&IL64(63))))!=0))) goto LA22;
...
I_142723 = 0;
HEX3Atmp_143099 = 0;
HEX3Atmp_143099 = (NI64)(Length_142714 - 1);
Res_143101 = 0;
Res_143101 = 0;
while (1) {
...
HEX3Atmp_143095 = 0;
HEX3Atmp_143096 = 0;
HEX3Atmp_143095 = (NI64)(I_142723 + 1);
HEX3Atmp_143096 = (NI64)(Length_142714 - 1);
Res_143098 = 0;
...
if (!((IL64(1097364930612) &(IL64(1)<<(((*(*S_130096).Typ).Kind)&IL64(63))))!=0)) goto LA15;
...
if (!(Diff_130191 == IL64(9223372036854775807))) goto LA2;
LOC4 = 0;
...
if (!LOC2) goto LA3;
if (!!(((IL64(1097364144160) &(IL64(1)<<(((*Castdest_130201).Kind)&IL64(63))))!=0))) goto LA6;
LOC8 = 0;
...
if (!(LOC11)) goto LA12;
LOC11 = ((6291456 &(IL64(1)<<(((*D_130217).Kind)&IL64(63))))!=0);
LA12: ;
LOC10 = LOC11;
if (!(LOC10)) goto LA13;
...
if (!!((I_124185 == (NI64)(LOC9 - 1)))) goto LA10;
Result_124176 = resizeString(Result_124176, 2);
...
I_134812 = 0;
HEX3Atmp_142957 = 0;
HEX3Atmp_142957 = (NI64)(Length_134778 - 1);
Res_142959 = 0;
Res_142959 = 0;
while (1) {
...
I_135327 = 0;
HEX3Atmp_142966 = 0;
HEX3Atmp_142966 = (NI64)(Length_135318 - 2);
Res_142968 = 0;
Res_142968 = 0;
while (1) {
...
asgnRefNoCycle((void**) &(*N_135316).KindU.S6.Sons->data[(NI64)(Length_135318 - 1)], Semexprwithtype_122122(C_135315, (*N_135316).KindU.S6.Sons->data[(NI64)(Length_135318 - 1)], 0));
asgnRef((void**) &(*N_135316).Typ, (*(*N_135316).KindU.S6.Sons->data[(NI64)(Length_135318 - 1)]).Typ);
LA3: ;
