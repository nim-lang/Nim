...
STRING_LITERAL(TMP21324, "out of memory; cannot even throw an exception", 45);
STRING_LITERAL(TMP21326, "cannot write string to file", 27);
STRING_LITERAL(TMP21327, "No stack traceback available", 28);
STRING_LITERAL(TMP21328, "Error: unhandled exception: ", 28);
STRING_LITERAL(TMP21329, "Error: unhandled exception", 26);
STRING_LITERAL(TMP21330, " [", 2);
STRING_LITERAL(TMP21331, "]\012", 2);
STRING_LITERAL(TMP21332, "\012", 1);
...
NIM_CONST TY4510 Formatopen_4509 = {((NimStringDesc*) &TMP21334),
...
STRING_LITERAL(TMP197649, "", 0);
STRING_LITERAL(TMP197660, "no exception to reraise", 23);
STRING_LITERAL(TMP197771, " (invalid data!)", 16);
STRING_LITERAL(TMP197879, "cannot retrieve file position", 29);
STRING_LITERAL(TMP197880, "cannot set file position", 24);
STRING_LITERAL(TMP199554, "[GC] total memory: ", 19);
STRING_LITERAL(TMP199555, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP199556, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP199557, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP199558, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP199559, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP199560, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP199561, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP199562, "\012[GC] max stack size: ", 22);
...
I_13816 = 0;
HEX3Atmp_21223 = 0;
HEX3Atmp_21223 = (NI32)((*N_13805).len - 1);
Res_21225 = 0;
Res_21225 = 0;
while (1) {
...
I_13854 = 0;
HEX3Atmp_21226 = 0;
HEX3Atmp_21226 = (NI32)((NI32)((*Mt_12223).size / (*(*Mt_12223).base).size) - 1);
Res_21228 = 0;
Res_21228 = 0;
while (1) {
...
I_13902 = 0;
HEX3Atmp_21229 = 0;
HEX3Atmp_21229 = (NI32)((*S_13882).len - 1);
Res_21231 = 0;
Res_21231 = 0;
while (1) {
...
Res_21222 = 0;
while (1) {
if (!(Res_21222 <= Oldmax_10975)) goto LA2;
I_10985 = Res_21222;
...
HEX3Atmp_21236 = (*Gch_15406).Cycleroots;
R_21238 = 0;
...
if (!!(((NI32)(W_21242 & 1) == 0))) goto LA5;
C_15408 = ((TY10802*) ((NI32)((NI32)((NU32)((*R_21238).Key) << (NU32)(12)) | (NI32)((NU32)((NI32)((NU32)((NI32)((NU32)(I_21240) << (NU32)(5))) + (NU32)(J_21244))) * (NU32)(8)))));
Tabsize_15407 += 1;
Forallchildren_12212(C_15408, ((NU8) 2));
LA5: ;
J_21244 += 1;
W_21242 = (NI32)((NU32)(W_21242) >> (NU32)(1));
} LA3: ;
I_21240 += 1;
} LA2: ;
...
HEX3Atmp_21245 = (*Gch_15406).Cycleroots;
R_21247 = 0;
...
if (!!(((NI32)(W_21251 & 1) == 0))) goto LA11;
C_15425 = ((TY10802*) ((NI32)((NI32)((NU32)((*R_21247).Key) << (NU32)(12)) | (NI32)((NU32)((NI32)((NU32)((NI32)((NU32)(I_21249) << (NU32)(5))) + (NU32)(J_21253))) * (NU32)(8)))));
...
LA11: ;
J_21253 += 1;
W_21251 = (NI32)((NU32)(W_21251) >> (NU32)(1));
} LA9: ;
I_21249 += 1;
} LA8: ;
...
HEX3Atmp_21254 = (*Gch_15406).Cycleroots;
R_21256 = 0;
...
if (!!(((NI32)(W_21260 & 1) == 0))) goto LA31;
C_15447 = ((TY10802*) ((NI32)((NI32)((NU32)((*R_21256).Key) << (NU32)(12)) | (NI32)((NU32)((NI32)((NU32)((NI32)((NU32)(I_21258) << (NU32)(5))) + (NU32)(J_21262))) * (NU32)(8)))));
...
LA31: ;
J_21262 += 1;
W_21260 = (NI32)((NU32)(W_21260) >> (NU32)(1));
} LA29: ;
I_21258 += 1;
} LA28: ;
...
I_17814 = 0;
HEX3Atmp_21263 = 0;
HEX3Atmp_21263 = (NI32)((*Gch_17804).Decstack.Len - 1);
Res_21265 = 0;
Res_21265 = 0;
while (1) {
...
HEX3Atmp_21232 = 0;
HEX3Atmp_21233 = 0;
HEX3Atmp_21232 = (NI32)(L_14002 - 1);
HEX3Atmp_21233 = ((0 >= (NI32)(L_14002 - 8)) ? 0 : (NI32)(L_14002 - 8));
Res_21235 = 0;
...
appendString((*S_5396), ((NimStringDesc*) &TMP21327));
...
appendString(Buf_5201, ((NimStringDesc*) &TMP21328));
...
asgnRefNoCycle((void**) &(*E_4665).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP21326)));
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3866(stdout, ((NimStringDesc*) &TMP21332));
}
N_NIMCALL(void, Raiseoutofmem_8241)(void) {
if (!(Goutofmem_8240 == NIM_NIL)) goto LA2;
rawEcho(((NimStringDesc*) &TMP21324));
rawEchoNL();
exit(1);
LA2: ;
asgnRefNoCycle((void**) &(*Goutofmem_8240).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP21333)));
...
NIM_BOOL LOC2;
Result_8416 = 0;
Result_8416 = mmap(NIM_NIL, Size_8415, ((NI32) 3), ((NI32) 258), ((NI32) -1), 0);
...
appendString(Buf_5201, ((NimStringDesc*) &TMP21339));
goto LA1;
LA2: ;
if (!(S_5679 == SIGSEGV)) goto LA4;
Buf_5201 = resizeString(Buf_5201, 61);
appendString(Buf_5201, ((NimStringDesc*) &TMP21340));
goto LA1;
LA4: ;
...
LA9: ;
Buf_5201 = resizeString(Buf_5201, 31);
appendString(Buf_5201, ((NimStringDesc*) &TMP21341));
goto LA1;
LA6: ;
if (!(S_5679 == SIGFPE)) goto LA11;
Buf_5201 = resizeString(Buf_5201, 26);
appendString(Buf_5201, ((NimStringDesc*) &TMP21342));
goto LA1;
LA11: ;
if (!(S_5679 == SIGILL)) goto LA13;
Buf_5201 = resizeString(Buf_5201, 27);
appendString(Buf_5201, ((NimStringDesc*) &TMP21343));
goto LA1;
LA13: ;
if (!(S_5679 == SIGSEGV)) goto LA15;
Buf_5201 = resizeString(Buf_5201, 60);
appendString(Buf_5201, ((NimStringDesc*) &TMP21344));
goto LA1;
LA15: ;
...
I_19697 = 0;
HEX3Atmp_21290 = 0;
HEX3Atmp_21290 = (NI32)((*N_19687).len - 1);
Res_21292 = 0;
Res_21292 = 0;
while (1) {
...
I_19725 = 0;
HEX3Atmp_21293 = 0;
HEX3Atmp_21293 = (NI32)((NI32)((*Typ_19682).size / (*(*Typ_19682).base).size) - 1);
Res_21295 = 0;
Res_21295 = 0;
while (1) {
...
J_19451 = 0;
HEX3Atmp_21272 = 0;
HEX3Atmp_21272 = (NI32)((NI32)(I_19405 / 2) - 1);
Res_21274 = 0;
Res_21274 = 0;
while (1) {
...
I_19744 = 0;
HEX3Atmp_21296 = 0;
HEX3Atmp_21296 = (NI32)((*N_19734).len - 1);
Res_21298 = 0;
Res_21298 = 0;
while (1) {
...
I_19781 = 0;
HEX3Atmp_21299 = 0;
HEX3Atmp_21299 = (NI32)((NI32)((*Mt_19729).size / (*(*Mt_19729).base).size) - 1);
Res_21301 = 0;
Res_21301 = 0;
while (1) {
...
asgnRefNoCycle((void**) &(*E_4529).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP21333)));
...
Result_4016 = 0;
Result_4016 = NIM_NIL;
Result_4016 = copyString(((NimStringDesc*) &TMP197649));
...
asgnRefNoCycle((void**) &(*E_5634).Sup.Sup.message, copyString(((NimStringDesc*) &TMP197660)));
...
I_19025 = 0;
HEX3Atmp_21269 = 0;
HEX3Atmp_21269 = (NI32)((*Result_19006).len - 1);
Res_21271 = 0;
Res_21271 = Newlen_19005;
while (1) {
...
J_19518 = 0;
HEX3Atmp_21275 = 0;
HEX3Atmp_21275 = (NI32)((NI32)(I_19472 / 2) - 1);
Res_21277 = 0;
Res_21277 = 0;
while (1) {
...
appendString(LOC4, ((NimStringDesc*) &TMP197771));
Result_19834 = LOC4;
LA1: ;
return Result_19834;
}
...
asgnRefNoCycle((void**) &(*E_4713).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP197879)));
...
asgnRefNoCycle((void**) &(*E_4688).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP197880)));
...
Result_4463 = NIM_NIL;
F_4464 = 0;
pushSafePoint(&TMP197878);
TMP197878.status = setjmp(TMP197878.context);
if (TMP197878.status == 0) {
...
Result_4463 = copyString(NIM_NIL);
TMP197878.status = 0;popCurrentException();}
}
if (TMP197878.status != 0) reraiseException();
return Result_4463;
}
...
I_18740 = 0;
HEX3Atmp_21266 = 0;
HEX3Atmp_21266 = (NI32)(S_18727->Sup.len - 1);
Res_21268 = 0;
Res_21268 = 0;
while (1) {
if (!(Res_21268 <= HEX3Atmp_21266)) goto LA1;
I_18740 = Res_21268;
...
I_19594 = 0;
HEX3Atmp_21278 = 0;
HEX3Atmp_21278 = (NI32)((*N_19583).len - 1);
Res_21280 = 0;
Res_21280 = 0;
while (1) {
...
I_19637 = 0;
HEX3Atmp_21281 = 0;
HEX3Atmp_21281 = (NI32)((*Seq_19626).len - 1);
Res_21283 = 0;
Res_21283 = 0;
while (1) {
...
I_19647 = 0;
HEX3Atmp_21284 = 0;
HEX3Atmp_21284 = (NI32)((NI32)((*Mt_19577).size / (*(*Mt_19577).base).size) - 1);
Res_21286 = 0;
Res_21286 = 0;
while (1) {
...
N_NIMCALL(void, Quit_21346)(NimStringDesc* Errormsg_21348) {
rawEcho(Errormsg_21348);
rawEchoNL();
exit(1);
}
...
appendString(LOC1, ((NimStringDesc*) &TMP199562));
...
Initgc_3231();
asgnRefNoCycle((void**) &Stacktracenewline_4826, copyString(((NimStringDesc*) &TMP21332)));
excHandler = NIM_NIL;
