...
STRING_LITERAL(TMP198909, "failed to create a pipe", 23);
STRING_LITERAL(TMP198910, "failed to fork process", 22);
STRING_LITERAL(TMP198911, "", 0);
STRING_LITERAL(TMP198912, "=", 1);
STRING_LITERAL(TMP198913, " ", 1);
STRING_LITERAL(TMP198915, "sh", 2);
STRING_LITERAL(TMP198916, "-c", 2);
NIM_CONST TY118997 TMP198914 = {((NimStringDesc*) &TMP198915),
((NimStringDesc*) &TMP198916)}
;
STRING_LITERAL(TMP198917, "execve call failed: ", 20);
STRING_LITERAL(TMP198918, "\012", 1);
...
NI Result_69403;
Result_69403 = 0;
Result_69403 = sysconf(_SC_NPROCESSORS_ONLN);
if (!(Result_69403 <= 0)) goto LA2;
Result_69403 = 1;
LA2: ;
return Result_69403;
}
...
nosOSError(((NimStringDesc*) &TMP198911));
LA3: ;
}
N_NIMCALL(NCSTRING*, Tocstringarray_70218)(NimStringDesc** B_70221, NI B_70221Len0, NimStringDesc** A_70222, NI A_70222Len0) {
...
void* LOC5;
Result_70223 = 0;
LOC1 = Alloc0_2353((NI32)((NI32)((NI32)(A_70222Len0 + B_70221Len0) + 1) * 4));
...
I_70252 = Res_70606;
LOC3 = Alloc_2350((NI32)(B_70221[I_70252]->Sup.len + 1));
Result_70223[(I_70252)-0] = ((NCSTRING) (LOC3));
memcpy(((void*) (Result_70223[(I_70252)-0])), ((void*) (B_70221[I_70252]->data)), (NI32)(B_70221[I_70252]->Sup.len + 1));
Res_70606 += 1;
} LA2: ;
I_70265 = 0;
HEX3Atmp_70607 = 0;
...
I_70265 = Res_70609;
LOC5 = Alloc_2350((NI32)(A_70222[I_70265]->Sup.len + 1));
Result_70223[((NI32)(I_70265 + B_70221Len0))-0] = ((NCSTRING) (LOC5));
memcpy(((void*) (Result_70223[((NI32)(I_70265 + B_70221Len0))-0])), ((void*) (A_70222[I_70265]->data)), (NI32)(A_70222[I_70265]->Sup.len + 1));
Res_70609 += 1;
} LA4: ;
return Result_70223;
}
...
appendString(LOC7, ((NimStringDesc*) &TMP198912));
appendString(LOC7, Val_70298);
X_70299 = LOC7;
LOC8 = Alloc_2350((NI32)(X_70299->Sup.len + 1));
Result_70293[(I_70296)-0] = ((NCSTRING) (LOC8));
memcpy(((void*) (Result_70293[(I_70296)-0])), ((void*) (&X_70299->data[0])), (NI32)(X_70299->Sup.len + 1));
I_70296 += 1;
LA5: ;
Res_70615 += 1;
} LA3: ;
...
appendString(Result_70208, ((NimStringDesc*) &TMP198913));
LOC2 = 0;
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3866(stdout, ((NimStringDesc*) &TMP198918));
}
N_NIMCALL(TY69202*, nospstartProcess)(NimStringDesc* Command_69238, NimStringDesc* Workingdir_69239, NimStringDesc** Args_69244, NI Args_69244Len0, TY67408* Env_69245, NU8 Options_69248) {
...
nosOSError(((NimStringDesc*) &TMP198910));
LA9: ;
...
A_70433 = Tocstringarray_70218(TMP198914, 2, LOC53, 1);
...
appendString(LOC60, ((NimStringDesc*) &TMP198917));
...
LOC66 = 0;
LOC67 = 0;
LOC67 = nsuJoinSep(Args_69244, Args_69244Len0, ((NimStringDesc*) &TMP198913));
LOC66 = rawNewString(Command_69238->Sup.len + LOC67->Sup.len + 1);
appendString(LOC66, Command_69238);
appendString(LOC66, ((NimStringDesc*) &TMP198913));
...
I_69661 = 0;
HEX3Atmp_69680 = 0;
HEX3Atmp_69680 = (NI32)(C_69609->Sup.len - 1);
Res_69682 = 0;
Res_69682 = 1;
while (1) {
...
Result_69608 = nospstartProcess(C_69609->data[0], ((NimStringDesc*) &TMP198911), A_69627->data, A_69627->Sup.len, NIM_NIL, Options_69607);
return Result_69608;
}
N_NIMCALL(NIM_BOOL, nosprunning)(TY69202* P_69260) {
