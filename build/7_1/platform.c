...
;
STRING_LITERAL(TMP51700, "solaris", 7);
NU8 Targetcpu_51568;
NU8 Hostcpu_51569;
NU8 Targetos_51570;
NU8 Hostos_51571;
...
Intsize_51578 = (NI32)(Cpu_51461[(C_51585)-1].Intsize / 8);
Floatsize_51579 = (NI32)(Cpu_51461[(C_51585)-1].Floatsize / 8);
Ptrsize_51580 = (NI32)(Cpu_51461[(C_51585)-1].Bit / 8);
asgnRefNoCycle((void**) &Tnl_51581, copyString(Os_51053[(O_51584)-1].Newline));
}
N_NOINLINE(void, platformInit)(void) {
Hostcpu_51569 = Nametocpu_51575(((NimStringDesc*) &TMP51555));
