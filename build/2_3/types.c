...
STRING_LITERAL(TMP193935, "invalid kind for first(", 23);
STRING_LITERAL(TMP193936, "invalid kind for last(", 22);
STRING_LITERAL(TMP193949, "computeRecSizeAux(record case branch)", 37);
STRING_LITERAL(TMP193950, "computeRecSizeAux()", 19);
STRING_LITERAL(TMP193951, "getSize(", 8);
STRING_LITERAL(TMP193994, "None", 4);
STRING_LITERAL(TMP193995, "bool", 4);
STRING_LITERAL(TMP193996, "Char", 4);
STRING_LITERAL(TMP193997, "empty", 5);
STRING_LITERAL(TMP193998, "Array Constructor [$1]", 22);
STRING_LITERAL(TMP193999, "nil", 3);
STRING_LITERAL(TMP194000, "expr", 4);
STRING_LITERAL(TMP194001, "stmt", 4);
STRING_LITERAL(TMP194002, "typeDesc", 8);
STRING_LITERAL(TMP194003, "GenericInvokation", 17);
STRING_LITERAL(TMP194004, "GenericBody", 11);
STRING_LITERAL(TMP194005, "GenericInst", 11);
STRING_LITERAL(TMP194006, "GenericParam", 12);
STRING_LITERAL(TMP194007, "distinct $1", 11);
STRING_LITERAL(TMP194008, "enum", 4);
STRING_LITERAL(TMP194009, "ordinal[$1]", 11);
STRING_LITERAL(TMP194010, "array[$1, $2]", 13);
STRING_LITERAL(TMP194011, "object", 6);
STRING_LITERAL(TMP194012, "tuple", 5);
STRING_LITERAL(TMP194013, "set[$1]", 7);
STRING_LITERAL(TMP194014, "range[$1]", 9);
STRING_LITERAL(TMP194015, "ptr ", 4);
STRING_LITERAL(TMP194016, "ref ", 4);
STRING_LITERAL(TMP194017, "var ", 4);
STRING_LITERAL(TMP194018, "seq[$1]", 7);
STRING_LITERAL(TMP194019, "proc", 4);
STRING_LITERAL(TMP194020, "pointer", 7);
STRING_LITERAL(TMP194021, "OpenArray[$1]", 13);
STRING_LITERAL(TMP194022, "string", 6);
STRING_LITERAL(TMP194023, "CString", 7);
STRING_LITERAL(TMP194024, "Forward", 7);
STRING_LITERAL(TMP194025, "int", 3);
STRING_LITERAL(TMP194026, "int8", 4);
STRING_LITERAL(TMP194027, "int16", 5);
STRING_LITERAL(TMP194028, "int32", 5);
STRING_LITERAL(TMP194029, "int64", 5);
STRING_LITERAL(TMP194030, "float", 5);
STRING_LITERAL(TMP194031, "float32", 7);
STRING_LITERAL(TMP194032, "float64", 7);
STRING_LITERAL(TMP194033, "float128", 8);
NIM_CONST TY97412 Typetostr_97411 = {((NimStringDesc*) &TMP193994),
...
;
STRING_LITERAL(TMP194034, ", ", 2);
STRING_LITERAL(TMP194035, "array[", 6);
STRING_LITERAL(TMP194037, "..", 2);
STRING_LITERAL(TMP194038, "Array constructor[", 18);
STRING_LITERAL(TMP194039, "seq[", 4);
STRING_LITERAL(TMP194040, "ordinal[", 8);
STRING_LITERAL(TMP194041, "set[", 4);
STRING_LITERAL(TMP194042, "openarray[", 10);
STRING_LITERAL(TMP194043, "distinct ", 9);
STRING_LITERAL(TMP194044, "tuple[", 6);
STRING_LITERAL(TMP194045, ": ", 2);
extern NIM_CONST TY97412 Typetostr_97411;
STRING_LITERAL(TMP194046, "range ", 6);
STRING_LITERAL(TMP194047, "proc (", 6);
extern NIM_CONST TY54016 Callingconvtostr_54015;
STRING_LITERAL(TMP194048, "noSideEffect", 12);
STRING_LITERAL(TMP194049, "{.", 2);
STRING_LITERAL(TMP194050, ".}", 2);
STRING_LITERAL(TMP194066, "sameTuple", 9);
STRING_LITERAL(TMP194077, "getProcHeader", 13);
STRING_LITERAL(TMP194270, "searchTypeNodeForAux(record case branch)", 40);
STRING_LITERAL(TMP194271, "searchTypeNodeForAux()", 22);
...
break;
default:
Limessage_46566((*N_96111).Info, ((NU8) 71), ((NimStringDesc*) &TMP193934));
Result_96262 = 0;
break;
}
return Result_96262;
...
appendString(LOC11, ((NimStringDesc*) &TMP193935));
...
appendString(LOC6, ((NimStringDesc*) &TMP193936));
...
appendString(LOC4, ((NimStringDesc*) &TMP193951));
...
appendString(LOC1, ((NimStringDesc*) &TMP194037));
...
T_97415 = 0;
T_97415 = Typ_96016;
Result_97410 = copyString(((NimStringDesc*) &TMP193934));
...
appendString(Result_97410, ((NimStringDesc*) &TMP194034));
LA14: ;
LOC16 = 0;
...
appendString(LOC26, ((NimStringDesc*) &TMP194038));
appendString(LOC26, LOC27);
appendString(LOC26, ((NimStringDesc*) &TMP194034));
...
appendString(LOC29, ((NimStringDesc*) &TMP194039));
...
appendString(LOC31, ((NimStringDesc*) &TMP194040));
...
appendString(LOC33, ((NimStringDesc*) &TMP194041));
...
appendString(LOC35, ((NimStringDesc*) &TMP194042));
...
appendString(LOC37, ((NimStringDesc*) &TMP194043));
appendString(LOC37, LOC38);
Result_97410 = LOC37;
break;
case ((NU8) 18):
Result_97410 = copyString(((NimStringDesc*) &TMP194044));
...
appendString(LOC44, ((NimStringDesc*) &TMP194045));
...
appendString(LOC59, ((NimStringDesc*) &TMP194046));
appendString(LOC59, LOC60);
Result_97410 = LOC59;
break;
case ((NU8) 25):
Result_97410 = copyString(((NimStringDesc*) &TMP194047));
I_97565 = 0;
HEX3Atmp_97614 = 0;
...
appendString(LOC71, ((NimStringDesc*) &TMP194045));
...
goto LA73;
LA74: ;
Prag_97579 = copyString(((NimStringDesc*) &TMP193934));
LA73: ;
if (!(((*T_97415).Flags &(1<<((((NU8) 1))&7)))!=0)) goto LA77;
Addsep_24854(&Prag_97579, ((NimStringDesc*) &TMP194034), 0);
Prag_97579 = resizeString(Prag_97579, 12);
appendString(Prag_97579, ((NimStringDesc*) &TMP194048));
LA77: ;
...
Internalerror_46571((*(*A_98205).N).Info, ((NimStringDesc*) &TMP194066));
LA22: ;
if (!!(((*(*(*B_98206).N).KindU.S6.Sons->data[I_98250]).Kind == ((NU8) 3)))) goto LA25;
Internalerror_46571((*(*B_98206).N).Info, ((NimStringDesc*) &TMP194066));
LA25: ;
...
Internalerror_46575(((NimStringDesc*) &TMP194077));
LA5: ;
...
appendString(Result_96315, ((NimStringDesc*) &TMP194045));
LOC7 = 0;
...
Result_96315 = resizeString(Result_96315, 2);
appendString(Result_96315, ((NimStringDesc*) &TMP194034));
LA10: ;
Res_96425 += 1;
} LA3: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP194045));
...
break;
default:
Internalerror_46571((*N_96767).Info, ((NimStringDesc*) &TMP194271));
break;
}
BeforeRet: ;
return Result_96771;
