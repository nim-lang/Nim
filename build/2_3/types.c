...
STRING_LITERAL(TMP196945, "", 0);
STRING_LITERAL(TMP196946, "invalid kind for first(", 23);
STRING_LITERAL(TMP196947, "invalid kind for last(", 22);
STRING_LITERAL(TMP196960, "computeRecSizeAux(record case branch)", 37);
STRING_LITERAL(TMP196961, "computeRecSizeAux()", 19);
STRING_LITERAL(TMP196962, "getSize(", 8);
STRING_LITERAL(TMP197005, "None", 4);
STRING_LITERAL(TMP197006, "bool", 4);
STRING_LITERAL(TMP197007, "Char", 4);
STRING_LITERAL(TMP197008, "empty", 5);
STRING_LITERAL(TMP197009, "Array Constructor [$1]", 22);
STRING_LITERAL(TMP197010, "nil", 3);
STRING_LITERAL(TMP197011, "expr", 4);
STRING_LITERAL(TMP197012, "stmt", 4);
STRING_LITERAL(TMP197013, "typeDesc", 8);
STRING_LITERAL(TMP197014, "GenericInvokation", 17);
STRING_LITERAL(TMP197015, "GenericBody", 11);
STRING_LITERAL(TMP197016, "GenericInst", 11);
STRING_LITERAL(TMP197017, "GenericParam", 12);
STRING_LITERAL(TMP197018, "distinct $1", 11);
STRING_LITERAL(TMP197019, "enum", 4);
STRING_LITERAL(TMP197020, "ordinal[$1]", 11);
STRING_LITERAL(TMP197021, "array[$1, $2]", 13);
STRING_LITERAL(TMP197022, "object", 6);
STRING_LITERAL(TMP197023, "tuple", 5);
STRING_LITERAL(TMP197024, "set[$1]", 7);
STRING_LITERAL(TMP197025, "range[$1]", 9);
STRING_LITERAL(TMP197026, "ptr ", 4);
STRING_LITERAL(TMP197027, "ref ", 4);
STRING_LITERAL(TMP197028, "var ", 4);
STRING_LITERAL(TMP197029, "seq[$1]", 7);
STRING_LITERAL(TMP197030, "proc", 4);
STRING_LITERAL(TMP197031, "pointer", 7);
STRING_LITERAL(TMP197032, "OpenArray[$1]", 13);
STRING_LITERAL(TMP197033, "string", 6);
STRING_LITERAL(TMP197034, "CString", 7);
STRING_LITERAL(TMP197035, "Forward", 7);
STRING_LITERAL(TMP197036, "int", 3);
STRING_LITERAL(TMP197037, "int8", 4);
STRING_LITERAL(TMP197038, "int16", 5);
STRING_LITERAL(TMP197039, "int32", 5);
STRING_LITERAL(TMP197040, "int64", 5);
STRING_LITERAL(TMP197041, "float", 5);
STRING_LITERAL(TMP197042, "float32", 7);
STRING_LITERAL(TMP197043, "float64", 7);
STRING_LITERAL(TMP197044, "float128", 8);
NIM_CONST TY97495 Typetostr_97494 = {((NimStringDesc*) &TMP197005),
...
;
STRING_LITERAL(TMP197045, "array[", 6);
STRING_LITERAL(TMP197047, "..", 2);
STRING_LITERAL(TMP197048, ", ", 2);
STRING_LITERAL(TMP197049, "Array constructor[", 18);
STRING_LITERAL(TMP197050, "seq[", 4);
STRING_LITERAL(TMP197051, "ordinal[", 8);
STRING_LITERAL(TMP197052, "set[", 4);
STRING_LITERAL(TMP197053, "openarray[", 10);
STRING_LITERAL(TMP197054, "distinct ", 9);
STRING_LITERAL(TMP197055, "tuple[", 6);
STRING_LITERAL(TMP197056, ": ", 2);
extern NIM_CONST TY97495 Typetostr_97494;
STRING_LITERAL(TMP197057, "range ", 6);
STRING_LITERAL(TMP197058, "proc (", 6);
extern NIM_CONST TY55016 Callingconvtostr_55015;
STRING_LITERAL(TMP197059, "noSideEffect", 12);
STRING_LITERAL(TMP197060, "{.", 2);
STRING_LITERAL(TMP197061, ".}", 2);
STRING_LITERAL(TMP197077, "sameTuple", 9);
STRING_LITERAL(TMP197088, "getProcHeader", 13);
STRING_LITERAL(TMP197284, "searchTypeNodeForAux(record case branch)", 40);
STRING_LITERAL(TMP197285, "searchTypeNodeForAux()", 22);
...
break;
default:
Limessage_47562((*N_96109).Info, ((NU8) 71), ((NimStringDesc*) &TMP196945));
Result_96263 = 0;
break;
}
return Result_96263;
...
appendString(LOC11, ((NimStringDesc*) &TMP196946));
...
appendString(LOC6, ((NimStringDesc*) &TMP196947));
...
appendString(LOC4, ((NimStringDesc*) &TMP196962));
...
appendString(LOC1, ((NimStringDesc*) &TMP197047));
...
T_97498 = 0;
T_97498 = Typ_96016;
Result_97493 = copyString(((NimStringDesc*) &TMP196945));
...
appendString(LOC13, ((NimStringDesc*) &TMP197045));
appendString(LOC13, LOC14);
appendString(LOC13, ((NimStringDesc*) &TMP197048));
...
appendString(LOC16, ((NimStringDesc*) &TMP197045));
appendString(LOC16, LOC17);
appendString(LOC16, ((NimStringDesc*) &TMP197048));
...
appendString(Result_97493, ((NimStringDesc*) &TMP197048));
LA24: ;
LOC26 = 0;
...
appendString(LOC30, ((NimStringDesc*) &TMP197050));
...
appendString(LOC32, ((NimStringDesc*) &TMP197051));
...
appendString(LOC34, ((NimStringDesc*) &TMP197052));
...
appendString(LOC36, ((NimStringDesc*) &TMP197053));
...
appendString(LOC38, ((NimStringDesc*) &TMP197054));
appendString(LOC38, LOC39);
Result_97493 = LOC38;
break;
case ((NU8) 18):
Result_97493 = copyString(((NimStringDesc*) &TMP197055));
...
appendString(LOC45, ((NimStringDesc*) &TMP197056));
...
appendString(LOC60, ((NimStringDesc*) &TMP197057));
appendString(LOC60, LOC61);
Result_97493 = LOC60;
break;
case ((NU8) 25):
Result_97493 = copyString(((NimStringDesc*) &TMP197058));
I_97810 = 0;
HEX3Atmp_97893 = 0;
...
appendString(LOC72, ((NimStringDesc*) &TMP197056));
...
goto LA74;
LA75: ;
Prag_97832 = copyString(((NimStringDesc*) &TMP196945));
LA74: ;
if (!(((*T_97498).Flags &(1<<((((NU8) 1))&7)))!=0)) goto LA78;
Addsep_25820(&Prag_97832, ((NimStringDesc*) &TMP197048), 0);
Prag_97832 = resizeString(Prag_97832, 12);
appendString(Prag_97832, ((NimStringDesc*) &TMP197059));
LA78: ;
...
Internalerror_47567((*(*A_98513).N).Info, ((NimStringDesc*) &TMP197077));
LA22: ;
if (!!(((*(*(*B_98514).N).KindU.S6.Sons->data[I_98558]).Kind == ((NU8) 3)))) goto LA25;
Internalerror_47567((*(*B_98514).N).Info, ((NimStringDesc*) &TMP197077));
LA25: ;
...
Internalerror_47571(((NimStringDesc*) &TMP197088));
LA5: ;
...
appendString(Result_96316, ((NimStringDesc*) &TMP197056));
LOC7 = 0;
...
Result_96316 = resizeString(Result_96316, 2);
appendString(Result_96316, ((NimStringDesc*) &TMP197048));
LA10: ;
Res_96447 += 1;
} LA3: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP197056));
...
break;
default:
Internalerror_47567((*N_96807).Info, ((NimStringDesc*) &TMP197285));
break;
}
BeforeRet: ;
return Result_96811;
