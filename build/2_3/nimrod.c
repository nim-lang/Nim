...
static N_INLINE(void, rawEchoNL)(void) {
Write_3866(stdout, ((NimStringDesc*) &TMP197509));
}
N_NIMCALL(void, Handlecmdline_195245)(void) {
NI Start_195247;
NI LOC2;
...
if (!!(((1073742848 &(1<<((Gcmd_46084)&31)))!=0))) goto LA17;
...
appendString(LOC25, ((NimStringDesc*) &TMP197510));
