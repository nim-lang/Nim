...
STRING_LITERAL(TMP198500, "\012", 1);
STRING_LITERAL(TMP198501, "./", 2);
...
Key_196215 = 0;
Key_196215 = copyStrLast(P_196210.Key, 0, (NI32)(Bracketle_196212 - 1));
Val_196228 = 0;
LOC5 = 0;
LOC6 = 0;
LOC6 = copyStr(P_196210.Key, (NI32)(Bracketle_196212 + 1));
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3658(stdout, ((NimStringDesc*) &TMP198500));
}
N_NIMCALL(void, Handlecmdline_196258)(void) {
NI Start_196260;
NI LOC2;
...
rawEchoNL();
LA10: ;
LOC14 = !(((536871424 &(1<<((Gcmd_46082)&31)))!=0));
if (!(LOC14)) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP198501));
