...
STRING_LITERAL(TMP197237, "cgmeth.genConv", 14);
STRING_LITERAL(TMP197238, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP197239, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP197771, "and", 3);
STRING_LITERAL(TMP197772, "is", 2);
...
Ands_158515 = Getsyssym_101024(((NimStringDesc*) &TMP197771));
Iss_158516 = Getsyssym_101024(((NimStringDesc*) &TMP197772));
Meth_158537 = 0;
HEX3Atmp_158673 = 0;
