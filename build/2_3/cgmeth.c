...
STRING_LITERAL(TMP196220, "cgmeth.genConv", 14);
STRING_LITERAL(TMP196221, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP196222, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP196758, "and", 3);
STRING_LITERAL(TMP196759, "is", 2);
...
Ands_159499 = Getsyssym_102024(((NimStringDesc*) &TMP196758));
Iss_159500 = Getsyssym_102024(((NimStringDesc*) &TMP196759));
Meth_159522 = 0;
HEX3Atmp_159653 = 0;
