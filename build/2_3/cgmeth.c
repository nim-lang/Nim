...
STRING_LITERAL(TMP196226, "cgmeth.genConv", 14);
STRING_LITERAL(TMP196227, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP196228, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP196763, "and", 3);
STRING_LITERAL(TMP196764, "is", 2);
...
while (1) {
Aa_160164 = Skiptypes_97087(Aa_160164, IL64(2251799813685248));
Bb_160165 = Skiptypes_97087(Bb_160165, IL64(2251799813685248));
LOC17 = ((*Aa_160164).Kind == (*Bb_160165).Kind);
if (!(LOC17)) goto LA18;
LOC17 = ((IL64(246290604621824) &(IL64(1)<<(((*Aa_160164).Kind)&IL64(63))))!=0);
LA18: ;
if (!LOC17) goto LA19;
...
I_160251 = 0;
HEX3Atmp_160382 = 0;
HEX3Atmp_160382 = (NI64)(L_160230 - 1);
Res_160384 = 0;
Res_160384 = 0;
while (1) {
...
Source_160011 = 0;
Diff_160012 = 0;
Dest_160010 = Skiptypes_97087(D_160007, IL64(47534086692012032));
Source_160011 = Skiptypes_97087((*N_160006).Typ, IL64(47534086692012032));
...
if (!(Diff_160012 == IL64(9223372036854775807))) goto LA7;
...
LOC2 = 0;
LOC2 = Skiptypes_97087(T_160390, IL64(2498090418307072));
...
if (!LOC4) goto LA5;
Aa_160419 = Skiptypes_97087((*(*A_160414).Typ).Sons->data[Col_160429], IL64(2498090418307072));
Bb_160420 = Skiptypes_97087((*(*B_160415).Typ).Sons->data[Col_160429], IL64(2498090418307072));
D_160418 = Inheritancediff_97121(Aa_160419, Bb_160420);
if (!!((D_160418 == IL64(9223372036854775807)))) goto LA8;
...
H_160442 = 1;
while (1) {
H_160442 = (NI64)((NI64)(3 * H_160442) + 1);
if (!(N_160440 < H_160442)) goto LA3;
goto LA1;
LA3: ;
} LA1: ;
while (1) {
H_160442 = (NI64)(H_160442 / 3);
I_160466 = 0;
HEX3Atmp_160475 = 0;
HEX3Atmp_160475 = (NI64)(N_160440 - 1);
Res_160477 = 0;
Res_160477 = H_160442;
while (1) {
...
J_160441 = I_160466;
while (1) {
LOC8 = Cmpsignatures_160412((*A_160438)->data[(NI64)(J_160441 - H_160442)], V_160443, Relevantcols_160439);
if (!(0 <= LOC8)) goto LA7;
asgnRef((void**) &(*A_160438)->data[J_160441], (*A_160438)->data[(NI64)(J_160441 - H_160442)]);
J_160441 = (NI64)(J_160441 - H_160442);
...
Ands_160491 = Getsyssym_102024(((NimStringDesc*) &TMP196763));
Iss_160492 = Getsyssym_102024(((NimStringDesc*) &TMP196764));
Meth_160514 = 0;
HEX3Atmp_160645 = 0;
...
Col_160523 = 0;
HEX3Atmp_160639 = 0;
HEX3Atmp_160639 = (NI64)(Paramlen_160493 - 1);
Res_160641 = 0;
Res_160641 = 1;
while (1) {
...
Col_160567 = 0;
HEX3Atmp_160642 = 0;
HEX3Atmp_160642 = (NI64)(Paramlen_160493 - 1);
Res_160644 = 0;
Res_160644 = 1;
while (1) {
...
Bucket_160670 = 0;
HEX3Atmp_160686 = 0;
HEX3Atmp_160686 = (NI64)(Gmethods_160158->Sup.len - 1);
Res_160688 = 0;
Res_160688 = 0;
while (1) {
