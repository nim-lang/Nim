...
goto LA5;
LA6: ;
LOC9 = ((150994944 & (*S_106079).Flags) == 0);
if (!(LOC9)) goto LA10;
LOC9 = (((*S_106079).Options &(1<<((((NU8) 12))&31)))!=0);
LA10: ;
if (!LOC9) goto LA11;
F.line = 57;F.filename = "lookups.nim";
if (!!(((151257600 &(1<<(((*S_106079).Kind)&31)))!=0))) goto LA14;
...
if (!!(((1967104 &(1<<(((*Fn_106038).Kind)&31)))!=0))) goto LA2;
...
if (!(LOC5)) goto LA6;
LOC5 = !(((1967104 &(1<<(((*Check_106269).Kind)&31)))!=0));
LA6: ;
if (!LOC5) goto LA7;
