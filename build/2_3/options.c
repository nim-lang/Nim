...
NIM_CONST NU32 Checksoptions_45073 = IL64(4261609472);
STRING_LITERAL(TMP45088, "", 0);
STRING_LITERAL(TMP193641, "nimcache", 8);
STRING_LITERAL(TMP193653, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP193641));
...
if (!(LOC2)) goto LA3;
LOC2 = ((NU8)(Path_45212->data[(NI32)(Path_45212->Sup.len - 1)]) == (NU8)(47));
LA3: ;
if (!LOC2) goto LA4;
Result_45213 = copyStrLast(Path_45212, 0, (NI32)(Path_45212->Sup.len - 2));
goto LA1;
LA4: ;
...
LOC7[1] = copyString(((NimStringDesc*) &TMP193641));
LOC7[2] = copyString(Head_45244);
Subdir_45254 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_45103) goto LA9;
pushSafePoint(&TMP193652);
TMP193652.status = setjmp(TMP193652.context);
if (TMP193652.status == 0) {
...
appendString(LOC11, ((NimStringDesc*) &TMP193653));
appendString(LOC11, Subdir_45254);
Writeln_45258(stdout, LOC11);
exit(1);
TMP193652.status = 0;popCurrentException();}
}
if (TMP193652.status != 0) reraiseException();
LA9: ;
...
Gimplicitmods_45130 = (TY38221*) setLengthSeq(&(Gimplicitmods_45130)->Sup, sizeof(NimStringDesc*), (NI32)(Length_45173 + 1));
...
Write_3658(F_45261, ((NimStringDesc*) &TMP195503));
}
N_NOINLINE(void, optionsInit)(void) {
TY45320 LOC1;
Goptions_45076 = 1050280192;
Gglobaloptions_45078 = 134217728;
