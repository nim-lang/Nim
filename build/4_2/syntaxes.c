...
;
STRING_LITERAL(TMP197744, "|", 1);
STRING_LITERAL(TMP197875, "parser to implement", 19);
...
LOC5 = LOC6;
if (!(LOC5)) goto LA8;
LOC5 = Identeq_55028((*(*N_93378).KindU.S6.Sons->data[0]).KindU.S5.Ident, ((NimStringDesc*) &TMP197744));
LA8: ;
if (!LOC5) goto LA9;
I_93468 = 0;
Res_93536 = 0;
...
break;
case ((NU8) 2):
Internalerror_49212(((NimStringDesc*) &TMP197875));
