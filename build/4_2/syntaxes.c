...
;
STRING_LITERAL(TMP196745, "|", 1);
STRING_LITERAL(TMP196868, "parser to implement", 19);
...
LOC5 = LOC6;
if (!(LOC5)) goto LA8;
LOC5 = Identeq_54028((*(*N_91384).KindU.S6.Sons->data[0]).KindU.S5.Ident, ((NimStringDesc*) &TMP196745));
LA8: ;
if (!LOC5) goto LA9;
I_91475 = 0;
Res_91544 = 0;
...
break;
case ((NU8) 2):
Internalerror_47571(((NimStringDesc*) &TMP196868));
break;
}
return Result_91067;
}
