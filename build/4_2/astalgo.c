...
STRING_LITERAL(TMP194677, "lookupInRecord", 14);
STRING_LITERAL(TMP194678, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP194679, "lookupInRecord()", 16);
...
Internalerror_46571((*List_59196).Info, ((NimStringDesc*) &TMP194055));
LA4: ;
...
Result_60350 = Torope_51046(((NimStringDesc*) &TMP194138));
goto LA1;
LA2: ;
...
App_51036(&Result_60350, ((NimStringDesc*) &TMP194142));
LA11: ;
LA1: ;
return Result_60350;
}
...
break;
default:
Internalerror_46571((*N_59201).Info, ((NimStringDesc*) &TMP194679));
break;
}
BeforeRet: ;
return Result_59243;
...
Write_3658(F_60745, ((NimStringDesc*) &TMP195505));
}
