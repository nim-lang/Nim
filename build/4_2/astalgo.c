...
STRING_LITERAL(TMP197066, "getSymFromList", 14);
STRING_LITERAL(TMP197149, "null", 4);
STRING_LITERAL(TMP197150, " ", 1);
STRING_LITERAL(TMP197151, "(", 1);
STRING_LITERAL(TMP197152, ", ", 2);
STRING_LITERAL(TMP197153, ")", 1);
STRING_LITERAL(TMP197691, "lookupInRecord", 14);
STRING_LITERAL(TMP197692, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP197693, "lookupInRecord()", 16);
...
Internalerror_47567((*List_59199).Info, ((NimStringDesc*) &TMP197066));
LA4: ;
...
Result_60414 = Torope_52046(((NimStringDesc*) &TMP197149));
goto LA1;
LA2: ;
...
App_52036(&Result_60414, ((NimStringDesc*) &TMP197153));
LA11: ;
LA1: ;
return Result_60414;
}
...
break;
default:
Internalerror_47567((*N_59204).Info, ((NimStringDesc*) &TMP197693));
break;
}
BeforeRet: ;
return Result_59246;
...
Write_3658(F_60815, ((NimStringDesc*) &TMP198505));
}
