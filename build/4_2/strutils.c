...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193658, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP193704, "invalid float: ", 15);
STRING_LITERAL(TMP193745, "0123456789ABCDEF", 16);
...
appendString(LOC5, ((NimStringDesc*) &TMP193658));
...
appendString(LOC5, ((NimStringDesc*) &TMP193704));
...
J_23462 = Res_23466;
Result_23452->data[J_23462] = ((NimStringDesc*) &TMP193745)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_23450) >> (NU64)(Shift_23454)))) & ((NI32) 15))];
...
L_24031 = 0;
L_24031 = (NI64)(Sep_24005->Sup.len * (NI64)(A_24004Len0 - 1));
I_24039 = 0;
HEX3Atmp_24063 = 0;
