...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP196664, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP196711, "invalid float: ", 15);
STRING_LITERAL(TMP196752, "0123456789ABCDEF", 16);
...
appendString(LOC5, ((NimStringDesc*) &TMP196664));
...
appendString(LOC5, ((NimStringDesc*) &TMP196711));
...
J_25462 = Res_25466;
Result_25452->data[J_25462] = ((NimStringDesc*) &TMP196752)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_25450) >> (NU64)(Shift_25454)))) & ((NI32) 15))];
