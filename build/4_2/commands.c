...
STRING_LITERAL(TMP193651, "lib", 3);
STRING_LITERAL(TMP193652, "", 0);
STRING_LITERAL(TMP193661, "boehmgc", 7);
STRING_LITERAL(TMP193662, "nogc", 4);
extern NIM_CONST TY45494 Hintstostr_45493;
extern NIM_CONST TY45474 Warningstostr_45473;
STRING_LITERAL(TMP193663, "endb", 4);
STRING_LITERAL(TMP193664, "profiler", 8);
STRING_LITERAL(TMP193665, "guiapp", 6);
STRING_LITERAL(TMP193666, "library", 7);
STRING_LITERAL(TMP193670, "Advanced commands::\012  pretty                    pretty print th"
...
LOC1[2] = copyString(((NimStringDesc*) &TMP193651));
...
LA2: ;
Trunc_70415 = 0;
Trunc_70415 = nosChangeFileExt(Found_70414, ((NimStringDesc*) &TMP193652));
...
NU8 LOC24;
Id_70286 = 0;
Id_70286 = copyString(((NimStringDesc*) &TMP193652));
I_70287 = 0;
I_70287 = 0;
N_70288 = 0;
N_70288 = ((NU8) 222);
...
NIM_BOOL LOC2;
NIM_BOOL LOC7;
unsureAsgnRef((void**) &(*Cmd_70142), copyString(((NimStringDesc*) &TMP193652)));
I_70146 = 0;
I_70146 = 0;
...
unsureAsgnRef((void**) &(*Arg_70143), copyString(((NimStringDesc*) &TMP193652)));
goto LA12;
LA13: ;
...
goto LA16;
LA17: ;
Undefsymbol_61056(((NimStringDesc*) &TMP193664));
LA16: ;
break;
case ((NU8) 127):
case ((NU8) 187):
...
Gglobaloptions_44077 &= ~(1 << ((NI32)(((NU8) 11)) % (sizeof(NI32)*8)));
Definesymbol_61053(((NimStringDesc*) &TMP193666));
break;
default:
