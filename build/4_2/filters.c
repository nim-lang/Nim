...
STRING_LITERAL(TMP195852, "startswith", 10);
STRING_LITERAL(TMP195853, "", 0);
STRING_LITERAL(TMP195854, "true", 4);
STRING_LITERAL(TMP195855, "false", 5);
STRING_LITERAL(TMP195856, "leading", 7);
STRING_LITERAL(TMP195857, "trailing", 8);
STRING_LITERAL(TMP195858, "sub", 3);
STRING_LITERAL(TMP195859, "by", 2);
static N_INLINE(NI, Sonslen_55804)(TY55526* N_55806) {
NI Result_56880;
Result_56880 = 0;
...
if (!(LOC4)) goto LA5;
LOC4 = Identeq_54028((*X_90299).KindU.S5.Ident, ((NimStringDesc*) &TMP195854));
LA5: ;
if (!LOC4) goto LA6;
...
if (!(LOC8)) goto LA9;
LOC8 = Identeq_54028((*X_90299).KindU.S5.Ident, ((NimStringDesc*) &TMP195855));
LA9: ;
if (!LOC8) goto LA10;
...
Result_90358 = 0;
Pattern_90359 = 0;
Pattern_90359 = Strarg_90020(Call_90013, ((NimStringDesc*) &TMP195852), 1, ((NimStringDesc*) &TMP195853));
Leading_90360 = 0;
Leading_90360 = Boolarg_90026(Call_90013, ((NimStringDesc*) &TMP195856), 2, NIM_TRUE);
Trailing_90361 = 0;
Trailing_90361 = Boolarg_90026(Call_90013, ((NimStringDesc*) &TMP195857), 3, NIM_TRUE);
Result_90358 = Llstreamopen_75217(((NimStringDesc*) &TMP195853));
while (1) {
...
Result_90373 = 0;
Sub_90374 = 0;
Sub_90374 = Strarg_90020(Call_90008, ((NimStringDesc*) &TMP195858), 1, ((NimStringDesc*) &TMP195853));
if (!(Sub_90374->Sup.len == 0)) goto LA2;
Invalidpragma_90032(Call_90008);
LA2: ;
By_90379 = 0;
By_90379 = Strarg_90020(Call_90008, ((NimStringDesc*) &TMP195859), 2, ((NimStringDesc*) &TMP195853));
Result_90373 = Llstreamopen_75217(((NimStringDesc*) &TMP195853));
while (1) {
