...
STRING_LITERAL(TMP195849, "startswith", 10);
STRING_LITERAL(TMP195850, "", 0);
STRING_LITERAL(TMP195851, "true", 4);
STRING_LITERAL(TMP195852, "false", 5);
STRING_LITERAL(TMP195853, "leading", 7);
STRING_LITERAL(TMP195854, "trailing", 8);
STRING_LITERAL(TMP195855, "sub", 3);
STRING_LITERAL(TMP195856, "by", 2);
static N_INLINE(NI, Sonslen_55804)(TY55526* N_55806) {
NI Result_56886;
Result_56886 = 0;
...
Limessage_47569((*N_90034).Info, ((NU8) 160), LOC1);
}
N_NIMCALL(TY55526*, Getarg_90036)(TY55526* N_90038, NimStringDesc* Name_90039, NI Pos_90040) {
...
if (!(LOC4)) goto LA5;
LOC4 = Identeq_54028((*X_90299).KindU.S5.Ident, ((NimStringDesc*) &TMP195851));
LA5: ;
if (!LOC4) goto LA6;
...
if (!(LOC8)) goto LA9;
LOC8 = Identeq_54028((*X_90299).KindU.S5.Ident, ((NimStringDesc*) &TMP195852));
LA9: ;
if (!LOC8) goto LA10;
...
Result_90358 = 0;
Pattern_90359 = 0;
Pattern_90359 = Strarg_90020(Call_90013, ((NimStringDesc*) &TMP195849), 1, ((NimStringDesc*) &TMP195850));
Leading_90360 = 0;
Leading_90360 = Boolarg_90026(Call_90013, ((NimStringDesc*) &TMP195853), 2, NIM_TRUE);
Trailing_90361 = 0;
Trailing_90361 = Boolarg_90026(Call_90013, ((NimStringDesc*) &TMP195854), 3, NIM_TRUE);
Result_90358 = Llstreamopen_75025(((NimStringDesc*) &TMP195850));
while (1) {
LOC2 = Llstreamatend_75071(Stdin_90011);
if (!!(LOC2)) goto LA1;
Line_90362 = 0;
Line_90362 = Llstreamreadline_75048(Stdin_90011);
Stripped_90363 = 0;
...
LA5: ;
if (!LOC4) goto LA6;
Llstreamwriteln_75067(Result_90358, Stripped_90363);
goto LA3;
LA6: ;
Llstreamwriteln_75067(Result_90358, Line_90362);
LA3: ;
} LA1: ;
Llstreamclose_75040(Stdin_90011);
return Result_90358;
}
N_NIMCALL(TY75013*, Filterreplace_90004)(TY75013* Stdin_90006, NimStringDesc* Filename_90007, TY55526* Call_90008) {
TY75013* Result_90373;
...
Result_90373 = 0;
Sub_90374 = 0;
Sub_90374 = Strarg_90020(Call_90008, ((NimStringDesc*) &TMP195855), 1, ((NimStringDesc*) &TMP195850));
if (!(Sub_90374->Sup.len == 0)) goto LA2;
Invalidpragma_90032(Call_90008);
LA2: ;
By_90379 = 0;
By_90379 = Strarg_90020(Call_90008, ((NimStringDesc*) &TMP195856), 2, ((NimStringDesc*) &TMP195850));
Result_90373 = Llstreamopen_75025(((NimStringDesc*) &TMP195850));
while (1) {
LOC5 = Llstreamatend_75071(Stdin_90006);
if (!!(LOC5)) goto LA4;
Line_90380 = 0;
Line_90380 = Llstreamreadline_75048(Stdin_90006);
LOC6 = 0;
LOC6 = nsuReplaceStr(Line_90380, Sub_90374, By_90379);
Llstreamwriteln_75067(Result_90373, LOC6);
} LA4: ;
Llstreamclose_75040(Stdin_90006);
return Result_90373;
}
