...
STRING_LITERAL(TMP196856, "startswith", 10);
STRING_LITERAL(TMP196857, "", 0);
STRING_LITERAL(TMP196858, "true", 4);
STRING_LITERAL(TMP196859, "false", 5);
STRING_LITERAL(TMP196860, "leading", 7);
STRING_LITERAL(TMP196861, "trailing", 8);
STRING_LITERAL(TMP196862, "sub", 3);
STRING_LITERAL(TMP196863, "by", 2);
N_NIMCALL(void, Invalidpragma_89032)(TY55525* N_89034) {
NimStringDesc* LOC1;
LOC1 = 0;
...
if (!(LOC4)) goto LA5;
LOC4 = Identeq_54028((*X_89301).KindU.S5.Ident, ((NimStringDesc*) &TMP196858));
LA5: ;
if (!LOC4) goto LA6;
...
if (!(LOC8)) goto LA9;
LOC8 = Identeq_54028((*X_89301).KindU.S5.Ident, ((NimStringDesc*) &TMP196859));
LA9: ;
if (!LOC8) goto LA10;
...
Result_89360 = 0;
Pattern_89361 = 0;
Pattern_89361 = Strarg_89020(Call_89013, ((NimStringDesc*) &TMP196856), 1, ((NimStringDesc*) &TMP196857));
Leading_89362 = 0;
Leading_89362 = Boolarg_89026(Call_89013, ((NimStringDesc*) &TMP196860), 2, NIM_TRUE);
Trailing_89363 = 0;
Trailing_89363 = Boolarg_89026(Call_89013, ((NimStringDesc*) &TMP196861), 3, NIM_TRUE);
Result_89360 = Llstreamopen_74025(((NimStringDesc*) &TMP196857));
while (1) {
...
Result_89376 = 0;
Sub_89377 = 0;
Sub_89377 = Strarg_89020(Call_89008, ((NimStringDesc*) &TMP196862), 1, ((NimStringDesc*) &TMP196857));
if (!(Sub_89377->Sup.len == 0)) goto LA2;
Invalidpragma_89032(Call_89008);
LA2: ;
By_89382 = 0;
By_89382 = Strarg_89020(Call_89008, ((NimStringDesc*) &TMP196863), 2, ((NimStringDesc*) &TMP196857));
Result_89376 = Llstreamopen_74025(((NimStringDesc*) &TMP196857));
while (1) {
