...
STRING_LITERAL(TMP196678, "Error: $1", 9);
STRING_LITERAL(TMP196679, "Warning: $1", 11);
STRING_LITERAL(TMP196680, "Hint: $1", 8);
STRING_LITERAL(TMP197256, "$1($2, $3) Checkpoint: ", 23);
...
goto BeforeRet;
LA6: ;
Frmt_48031 = copyString(((NimStringDesc*) &TMP196679));
Gwarncounter_47542 += 1;
break;
case ((NU8) 222) ... ((NU8) 234):
...
goto BeforeRet;
LA12: ;
Frmt_48031 = copyString(((NimStringDesc*) &TMP196680));
Ghintcounter_47541 += 1;
break;
default:
break;
...
LOC11 = 0;
LOC11 = nsuFormatOpenArray(((NimStringDesc*) &TMP197256), LOC10, 3);
...
Write_3658(F_47844, ((NimStringDesc*) &TMP198503));
}
