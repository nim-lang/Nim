...
STRING_LITERAL(TMP195708, "@", 1);
STRING_LITERAL(TMP195709, "\')\'", 3);
STRING_LITERAL(TMP195710, "\':\'", 3);
STRING_LITERAL(TMP195711, "@if", 3);
STRING_LITERAL(TMP195712, "@end", 4);
STRING_LITERAL(TMP195714, "-", 1);
STRING_LITERAL(TMP195715, "--", 2);
STRING_LITERAL(TMP195716, "", 0);
STRING_LITERAL(TMP195717, "\']\'", 3);
STRING_LITERAL(TMP195718, "&", 1);
STRING_LITERAL(TMP195720, "config", 6);
STRING_LITERAL(TMP195721, "/etc/", 5);
STRING_LITERAL(TMP195722, "nimrod.cfg", 10);
STRING_LITERAL(TMP195723, "cfg", 3);
...
goto LA4;
LA5: ;
Lexmessage_77326(&(*L_80061), ((NU8) 21), ((NimStringDesc*) &TMP195709));
LA4: ;
goto LA1;
LA2: ;
...
goto LA1;
LA2: ;
Lexmessage_77326(&(*L_80120), ((NU8) 21), ((NimStringDesc*) &TMP195710));
LA1: ;
return Result_80122;
}
N_NIMCALL(void, Doelse_80181)(TY77267* L_80184, TY77263* Tok_80185) {
if (!((Condstack_80133->Sup.len-1) < 0)) goto LA2;
Lexmessage_77326(&(*L_80184), ((NU8) 21), ((NimStringDesc*) &TMP195711));
LA2: ;
...
Res_80204 = 0;
if (!((Condstack_80133->Sup.len-1) < 0)) goto LA2;
Lexmessage_77326(&(*L_80202), ((NU8) 21), ((NimStringDesc*) &TMP195711));
LA2: ;
...
N_NIMCALL(void, Doend_80150)(TY77267* L_80153, TY77263* Tok_80154) {
if (!((Condstack_80133->Sup.len-1) < 0)) goto LA2;
Lexmessage_77326(&(*L_80153), ((NU8) 21), ((NimStringDesc*) &TMP195711));
LA2: ;
...
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*(*Tok_80179).Ident).S, ((NimStringDesc*) &TMP195708));
LA4: ;
if (!LOC3) goto LA5;
...
Lexmessage_77326(&(*L_80178), ((NU8) 21), ((NimStringDesc*) &TMP195712));
goto LA2;
LA24: ;
Ppgettok_80010(L_80178, Tok_80179);
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*(*Tok_80321).Ident).S, ((NimStringDesc*) &TMP195708));
LA3: ;
if (!LOC2) goto LA1;
...
LOC3 = 0;
LOC3 = Getident_54016(((NimStringDesc*) &TMP195714));
LOC2 = ((*(*Tok_80362).Ident).Sup.Id == (*LOC3).Sup.Id);
if (LOC2) goto LA4;
LOC5 = 0;
LOC5 = Getident_54016(((NimStringDesc*) &TMP195715));
...
Conftok_80317(L_80361, Tok_80362);
Val_80364 = copyString(((NimStringDesc*) &TMP195716));
while (1) {
...
goto LA14;
LA15: ;
Lexmessage_77326(&(*L_80361), ((NU8) 21), ((NimStringDesc*) &TMP195717));
LA14: ;
...
if (!(LOC27)) goto LA28;
LOC29 = 0;
LOC29 = Getident_54016(((NimStringDesc*) &TMP195718));
...
Lexmessage_77326(&L_80437, ((NU8) 21), ((NimStringDesc*) &TMP195712));
LA6: ;
...
LOC6[1] = copyString(((NimStringDesc*) &TMP195720));
...
appendString(LOC11, ((NimStringDesc*) &TMP195721));
...
LA4: ;
LA2: ;
Loadspecialconfig_80007(((NimStringDesc*) &TMP195722));
LOC10 = !(((Gglobaloptions_46079 &(1<<((((NU8) 17))&31)))!=0));
if (!(LOC10)) goto LA11;
LOC10 = !(((Project_80006) && (Project_80006)->Sup.len == 0));
LA11: ;
if (!LOC10) goto LA12;
Conffile_80520 = nosChangeFileExt(Project_80006, ((NimStringDesc*) &TMP195723));
