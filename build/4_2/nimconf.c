...
STRING_LITERAL(TMP193678, "/usr", 4);
STRING_LITERAL(TMP193679, "/usr/lib/nimrod", 15);
STRING_LITERAL(TMP193680, "/usr/local", 10);
STRING_LITERAL(TMP193681, "/usr/local/lib/nimrod", 21);
STRING_LITERAL(TMP193682, "lib", 3);
STRING_LITERAL(TMP193708, "@", 1);
STRING_LITERAL(TMP193709, "\')\'", 3);
STRING_LITERAL(TMP193710, "\':\'", 3);
STRING_LITERAL(TMP193711, "@if", 3);
STRING_LITERAL(TMP193712, "@end", 4);
STRING_LITERAL(TMP193714, "-", 1);
STRING_LITERAL(TMP193715, "--", 2);
STRING_LITERAL(TMP193716, "", 0);
STRING_LITERAL(TMP193717, "\']\'", 3);
STRING_LITERAL(TMP193718, "&", 1);
STRING_LITERAL(TMP193721, "config", 6);
STRING_LITERAL(TMP193722, "/etc/", 5);
STRING_LITERAL(TMP193723, "nimrod.cfg", 10);
STRING_LITERAL(TMP193724, "cfg", 3);
...
goto LA4;
LA5: ;
Lexmessage_73326(&(*L_76062), ((NU8) 21), ((NimStringDesc*) &TMP193709));
LA4: ;
goto LA1;
LA2: ;
...
goto LA1;
LA2: ;
Lexmessage_73326(&(*L_76123), ((NU8) 21), ((NimStringDesc*) &TMP193710));
LA1: ;
return Result_76125;
}
N_NIMCALL(void, Doelse_76182)(TY73267* L_76185, TY73263* Tok_76186) {
if (!((Condstack_76136->Sup.len-1) < 0)) goto LA2;
Lexmessage_73326(&(*L_76185), ((NU8) 21), ((NimStringDesc*) &TMP193711));
LA2: ;
...
Res_76203 = 0;
if (!((Condstack_76136->Sup.len-1) < 0)) goto LA2;
Lexmessage_73326(&(*L_76201), ((NU8) 21), ((NimStringDesc*) &TMP193711));
LA2: ;
...
N_NIMCALL(void, Doend_76153)(TY73267* L_76156, TY73263* Tok_76157) {
if (!((Condstack_76136->Sup.len-1) < 0)) goto LA2;
Lexmessage_73326(&(*L_76156), ((NU8) 21), ((NimStringDesc*) &TMP193711));
LA2: ;
...
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*(*Tok_76180).Ident).S, ((NimStringDesc*) &TMP193708));
LA4: ;
if (!LOC3) goto LA5;
...
Lexmessage_73326(&(*L_76179), ((NU8) 21), ((NimStringDesc*) &TMP193712));
goto LA2;
LA24: ;
Ppgettok_76010(L_76179, Tok_76180);
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*(*Tok_76333).Ident).S, ((NimStringDesc*) &TMP193708));
LA3: ;
if (!LOC2) goto LA1;
...
LOC3 = Getident_52016(((NimStringDesc*) &TMP193714));
LOC2 = ((*(*Tok_76375).Ident).Sup.Id == (*LOC3).Sup.Id);
if (LOC2) goto LA4;
LOC5 = Getident_52016(((NimStringDesc*) &TMP193715));
...
Conftok_76329(L_76374, Tok_76375);
Val_76377 = copyString(((NimStringDesc*) &TMP193716));
while (1) {
...
goto LA14;
LA15: ;
Lexmessage_73326(&(*L_76374), ((NU8) 21), ((NimStringDesc*) &TMP193717));
LA14: ;
...
if (!(LOC27)) goto LA28;
LOC29 = Getident_52016(((NimStringDesc*) &TMP193718));
...
Lexmessage_73326(&L_76450, ((NU8) 21), ((NimStringDesc*) &TMP193712));
LA6: ;
...
LOC6[1] = copyString(((NimStringDesc*) &TMP193721));
...
appendString(LOC11, ((NimStringDesc*) &TMP193722));
...
if (!eqStrings(Prefix_76541, ((NimStringDesc*) &TMP193678))) goto LA5;
asgnRefNoCycle((void**) &Libpath_44110, copyString(((NimStringDesc*) &TMP193679)));
goto LA4;
LA5: ;
if (!eqStrings(Prefix_76541, ((NimStringDesc*) &TMP193680))) goto LA7;
asgnRefNoCycle((void**) &Libpath_44110, copyString(((NimStringDesc*) &TMP193681)));
goto LA4;
LA7: ;
asgnRefNoCycle((void**) &Libpath_44110, nosJoinPath(Prefix_76541, ((NimStringDesc*) &TMP193682)));
LA4: ;
LA2: ;
Loadspecialconfig_76007(((NimStringDesc*) &TMP193723));
LOC10 = !(((Gglobaloptions_44077 &(1<<((((NU8) 17))&31)))!=0));
if (!(LOC10)) goto LA11;
LOC10 = !(((Project_76006) && (Project_76006)->Sup.len == 0));
LA11: ;
if (!LOC10) goto LA12;
Conffile_76540 = nosChangeFileExt(Project_76006, ((NimStringDesc*) &TMP193724));
