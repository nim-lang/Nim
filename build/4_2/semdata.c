...
STRING_LITERAL(TMP196104, "", 0);
STRING_LITERAL(TMP196122, "owner is nil", 12);
STRING_LITERAL(TMP196124, "popOwner", 8);
STRING_LITERAL(TMP196132, "makeVarType", 11);
STRING_LITERAL(TMP196206, "makePtrType", 11);
...
Limessage_47569((*Sym_107068).Info, ((NU8) 26), ((NimStringDesc*) &TMP196104));
LA2: ;
...
Internalerror_47578(((NimStringDesc*) &TMP196132));
LA2: ;
