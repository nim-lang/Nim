...
STRING_LITERAL(TMP197111, "", 0);
STRING_LITERAL(TMP197129, "owner is nil", 12);
STRING_LITERAL(TMP197131, "popOwner", 8);
STRING_LITERAL(TMP197139, "makeVarType", 11);
STRING_LITERAL(TMP197217, "makePtrType", 11);
...
Limessage_47562((*Sym_106068).Info, ((NU8) 26), ((NimStringDesc*) &TMP197111));
LA2: ;
...
Internalerror_47571(((NimStringDesc*) &TMP197139));
LA2: ;
