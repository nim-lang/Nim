...
STRING_LITERAL(TMP198222, "equalGenericParams", 18);
...
Internalerror_49208((*Proca_122016).Info, ((NimStringDesc*) &TMP198222));
LA17: ;
if (!!(((*(*Procb_122017).KindU.S6.Sons->data[I_122077]).Kind == ((NU8) 3)))) goto LA20;
Internalerror_49208((*Procb_122017).Info, ((NimStringDesc*) &TMP198222));
LA20: ;
