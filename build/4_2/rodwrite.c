...
N_NIMCALL(TY52008*, Encodenode_111298)(TY111004* W_111300, TY47538 Finfo_111301, TY55526* N_111302);
...
N_NIMCALL(TY52008*, Encodelib_111827)(TY111004* W_111829, TY55544* Lib_111830, TY47538 Info_111831);
...
STRING_LITERAL(TMP196813, "rodwrite: module ID not set", 27);
STRING_LITERAL(TMP196815, " ", 1);
STRING_LITERAL(TMP196816, "symStack: module nil: ", 22);
STRING_LITERAL(TMP196817, "\012", 1);
STRING_LITERAL(TMP196818, "$1 $2\012", 6);
STRING_LITERAL(TMP196819, "{}", 2);
STRING_LITERAL(TMP196820, "+$1", 3);
STRING_LITERAL(TMP196821, "&$1", 3);
STRING_LITERAL(TMP196822, "^$1", 3);
STRING_LITERAL(TMP196823, "?$1,$2,$3", 9);
STRING_LITERAL(TMP196824, "*$1", 3);
STRING_LITERAL(TMP196825, "$$$1", 4);
STRING_LITERAL(TMP196826, "@$1", 3);
STRING_LITERAL(TMP196827, "()", 2);
STRING_LITERAL(TMP196828, "(", 1);
STRING_LITERAL(TMP196829, "?$1,$2", 6);
STRING_LITERAL(TMP196830, "?$1", 3);
STRING_LITERAL(TMP196831, "!$1", 3);
STRING_LITERAL(TMP196832, ")", 1);
STRING_LITERAL(TMP196833, "%$1", 3);
STRING_LITERAL(TMP196834, "`$1", 3);
STRING_LITERAL(TMP196835, "<$1>", 4);
STRING_LITERAL(TMP196836, "|$1", 3);
STRING_LITERAL(TMP196837, "[]", 2);
STRING_LITERAL(TMP196838, "encodeType: tyForward", 21);
STRING_LITERAL(TMP196839, "/$1", 3);
STRING_LITERAL(TMP196840, "=$1", 3);
STRING_LITERAL(TMP196841, "^()", 3);
STRING_LITERAL(TMP196842, "NIM:", 4);
STRING_LITERAL(TMP196843, "1012", 4);
STRING_LITERAL(TMP196844, "ID:", 3);
STRING_LITERAL(TMP196845, "CRC:", 4);
STRING_LITERAL(TMP196846, "OPTIONS:", 8);
STRING_LITERAL(TMP196847, "DEFINES:", 8);
STRING_LITERAL(TMP196848, "FILES(\012", 7);
STRING_LITERAL(TMP196849, ")\012", 2);
STRING_LITERAL(TMP196850, "INCLUDES(\012", 10);
STRING_LITERAL(TMP196851, "DEPS:", 5);
STRING_LITERAL(TMP196852, "INTERF(\012", 8);
STRING_LITERAL(TMP196853, "COMPILERPROCS(\012", 15);
STRING_LITERAL(TMP196854, "INDEX(\012", 7);
STRING_LITERAL(TMP196855, "IMPORTS(\012", 9);
STRING_LITERAL(TMP196856, "CONVERTERS:", 11);
STRING_LITERAL(TMP196857, "INIT(\012", 6);
STRING_LITERAL(TMP196858, "DATA(\012", 6);
STRING_LITERAL(TMP196859, "rod", 3);
STRING_LITERAL(TMP196860, "rodwrite.process", 16);
TY55895 Debugwritten_112082;
...
Initiitable_60220(&(*Result_111148).Index.Tab);
Initiitable_60220(&(*Result_111148).Imports.Tab);
...
NI LOC2;
NI L_111285;
LOC2 = Iitableget_60224((*W_111271).Index.Tab, (*S_111272).Sup.Id);
if (!(LOC2 == (IL64(-9223372036854775807) - IL64(1)))) goto LA3;
L_111285 = 0;
L_111285 = (*W_111271).Sstack->Sup.len;
(*W_111271).Sstack = (TY55528*) setLengthSeq(&((*W_111271).Sstack)->Sup, sizeof(TY55548*), (NI64)(L_111285 + 1));
...
TY52008* LOC4;
TY176845 LOC5;
if (!((NI64)(Key_112070 - (*W_112069).Lastidxkey) == 1)) goto LA2;
LOC4 = 0;
LOC4 = Encodeint_93073(((NI64) ((NI64)(Val_112071 - (*W_112069).Lastidxval))));
App_52031(&(*W_112069).R, LOC4);
App_52036(&(*W_112069).R, ((NimStringDesc*) &TMP196817));
goto LA1;
LA2: ;
memset((void*)&LOC5, 0, sizeof(LOC5));
LOC5[0] = Encodeint_93073(((NI64) ((NI64)(Key_112070 - (*W_112069).Lastidxkey))));
LOC5[1] = Encodeint_93073(((NI64) ((NI64)(Val_112071 - (*W_112069).Lastidxval))));
Appf_52071(&(*W_112069).R, ((NimStringDesc*) &TMP196818), LOC5, 2);
LA1: ;
(*W_112069).Lastidxkey = Key_112070;
(*W_112069).Lastidxval = Val_112071;
Iitableput_60228(&(*W_112069).Tab, Key_112070, Val_112071);
}
N_NIMCALL(TY52008*, Encodestr_111048)(TY111004* W_111050, NimStringDesc* S_111051) {
...
NI LOC2;
NI L_111256;
LOC2 = Iitableget_60224((*W_111242).Index.Tab, (*T_111243).Sup.Id);
if (!(LOC2 == (IL64(-9223372036854775807) - IL64(1)))) goto LA3;
L_111256 = 0;
L_111256 = (*W_111242).Tstack->Sup.len;
(*W_111242).Tstack = (TY55550*) setLengthSeq(&((*W_111242).Tstack)->Sup, sizeof(TY55552*), (NI64)(L_111256 + 1));
...
(*W_111091).Files = (TY39221*) setLengthSeq(&((*W_111091).Files)->Sup, sizeof(NimStringDesc*), (NI64)(Result_111093 + 1));
...
Result_111303 = Torope_52046(((NimStringDesc*) &TMP196827));
goto BeforeRet;
LA2: ;
Result_111303 = Torope_52046(((NimStringDesc*) &TMP196828));
LOC4 = 0;
...
LOC9 = 0;
LOC9 = Tofilename_47718((*N_111302).Info);
LOC10 = Fileidx_111089(W_111300, LOC9);
LOC8[2] = Encodeint_93073(((NI64) (LOC10)));
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196823), LOC8, 3);
goto LA5;
LA6: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196829), LOC13, 2);
goto LA5;
LA11: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196830), LOC16, 1);
goto LA5;
LA14: ;
LA5: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196831), LOC28, 1);
LA26: ;
break;
case ((NU8) 11) ... ((NU8) 13):
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196831), LOC32, 1);
LA30: ;
break;
case ((NU8) 14) ... ((NU8) 16):
...
App_52036(&Result_111303, ((NimStringDesc*) &TMP196832));
BeforeRet: ;
...
Appf_52071(&Result_111552, ((NimStringDesc*) &TMP196824), LOC8, 1);
LA6: ;
if (!!(((*Loc_111551).Flags == 0))) goto LA10;
memset((void*)&LOC12, 0, sizeof(LOC12));
LOC12[0] = Encodeint_93073(((NI64) (((int) ((*Loc_111551).Flags)))));
Appf_52071(&Result_111552, ((NimStringDesc*) &TMP196825), LOC12, 1);
LA10: ;
if (!!(((*Loc_111551).T == NIM_NIL))) goto LA14;
memset((void*)&LOC16, 0, sizeof(LOC16));
LOC16[0] = Encodeint_93073(((NI64) ((*(*Loc_111551).T).Sup.Id)));
Appf_52071(&Result_111552, ((NimStringDesc*) &TMP196822), LOC16, 1);
...
Appf_52071(&Result_111832, ((NimStringDesc*) &TMP196836), LOC1, 1);
memset((void*)&LOC2, 0, sizeof(LOC2));
LOC3 = 0;
LOC3 = Ropetostr_52063((*Lib_111830).Name);
LOC2[0] = Encodestr_111048(W_111829, LOC3);
Appf_52071(&Result_111832, ((NimStringDesc*) &TMP196836), LOC2, 1);
memset((void*)&LOC4, 0, sizeof(LOC4));
LOC4[0] = Encodenode_111298(W_111829, Info_111831, (*Lib_111830).Path);
Appf_52071(&Result_111832, ((NimStringDesc*) &TMP196836), LOC4, 1);
...
Result_111857 = Torope_52046(((NimStringDesc*) &TMP196819));
goto BeforeRet;
LA2: ;
...
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196820), LOC5, 1);
memset((void*)&LOC6, 0, sizeof(LOC6));
LOC6[0] = Encodestr_111048(W_111855, (*(*S_111856).Name).S);
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196821), LOC6, 1);
if (!!(((*S_111856).Typ == NIM_NIL))) goto LA8;
memset((void*)&LOC10, 0, sizeof(LOC10));
LOC10[0] = Encodeint_93073(((NI64) ((*(*S_111856).Typ).Sup.Id)));
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196822), LOC10, 1);
...
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196825), LOC27, 1);
LA25: ;
if (!!(((*S_111856).Magic == ((NU8) 0)))) goto LA29;
memset((void*)&LOC31, 0, sizeof(LOC31));
LOC31[0] = Encodeint_93073(((NI64) ((*S_111856).Magic)));
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196826), LOC31, 1);
LA29: ;
if (!!(((*S_111856).Ast == NIM_NIL))) goto LA33;
LOC36 = Astneeded_105057(S_111856);
if (!!(LOC36)) goto LA37;
...
LOC3 = Iitableget_60224((*W_112085).Index.Tab, (*S_112088).Sup.Id);
if (!(LOC3 == (IL64(-9223372036854775807) - IL64(1)))) goto LA4;
M_112089 = Getmodule_60198(S_112088);
if (!(M_112089 == NIM_NIL)) goto LA7;
LOC9 = 0;
LOC9 = rawNewString((*(*S_112088).Name).S->Sup.len + 22);
appendString(LOC9, ((NimStringDesc*) &TMP196816));
...
App_52036(&(*W_112085).Data, ((NimStringDesc*) &TMP196817));
...
Appf_52071(&(*W_112085).Interf, ((NimStringDesc*) &TMP196818), LOC19, 2);
LA17: ;
...
Appf_52071(&(*W_112085).Compilerprocs, ((NimStringDesc*) &TMP196818), LOC23, 2);
LA21: ;
if (!((*S_112088).Kind == ((NU8) 13))) goto LA25;
if (!!(((*W_112085).Converters == NIM_NIL))) goto LA28;
App_52036(&(*W_112085).Converters, ((NimStringDesc*) &TMP196815));
LA28: ;
LOC30 = 0;
...
goto LA10;
LA13: ;
LOC31 = Iitableget_60224((*W_112085).Imports.Tab, (*S_112088).Sup.Id);
...
Result_111663 = Torope_52046(((NimStringDesc*) &TMP196837));
goto BeforeRet;
LA2: ;
Result_111663 = NIM_NIL;
if (!((*T_111662).Kind == ((NU8) 30))) goto LA5;
Internalerror_48163(((NimStringDesc*) &TMP196838));
LA5: ;
LOC7 = 0;
...
Appf_52071(&Result_111663, ((NimStringDesc*) &TMP196820), LOC8, 1);
if (!!(((*T_111662).N == NIM_NIL))) goto LA10;
LOC12 = Unknownlineinfo_47575();
LOC13 = 0;
...
App_52036(&Result_111663, ((NimStringDesc*) &TMP196841));
goto LA45;
LA46: ;
memset((void*)&LOC48, 0, sizeof(LOC48));
LOC48[0] = Encodeint_93073(((NI64) ((*(*T_111662).Sons->data[I_111806]).Sup.Id)));
Appf_52071(&Result_111663, ((NimStringDesc*) &TMP196822), LOC48, 1);
...
LOC3 = Iitableget_60224((*W_112216).Index.Tab, (*(*W_112216).Tstack->data[I_112217]).Sup.Id);
if (!(LOC3 == (IL64(-9223372036854775807) - IL64(1)))) goto LA4;
L_112234 = 0;
...
App_52036(&(*W_112216).Data, ((NimStringDesc*) &TMP196817));
LA4: ;
I_112217 += 1;
} LA1: ;
...
Internalerror_48163(((NimStringDesc*) &TMP196813));
LA2: ;
W_112836 = 0;
...
Content_112347 = 0;
Content_112347 = Torope_52046(((NimStringDesc*) &TMP196842));
LOC1 = 0;
LOC1 = Torope_52046(((NimStringDesc*) &TMP196843));
App_52031(&Content_112347, LOC1);
App_52036(&Content_112347, ((NimStringDesc*) &TMP196817));
LOC2 = 0;
LOC2 = Torope_52046(((NimStringDesc*) &TMP196844));
...
App_52036(&Content_112347, ((NimStringDesc*) &TMP196817));
LOC4 = 0;
LOC4 = Torope_52046(((NimStringDesc*) &TMP196845));
...
App_52036(&Content_112347, ((NimStringDesc*) &TMP196817));
LOC6 = 0;
LOC6 = Torope_52046(((NimStringDesc*) &TMP196846));
...
App_52036(&Content_112347, ((NimStringDesc*) &TMP196817));
LOC8 = 0;
LOC8 = Torope_52046(((NimStringDesc*) &TMP196847));
App_52031(&Content_112347, LOC8);
App_52031(&Content_112347, (*W_111047).Defines);
App_52036(&Content_112347, ((NimStringDesc*) &TMP196817));
LOC9 = 0;
LOC9 = Torope_52046(((NimStringDesc*) &TMP196848));
...
App_52036(&(*W_111031).Moddeps, ((NimStringDesc*) &TMP196815));
LA2: ;
...
App_52036(&(*W_111043).Init, ((NimStringDesc*) &TMP196817));
LOC3 = Unknownlineinfo_47575();
LOC4 = 0;
LOC4 = Encodenode_111298(W_111043, LOC3, N_111044);
App_52031(&(*W_111043).Data, LOC4);
App_52036(&(*W_111043).Data, ((NimStringDesc*) &TMP196817));
...
App_52036(&(*W_111035).Incldeps, ((NimStringDesc*) &TMP196815));
LOC3 = Crcfromfile_50029(Dep_111036);
LOC4 = 0;
LOC4 = Encodeint_93073(((NI64) (LOC3)));
App_52031(&(*W_111035).Incldeps, LOC4);
App_52036(&(*W_111035).Incldeps, ((NimStringDesc*) &TMP196817));
}
N_NIMCALL(TY55526*, Process_112405)(TY105002* C_112407, TY55526* N_112408) {
...
Internalerror_48159((*N_112408).Info, ((NimStringDesc*) &TMP196860));
LA8: ;
...
Internalerror_48159((*A_112568).Info, ((NimStringDesc*) &TMP196860));
LA24: ;
...
Internalerror_48159((*A_112632).Info, ((NimStringDesc*) &TMP196860));
LA33: ;
...
Internalerror_48159((*A_112696).Info, ((NimStringDesc*) &TMP196860));
LA42: ;
S_112751 = 0;
...
Intsetinit_55919(&Debugwritten_112082);
}
