...
STRING_LITERAL(TMP194299, "c\"", 2);
STRING_LITERAL(TMP194300, "\\00\"", 4);
STRING_LITERAL(TMP194302, "\"", 1);
STRING_LITERAL(TMP194303, "\012", 1);
...
Res_154226 = copyString(((NimStringDesc*) &TMP194299));
I_154236 = 0;
HEX3Atmp_154247 = 0;
...
appendString(Res_154226, ((NimStringDesc*) &TMP194300));
...
Res_154200 = copyString(((NimStringDesc*) &TMP194302));
I_154210 = 0;
HEX3Atmp_154216 = 0;
...
appendString(Res_154200, ((NimStringDesc*) &TMP194303));
