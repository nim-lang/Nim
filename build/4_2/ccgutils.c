...
STRING_LITERAL(TMP197308, "c\"", 2);
STRING_LITERAL(TMP197309, "\\00\"", 4);
STRING_LITERAL(TMP197311, "\"", 1);
STRING_LITERAL(TMP197312, "\012", 1);
...
Res_157226 = copyString(((NimStringDesc*) &TMP197308));
I_157236 = 0;
HEX3Atmp_157247 = 0;
HEX3Atmp_157247 = (NI64)((NI64)(S_157015->Sup.len + 0) - 1);
Res_157249 = 0;
Res_157249 = 0;
while (1) {
if (!(Res_157249 <= HEX3Atmp_157247)) goto LA1;
I_157236 = Res_157249;
if (!((NI64)((NI64)((NI64)(I_157236 - 0) + 1) % 64) == 0)) goto LA3;
LOC5 = 0;
...
appendString(Res_157226, ((NimStringDesc*) &TMP197309));
LOC7 = 0;
...
Res_157200 = copyString(((NimStringDesc*) &TMP197311));
I_157210 = 0;
HEX3Atmp_157216 = 0;
HEX3Atmp_157216 = (NI64)((NI64)(S_157012->Sup.len + 0) - 1);
Res_157218 = 0;
Res_157218 = 0;
while (1) {
if (!(Res_157218 <= HEX3Atmp_157216)) goto LA1;
I_157210 = Res_157218;
if (!((NI64)((NI64)((NI64)(I_157210 - 0) + 1) % 64) == 0)) goto LA3;
Res_157200 = addChar(Res_157200, 34);
Res_157200 = resizeString(Res_157200, 1);
appendString(Res_157200, ((NimStringDesc*) &TMP197312));
LOC5 = 0;
