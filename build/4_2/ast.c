...
STRING_LITERAL(TMP193889, "ID already used: ", 17);
STRING_LITERAL(TMP193951, "leValue", 7);
STRING_LITERAL(TMP193952, "SameValue", 9);
STRING_LITERAL(TMP193968, "getInt", 6);
STRING_LITERAL(TMP193969, "getFloat", 8);
STRING_LITERAL(TMP193970, "getStr", 6);
STRING_LITERAL(TMP193972, "getStrOrChar", 12);
STRING_LITERAL(TMP194039, "valueToString", 13);
NI Gid_53690;
...
Gid_53690 = ((Gid_53690 >= (NI64)(Id_53695 + 1)) ? Gid_53690 : (NI64)(Id_53695 + 1));
}
...
Result_55699 = (*N_53809).KindU.S6.Sons->data[(NI64)(LOC1 - 1)];
return Result_55699;
}
N_NIMCALL(NI, Getid_53691)(void) {
NI Result_53954;
...
NI Result_56066;
Result_56066 = 0;
Result_56066 = (NI64)((NI64)((NI64)(5 * H_56064) + 1) & Maxhash_56065);
return Result_56066;
}
N_NIMCALL(TY53894*, Intsetget_56083)(TY53898* T_56085, NI Key_56086) {
...
Result_56087 = 0;
H_56088 = 0;
H_56088 = (NI64)(Key_56086 & (*T_56085).Max);
while (1) {
...
NIM_BOOL LOC1;
Result_56055 = 0;
LOC1 = ((NI64)(Length_56053 * 2) < (NI64)(Counter_56054 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI64)(Length_56053 - Counter_56054) < 4);
LA2: ;
Result_56055 = LOC1;
return Result_56055;
}
...
NI H_56109;
H_56109 = 0;
H_56109 = (NI64)((*Desc_56108).Key & (*T_56105).Max);
while (1) {
...
(*T_56145).Max = (NI64)((NI64)((NI64)((*T_56145).Max + 1) * 2) - 1);
N_56146 = (TY53896*) newSeq(NTI53896, (NI64)((*T_56145).Max + 1));
I_56167 = 0;
Res_56191 = 0;
Res_56191 = 0;
while (1) {
...
Result_56199 = 0;
H_56200 = 0;
H_56200 = (NI64)(Key_56198 & (*T_56197).Max);
while (1) {
...
LOC6 = Mustrehash_56051((NI64)((*T_56197).Max + 1), (*T_56197).Counter);
if (!LOC6) goto LA7;
...
U_56290 = 0;
T_56291 = 0;
T_56291 = Intsetput_56194(S_53915, (NI64)((NU64)(Key_53916) >> (NU64)(9)));
U_56290 = (NI64)(Key_53916 & 511);
(*T_56291).Bits[((NI64)((NU64)(U_56290) >> (NU64)(6)))-0] = (NI64)((*T_56291).Bits[((NI64)((NU64)(U_56290) >> (NU64)(6)))-0] | (NI64)((NU64)(1) << (NU64)((NI64)(U_56290 & 63))));
}
N_NIMCALL(NIM_BOOL, Intsetcontainsorincl_53926)(TY53898* S_53929, NI Key_53930) {
...
U_56316 = 0;
T_56317 = 0;
T_56317 = Intsetget_56083(&(*S_53929), (NI64)((NU64)(Key_53930) >> (NU64)(9)));
if (!!((T_56317 == NIM_NIL))) goto LA2;
U_56316 = (NI64)(Key_53930 & 511);
Result_56315 = !(((NI64)((*T_56317).Bits[((NI64)((NU64)(U_56316) >> (NU64)(6)))-0] & (NI64)((NU64)(1) << (NU64)((NI64)(U_56316 & 63)))) == 0));
if (!!(Result_56315)) goto LA5;
(*T_56317).Bits[((NI64)((NU64)(U_56316) >> (NU64)(6)))-0] = (NI64)((*T_56317).Bits[((NI64)((NU64)(U_56316) >> (NU64)(6)))-0] | (NI64)((NU64)(1) << (NU64)((NI64)(U_56316 & 63))));
LA5: ;
goto LA1;
LA2: ;
...
appendString(LOC9, ((NimStringDesc*) &TMP193889));
...
Gid_53690 = (NI64)((NI64)((NI64)((NI64)(Gid_53690 / Idrange_53698) + 1) * Idrange_53698) + 1);
}
...
U_56270 = 0;
T_56271 = 0;
T_56271 = Intsetget_56083(S_53910, (NI64)((NU64)(Key_53911) >> (NU64)(9)));
if (!!((T_56271 == NIM_NIL))) goto LA2;
U_56270 = (NI64)(Key_53911 & 511);
Result_56269 = !(((NI64)((*T_56271).Bits[((NI64)((NU64)(U_56270) >> (NU64)(6)))-0] & (NI64)((NU64)(1) << (NU64)((NI64)(U_56270 & 63)))) == 0));
goto LA1;
LA2: ;
...
LA2: ;
(*Father_53815).KindU.S6.Sons = (TY53517*) setLengthSeq(&((*Father_53815).KindU.S6.Sons)->Sup, sizeof(TY53523*), (NI64)((*Father_53815).KindU.S6.Sons->Sup.len + Length_53816));
}
N_NIMCALL(TY53523*, Copytree_53856)(TY53523* Src_53858) {
...
Result_55715 = (*N_53812).Sons->data[(NI64)(LOC1 - 1)];
return Result_55715;
}
N_NIMCALL(TY53523*, Newintnode_53711)(NU8 Kind_53713, NI64 Intval_53714) {
...
break;
default:
Internalerror_45567((*A_53870).Info, ((NimStringDesc*) &TMP193951));
break;
}
return Result_53979;
}
...
break;
default:
Internalerror_45567((*A_53866).Info, ((NimStringDesc*) &TMP193952));
break;
}
return Result_54094;
}
...
I_55301 = 0;
HEX3Atmp_55351 = 0;
HEX3Atmp_55351 = (NI64)(Length_55293 - 2);
Res_55353 = 0;
Res_55353 = Idx_53836;
while (1) {
if (!(Res_55353 <= HEX3Atmp_55351)) goto LA4;
I_55301 = Res_55353;
asgnRefNoCycle((void**) &(*Father_53835).KindU.S6.Sons->data[I_55301], (*Father_53835).KindU.S6.Sons->data[(NI64)(I_55301 + 1)]);
Res_55353 += 1;
} LA4: ;
(*Father_53835).KindU.S6.Sons = (TY53517*) setLengthSeq(&((*Father_53835).KindU.S6.Sons)->Sup, sizeof(TY53523*), (NI64)(Length_55293 - 1));
BeforeRet: ;
}
...
break;
default:
Internalerror_45567((*A_55973).Info, ((NimStringDesc*) &TMP193968));
Result_55974 = 0;
break;
}
return Result_55974;
...
break;
default:
Internalerror_45567((*A_55989).Info, ((NimStringDesc*) &TMP193969));
...
break;
default:
Internalerror_45567((*A_56005).Info, ((NimStringDesc*) &TMP193970));
...
break;
default:
Internalerror_45567((*A_56021).Info, ((NimStringDesc*) &TMP193972));
...
break;
default:
Internalerror_45567((*A_53874).Info, ((NimStringDesc*) &TMP194039));
...
LA2: ;
(*Father_53819).Sons = (TY53547*) setLengthSeq(&((*Father_53819).Sons)->Sup, sizeof(TY53549*), (NI64)((*Father_53819).Sons->Sup.len + Length_53820));
}
N_NIMCALL(void, Assigntype_53777)(TY53549* Dest_53779, TY53549* Src_53780) {
NI LOC1;
NI I_54624;
...
U_56297 = 0;
T_56298 = 0;
T_56298 = Intsetget_56083(&(*S_53920), (NI64)((NU64)(Key_53921) >> (NU64)(9)));
if (!!((T_56298 == NIM_NIL))) goto LA2;
U_56297 = (NI64)(Key_53921 & 511);
(*T_56298).Bits[((NI64)((NU64)(U_56297) >> (NU64)(6)))-0] = (NI64)((*T_56298).Bits[((NI64)((NU64)(U_56297) >> (NU64)(6)))-0] & (NI64)((NU64) ~((NI64)((NU64)(1) << (NU64)((NI64)(U_56297 & 63))))));
LA2: ;
}
