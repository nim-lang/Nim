...
STRING_LITERAL(TMP196041, "int", 3);
STRING_LITERAL(TMP196042, "int8", 4);
STRING_LITERAL(TMP196043, "int16", 5);
STRING_LITERAL(TMP196044, "int32", 5);
STRING_LITERAL(TMP196045, "int64", 5);
STRING_LITERAL(TMP196046, "float", 5);
STRING_LITERAL(TMP196047, "float32", 7);
STRING_LITERAL(TMP196048, "float64", 7);
STRING_LITERAL(TMP196049, "bool", 4);
STRING_LITERAL(TMP196050, "char", 4);
STRING_LITERAL(TMP196051, "string", 6);
STRING_LITERAL(TMP196052, "cstring", 7);
STRING_LITERAL(TMP196053, "pointer", 7);
STRING_LITERAL(TMP196054, "request for typekind: ", 22);
STRING_LITERAL(TMP196055, "wanted: ", 8);
STRING_LITERAL(TMP196056, " got: ", 6);
STRING_LITERAL(TMP196057, "type not found: ", 16);
...
break;
case ((NU8) 26):
Result_102080 = Systypefromname_102073(((NimStringDesc*) &TMP196053));
break;
case ((NU8) 5):
...
appendString(LOC4, ((NimStringDesc*) &TMP196054));
...
appendString(LOC8, ((NimStringDesc*) &TMP196056));
...
appendString(LOC12, ((NimStringDesc*) &TMP196057));
