...
STRING_LITERAL(TMP196987, "int", 3);
STRING_LITERAL(TMP196988, "int8", 4);
STRING_LITERAL(TMP196989, "int16", 5);
STRING_LITERAL(TMP196990, "int32", 5);
STRING_LITERAL(TMP196991, "int64", 5);
STRING_LITERAL(TMP196992, "float", 5);
STRING_LITERAL(TMP196993, "float32", 7);
STRING_LITERAL(TMP196994, "float64", 7);
STRING_LITERAL(TMP196995, "bool", 4);
STRING_LITERAL(TMP196996, "char", 4);
STRING_LITERAL(TMP196997, "string", 6);
STRING_LITERAL(TMP196998, "cstring", 7);
STRING_LITERAL(TMP196999, "pointer", 7);
STRING_LITERAL(TMP197000, "request for typekind: ", 22);
STRING_LITERAL(TMP197001, "wanted: ", 8);
STRING_LITERAL(TMP197002, " got: ", 6);
STRING_LITERAL(TMP197003, "type not found: ", 16);
...
break;
case ((NU8) 29):
Result_101080 = Systypefromname_101073(((NimStringDesc*) &TMP196998));
break;
case ((NU8) 26):
Result_101080 = Systypefromname_101073(((NimStringDesc*) &TMP196999));
break;
case ((NU8) 5):
...
appendString(LOC4, ((NimStringDesc*) &TMP197000));
...
appendString(LOC8, ((NimStringDesc*) &TMP197001));
appendString(LOC8, reprEnum(Kind_101010, NTI55162));
appendString(LOC8, ((NimStringDesc*) &TMP197002));
...
appendString(LOC12, ((NimStringDesc*) &TMP197003));
