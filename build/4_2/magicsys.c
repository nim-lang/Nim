...
STRING_LITERAL(TMP195980, "int", 3);
STRING_LITERAL(TMP195981, "int8", 4);
STRING_LITERAL(TMP195982, "int16", 5);
STRING_LITERAL(TMP195983, "int32", 5);
STRING_LITERAL(TMP195984, "int64", 5);
STRING_LITERAL(TMP195985, "float", 5);
STRING_LITERAL(TMP195986, "float32", 7);
STRING_LITERAL(TMP195987, "float64", 7);
STRING_LITERAL(TMP195988, "bool", 4);
STRING_LITERAL(TMP195989, "char", 4);
STRING_LITERAL(TMP195990, "string", 6);
STRING_LITERAL(TMP195991, "cstring", 7);
STRING_LITERAL(TMP195992, "pointer", 7);
STRING_LITERAL(TMP195993, "request for typekind: ", 22);
STRING_LITERAL(TMP195994, "wanted: ", 8);
STRING_LITERAL(TMP195995, " got: ", 6);
STRING_LITERAL(TMP195996, "type not found: ", 16);
...
break;
case ((NU8) 26):
Result_102080 = Systypefromname_102073(((NimStringDesc*) &TMP195992));
break;
case ((NU8) 5):
...
appendString(LOC4, ((NimStringDesc*) &TMP195993));
...
appendString(LOC8, ((NimStringDesc*) &TMP195995));
...
appendString(LOC12, ((NimStringDesc*) &TMP195996));
