...
0}
;
STRING_LITERAL(TMP195740, "", 0);
STRING_LITERAL(TMP195741, "\012", 1);
STRING_LITERAL(TMP195742, "\"", 1);
STRING_LITERAL(TMP195743, "\\0", 2);
STRING_LITERAL(TMP195744, "\\x", 2);
STRING_LITERAL(TMP195746, "r\"", 2);
STRING_LITERAL(TMP195747, "\"\"", 2);
STRING_LITERAL(TMP195748, "\"\"\"", 3);
STRING_LITERAL(TMP195749, "0b", 2);
STRING_LITERAL(TMP195750, "0o", 2);
STRING_LITERAL(TMP195751, "0x", 2);
STRING_LITERAL(TMP195752, "\'i8", 3);
STRING_LITERAL(TMP195753, "\'i16", 4);
STRING_LITERAL(TMP195754, "\'i32", 4);
STRING_LITERAL(TMP195755, "\'i64", 4);
STRING_LITERAL(TMP195756, "\'f32", 4);
STRING_LITERAL(TMP195757, "\'f64", 4);
STRING_LITERAL(TMP195758, "nil", 3);
STRING_LITERAL(TMP195759, "[type node]", 11);
STRING_LITERAL(TMP195760, "rnimsyn.atom ", 13);
STRING_LITERAL(TMP195762, "(", 1);
STRING_LITERAL(TMP195763, " ", 1);
STRING_LITERAL(TMP195764, ",", 1);
STRING_LITERAL(TMP195765, "##", 2);
STRING_LITERAL(TMP195766, ")", 1);
STRING_LITERAL(TMP195767, "cast", 4);
STRING_LITERAL(TMP195768, "[", 1);
STRING_LITERAL(TMP195769, "]", 1);
STRING_LITERAL(TMP195770, "addr", 4);
STRING_LITERAL(TMP195771, "=", 1);
STRING_LITERAL(TMP195772, "chckRangeF", 10);
STRING_LITERAL(TMP195773, "chckRange64", 11);
STRING_LITERAL(TMP195774, "chckRange", 9);
STRING_LITERAL(TMP195775, "|", 1);
STRING_LITERAL(TMP195776, "{", 1);
STRING_LITERAL(TMP195777, "}", 1);
STRING_LITERAL(TMP195778, ".", 1);
STRING_LITERAL(TMP195779, "bind", 4);
STRING_LITERAL(TMP195780, "lambda", 6);
STRING_LITERAL(TMP195781, ":", 1);
STRING_LITERAL(TMP195782, "..", 2);
STRING_LITERAL(TMP195783, "^", 1);
STRING_LITERAL(TMP195784, "`", 1);
STRING_LITERAL(TMP195785, "if", 2);
NIM_CONST TY86848 TMP195786 = {0,
0}
;
STRING_LITERAL(TMP195787, " elif", 5);
STRING_LITERAL(TMP195788, " else", 5);
STRING_LITERAL(TMP195789, "type", 4);
STRING_LITERAL(TMP195790, "ref", 3);
STRING_LITERAL(TMP195791, "ptr", 3);
STRING_LITERAL(TMP195792, "var", 3);
STRING_LITERAL(TMP195793, "distinct", 8);
STRING_LITERAL(TMP195794, "object", 6);
STRING_LITERAL(TMP195795, "of", 2);
STRING_LITERAL(TMP195796, "proc", 4);
STRING_LITERAL(TMP195797, "enum", 4);
STRING_LITERAL(TMP195798, "when", 4);
STRING_LITERAL(TMP195799, "while", 5);
STRING_LITERAL(TMP195800, "case", 4);
STRING_LITERAL(TMP195801, "try", 3);
STRING_LITERAL(TMP195802, "for", 3);
STRING_LITERAL(TMP195803, "in", 2);
STRING_LITERAL(TMP195804, "block", 5);
STRING_LITERAL(TMP195805, "asm", 3);
STRING_LITERAL(TMP195806, "method", 6);
STRING_LITERAL(TMP195807, "iterator", 8);
STRING_LITERAL(TMP195808, "macro", 5);
STRING_LITERAL(TMP195809, "template", 8);
STRING_LITERAL(TMP195810, "const", 5);
STRING_LITERAL(TMP195811, "return", 6);
STRING_LITERAL(TMP195812, "raise", 5);
STRING_LITERAL(TMP195813, "yield", 5);
STRING_LITERAL(TMP195814, "discard", 7);
STRING_LITERAL(TMP195815, "break", 5);
STRING_LITERAL(TMP195816, "continue", 8);
STRING_LITERAL(TMP195817, "{.", 2);
STRING_LITERAL(TMP195818, ".}", 2);
STRING_LITERAL(TMP195819, "import", 6);
STRING_LITERAL(TMP195820, "from", 4);
STRING_LITERAL(TMP195821, "include", 7);
STRING_LITERAL(TMP195822, "elif", 4);
STRING_LITERAL(TMP195823, "else", 4);
STRING_LITERAL(TMP195824, "finally", 7);
STRING_LITERAL(TMP195825, "except", 6);
STRING_LITERAL(TMP195826, "tuple", 5);
STRING_LITERAL(TMP195827, "rnimsyn.gsub(", 13);
...
(*G_85071).Pos = 0;
(*G_85071).Idx = 0;
unsureAsgnRef((void**) &(*G_85071).Buf, copyString(((NimStringDesc*) &TMP195740)));
...
Str_85522 = 0;
Str_85522 = copyString(((NimStringDesc*) &TMP195740));
while (1) {
...
switch (((NU8)(C_85259))) {
case 0:
Result_85260 = copyString(((NimStringDesc*) &TMP195743));
break;
case 1 ... 31:
case 128 ... 255:
LOC1 = 0;
...
appendString(LOC1, ((NimStringDesc*) &TMP195744));
...
NimStringDesc* LOC2;
Result_85269 = 0;
Result_85269 = copyString(((NimStringDesc*) &TMP195742));
I_85295 = 0;
HEX3Atmp_85296 = 0;
...
appendString(LOC4, ((NimStringDesc*) &TMP195749));
appendString(LOC4, LOC5);
Result_85765 = LOC4;
goto LA1;
LA2: ;
...
appendString(LOC8, ((NimStringDesc*) &TMP195750));
...
appendString(LOC12, ((NimStringDesc*) &TMP195751));
...
switch ((*N_85803).Kind) {
case ((NU8) 1):
Result_85804 = copyString(((NimStringDesc*) &TMP195740));
break;
case ((NU8) 2):
...
LOC1 = 0;
LOC2 = 0;
LOC2 = nsuReplaceStr((*N_85803).KindU.S3.Strval, ((NimStringDesc*) &TMP195742), ((NimStringDesc*) &TMP195747));
...
appendString(LOC3, ((NimStringDesc*) &TMP195748));
...
appendString(LOC6, ((NimStringDesc*) &TMP195752));
Result_85804 = LOC6;
break;
case ((NU8) 8):
LOC8 = 0;
...
appendString(LOC10, ((NimStringDesc*) &TMP195754));
Result_85804 = LOC10;
break;
case ((NU8) 10):
LOC12 = 0;
...
appendString(LOC12, LOC13);
appendString(LOC12, ((NimStringDesc*) &TMP195755));
Result_85804 = LOC12;
break;
case ((NU8) 11):
...
appendString(LOC20, ((NimStringDesc*) &TMP195756));
Result_85804 = LOC20;
goto LA17;
LA18: ;
...
appendString(LOC22, ((NimStringDesc*) &TMP195756));
Result_85804 = LOC22;
LA17: ;
break;
case ((NU8) 13):
...
appendString(LOC27, ((NimStringDesc*) &TMP195757));
Result_85804 = LOC27;
goto LA24;
LA25: ;
LOC29 = 0;
...
appendString(LOC29, ((NimStringDesc*) &TMP195757));
Result_85804 = LOC29;
LA24: ;
break;
case ((NU8) 18):
...
appendString(LOC36, ((NimStringDesc*) &TMP195760));
...
goto LA7;
LA10: ;
T_87867 = ((NU8) ((NI64)((*(*N_87866).KindU.S5.Ident).Sup.Id + 2)));
LA7: ;
goto LA4;
LA5: ;
T_87867 = ((NU8) 2);
...
Result_86238 = (NI64)((NI64)(LOC13 + LOC14) + 2);
break;
case ((NU8) 47):
case ((NU8) 48):
case ((NU8) 49):
...
Result_86238 = (NI64)((NI64)(LOC16 + LOC17) + 8);
break;
case ((NU8) 52):
LOC18 = Lsub_85757((*N_85759).KindU.S6.Sons->data[0]);
Result_86238 = (NI64)(LOC18 + 6);
break;
case ((NU8) 53):
case ((NU8) 54):
...
Result_86238 = (NI64)((NI64)(LOC19 + LOC20) + 1);
break;
case ((NU8) 23):
case ((NU8) 63):
case ((NU8) 64):
LOC21 = Lsons_86189(N_85759, 0, -1);
Result_86238 = (NI64)(LOC21 + 3);
break;
case ((NU8) 30):
case ((NU8) 31):
case ((NU8) 32):
LOC22 = Lcomma_86115(N_85759, 0, -1);
Result_86238 = (NI64)(LOC22 + 2);
break;
case ((NU8) 46):
LOC23 = Lsons_86189(N_85759, 0, -1);
LOC24 = Sonslen_55804(N_85759);
Result_86238 = (NI64)((NI64)((NI64)(LOC23 + 2) + LOC24) - 1);
break;
case ((NU8) 112):
LOC25 = Lcomma_86115(N_85759, 0, -1);
Result_86238 = (NI64)(LOC25 + 7);
break;
case ((NU8) 36):
LOC26 = Lsons_86189(N_85759, 0, -1);
Result_86238 = (NI64)(LOC26 + 1);
break;
case ((NU8) 45):
LOC27 = Lsons_86189(N_85759, 0, -1);
Result_86238 = (NI64)(LOC27 + 5);
break;
case ((NU8) 37):
Result_86238 = Lsub_85757((*N_85759).KindU.S6.Sons->data[0]);
break;
...
if (!!(((*N_85759).KindU.S6.Sons->data[(NI64)(L_86380 - 2)] == NIM_NIL))) goto LA30;
LOC32 = Lsub_85757((*N_85759).KindU.S6.Sons->data[(NI64)(L_86380 - 2)]);
Result_86238 = (NI64)((NI64)(Result_86238 + LOC32) + 2);
LA30: ;
if (!!(((*N_85759).KindU.S6.Sons->data[(NI64)(L_86380 - 1)] == NIM_NIL))) goto LA34;
LOC36 = Lsub_85757((*N_85759).KindU.S6.Sons->data[(NI64)(L_86380 - 1)]);
Result_86238 = (NI64)((NI64)(Result_86238 + LOC36) + 3);
LA34: ;
break;
case ((NU8) 26):
...
Result_86238 = (NI64)((NI64)(LOC37 + 5) + LOC39);
break;
case ((NU8) 57):
LOC40 = Lcomma_86115(N_85759, 0, -1);
Result_86238 = (NI64)(12 + LOC40);
break;
case ((NU8) 58):
LOC41 = Lcomma_86115(N_85759, 0, -1);
Result_86238 = (NI64)(13 + LOC41);
break;
case ((NU8) 59):
LOC42 = Lcomma_86115(N_85759, 0, -1);
Result_86238 = (NI64)(11 + LOC42);
break;
case ((NU8) 55):
case ((NU8) 56):
case ((NU8) 60):
...
Result_86238 = (NI64)(Result_86238 + LOC47);
LA45: ;
LOC48 = Lcomma_86115(N_85759, 1, -1);
Result_86238 = (NI64)(Result_86238 + LOC48);
break;
case ((NU8) 24):
LOC49 = Lsons_86189(N_85759, 0, -1);
Result_86238 = (NI64)(LOC49 + 2);
break;
case ((NU8) 27):
LOC50 = Lsons_86189(N_85759, 0, -1);
Result_86238 = (NI64)(LOC50 + 2);
break;
case ((NU8) 28):
LOC51 = Lsons_86189(N_85759, 0, -1);
Result_86238 = (NI64)(LOC51 + 1);
break;
case ((NU8) 29):
...
Result_86238 = (NI64)(LOC77 + 4);
LA73: ;
break;
case ((NU8) 96):
LOC78 = Lsub_85757((*N_85759).KindU.S6.Sons->data[0]);
Result_86238 = (NI64)(LOC78 + 7);
break;
case ((NU8) 95):
...
Result_86238 = (NI64)((NI64)(LOC97 + LOC99) + 9);
break;
default:
Result_86238 = 81;
break;
...
Result_86840 = 0;
Result_86840 = ((NI64)(X_86839 + (*G_86838).Linelen) <= 80);
return Result_86840;
}
N_NIMCALL(void, Putwithspace_86918)(TY85016* G_86921, NU8 Kind_86922, NimStringDesc* S_86923) {
Put_85224(G_86921, Kind_86922, S_86923);
Put_85224(G_86921, ((NU8) 105), ((NimStringDesc*) &TMP195763));
}
N_NIMCALL(NIM_BOOL, Hascom_86879)(TY55526* N_86881) {
...
if (!(LOC6)) goto LA7;
LOC6 = nsuStartsWith((*N_85670).Comment, ((NimStringDesc*) &TMP195765));
LA7: ;
LOC4 = LOC6;
LA5: ;
Result_85671 = LOC4;
...
Com_85314 = 0;
Com_85314 = copyString(((NimStringDesc*) &TMP195740));
while (1) {
...
LA9: ;
if (!LOC6) goto LA10;
Put_85224(G_85697, ((NU8) 105), ((NimStringDesc*) &TMP195763));
LA10: ;
...
HEX3Atmp_86992 = (NI64)(LOC1 + Theend_86931);
Res_86994 = 0;
...
C_86945 = (I_86940 < (NI64)(LOC3 + Theend_86931));
Sublen_86963 = 0;
LOC4 = Lsub_85757((*N_86928).KindU.S6.Sons->data[I_86940]);
Sublen_86963 = (NI64)(LOC4 + C_86945);
LOC7 = Fits_86836(&(*G_86927), Sublen_86963);
LOC6 = !(LOC7);
if (!(LOC6)) goto LA8;
LOC6 = ((NI64)(Ind_86929 + Sublen_86963) < 80);
LA8: ;
if (!LOC6) goto LA9;
...
Putwithspace_86918(G_86927, ((NU8) 92), ((NimStringDesc*) &TMP195764));
...
Ind_87026 = (NI64)((*G_87022).Indent + 4);
LA2: ;
...
Ind_87003 = (NI64)((*G_86998).Indent + 2);
goto LA1;
LA2: ;
Ind_87003 = (*G_86998).Linelen;
if (!(40 < Ind_87003)) goto LA5;
Ind_87003 = (NI64)((*G_86998).Indent + 4);
LA5: ;
LA1: ;
...
HEX3Atmp_87060 = (NI64)(LOC1 + Theend_87038);
Res_87062 = 0;
...
goto LA1;
LA2: ;
Addtok_85105(G_85145, ((NU8) 102), ((NimStringDesc*) &TMP195741));
LA1: ;
...
HEX3Atmp_87128 = (NI64)(LOC4 + Theend_87101);
Res_87130 = 0;
...
I_87316 = 0;
HEX3Atmp_87329 = 0;
HEX3Atmp_87329 = (NI64)(Length_87307 - 1);
Res_87331 = 0;
Res_87331 = 1;
while (1) {
...
Putwithspace_86918(G_87335, ((NU8) 61), ((NimStringDesc*) &TMP195799));
Gsub_86872(G_87335, (*N_87336).KindU.S6.Sons->data[0]);
Putwithspace_86918(G_87335, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Initcontext_86860(&C_87337);
LOC2 = Longmode_87097(N_87336, 0, -1);
if (LOC2) goto LA3;
LOC4 = Lsub_85757((*N_87336).KindU.S6.Sons->data[1]);
LOC2 = (80 < (NI64)(LOC4 + (*G_87335).Linelen));
LA3: ;
if (!LOC2) goto LA5;
...
Last_87586 = 0;
if (!((*(*N_87561).KindU.S6.Sons->data[(NI64)(Length_87564 - 1)]).Kind == ((NU8) 78))) goto LA3;
LOC1 = -2;
goto LA2;
LA3: ;
LOC1 = -1;
...
LA6: ;
Putwithspace_86918(G_87560, ((NU8) 11), ((NimStringDesc*) &TMP195800));
...
Initcontext_86860(&C_87562);
LOC12 = Longmode_87097((*N_87561).KindU.S6.Sons->data[(NI64)(Length_87564 - 1)], 0, -1);
if (!LOC12) goto LA13;
C_87562.Flags |=(1<<((NI8)(((NU8) 0))%(sizeof(NI8)*8)));
LA13: ;
Gsub_86866(G_87560, (*N_87561).KindU.S6.Sons->data[(NI64)(Length_87564 - 1)], &C_87562);
LA9: ;
}
N_NIMCALL(void, Gmacro_87510)(TY85016* G_87513, TY55526* N_87514) {
TY86848 C_87515;
...
Putwithspace_86918(G_87513, ((NU8) 94), ((NimStringDesc*) &TMP195781));
LOC2 = Longmode_87097(N_87514, 0, -1);
if (LOC2) goto LA3;
LOC4 = Lsub_85757((*N_87514).KindU.S6.Sons->data[1]);
LOC2 = (80 < (NI64)(LOC4 + (*G_87513).Linelen));
LA3: ;
if (!LOC2) goto LA5;
...
Put_85224(G_87394, ((NU8) 56), ((NimStringDesc*) &TMP195801));
Putwithspace_86918(G_87394, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Initcontext_86860(&C_87396);
LOC2 = Longmode_87097(N_87395, 0, -1);
if (LOC2) goto LA3;
LOC4 = Lsub_85757((*N_87395).KindU.S6.Sons->data[0]);
LOC2 = (80 < (NI64)(LOC4 + (*G_87394).Linelen));
LA3: ;
if (!LOC2) goto LA5;
...
Putwithspace_86918(G_87441, ((NU8) 25), ((NimStringDesc*) &TMP195802));
Initcontext_86860(&C_87443);
LOC2 = Longmode_87097(N_87442, 0, -1);
if (LOC2) goto LA3;
LOC4 = Lsub_85757((*N_87442).KindU.S6.Sons->data[(NI64)(Length_87444 - 1)]);
LOC5 = Lsub_85757((*N_87442).KindU.S6.Sons->data[(NI64)(Length_87444 - 2)]);
LOC2 = (80 < (NI64)((NI64)((NI64)(LOC4 + LOC5) + 6) + (*G_87441).Linelen));
LA3: ;
if (!LOC2) goto LA6;
C_87443.Flags |=(1<<((NI8)(((NU8) 0))%(sizeof(NI8)*8)));
LA6: ;
Gcomma_86995(G_87441, N_87442, &C_87443, 0, -3);
Put_85224(G_87441, ((NU8) 105), ((NimStringDesc*) &TMP195763));
Putwithspace_86918(G_87441, ((NU8) 31), ((NimStringDesc*) &TMP195803));
Gsub_86866(G_87441, (*N_87442).KindU.S6.Sons->data[(NI64)(Length_87444 - 2)], &C_87443);
Putwithspace_86918(G_87441, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gcoms_85741(G_87441);
Gstmts_87131(G_87441, (*N_87442).KindU.S6.Sons->data[(NI64)(Length_87444 - 1)], &C_87443);
}
N_NIMCALL(void, Gblock_87751)(TY85016* G_87754, TY55526* N_87755) {
TY86848 C_87756;
NIM_BOOL LOC5;
...
Putwithspace_86918(G_87754, ((NU8) 9), ((NimStringDesc*) &TMP195804));
Gsub_86872(G_87754, (*N_87755).KindU.S6.Sons->data[0]);
goto LA1;
LA2: ;
Put_85224(G_87754, ((NU8) 9), ((NimStringDesc*) &TMP195804));
LA1: ;
Putwithspace_86918(G_87754, ((NU8) 94), ((NimStringDesc*) &TMP195781));
LOC5 = Longmode_87097(N_87755, 0, -1);
if (LOC5) goto LA6;
LOC7 = Lsub_85757((*N_87755).KindU.S6.Sons->data[1]);
LOC5 = (80 < (NI64)(LOC7 + (*G_87754).Linelen));
LA6: ;
if (!LOC5) goto LA8;
...
N_NIMCALL(void, Gasm_87833)(TY85016* G_87836, TY55526* N_87837) {
Putwithspace_86918(G_87836, ((NU8) 6), ((NimStringDesc*) &TMP195805));
...
Put_85224(G_87653, ((NU8) 105), ((NimStringDesc*) &TMP195763));
Putwithspace_86918(G_87653, ((NU8) 95), ((NimStringDesc*) &TMP195771));
...
LA22: ;
Put_85224(G_86869, ((NU8) 80), ((NimStringDesc*) &TMP195762));
Gcomma_87019(G_86869, N_86870, 1, -1);
Put_85224(G_86869, ((NU8) 81), ((NimStringDesc*) &TMP195766));
break;
case ((NU8) 22):
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
...
LOC29 = 0;
LOC29 = nsuReplaceStr((*LOC28).KindU.S3.Strval, ((NimStringDesc*) &TMP195742), ((NimStringDesc*) &TMP195747));
...
break;
case ((NU8) 51):
Put_85224(G_86869, ((NU8) 12), ((NimStringDesc*) &TMP195767));
Put_85224(G_86869, ((NU8) 82), ((NimStringDesc*) &TMP195768));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 83), ((NimStringDesc*) &TMP195769));
Put_85224(G_86869, ((NU8) 80), ((NimStringDesc*) &TMP195762));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
Put_85224(G_86869, ((NU8) 81), ((NimStringDesc*) &TMP195766));
break;
case ((NU8) 52):
Put_85224(G_86869, ((NU8) 3), ((NimStringDesc*) &TMP195770));
Put_85224(G_86869, ((NU8) 80), ((NimStringDesc*) &TMP195762));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 81), ((NimStringDesc*) &TMP195766));
break;
...
case ((NU8) 20):
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 105), ((NimStringDesc*) &TMP195763));
Gcomma_87019(G_86869, N_86870, 1, -1);
break;
case ((NU8) 23):
case ((NU8) 63):
...
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 105), ((NimStringDesc*) &TMP195763));
Putwithspace_86918(G_86869, ((NU8) 95), ((NimStringDesc*) &TMP195771));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
break;
case ((NU8) 57):
...
break;
case ((NU8) 59):
Put_85224(G_86869, ((NU8) 2), ((NimStringDesc*) &TMP195774));
Put_85224(G_86869, ((NU8) 80), ((NimStringDesc*) &TMP195762));
Gcomma_87019(G_86869, N_86870, 0, -1);
Put_85224(G_86869, ((NU8) 81), ((NimStringDesc*) &TMP195766));
break;
...
Put_85224(G_86869, ((NU8) 99), ((NimStringDesc*) &TMP195775));
LA37: ;
...
break;
case ((NU8) 31):
Put_85224(G_86869, ((NU8) 84), ((NimStringDesc*) &TMP195776));
Gcomma_86995(G_86869, N_86870, C_86871, 0, -1);
Put_85224(G_86869, ((NU8) 85), ((NimStringDesc*) &TMP195777));
break;
case ((NU8) 32):
Put_85224(G_86869, ((NU8) 82), ((NimStringDesc*) &TMP195768));
Gcomma_86995(G_86869, N_86870, C_86871, 0, -1);
...
case ((NU8) 36):
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 96), ((NimStringDesc*) &TMP195778));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
break;
case ((NU8) 45):
Putwithspace_86918(G_86869, ((NU8) 8), ((NimStringDesc*) &TMP195779));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 37):
case ((NU8) 53):
...
break;
case ((NU8) 42):
Putwithspace_86918(G_86869, ((NU8) 36), ((NimStringDesc*) &TMP195780));
...
if (!!(((*N_86870).KindU.S6.Sons->data[(NI64)(L_88348 - 2)] == NIM_NIL))) goto LA40;
Putwithspace_86918(G_86869, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[(NI64)(L_88348 - 2)]);
LA40: ;
if (!!(((*N_86870).KindU.S6.Sons->data[(NI64)(L_88348 - 1)] == NIM_NIL))) goto LA43;
Put_85224(G_86869, ((NU8) 105), ((NimStringDesc*) &TMP195763));
Putwithspace_86918(G_86869, ((NU8) 95), ((NimStringDesc*) &TMP195771));
Gsub_86866(G_86869, (*N_86870).KindU.S6.Sons->data[(NI64)(L_88348 - 1)], C_86871);
LA43: ;
break;
case ((NU8) 26):
Put_85224(G_86869, ((NU8) 80), ((NimStringDesc*) &TMP195762));
...
LOC49 = Fits_86836(&(*G_86869), (NI64)((NI64)(LOC47 + LOC48) + 1));
if (!!(LOC49)) goto LA50;
Optnl_85153(G_86869, (NI64)((*G_86869).Indent + 4));
goto LA46;
LA50: ;
Put_85224(G_86869, ((NU8) 105), ((NimStringDesc*) &TMP195763));
LA46: ;
...
case ((NU8) 35):
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 97), ((NimStringDesc*) &TMP195782));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
break;
case ((NU8) 38):
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Putwithspace_86918(G_86869, ((NU8) 98), ((NimStringDesc*) &TMP195783));
break;
case ((NU8) 43):
Put_85224(G_86869, ((NU8) 101), ((NimStringDesc*) &TMP195784));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 101), ((NimStringDesc*) &TMP195784));
break;
case ((NU8) 39):
Putwithspace_86918(G_86869, ((NU8) 28), ((NimStringDesc*) &TMP195785));
...
Gsons_87031(G_86869, N_86870, &TMP195786, 1, -1);
break;
case ((NU8) 40):
Putwithspace_86918(G_86869, ((NU8) 19), ((NimStringDesc*) &TMP195787));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Putwithspace_86918(G_86869, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
break;
case ((NU8) 41):
Put_85224(G_86869, ((NU8) 20), ((NimStringDesc*) &TMP195788));
Putwithspace_86918(G_86869, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 110):
Putwithspace_86918(G_86869, ((NU8) 58), ((NimStringDesc*) &TMP195789));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 116):
Putwithspace_86918(G_86869, ((NU8) 51), ((NimStringDesc*) &TMP195790));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 117):
Putwithspace_86918(G_86869, ((NU8) 49), ((NimStringDesc*) &TMP195791));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 118):
Putwithspace_86918(G_86869, ((NU8) 59), ((NimStringDesc*) &TMP195792));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 119):
Putwithspace_86918(G_86869, ((NU8) 17), ((NimStringDesc*) &TMP195793));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 91):
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
...
break;
case ((NU8) 111):
Putwithspace_86918(G_86869, ((NU8) 44), ((NimStringDesc*) &TMP195794));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
Gcoms_85741(G_86869);
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[2]);
...
break;
case ((NU8) 67):
Putwithspace_86918(G_86869, ((NU8) 45), ((NimStringDesc*) &TMP195795));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 120):
Putwithspace_86918(G_86869, ((NU8) 48), ((NimStringDesc*) &TMP195796));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[1]);
break;
case ((NU8) 121):
Putwithspace_86918(G_86869, ((NU8) 22), ((NimStringDesc*) &TMP195797));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Gcoms_85741(G_86869);
Indentnl_85162(G_86869);
...
case ((NU8) 101):
case ((NU8) 106):
Gstmts_87131(G_86869, N_86870, &TMP195786);
break;
case ((NU8) 82):
Putwithspace_86918(G_86869, ((NU8) 28), ((NimStringDesc*) &TMP195785));
...
case ((NU8) 83):
case ((NU8) 115):
Putwithspace_86918(G_86869, ((NU8) 60), ((NimStringDesc*) &TMP195798));
Gif_87212(G_86869, N_86870);
break;
case ((NU8) 85):
...
break;
case ((NU8) 70):
Putwithspace_86918(G_86869, ((NU8) 39), ((NimStringDesc*) &TMP195806));
Gproc_87650(G_86869, N_86870);
break;
case ((NU8) 74):
Putwithspace_86918(G_86869, ((NU8) 35), ((NimStringDesc*) &TMP195807));
Gproc_87650(G_86869, N_86870);
break;
case ((NU8) 72):
Putwithspace_86918(G_86869, ((NU8) 38), ((NimStringDesc*) &TMP195808));
Gproc_87650(G_86869, N_86870);
break;
case ((NU8) 73):
Putwithspace_86918(G_86869, ((NU8) 55), ((NimStringDesc*) &TMP195809));
Gproc_87650(G_86869, N_86870);
break;
case ((NU8) 90):
Gsection_87063(G_86869, N_86870, &TMP195786, ((NU8) 58), ((NimStringDesc*) &TMP195789));
break;
case ((NU8) 88):
Initcontext_86860(&A_87999);
A_87999.Flags |=(1<<((NI8)(((NU8) 2))%(sizeof(NI8)*8)));
Gsection_87063(G_86869, N_86870, &A_87999, ((NU8) 13), ((NimStringDesc*) &TMP195810));
break;
case ((NU8) 87):
...
break;
case ((NU8) 96):
Putwithspace_86918(G_86869, ((NU8) 52), ((NimStringDesc*) &TMP195811));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 95):
Putwithspace_86918(G_86869, ((NU8) 50), ((NimStringDesc*) &TMP195812));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 92):
Putwithspace_86918(G_86869, ((NU8) 65), ((NimStringDesc*) &TMP195813));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 100):
Putwithspace_86918(G_86869, ((NU8) 16), ((NimStringDesc*) &TMP195814));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 97):
Putwithspace_86918(G_86869, ((NU8) 10), ((NimStringDesc*) &TMP195815));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 98):
Putwithspace_86918(G_86869, ((NU8) 14), ((NimStringDesc*) &TMP195816));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
break;
case ((NU8) 81):
if (!!((((*G_86869).Flags &(1<<((((NU8) 4))&7)))!=0))) goto LA65;
Put_85224(G_86869, ((NU8) 88), ((NimStringDesc*) &TMP195817));
Gcomma_86995(G_86869, N_86870, &TMP195786, 0, -1);
Put_85224(G_86869, ((NU8) 89), ((NimStringDesc*) &TMP195818));
LA65: ;
break;
case ((NU8) 102):
Putwithspace_86918(G_86869, ((NU8) 30), ((NimStringDesc*) &TMP195819));
Gcoms_85741(G_86869);
Indentnl_85162(G_86869);
...
break;
case ((NU8) 103):
Putwithspace_86918(G_86869, ((NU8) 26), ((NimStringDesc*) &TMP195820));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Put_85224(G_86869, ((NU8) 105), ((NimStringDesc*) &TMP195763));
Putwithspace_86918(G_86869, ((NU8) 30), ((NimStringDesc*) &TMP195819));
Gcomma_86995(G_86869, N_86870, &TMP195786, 1, -1);
Putnl_85149(G_86869);
break;
case ((NU8) 104):
Putwithspace_86918(G_86869, ((NU8) 32), ((NimStringDesc*) &TMP195821));
Gcoms_85741(G_86869);
Indentnl_85162(G_86869);
Gcommaaux_86924(G_86869, N_86870, (*G_86869).Indent, 0, -1);
Dedent_85178(G_86869);
...
case ((NU8) 76):
Optnl_85158(G_86869);
Putwithspace_86918(G_86869, ((NU8) 19), ((NimStringDesc*) &TMP195822));
Gsub_86872(G_86869, (*N_86870).KindU.S6.Sons->data[0]);
Putwithspace_86918(G_86869, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gcoms_85741(G_86869);
...
case ((NU8) 78):
Optnl_85158(G_86869);
Put_85224(G_86869, ((NU8) 20), ((NimStringDesc*) &TMP195823));
Putwithspace_86918(G_86869, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gcoms_85741(G_86869);
...
case ((NU8) 94):
Optnl_85158(G_86869);
Put_85224(G_86869, ((NU8) 24), ((NimStringDesc*) &TMP195824));
Putwithspace_86918(G_86869, ((NU8) 94), ((NimStringDesc*) &TMP195781));
Gcoms_85741(G_86869);
Gstmts_87131(G_86869, (*N_86870).KindU.S6.Sons->data[0], C_86871);
break;
case ((NU8) 77):
Optnl_85158(G_86869);
Putwithspace_86918(G_86869, ((NU8) 23), ((NimStringDesc*) &TMP195825));
...
break;
case ((NU8) 112):
Put_85224(G_86869, ((NU8) 57), ((NimStringDesc*) &TMP195826));
Put_85224(G_86869, ((NU8) 82), ((NimStringDesc*) &TMP195768));
Gcomma_87019(G_86869, N_86870, 0, -1);
Put_85224(G_86869, ((NU8) 83), ((NimStringDesc*) &TMP195769));
break;
...
appendString(LOC72, ((NimStringDesc*) &TMP195827));
...
unsureAsgnRef((void**) &(*Literal_85063), copyStrLast((*R_85059).Buf, (NI64)((*R_85059).Pos + 0), (NI64)((NI64)((NI64)((*R_85059).Pos + 0) + ((NI) (Length_89292))) - 1)));
