...
STRING_LITERAL(TMP196946, "", 0);
STRING_LITERAL(TMP196947, "invalid kind for first(", 23);
STRING_LITERAL(TMP196948, "invalid kind for last(", 22);
STRING_LITERAL(TMP196961, "computeRecSizeAux(record case branch)", 37);
STRING_LITERAL(TMP196962, "computeRecSizeAux()", 19);
STRING_LITERAL(TMP196963, "getSize(", 8);
STRING_LITERAL(TMP197006, "None", 4);
STRING_LITERAL(TMP197007, "bool", 4);
STRING_LITERAL(TMP197008, "Char", 4);
STRING_LITERAL(TMP197009, "empty", 5);
STRING_LITERAL(TMP197010, "Array Constructor [$1]", 22);
STRING_LITERAL(TMP197011, "nil", 3);
STRING_LITERAL(TMP197012, "expr", 4);
STRING_LITERAL(TMP197013, "stmt", 4);
STRING_LITERAL(TMP197014, "typeDesc", 8);
STRING_LITERAL(TMP197015, "GenericInvokation", 17);
STRING_LITERAL(TMP197016, "GenericBody", 11);
STRING_LITERAL(TMP197017, "GenericInst", 11);
STRING_LITERAL(TMP197018, "GenericParam", 12);
STRING_LITERAL(TMP197019, "distinct $1", 11);
STRING_LITERAL(TMP197020, "enum", 4);
STRING_LITERAL(TMP197021, "ordinal[$1]", 11);
STRING_LITERAL(TMP197022, "array[$1, $2]", 13);
STRING_LITERAL(TMP197023, "object", 6);
STRING_LITERAL(TMP197024, "tuple", 5);
STRING_LITERAL(TMP197025, "set[$1]", 7);
STRING_LITERAL(TMP197026, "range[$1]", 9);
STRING_LITERAL(TMP197027, "ptr ", 4);
STRING_LITERAL(TMP197028, "ref ", 4);
STRING_LITERAL(TMP197029, "var ", 4);
STRING_LITERAL(TMP197030, "seq[$1]", 7);
STRING_LITERAL(TMP197031, "proc", 4);
STRING_LITERAL(TMP197032, "pointer", 7);
STRING_LITERAL(TMP197033, "OpenArray[$1]", 13);
STRING_LITERAL(TMP197034, "string", 6);
STRING_LITERAL(TMP197035, "CString", 7);
STRING_LITERAL(TMP197036, "Forward", 7);
STRING_LITERAL(TMP197037, "int", 3);
STRING_LITERAL(TMP197038, "int8", 4);
STRING_LITERAL(TMP197039, "int16", 5);
STRING_LITERAL(TMP197040, "int32", 5);
STRING_LITERAL(TMP197041, "int64", 5);
STRING_LITERAL(TMP197042, "float", 5);
STRING_LITERAL(TMP197043, "float32", 7);
STRING_LITERAL(TMP197044, "float64", 7);
STRING_LITERAL(TMP197045, "float128", 8);
NIM_CONST TY97495 Typetostr_97494 = {((NimStringDesc*) &TMP197006),
...
((NimStringDesc*) &TMP197044),
((NimStringDesc*) &TMP197045)}
;
STRING_LITERAL(TMP197046, "array[", 6);
STRING_LITERAL(TMP197048, "..", 2);
STRING_LITERAL(TMP197049, ", ", 2);
STRING_LITERAL(TMP197050, "Array constructor[", 18);
STRING_LITERAL(TMP197051, "seq[", 4);
STRING_LITERAL(TMP197052, "ordinal[", 8);
STRING_LITERAL(TMP197053, "set[", 4);
STRING_LITERAL(TMP197054, "openarray[", 10);
STRING_LITERAL(TMP197055, "distinct ", 9);
STRING_LITERAL(TMP197056, "tuple[", 6);
STRING_LITERAL(TMP197057, ": ", 2);
extern NIM_CONST TY97495 Typetostr_97494;
STRING_LITERAL(TMP197058, "range ", 6);
STRING_LITERAL(TMP197059, "proc (", 6);
extern NIM_CONST TY55016 Callingconvtostr_55015;
STRING_LITERAL(TMP197060, "noSideEffect", 12);
STRING_LITERAL(TMP197061, "{.", 2);
STRING_LITERAL(TMP197062, ".}", 2);
STRING_LITERAL(TMP197078, "sameTuple", 9);
STRING_LITERAL(TMP197089, "getProcHeader", 13);
STRING_LITERAL(TMP197285, "searchTypeNodeForAux(record case branch)", 40);
STRING_LITERAL(TMP197286, "searchTypeNodeForAux()", 22);
...
break;
default:
Limessage_47562((*N_96109).Info, ((NU8) 71), ((NimStringDesc*) &TMP196946));
Result_96263 = 0;
break;
}
return Result_96263;
...
appendString(LOC11, ((NimStringDesc*) &TMP196947));
...
Result_98034 = ((NI64) ((*(*(*(*T_96006).N).KindU.S6.Sons->data[(NI64)(LOC4 - 1)]).KindU.S4.Sym).Position));
break;
case ((NU8) 11):
case ((NU8) 13):
LOC5 = 0;
...
appendString(LOC6, ((NimStringDesc*) &TMP196948));
...
Result_96166 = IL64(9223372036854775807);
BeforeRet: ;
return Result_96166;
}
N_NIMCALL(NI64, Align_99198)(NI64 Address_99200, NI64 Alignment_99201) {
...
break;
default:
Internalerror_47571(((NimStringDesc*) &TMP196961));
break;
}
Res_99343 += 1;
} LA2: ;
...
break;
default:
Internalerror_47571(((NimStringDesc*) &TMP196962));
(*A_99212) = 1;
Result_99214 = -1;
break;
}
...
Result_99357 = ((NI64) ((NI64)(2 * Ptrsize_51572)));
goto LA7;
LA8: ;
...
appendString(LOC4, ((NimStringDesc*) &TMP196963));
...
appendString(LOC1, ((NimStringDesc*) &TMP197048));
...
T_97498 = 0;
T_97498 = Typ_96016;
Result_97493 = copyString(((NimStringDesc*) &TMP196946));
...
appendString(LOC13, ((NimStringDesc*) &TMP197046));
appendString(LOC13, LOC14);
appendString(LOC13, ((NimStringDesc*) &TMP197049));
...
appendString(LOC16, ((NimStringDesc*) &TMP197046));
appendString(LOC16, LOC17);
appendString(LOC16, ((NimStringDesc*) &TMP197049));
...
appendString(Result_97493, ((NimStringDesc*) &TMP197049));
LA24: ;
LOC26 = 0;
...
appendString(LOC27, ((NimStringDesc*) &TMP197050));
appendString(LOC27, LOC28);
appendString(LOC27, ((NimStringDesc*) &TMP197049));
...
appendString(LOC30, ((NimStringDesc*) &TMP197051));
...
appendString(LOC32, ((NimStringDesc*) &TMP197052));
...
appendString(LOC34, ((NimStringDesc*) &TMP197053));
...
appendString(LOC36, ((NimStringDesc*) &TMP197054));
...
appendString(LOC38, ((NimStringDesc*) &TMP197055));
appendString(LOC38, LOC39);
Result_97493 = LOC38;
break;
case ((NU8) 18):
Result_97493 = copyString(((NimStringDesc*) &TMP197056));
if (!!(((*T_97498).N == NIM_NIL))) goto LA41;
I_97713 = 0;
HEX3Atmp_97881 = 0;
LOC43 = Sonslen_55803((*T_97498).N);
HEX3Atmp_97881 = (NI64)(LOC43 - 1);
Res_97883 = 0;
Res_97883 = 0;
while (1) {
...
appendString(LOC45, ((NimStringDesc*) &TMP197057));
...
if (!(I_97713 < (NI64)(LOC48 - 1))) goto LA49;
Result_97493 = resizeString(Result_97493, 2);
appendString(Result_97493, ((NimStringDesc*) &TMP197049));
LA49: ;
Res_97883 += 1;
...
if (!(I_97784 < (NI64)(LOC55 - 1))) goto LA56;
Result_97493 = resizeString(Result_97493, 2);
appendString(Result_97493, ((NimStringDesc*) &TMP197049));
LA56: ;
Res_97889 += 1;
...
appendString(LOC60, ((NimStringDesc*) &TMP197058));
appendString(LOC60, LOC61);
Result_97493 = LOC60;
break;
case ((NU8) 25):
Result_97493 = copyString(((NimStringDesc*) &TMP197059));
I_97810 = 0;
HEX3Atmp_97893 = 0;
LOC62 = Sonslen_55806(T_97498);
HEX3Atmp_97893 = (NI64)(LOC62 - 1);
Res_97895 = 0;
Res_97895 = 1;
while (1) {
...
if (!(I_97810 < (NI64)(LOC66 - 1))) goto LA67;
Result_97493 = resizeString(Result_97493, 2);
appendString(Result_97493, ((NimStringDesc*) &TMP197049));
LA67: ;
Res_97895 += 1;
...
appendString(LOC72, ((NimStringDesc*) &TMP197057));
...
goto LA74;
LA75: ;
Prag_97832 = copyString(((NimStringDesc*) &TMP196946));
LA74: ;
if (!(((*T_97498).Flags &(1<<((((NU8) 1))&7)))!=0)) goto LA78;
Addsep_25820(&Prag_97832, ((NimStringDesc*) &TMP197049), 0);
Prag_97832 = resizeString(Prag_97832, 12);
appendString(Prag_97832, ((NimStringDesc*) &TMP197060));
LA78: ;
if (!!((Prag_97832->Sup.len == 0))) goto LA81;
LOC83 = 0;
LOC83 = rawNewString(Prag_97832->Sup.len + 4);
appendString(LOC83, ((NimStringDesc*) &TMP197061));
appendString(LOC83, Prag_97832);
appendString(LOC83, ((NimStringDesc*) &TMP197062));
...
Internalerror_47567((*(*A_98513).N).Info, ((NimStringDesc*) &TMP197078));
LA22: ;
if (!!(((*(*(*B_98514).N).KindU.S6.Sons->data[I_98558]).Kind == ((NU8) 3)))) goto LA25;
Internalerror_47567((*(*B_98514).N).Info, ((NimStringDesc*) &TMP197078));
LA25: ;
...
Internalerror_47571(((NimStringDesc*) &TMP197089));
LA5: ;
...
appendString(Result_96316, ((NimStringDesc*) &TMP197057));
LOC7 = 0;
...
if (!!((I_96344 == (NI64)(LOC9 - 1)))) goto LA10;
Result_96316 = resizeString(Result_96316, 2);
appendString(Result_96316, ((NimStringDesc*) &TMP197049));
LA10: ;
Res_96447 += 1;
} LA3: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP197057));
...
I_98213 = 0;
HEX3Atmp_98353 = 0;
HEX3Atmp_98353 = (NI64)(Length_98201 - 1);
Res_98355 = 0;
Res_98355 = 1;
while (1) {
...
Result_99025 = ((IL64(1097364160516) &(IL64(1)<<(((*LOC21).Kind)&IL64(63))))!=0);
break;
case ((NU8) 27):
...
break;
default:
Internalerror_47571(((NimStringDesc*) &TMP197285));
break;
}
Res_96918 += 1;
} LA10: ;
...
break;
default:
Internalerror_47567((*N_96807).Info, ((NimStringDesc*) &TMP197286));
break;
}
BeforeRet: ;
return Result_96811;
...
Result_97138 = 0;
Result_97138 = ((289406976 &(IL64(1)<<(((*T_97137).Kind)&IL64(63))))!=0);
return Result_97138;
}
