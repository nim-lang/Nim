...
STRING_LITERAL(TMP194229, "cgmeth.genConv", 14);
STRING_LITERAL(TMP194230, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP194231, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP194765, "and", 3);
STRING_LITERAL(TMP194766, "is", 2);
...
Internalerror_45567((*N_155016).Info, ((NimStringDesc*) &TMP194231));
LA18: ;
goto LA9;
LA15: ;
...
Ands_155515 = Getsyssym_98024(((NimStringDesc*) &TMP194765));
Iss_155516 = Getsyssym_98024(((NimStringDesc*) &TMP194766));
Meth_155537 = 0;
HEX3Atmp_155673 = 0;
