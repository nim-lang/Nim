...
STRING_LITERAL(TMP193699, "_", 1);
static NIM_CONST TY20402 TMP193700 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;static NIM_CONST TY20402 TMP193701 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x07, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193703, "getNumber", 9);
STRING_LITERAL(TMP193705, "\012", 1);
static NIM_CONST TY20402 TMP193706 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xEC, 0x00, 0xF0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;STRING_LITERAL(TMP193707, " (\\", 3);
STRING_LITERAL(TMP193713, "tokToStr", 8);
STRING_LITERAL(TMP193736, "pushInd", 7);
STRING_LITERAL(TMP195479, " ", 1);
...
break;
case 48 ... 57:
LOC5 = Matchtwochars_73679(&(*L_74379), 48, TMP193700);
if (!LOC5) goto LA6;
...
Lexmessage_73326(&(*L_74748), ((NU8) 12), ((NimStringDesc*) &TMP193699));
goto BeforeRet;
LA3: ;
break;
default:
...
Lexmessage_73326(&(*L_73624), ((NU8) 12), ((NimStringDesc*) &TMP193699));
goto LA1;
LA9: ;
...
Matchunderscorechars_73621(L_73748, Result, TMP193701);
...
(*L_73748).Sup.Bufpos = Pos_73750;
LA12: ;
TMP193702.prev = excHandler;
excHandler = &TMP193702;
TMP193702.status = setjmp(TMP193702.context);
if (TMP193702.status == 0) {
...
Lexmessage_73326(&(*L_73748), ((NU8) 12), ((NimStringDesc*) &TMP193699));
goto LA44;
LA46: ;
Pos_73750 += 1;
break;
...
Internalerror_45567(LOC56, ((NimStringDesc*) &TMP193703));
break;
}
...
Internalerror_45567(LOC57, ((NimStringDesc*) &TMP193703));
break;
}
goto LA39;
LA42: ;
...
if ((TMP193702.exc->Sup.m_type == NTI440)) {
Lexmessage_73326(&(*L_73748), ((NU8) 14), (*Result).Literal);
TMP193702.status = 0;}
else if ((TMP193702.exc->Sup.m_type == NTI432)) {
Lexmessage_73326(&(*L_73748), ((NU8) 15), (*Result).Literal);
TMP193702.status = 0;}
else if ((TMP193702.exc->Sup.m_type == NTI448)) {
Lexmessage_73326(&(*L_73748), ((NU8) 15), (*Result).Literal);
TMP193702.status = 0;}
}
excHandler = excHandler->prev;
if (TMP193702.status != 0) { raiseException(TMP193702.exc, TMP193702.exc->name); }
...
appendString(LOC9, ((NimStringDesc*) &TMP193705));
...
if (!((TMP193706[((NU8)(C_74854))/8] &(1<<(((NU8)(C_74854))%8)))!=0)) goto LA3;
...
break;
default:
if (!((TMP193706[((NU8)(C_75132))/8] &(1<<(((NU8)(C_75132))%8)))!=0)) goto LA44;
Getoperator_74845(L_73307, Tok_73309);
goto LA43;
LA44: ;
...
appendString(LOC47, ((NimStringDesc*) &TMP193707));
...
goto LA1;
LA2: ;
Internalerror_45571(((NimStringDesc*) &TMP193713));
...
goto LA1;
LA2: ;
Internalerror_45571(((NimStringDesc*) &TMP193736));
LA1: ;
}
...
Write_3658(stdout, ((NimStringDesc*) &TMP195479));
LOC1 = Toktostr_73323(Tok_73322);
Writeln_73552(stdout, LOC1);
}
N_NIMCALL(void, Writeln_73552)(FILE* F_73555, NimStringDesc* X_73556) {
Write_3658(F_73555, X_73556);
Write_3658(F_73555, ((NimStringDesc*) &TMP193705));
}
