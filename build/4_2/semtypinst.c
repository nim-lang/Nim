...
STRING_LITERAL(TMP198038, "substitution with generic parameter", 35);
STRING_LITERAL(TMP198039, "no generic body", 15);
STRING_LITERAL(TMP198042, "acyclic", 7);
STRING_LITERAL(TMP198045, "", 0);
STRING_LITERAL(TMP198046, "ReplaceTypeVarsT: tyGenericBody", 31);
...
Internalerror_49208((*Cl_126303).Info, ((NimStringDesc*) &TMP198038));
goto LA2;
LA6: ;
LA2: ;
...
LA3: ;
if (!LOC2) goto LA5;
Localerror_49193(Info_126006, ((NU8) 158), ((NimStringDesc*) &TMP198042));
goto LA1;
LA5: ;
...
LA12: ;
if (!LOC11) goto LA13;
Localerror_49193(Info_126006, ((NU8) 191), ((NimStringDesc*) &TMP198045));
goto LA1;
LA13: ;
LA1: ;
}
...
Internalerror_49208((*Cl_126153).Info, ((NimStringDesc*) &TMP198039));
LA5: ;
Header_126335 = NIM_NIL;
I_126364 = 0;
HEX3Atmp_126438 = 0;
...
break;
case ((NU8) 10):
Internalerror_49208((*Cl_126153).Info, ((NimStringDesc*) &TMP198046));
LOC25 = 0;
