...
STRING_LITERAL(TMP197491, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP197492, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP197493, "", 0);
STRING_LITERAL(TMP197494, "dot", 3);
...
Appf_52071(&Gdotgraph_187015, ((NimStringDesc*) &TMP197491), LOC1, 2);
}
N_NIMCALL(TY55526*, Adddotdependency_187025)(TY105002* C_187027, TY55526* N_187028) {
