...
STRING_LITERAL(TMP195482, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP195483, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP195484, "", 0);
STRING_LITERAL(TMP195485, "dot", 3);
...
Appf_51071(&Gdotgraph_185015, ((NimStringDesc*) &TMP195482), LOC1, 2);
}
N_NIMCALL(TY54525*, Adddotdependency_185025)(TY104002* C_185027, TY54525* N_185028) {
...
LOC3 = 0;
LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP195484));
LOC1[0] = Torope_51046(LOC3);
LOC1[1] = Gdotgraph_185015;
LOC4 = 0;
LOC4 = Ropef_51066(((NimStringDesc*) &TMP195483), LOC1, 2);
LOC5 = 0;
LOC5 = nosChangeFileExt(Project_185008, ((NimStringDesc*) &TMP195485));
