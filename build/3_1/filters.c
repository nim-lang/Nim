...
STRING_LITERAL(TMP197861, "startswith", 10);
STRING_LITERAL(TMP197862, "", 0);
STRING_LITERAL(TMP197863, "true", 4);
STRING_LITERAL(TMP197864, "false", 5);
STRING_LITERAL(TMP197865, "leading", 7);
STRING_LITERAL(TMP197866, "trailing", 8);
STRING_LITERAL(TMP197867, "sub", 3);
STRING_LITERAL(TMP197868, "by", 2);
static N_INLINE(NI, Sonslen_56804)(TY56526* N_56806) {
NI Result_57897;
Result_57897 = 0;
...
if (!(LOC4)) goto LA5;
LOC4 = Identeq_55028((*X_91299).KindU.S5.Ident, ((NimStringDesc*) &TMP197863));
LA5: ;
if (!LOC4) goto LA6;
...
if (!(LOC8)) goto LA9;
LOC8 = Identeq_55028((*X_91299).KindU.S5.Ident, ((NimStringDesc*) &TMP197864));
LA9: ;
if (!LOC8) goto LA10;
...
Pattern_91359 = Strarg_91020(Call_91013, ((NimStringDesc*) &TMP197861), 1, ((NimStringDesc*) &TMP197862));
Leading_91360 = 0;
Leading_91360 = Boolarg_91026(Call_91013, ((NimStringDesc*) &TMP197865), 2, NIM_TRUE);
Trailing_91361 = 0;
Trailing_91361 = Boolarg_91026(Call_91013, ((NimStringDesc*) &TMP197866), 3, NIM_TRUE);
Result_91358 = Llstreamopen_76217(((NimStringDesc*) &TMP197862));
while (1) {
...
Sub_91374 = NIM_NIL;
Sub_91374 = Strarg_91020(Call_91008, ((NimStringDesc*) &TMP197867), 1, ((NimStringDesc*) &TMP197862));
if (!(Sub_91374->Sup.len == 0)) goto LA2;
Invalidpragma_91032(Call_91008);
LA2: ;
By_91379 = NIM_NIL;
By_91379 = Strarg_91020(Call_91008, ((NimStringDesc*) &TMP197868), 2, ((NimStringDesc*) &TMP197862));
Result_91373 = Llstreamopen_76217(((NimStringDesc*) &TMP197862));
while (1) {
