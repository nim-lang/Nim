...
STRING_LITERAL(TMP197645, "nimcache", 8);
STRING_LITERAL(TMP197657, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP197645));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP197645));
LOC7[2] = copyString(Head_47250);
Subdir_47262 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_47109) goto LA9;
pushSafePoint(&TMP197656);
TMP197656.status = setjmp(TMP197656.context);
if (TMP197656.status == 0) {
...
appendString(LOC11, ((NimStringDesc*) &TMP197657));
appendString(LOC11, Subdir_47262);
Writeln_47266(stdout, LOC11);
exit(1);
TMP197656.status = 0;popCurrentException();}
}
if (TMP197656.status != 0) reraiseException();
LA9: ;
...
Write_3866(F_47269, ((NimStringDesc*) &TMP199564));
}
