...
STRING_LITERAL(TMP195978, "int", 3);
STRING_LITERAL(TMP195979, "int8", 4);
STRING_LITERAL(TMP195980, "int16", 5);
STRING_LITERAL(TMP195981, "int32", 5);
STRING_LITERAL(TMP195982, "int64", 5);
STRING_LITERAL(TMP195983, "float", 5);
STRING_LITERAL(TMP195984, "float32", 7);
STRING_LITERAL(TMP195985, "float64", 7);
STRING_LITERAL(TMP195986, "bool", 4);
STRING_LITERAL(TMP195987, "char", 4);
STRING_LITERAL(TMP195988, "string", 6);
STRING_LITERAL(TMP195989, "cstring", 7);
STRING_LITERAL(TMP195990, "pointer", 7);
STRING_LITERAL(TMP195991, "request for typekind: ", 22);
STRING_LITERAL(TMP195992, "wanted: ", 8);
STRING_LITERAL(TMP195993, " got: ", 6);
STRING_LITERAL(TMP195994, "type not found: ", 16);
...
switch (Kind_102010) {
case ((NU8) 31):
Result_102080 = Systypefromname_102073(((NimStringDesc*) &TMP195978));
break;
case ((NU8) 32):
...
appendString(LOC4, ((NimStringDesc*) &TMP195991));
...
appendString(LOC8, ((NimStringDesc*) &TMP195992));
...
appendString(LOC12, ((NimStringDesc*) &TMP195994));
