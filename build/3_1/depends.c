...
STRING_LITERAL(TMP197489, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP197490, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP197491, "", 0);
STRING_LITERAL(TMP197492, "dot", 3);
...
Appf_52071(&Gdotgraph_187015, ((NimStringDesc*) &TMP197489), LOC1, 2);
}
N_NIMCALL(TY55526*, Adddotdependency_187025)(TY105002* C_187027, TY55526* N_187028) {
...
LOC3 = 0;
LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP197491));
LOC1[0] = Torope_52046(LOC3);
LOC1[1] = Gdotgraph_187015;
LOC4 = 0;
LOC4 = Ropef_52066(((NimStringDesc*) &TMP197490), LOC1, 2);
LOC5 = 0;
LOC5 = nosChangeFileExt(Project_187008, ((NimStringDesc*) &TMP197492));
