...
STRING_LITERAL(TMP199540, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP199541, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP199542, "", 0);
STRING_LITERAL(TMP199543, "dot", 3);
...
Appf_53071(&Gdotgraph_189015, ((NimStringDesc*) &TMP199540), LOC1, 2);
}
N_NIMCALL(TY56526*, Adddotdependency_189025)(TY106002* C_189027, TY56526* N_189028) {
...
LOC3 = 0;
LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP199542));
LOC1[0] = Torope_53046(LOC3);
LOC1[1] = Gdotgraph_189015;
LOC4 = 0;
LOC4 = Ropef_53066(((NimStringDesc*) &TMP199541), LOC1, 2);
LOC5 = 0;
LOC5 = nosChangeFileExt(Project_189008, ((NimStringDesc*) &TMP199543));
