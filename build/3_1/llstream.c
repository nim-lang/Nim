...
STRING_LITERAL(TMP196701, "", 0);
STRING_LITERAL(TMP196702, "Nimrod> ", 8);
STRING_LITERAL(TMP196703, "\012", 1);
...
Line_74179 = 0;
L_74180 = 0;
asgnRefNoCycle((void**) &(*S_74175).S, copyString(((NimStringDesc*) &TMP196701)));
(*S_74175).Rd = 0;
while (1) {
Write_3658(stdout, ((NimStringDesc*) &TMP196702));
...
appendString((*S_74175).S, ((NimStringDesc*) &TMP196703));
LOC3 = (0 < L_74180);
if (!(LOC3)) goto LA4;
...
switch ((*S_74050).Kind) {
case ((NU8) 0):
Result_74235 = copyString(((NimStringDesc*) &TMP196701));
break;
case ((NU8) 1):
Result_74235 = copyString(((NimStringDesc*) &TMP196701));
while (1) {
...
Llstreamwrite_74054(S_74069, ((NimStringDesc*) &TMP196703));
}
...
asgnRefNoCycle((void**) &(*Result_74154).S, copyString(((NimStringDesc*) &TMP196701)));
return Result_74154;
}
