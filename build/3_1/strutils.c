...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193650, "invalid integer: ", 17);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP193697, "invalid float: ", 15);
STRING_LITERAL(TMP193739, "0123456789ABCDEF", 16);
...
appendString(LOC5, ((NimStringDesc*) &TMP193650));
...
appendString(LOC5, ((NimStringDesc*) &TMP193697));
...
J_24397 = Res_24400;
Result_24387->data[J_24397] = ((NimStringDesc*) &TMP193739)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(X_24385) >> (NU64)(Shift_24389)))) & ((NI32) 15))];
