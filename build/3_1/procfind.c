...
STRING_LITERAL(TMP194168, "equalGenericParams", 18);
static N_INLINE(NI, Sonslen_54803)(TY54525* N_54805) {
NI Result_55880;
Result_55880 = 0;
...
Internalerror_46571((*Proca_120016).Info, ((NimStringDesc*) &TMP194168));
LA17: ;
if (!!(((*(*Procb_120017).KindU.S6.Sons->data[I_120076]).Kind == ((NU8) 3)))) goto LA20;
Internalerror_46571((*Procb_120017).Info, ((NimStringDesc*) &TMP194168));
LA20: ;
