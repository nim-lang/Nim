...
STRING_LITERAL(TMP193639, "unknown OS error", 16);
STRING_LITERAL(TMP193712, "HOME", 4);
STRING_LITERAL(TMP193713, "/.config/", 9);
...
NI Result_40430;
Result_40430 = 0;
Result_40430 = (NI32)(((NI) (cmdCount)) - 1);
goto BeforeRet;
BeforeRet: ;
return Result_40430;
}
...
I_37550 = 0;
HEX3Atmp_37565 = 0;
HEX3Atmp_37565 = (NI32)(Path_37535->Sup.len - 1);
Res_37567 = 0;
...
unsureAsgnRef((void**) &(*Result).Head, copyStrLast(Path_37535, 0, (NI32)(Seppos_37540 - 1)));
unsureAsgnRef((void**) &(*Result).Tail, copyStr(Path_37535, (NI32)(Seppos_37540 + 1)));
goto LA5;
LA6: ;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_37659->data[(NI32)(Path_37659->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Path_37659->data[(NI32)(Path_37659->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_37697 = 0;
HEX3Atmp_37718 = 0;
HEX3Atmp_37718 = (NI32)(Path_37659->Sup.len - 1);
Res_37720 = 0;
...
unsureAsgnRef((void**) &(*Result).Dir, copyStrLast(Path_37659, 0, (NI32)(Seppos_37684 - 1)));
unsureAsgnRef((void**) &(*Result).Name, copyStrLast(Path_37659, (NI32)(Seppos_37684 + 1), (NI32)(Dotpos_37687 - 1)));
...
Result_41003 = 0;
Size_41004 = 0;
_NSGetExecutablePath(NIM_NIL, &Size_41004);
Result_41003 = mnewString(((NI) (Size_41004)));
LOC2 = _NSGetExecutablePath(Result_41003->data, &Size_41004);
if (!LOC2) goto LA3;
Result_41003 = copyString(((NimStringDesc*) &TMP193636));
LA3: ;
return Result_41003;
}
...
goto LA1;
LA2: ;
if (!(((NU8)(Head_37403->data[(NI32)(Head_37403->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Head_37403->data[(NI32)(Head_37403->Sup.len - 1)])) == ((NU8)(47)))) goto LA4;
...
I_37639 = 0;
HEX3Atmp_37654 = 0;
HEX3Atmp_37654 = (NI32)(S_37628->Sup.len - 1);
Res_37656 = 0;
...
LOC6 = 0;
LOC7 = 0;
LOC7 = copyStrLast(Filename_37820, 0, (NI32)(Extpos_37823 - 1));
LOC8 = 0;
...
asgnRefNoCycle((void**) &(*E_35821).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193639)));
...
I_39413 = 0;
HEX3Atmp_39426 = 0;
HEX3Atmp_39426 = (NI32)(Dir_39403->Sup.len - 1);
Res_39428 = 0;
Res_39428 = 1;
while (1) {
...
LOC5 = 0;
LOC5 = copyStrLast(Dir_39403, 0, (NI32)(I_39413 - 1));
...
Result_38420 = copyStr(Environment_38238->data[I_38421], (NI32)(LOC4 + 1));
goto BeforeRet;
goto LA1;
LA2: ;
Env_38424 = 0;
...
LOC1 = 0;
LOC2 = 0;
LOC2 = Getenv_38417(((NimStringDesc*) &TMP193712));
LOC1 = rawNewString(LOC2->Sup.len + 9);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP193713));
Result_40203 = LOC1;
goto BeforeRet;
BeforeRet: ;
return Result_40203;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_37727->data[(NI32)(Path_37727->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Path_37727->data[(NI32)(Path_37727->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
A_41207.tv_sec = ((NI) ((NI32)(Milsecs_41206 / 1000)));
A_41207.tv_nsec = (NI32)((NI32)(Milsecs_41206 % 1000) * 1000);
