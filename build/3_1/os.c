...
STRING_LITERAL(TMP45220, "unknown OS error", 16);
...
Result_41203 = 0;
Size_41204 = 0;
F.line = 1193;F.filename = "os.nim";
_NSGetExecutablePath(NIM_NIL, &Size_41204);
F.line = 1194;F.filename = "os.nim";
Result_41203 = mnewString(((NI) (Size_41204)));
F.line = 1195;F.filename = "os.nim";
LOC2 = _NSGetExecutablePath(Result_41203->data, &Size_41204);
if (!LOC2) goto LA3;
F.line = 1196;F.filename = "os.nim";
Result_41203 = copyString(((NimStringDesc*) &TMP44351));
LA3: ;
framePtr = framePtr->prev;
return Result_41203;
}
...
F.line = 1279;F.filename = "system.nim";
asgnRefNoCycle((void**) &(*E_35821).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP45220)));
