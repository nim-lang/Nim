...
STRING_LITERAL(TMP193651, "unknown OS error", 16);
STRING_LITERAL(TMP193717, "HOME", 4);
STRING_LITERAL(TMP193718, "/.config/", 9);
...
NI Result_39630;
Result_39630 = 0;
Result_39630 = (NI32)(((NI) (cmdCount)) - 1);
goto BeforeRet;
BeforeRet: ;
return Result_39630;
}
...
I_36592 = 0;
HEX3Atmp_36608 = 0;
HEX3Atmp_36608 = (NI32)(Path_36577->Sup.len - 1);
Res_36610 = 0;
...
unsureAsgnRef((void**) &(*Result).Head, copyStrLast(Path_36577, 0, (NI32)(Seppos_36582 - 1)));
unsureAsgnRef((void**) &(*Result).Tail, copyStr(Path_36577, (NI32)(Seppos_36582 + 1)));
goto LA5;
LA6: ;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_36714->data[(NI32)(Path_36714->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Path_36714->data[(NI32)(Path_36714->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_36752 = 0;
HEX3Atmp_36774 = 0;
HEX3Atmp_36774 = (NI32)(Path_36714->Sup.len - 1);
Res_36776 = 0;
...
unsureAsgnRef((void**) &(*Result).Dir, copyStrLast(Path_36714, 0, (NI32)(Seppos_36739 - 1)));
unsureAsgnRef((void**) &(*Result).Name, copyStrLast(Path_36714, (NI32)(Seppos_36739 + 1), (NI32)(Dotpos_36742 - 1)));
...
Result_40203 = 0;
Size_40204 = 0;
_NSGetExecutablePath(NIM_NIL, &Size_40204);
Result_40203 = mnewString(((NI) (Size_40204)));
LOC2 = _NSGetExecutablePath(Result_40203->data, &Size_40204);
if (!LOC2) goto LA3;
Result_40203 = copyString(((NimStringDesc*) &TMP193648));
LA3: ;
return Result_40203;
}
...
goto LA1;
LA2: ;
if (!(((NU8)(Head_36403->data[(NI32)(Head_36403->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Head_36403->data[(NI32)(Head_36403->Sup.len - 1)])) == ((NU8)(47)))) goto LA4;
...
I_36691 = 0;
HEX3Atmp_36707 = 0;
HEX3Atmp_36707 = (NI32)(S_36680->Sup.len - 1);
Res_36709 = 0;
...
goto LA1;
LA2: ;
LOC7 = copyStrLast(Filename_37020, 0, (NI32)(Extpos_37023 - 1));
...
asgnRefNoCycle((void**) &(*E_34821).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193651)));
...
I_38613 = 0;
HEX3Atmp_38627 = 0;
HEX3Atmp_38627 = (NI32)(Dir_38603->Sup.len - 1);
Res_38629 = 0;
Res_38629 = 1;
while (1) {
...
LOC5 = copyStrLast(Dir_38603, 0, (NI32)(I_38613 - 1));
...
Result_37628 = copyStr(Environment_37439->data[I_37629], (NI32)(LOC4 + 1));
goto BeforeRet;
goto LA1;
LA2: ;
Env_37632 = 0;
...
NimStringDesc* LOC2;
Result_39403 = 0;
LOC2 = Getenv_37625(((NimStringDesc*) &TMP193717));
LOC1 = rawNewString(LOC2->Sup.len + 9);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP193718));
Result_39403 = LOC1;
goto BeforeRet;
BeforeRet: ;
return Result_39403;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_36785->data[(NI32)(Path_36785->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Path_36785->data[(NI32)(Path_36785->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
A_40407.tv_sec = ((NI) ((NI32)(Milsecs_40406 / 1000)));
A_40407.tv_nsec = (NI32)((NI32)(Milsecs_40406 % 1000) * 1000);
