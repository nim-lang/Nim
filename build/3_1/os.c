...
STRING_LITERAL(TMP77535, "HOME", 4);
STRING_LITERAL(TMP77536, "/.config/", 9);
STRING_LITERAL(TMP193612, "invalid index", 13);
...
LOC1 = 0;
LOC2 = 0;
LOC2 = Getenv_38625(((NimStringDesc*) &TMP77535));
LOC1 = rawNewString(LOC2->Sup.len + 9);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP77536));
Result_40403 = LOC1;
goto BeforeRet;
BeforeRet: ;
framePtr = framePtr->prev;
...
F.line = 1280;F.filename = "system.nim";
asgnRefNoCycle((void**) &(*E_40612).Sup.Sup.message, copyString(((NimStringDesc*) &TMP193612)));
