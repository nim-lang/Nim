...
STRING_LITERAL(TMP193641, "crc", 3);
extern NIM_CONST TY50054 Os_50053;
extern NIM_CONST TY50461 Cpu_50460;
STRING_LITERAL(TMP193643, "0", 1);
STRING_LITERAL(TMP193662, " ", 1);
STRING_LITERAL(TMP193668, ".options.always", 15);
STRING_LITERAL(TMP193669, ".options.linker", 15);
STRING_LITERAL(TMP193670, ".path", 5);
STRING_LITERAL(TMP193718, ".cpp", 4);
STRING_LITERAL(TMP193719, ".m", 2);
STRING_LITERAL(TMP194777, ".debug", 6);
STRING_LITERAL(TMP194778, ".options.debug", 14);
STRING_LITERAL(TMP194779, ".speed", 6);
STRING_LITERAL(TMP194780, ".options.speed", 14);
STRING_LITERAL(TMP194781, ".size", 5);
STRING_LITERAL(TMP194782, ".options.size", 13);
STRING_LITERAL(TMP194783, ".always", 7);
STRING_LITERAL(TMP194784, ".exe", 4);
STRING_LITERAL(TMP194785, "exe", 3);
STRING_LITERAL(TMP194786, "file", 4);
STRING_LITERAL(TMP194787, "objfile", 7);
STRING_LITERAL(TMP194788, "options", 7);
STRING_LITERAL(TMP194789, "include", 7);
STRING_LITERAL(TMP194790, "nimrod", 6);
STRING_LITERAL(TMP194791, "lib", 3);
STRING_LITERAL(TMP194801, "[C_Files]\012", 10);
STRING_LITERAL(TMP194802, "--file:r\"$1\"$n", 14);
STRING_LITERAL(TMP194803, "[Symbols]$n$1", 13);
STRING_LITERAL(TMP194804, "mapping.txt", 11);
STRING_LITERAL(TMP194865, ".linkerexe", 10);
STRING_LITERAL(TMP194866, "builddll", 8);
STRING_LITERAL(TMP194867, "buildgui", 8);
STRING_LITERAL(TMP194868, "objfiles", 8);
STRING_LITERAL(TMP194869, "exefile", 7);
STRING_LITERAL(TMP194870, "compile_", 8);
...
Result_69520 = 0;
Crcfile_69521 = 0;
Crcfile_69521 = Togeneratedfile_45104(Filename_69519, ((NimStringDesc*) &TMP193641));
Currentcrc_69522 = 0;
...
LA8: ;
if (!LOC7) goto LA9;
Line_69525 = copyString(((NimStringDesc*) &TMP193643));
LA9: ;
fclose(F_69523);
Oldcrc_69530 = 0;
...
appendString((*Dest_69444), ((NimStringDesc*) &TMP193662));
LA4: ;
...
appendString(LOC4, ((NimStringDesc*) &TMP193668));
...
appendString(LOC5, ((NimStringDesc*) &TMP193669));
...
appendString(LOC6, ((NimStringDesc*) &TMP193670));
...
asgnRefNoCycle((void**) &Cext_69342, copyString(((NimStringDesc*) &TMP193718)));
goto LA2;
LA3: ;
...
appendString(LOC7, ((NimStringDesc*) &TMP193668));
LOC8 = 0;
...
appendString(LOC9, ((NimStringDesc*) &TMP193669));
LOC10 = 0;
...
appendString(LOC14, ((NimStringDesc*) &TMP193670));
...
appendString(LOC1, ((NimStringDesc*) &TMP194778));
...
appendString(LOC5, ((NimStringDesc*) &TMP194777));
Key_69613 = LOC5;
...
appendString(LOC15, ((NimStringDesc*) &TMP194779));
Key_69613 = LOC15;
...
appendString(LOC24, ((NimStringDesc*) &TMP194781));
Key_69613 = LOC24;
...
appendString(LOC31, ((NimStringDesc*) &TMP194783));
Key_69613 = LOC31;
...
appendString(LOC37, ((NimStringDesc*) &TMP194784));
Key_69613 = LOC37;
...
Exe_69615 = nosaddFileExt(Exe_69615, ((NimStringDesc*) &TMP194785));
LA43: ;
...
LOC65[0] = copyString(((NimStringDesc*) &TMP194786));
LOC65[1] = copyString(Cfile_69608);
LOC65[2] = copyString(((NimStringDesc*) &TMP194787));
LOC65[3] = copyString(Objfile_69609);
LOC65[4] = copyString(((NimStringDesc*) &TMP194788));
LOC65[5] = copyString(Options_69610);
LOC65[6] = copyString(((NimStringDesc*) &TMP194789));
LOC65[7] = copyString(Includecmd_69611);
LOC65[8] = copyString(((NimStringDesc*) &TMP194790));
LOC65[9] = Getprefixdir_45108();
LOC65[10] = copyString(((NimStringDesc*) &TMP194791));
...
LOC67[0] = copyString(((NimStringDesc*) &TMP194786));
LOC67[1] = copyString(Cfile_69608);
LOC67[2] = copyString(((NimStringDesc*) &TMP194787));
LOC67[3] = copyString(Objfile_69609);
LOC67[4] = copyString(((NimStringDesc*) &TMP194788));
LOC67[5] = copyString(Options_69610);
LOC67[6] = copyString(((NimStringDesc*) &TMP194789));
LOC67[7] = copyString(Includecmd_69611);
LOC67[8] = copyString(((NimStringDesc*) &TMP194790));
LOC68 = 0;
LOC68 = Getprefixdir_45108();
LOC67[9] = Quoteifcontainswhite_25255(LOC68);
LOC67[10] = copyString(((NimStringDesc*) &TMP194791));
...
Appf_51071(&Result_70044, ((NimStringDesc*) &TMP194802), LOC2, 1);
...
LA2: ;
Code_70076 = 0;
Code_70076 = Torope_51046(((NimStringDesc*) &TMP194801));
LOC4 = 0;
...
Appf_51071(&Code_70076, ((NimStringDesc*) &TMP194803), LOC6, 1);
LOC7 = 0;
LOC7 = nosJoinPath(Projectpath_45112, ((NimStringDesc*) &TMP194804));
...
appendString(LOC2, ((NimStringDesc*) &TMP194870));
...
appendString(LOC26, ((NimStringDesc*) &TMP194865));
...
Linkerexe_69924 = nosaddFileExt(Linkerexe_69924, ((NimStringDesc*) &TMP194785));
LA31: ;
...
LOC59[0] = copyString(((NimStringDesc*) &TMP194866));
LOC59[1] = copyString(Builddll_69802);
LOC59[2] = copyString(((NimStringDesc*) &TMP194867));
LOC59[3] = copyString(Buildgui_69801);
LOC59[4] = copyString(((NimStringDesc*) &TMP194788));
LOC59[5] = copyString(Linkoptions_69347);
LOC59[6] = copyString(((NimStringDesc*) &TMP194868));
LOC59[7] = copyString(Objfiles_69984);
LOC59[8] = copyString(((NimStringDesc*) &TMP194869));
LOC59[9] = copyString(Exefile_69958);
LOC59[10] = copyString(((NimStringDesc*) &TMP194790));
LOC59[11] = Getprefixdir_45108();
LOC59[12] = copyString(((NimStringDesc*) &TMP194791));
...
LOC61[0] = copyString(((NimStringDesc*) &TMP194866));
LOC61[1] = copyString(Builddll_69802);
LOC61[2] = copyString(((NimStringDesc*) &TMP194867));
LOC61[3] = copyString(Buildgui_69801);
LOC61[4] = copyString(((NimStringDesc*) &TMP194788));
LOC61[5] = copyString(Linkoptions_69347);
LOC61[6] = copyString(((NimStringDesc*) &TMP194868));
LOC61[7] = copyString(Objfiles_69984);
LOC61[8] = copyString(((NimStringDesc*) &TMP194869));
LOC61[9] = copyString(Exefile_69958);
LOC61[10] = copyString(((NimStringDesc*) &TMP194790));
LOC62 = 0;
LOC62 = Getprefixdir_45108();
LOC61[11] = Quoteifcontainswhite_25255(LOC62);
LOC61[12] = copyString(((NimStringDesc*) &TMP194791));
...
Write_3658(F_69542, ((NimStringDesc*) &TMP195504));
}
