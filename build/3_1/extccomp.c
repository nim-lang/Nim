...
STRING_LITERAL(TMP193653, "crc", 3);
STRING_LITERAL(TMP193654, "0", 1);
STRING_LITERAL(TMP193667, " ", 1);
STRING_LITERAL(TMP193673, ".options.always", 15);
STRING_LITERAL(TMP193674, ".options.linker", 15);
STRING_LITERAL(TMP193675, ".path", 5);
STRING_LITERAL(TMP193723, ".cpp", 4);
STRING_LITERAL(TMP194784, ".debug", 6);
STRING_LITERAL(TMP194785, ".options.debug", 14);
STRING_LITERAL(TMP194786, ".speed", 6);
STRING_LITERAL(TMP194787, ".options.speed", 14);
STRING_LITERAL(TMP194788, ".size", 5);
STRING_LITERAL(TMP194789, ".options.size", 13);
STRING_LITERAL(TMP194790, ".always", 7);
STRING_LITERAL(TMP194791, ".exe", 4);
STRING_LITERAL(TMP194792, "exe", 3);
extern NIM_CONST TY49054 Os_49053;
STRING_LITERAL(TMP194793, "file", 4);
STRING_LITERAL(TMP194794, "objfile", 7);
STRING_LITERAL(TMP194795, "options", 7);
STRING_LITERAL(TMP194796, "include", 7);
STRING_LITERAL(TMP194797, "nimrod", 6);
STRING_LITERAL(TMP194798, "lib", 3);
STRING_LITERAL(TMP194808, "[C_Files]\012", 10);
STRING_LITERAL(TMP194809, "--file:r\"$1\"$n", 14);
STRING_LITERAL(TMP194810, "[Symbols]$n$1", 13);
STRING_LITERAL(TMP194811, "mapping.txt", 11);
STRING_LITERAL(TMP194872, ".linkerexe", 10);
STRING_LITERAL(TMP194873, "builddll", 8);
STRING_LITERAL(TMP194874, "buildgui", 8);
STRING_LITERAL(TMP194875, "objfiles", 8);
STRING_LITERAL(TMP194876, "exefile", 7);
STRING_LITERAL(TMP194877, "compile_", 8);
...
Result_67607 = 0;
Crcfile_67608 = 0;
Crcfile_67608 = Togeneratedfile_44103(Filename_67606, ((NimStringDesc*) &TMP193653));
Currentcrc_67609 = 0;
...
LA8: ;
if (!LOC7) goto LA9;
Line_67612 = copyString(((NimStringDesc*) &TMP193654));
LA9: ;
fclose(F_67610);
Oldcrc_67617 = 0;
...
appendString((*Dest_67574), ((NimStringDesc*) &TMP193667));
LA4: ;
...
appendString(LOC4, ((NimStringDesc*) &TMP193673));
...
appendString(LOC6, ((NimStringDesc*) &TMP193675));
...
asgnRefNoCycle((void**) &Cext_67342, copyString(((NimStringDesc*) &TMP193723)));
LA3: ;
LOC5 = rawNewString(Cc_67041[(Ccompiler_67340)-1].Name->Sup.len + 15);
appendString(LOC5, Cc_67041[(Ccompiler_67340)-1].Name);
appendString(LOC5, ((NimStringDesc*) &TMP193673));
...
appendString(LOC7, ((NimStringDesc*) &TMP193674));
...
appendString(LOC12, ((NimStringDesc*) &TMP193675));
...
appendString(LOC1, ((NimStringDesc*) &TMP194785));
...
appendString(LOC5, ((NimStringDesc*) &TMP194784));
Key_67732 = LOC5;
...
appendString(LOC15, ((NimStringDesc*) &TMP194786));
Key_67732 = LOC15;
...
appendString(LOC24, ((NimStringDesc*) &TMP194788));
Key_67732 = LOC24;
...
appendString(LOC31, ((NimStringDesc*) &TMP194790));
Key_67732 = LOC31;
...
appendString(LOC37, ((NimStringDesc*) &TMP194791));
Key_67732 = LOC37;
...
Exe_67734 = nosaddFileExt(Exe_67734, ((NimStringDesc*) &TMP194792));
LA43: ;
...
LOC65[0] = copyString(((NimStringDesc*) &TMP194793));
LOC65[1] = copyString(Cfile_67727);
LOC65[2] = copyString(((NimStringDesc*) &TMP194794));
LOC65[3] = copyString(Objfile_67728);
LOC65[4] = copyString(((NimStringDesc*) &TMP194795));
LOC65[5] = copyString(Options_67729);
LOC65[6] = copyString(((NimStringDesc*) &TMP194796));
LOC65[7] = copyString(Includecmd_67730);
LOC65[8] = copyString(((NimStringDesc*) &TMP194797));
LOC65[9] = Getprefixdir_44107();
LOC65[10] = copyString(((NimStringDesc*) &TMP194798));
...
LOC67[0] = copyString(((NimStringDesc*) &TMP194793));
LOC67[1] = copyString(Cfile_67727);
LOC67[2] = copyString(((NimStringDesc*) &TMP194794));
LOC67[3] = copyString(Objfile_67728);
LOC67[4] = copyString(((NimStringDesc*) &TMP194795));
LOC67[5] = copyString(Options_67729);
LOC67[6] = copyString(((NimStringDesc*) &TMP194796));
LOC67[7] = copyString(Includecmd_67730);
LOC67[8] = copyString(((NimStringDesc*) &TMP194797));
LOC68 = Getprefixdir_44107();
LOC67[9] = Quoteifcontainswhite_24283(LOC68);
LOC67[10] = copyString(((NimStringDesc*) &TMP194798));
...
Appf_50074(&Result_68228, ((NimStringDesc*) &TMP194809), LOC2, 1);
...
LA2: ;
Code_68261 = 0;
Code_68261 = Torope_50046(((NimStringDesc*) &TMP194808));
...
Appf_50074(&Code_68261, ((NimStringDesc*) &TMP194810), LOC6, 1);
LOC7 = nosJoinPath(Projectpath_44111, ((NimStringDesc*) &TMP194811));
...
appendString(LOC2, ((NimStringDesc*) &TMP194877));
...
appendString(LOC26, ((NimStringDesc*) &TMP194872));
...
Linkerexe_68096 = nosaddFileExt(Linkerexe_68096, ((NimStringDesc*) &TMP194792));
LA31: ;
...
LOC60[0] = copyString(((NimStringDesc*) &TMP194873));
LOC60[1] = copyString(Builddll_67966);
LOC60[2] = copyString(((NimStringDesc*) &TMP194874));
LOC60[3] = copyString(Buildgui_67965);
LOC60[4] = copyString(((NimStringDesc*) &TMP194795));
LOC60[5] = copyString(Linkoptions_67390);
LOC60[6] = copyString(((NimStringDesc*) &TMP194875));
LOC60[7] = copyString(Objfiles_68164);
LOC60[8] = copyString(((NimStringDesc*) &TMP194876));
LOC60[9] = copyString(Exefile_68130);
LOC60[10] = copyString(((NimStringDesc*) &TMP194797));
LOC60[11] = Getprefixdir_44107();
LOC60[12] = copyString(((NimStringDesc*) &TMP194798));
...
LOC62[0] = copyString(((NimStringDesc*) &TMP194873));
LOC62[1] = copyString(Builddll_67966);
LOC62[2] = copyString(((NimStringDesc*) &TMP194874));
LOC62[3] = copyString(Buildgui_67965);
LOC62[4] = copyString(((NimStringDesc*) &TMP194795));
LOC62[5] = copyString(Linkoptions_67390);
LOC62[6] = copyString(((NimStringDesc*) &TMP194875));
LOC62[7] = copyString(Objfiles_68164);
LOC62[8] = copyString(((NimStringDesc*) &TMP194876));
LOC62[9] = copyString(Exefile_68130);
LOC62[10] = copyString(((NimStringDesc*) &TMP194797));
LOC63 = Getprefixdir_44107();
LOC62[11] = Quoteifcontainswhite_24283(LOC63);
LOC62[12] = copyString(((NimStringDesc*) &TMP194798));
...
Write_3658(F_67629, ((NimStringDesc*) &TMP195494));
}
