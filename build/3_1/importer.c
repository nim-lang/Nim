...
STRING_LITERAL(TMP198233, "nim", 3);
STRING_LITERAL(TMP198234, "getModuleFile()", 15);
STRING_LITERAL(TMP198235, "", 0);
STRING_LITERAL(TMP198236, "importAllSymbols: ", 18);
STRING_LITERAL(TMP198237, "rawImportSymbol", 15);
STRING_LITERAL(TMP198239, "importSymbol", 12);
STRING_LITERAL(TMP198240, "importSymbol: 2", 15);
STRING_LITERAL(TMP198241, "importSymbol: 3", 15);
...
LOC1 = 0;
LOC1 = nosaddFileExt(Modulename_111019, ((NimStringDesc*) &TMP198233));
...
break;
default:
Internalerror_49208((*N_111015).Info, ((NimStringDesc*) &TMP198234));
Result_111024 = copyString(((NimStringDesc*) &TMP198235));
break;
}
...
if (!((*Etyp_111103).Kind == ((NU8) 1) || (*Etyp_111103).Kind == ((NU8) 14))) goto LA13;
J_111139 = 0;
HEX3Atmp_111210 = 0;
LOC15 = Sonslen_56804((*Etyp_111103).N);
HEX3Atmp_111210 = (NI32)(LOC15 - 1);
Res_111212 = 0;
Res_111212 = 0;
while (1) {
...
Internalerror_49208((*S_111064).Info, ((NimStringDesc*) &TMP198237));
LA18: ;
...
appendString(LOC11, ((NimStringDesc*) &TMP198236));
...
Internalerror_49208((*Ident_111216).Info, ((NimStringDesc*) &TMP198239));
LA2: ;
S_111239 = NIM_NIL;
