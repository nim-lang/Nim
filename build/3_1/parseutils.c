...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP197654, "overflow", 8);
...
NI64 Sign_22952;
NI I_22953;
NI64 TMP197649;NI TMP197650;NI64 TMP197651;NI64 TMP197652;NI TMP197653;Result_22951 = 0;
Sign_22952 = 0;
Sign_22952 = -1;
I_22953 = 0;
I_22953 = Start_22950;
...
TMP197649 = mulInt64((*B_22949), 10);TMP197650 = subInt(((NU8)(S_22947->data[I_22953])), 48);TMP197651 = subInt64((NI64)(TMP197649), ((NI64) ((NI32)(TMP197650))));(*B_22949) = (NI64)(TMP197651);
I_22953 = addInt(I_22953, 1);
while (1) {
...
TMP197652 = mulInt64((*B_22949), Sign_22952);(*B_22949) = (NI64)(TMP197652);
TMP197653 = subInt(I_22953, Start_22950);Result_22951 = (NI32)(TMP197653);
LA7: ;
return Result_22951;
}
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* S_23044, NI64* Number_23046, NI Start_23047) {
...
asgnRefNoCycle((void**) &(*E_23069).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP197654)));
