...
STRING_LITERAL(TMP196867, "nim", 3);
STRING_LITERAL(TMP196920, "handleSymbolFile should have set the module\'s ID", 48);
STRING_LITERAL(TMP196922, "command line", 12);
STRING_LITERAL(TMP196923, "", 0);
STRING_LITERAL(TMP197867, "system", 6);
STRING_LITERAL(TMP198087, "pretty.nim", 10);
STRING_LITERAL(TMP198088, "nimdoc.cfg", 10);
STRING_LITERAL(TMP198476, "nimdoc.tex.cfg", 14);
STRING_LITERAL(TMP198484, "dot -Tpng -o", 12);
STRING_LITERAL(TMP198485, "png", 3);
STRING_LITERAL(TMP198486, "dot", 3);
STRING_LITERAL(TMP198488, "Beware: Indentation tokens depend on the parser\'s state!", 56);
STRING_LITERAL(TMP198489, "stdin", 5);
...
Compmods_192227 = (TY192208*) setLengthSeq(&(Compmods_192227)->Sup, sizeof(TY192206), (NI32)(Length_192243 + 1));
...
Rd_192359 = NIM_NIL;
F_192360 = 0;
F_192360 = nosaddFileExt(Filename_192324, ((NimStringDesc*) &TMP196867));
...
Internalerror_47571(((NimStringDesc*) &TMP196920));
LA13: ;
goto LA7;
LA10: ;
...
LOC4 = Newlineinfo_47574(((NimStringDesc*) &TMP196922), 1, 1);
Limessage_47562(LOC4, ((NU8) 181), ((NimStringDesc*) &TMP196923));
LA2: ;
}
N_NIMCALL(void, Semanticpasses_192408)(void) {
TY104006 LOC1;
...
TY55547* LOC5;
LOC1 = 0;
LOC1 = nosaddFileExt(((NimStringDesc*) &TMP197867), ((NimStringDesc*) &TMP196867));
LOC2 = 0;
LOC2 = nosJoinPath(Libpath_46110, LOC1);
LOC3 = 0;
LOC3 = Compilemodule_192322(LOC2, NIM_FALSE, NIM_TRUE);
LOC4 = 0;
LOC4 = nosaddFileExt(Filename_192407, ((NimStringDesc*) &TMP196867));
LOC5 = 0;
...
LOC6 = 0;
LOC6 = nosChangeFileExt(Filename_192438, ((NimStringDesc*) &TMP196923));
...
Module_192646 = 0;
LOC1 = 0;
LOC1 = nosaddFileExt(Filename_192645, ((NimStringDesc*) &TMP196867));
Module_192646 = Parsefile_91031(LOC1);
if (!!((Module_192646 == NIM_NIL))) goto LA3;
LOC5 = 0;
LOC5 = Getoutfile_46143(Filename_192645, ((NimStringDesc*) &TMP198087));
...
LOC3 = 0;
LOC4 = 0;
LOC4 = nosChangeFileExt(Filename_192412, ((NimStringDesc*) &TMP198485));
LOC5 = 0;
LOC5 = nosChangeFileExt(Filename_192412, ((NimStringDesc*) &TMP198486));
LOC3 = rawNewString(LOC4->Sup.len + LOC5->Sup.len + 13);
appendString(LOC3, ((NimStringDesc*) &TMP198484));
...
TY76263* Tok_192683;
F_192669 = 0;
F_192669 = nosaddFileExt(Filename_192668, ((NimStringDesc*) &TMP196867));
Stream_192670 = 0;
...
LOC5 = 0;
LOC5 = nosaddFileExt(((NimStringDesc*) &TMP197867), ((NimStringDesc*) &TMP196867));
LOC6 = 0;
LOC6 = nosJoinPath(Libpath_46110, LOC5);
LOC7 = 0;
LOC7 = Compilemodule_192322(LOC6, NIM_FALSE, NIM_TRUE);
M_192630 = 0;
M_192630 = Newmodule_192289(((NimStringDesc*) &TMP198489));
(*M_192630).Sup.Id = Getid_55693();
(*M_192630).Flags |=(1<<((NI32)(((NU8) 15))%(sizeof(NI32)*8)));
LOC8 = 0;
LOC8 = Llstreamopenstdin_74038();
Processmodule_104035(M_192630, ((NimStringDesc*) &TMP198489), LOC8, NIM_NIL);
}
...
case ((NU8) 205):
Gcmd_46082 = ((NU8) 7);
Loadspecialconfig_79007(((NimStringDesc*) &TMP198088));
Wantfile_192713(Filename_192204);
...
case ((NU8) 213):
Gcmd_46082 = ((NU8) 15);
Loadspecialconfig_79007(((NimStringDesc*) &TMP198476));
Wantfile_192713(Filename_192204);
...
Wantfile_192713(Filename_192204);
LOC6 = 0;
LOC6 = nosaddFileExt(Filename_192204, ((NimStringDesc*) &TMP196867));
LOC7 = 0;
...
Messageout_47550(((NimStringDesc*) &TMP198488));
break;
case ((NU8) 214):
Gcmd_46082 = ((NU8) 16);
