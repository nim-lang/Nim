...
A_66627 = (TY4177*) newSeq(NTI4177, 0);
I_66660 = 0;
HEX3Atmp_66680 = 0;
...
A_66627 = (TY4177*) incrSeq(&(A_66627)->Sup, sizeof(NimStringDesc*));
...
LOC1 = Alloc0_1777(mulInt(addInt(addInt(A_67221Len0, B_67220Len0), 1), 4));
...
LOC3 = Alloc_1774(addInt(B_67220[I_67250]->Sup.len, 1));
...
LOC5 = Alloc_1774(addInt(A_67221[I_67262]->Sup.len, 1));
...
LOC1 = nstlen(T_67289);
LOC2 = Alloc0_1777(mulInt(addInt(LOC1, 1), 4));
...
LOC8 = Alloc_1774(addInt(X_67312->Sup.len, 1));
...
static N_INLINE(void, rawEchoNL)(void) {
Write_3458(stdout, ((NimStringDesc*) &TMP67002));
}
N_NIMCALL(TY66202*, nospstartProcess)(NimStringDesc* Command_66238, NimStringDesc* Workingdir_66239, NimStringDesc** Args_66244, NI Args_66244Len0, TY64408* Env_66245, NU8 Options_66248) {
...
LOC2 = Open_3424(&F_67522, (*P_66270).Inputhandle, ((NU8) 1));
if (!!(LOC2)) goto LA3;
F.line = 516;F.filename = "osproc.nim";
nosOSError(((NimStringDesc*) &TMP66685));
LA3: ;
...
LOC2 = Open_3424(&F_67528, (*P_66273).Outputhandle, ((NU8) 0));
if (!!(LOC2)) goto LA3;
F.line = 521;F.filename = "osproc.nim";
nosOSError(((NimStringDesc*) &TMP66685));
LA3: ;
...
LOC2 = Open_3424(&F_67534, (*P_66276).Errorhandle, ((NU8) 0));
if (!!(LOC2)) goto LA3;
F.line = 526;F.filename = "osproc.nim";
nosOSError(((NimStringDesc*) &TMP66685));
LA3: ;
