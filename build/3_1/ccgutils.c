...
STRING_LITERAL(TMP197306, "c\"", 2);
STRING_LITERAL(TMP197307, "\\00\"", 4);
STRING_LITERAL(TMP197309, "\"", 1);
STRING_LITERAL(TMP197310, "\012", 1);
...
Res_157226 = copyString(((NimStringDesc*) &TMP197306));
I_157236 = 0;
HEX3Atmp_157247 = 0;
...
appendString(Res_157226, ((NimStringDesc*) &TMP197307));
LOC7 = 0;
...
Res_157200 = copyString(((NimStringDesc*) &TMP197309));
I_157210 = 0;
HEX3Atmp_157216 = 0;
...
appendString(Res_157200, ((NimStringDesc*) &TMP197310));
LOC5 = 0;
