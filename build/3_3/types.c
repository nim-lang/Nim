...
STRING_LITERAL(TMP195930, "None", 4);
STRING_LITERAL(TMP195931, "bool", 4);
STRING_LITERAL(TMP195932, "Char", 4);
STRING_LITERAL(TMP195933, "empty", 5);
STRING_LITERAL(TMP195934, "Array Constructor [$1]", 22);
STRING_LITERAL(TMP195935, "nil", 3);
STRING_LITERAL(TMP195936, "expr", 4);
STRING_LITERAL(TMP195937, "stmt", 4);
STRING_LITERAL(TMP195938, "typeDesc", 8);
STRING_LITERAL(TMP195939, "GenericInvokation", 17);
STRING_LITERAL(TMP195940, "GenericBody", 11);
STRING_LITERAL(TMP195941, "GenericInst", 11);
STRING_LITERAL(TMP195942, "GenericParam", 12);
STRING_LITERAL(TMP195943, "distinct $1", 11);
STRING_LITERAL(TMP195944, "enum", 4);
STRING_LITERAL(TMP195945, "ordinal[$1]", 11);
STRING_LITERAL(TMP195946, "array[$1, $2]", 13);
STRING_LITERAL(TMP195947, "object", 6);
STRING_LITERAL(TMP195948, "tuple", 5);
STRING_LITERAL(TMP195949, "set[$1]", 7);
STRING_LITERAL(TMP195950, "range[$1]", 9);
STRING_LITERAL(TMP195951, "ptr ", 4);
STRING_LITERAL(TMP195952, "ref ", 4);
STRING_LITERAL(TMP195953, "var ", 4);
STRING_LITERAL(TMP195954, "seq[$1]", 7);
STRING_LITERAL(TMP195955, "proc", 4);
STRING_LITERAL(TMP195956, "pointer", 7);
STRING_LITERAL(TMP195957, "OpenArray[$1]", 13);
STRING_LITERAL(TMP195958, "string", 6);
STRING_LITERAL(TMP195959, "CString", 7);
STRING_LITERAL(TMP195960, "Forward", 7);
STRING_LITERAL(TMP195961, "int", 3);
STRING_LITERAL(TMP195962, "int8", 4);
STRING_LITERAL(TMP195963, "int16", 5);
STRING_LITERAL(TMP195964, "int32", 5);
STRING_LITERAL(TMP195965, "int64", 5);
STRING_LITERAL(TMP195966, "float", 5);
STRING_LITERAL(TMP195967, "float32", 7);
STRING_LITERAL(TMP195968, "float64", 7);
STRING_LITERAL(TMP195969, "float128", 8);
NIM_CONST TY98424 Typetostr_98423 = {((NimStringDesc*) &TMP195930),
((NimStringDesc*) &TMP195931),
((NimStringDesc*) &TMP195932),
...
;
STRING_LITERAL(TMP195970, "", 0);
STRING_LITERAL(TMP195971, ", ", 2);
STRING_LITERAL(TMP195972, "array[", 6);
STRING_LITERAL(TMP195974, "..", 2);
STRING_LITERAL(TMP195975, "Array constructor[", 18);
STRING_LITERAL(TMP195976, "seq[", 4);
STRING_LITERAL(TMP195977, "ordinal[", 8);
STRING_LITERAL(TMP195978, "set[", 4);
STRING_LITERAL(TMP195979, "openarray[", 10);
STRING_LITERAL(TMP195980, "distinct ", 9);
STRING_LITERAL(TMP195981, "tuple[", 6);
STRING_LITERAL(TMP195982, ": ", 2);
extern NIM_CONST TY98424 Typetostr_98423;
STRING_LITERAL(TMP195983, "range ", 6);
STRING_LITERAL(TMP195984, "proc (", 6);
extern NIM_CONST TY55016 Callingconvtostr_55015;
STRING_LITERAL(TMP195985, "noSideEffect", 12);
STRING_LITERAL(TMP195986, "{.", 2);
STRING_LITERAL(TMP195987, ".}", 2);
STRING_LITERAL(TMP195999, "invalid kind for first(", 23);
STRING_LITERAL(TMP196000, "invalid kind for last(", 22);
STRING_LITERAL(TMP196013, "computeRecSizeAux(record case branch)", 37);
STRING_LITERAL(TMP196014, "computeRecSizeAux()", 19);
STRING_LITERAL(TMP196015, "getSize(", 8);
STRING_LITERAL(TMP196073, "sameTuple", 9);
STRING_LITERAL(TMP196084, "getProcHeader", 13);
STRING_LITERAL(TMP196273, "searchTypeNodeForAux(record case branch)", 40);
STRING_LITERAL(TMP196274, "searchTypeNodeForAux()", 22);
...
appendString(LOC1, ((NimStringDesc*) &TMP195974));
...
T_98427 = 0;
T_98427 = Typ_97016;
Result_98422 = copyString(((NimStringDesc*) &TMP195970));
...
appendString(Result_98422, ((NimStringDesc*) &TMP195971));
LA14: ;
LOC16 = 0;
...
appendString(LOC20, ((NimStringDesc*) &TMP195972));
appendString(LOC20, LOC21);
appendString(LOC20, ((NimStringDesc*) &TMP195971));
...
appendString(LOC23, ((NimStringDesc*) &TMP195972));
appendString(LOC23, LOC24);
appendString(LOC23, ((NimStringDesc*) &TMP195971));
...
appendString(LOC26, ((NimStringDesc*) &TMP195975));
appendString(LOC26, LOC27);
appendString(LOC26, ((NimStringDesc*) &TMP195971));
...
appendString(LOC29, ((NimStringDesc*) &TMP195976));
...
appendString(LOC31, ((NimStringDesc*) &TMP195977));
...
appendString(LOC33, ((NimStringDesc*) &TMP195978));
...
appendString(LOC35, ((NimStringDesc*) &TMP195979));
...
appendString(LOC37, ((NimStringDesc*) &TMP195980));
appendString(LOC37, LOC38);
Result_98422 = LOC37;
break;
case ((NU8) 18):
Result_98422 = copyString(((NimStringDesc*) &TMP195981));
...
appendString(LOC44, ((NimStringDesc*) &TMP195982));
...
appendString(LOC59, ((NimStringDesc*) &TMP195983));
appendString(LOC59, LOC60);
Result_98422 = LOC59;
break;
case ((NU8) 25):
Result_98422 = copyString(((NimStringDesc*) &TMP195984));
I_98587 = 0;
HEX3Atmp_98638 = 0;
...
appendString(LOC71, ((NimStringDesc*) &TMP195982));
...
goto LA73;
LA74: ;
Prag_98603 = copyString(((NimStringDesc*) &TMP195970));
LA73: ;
if (!(((*T_98427).Flags &(1<<((((NU8) 1))&7)))!=0)) goto LA77;
Addsep_25897(&Prag_98603, ((NimStringDesc*) &TMP195971), 0);
Prag_98603 = resizeString(Prag_98603, 12);
appendString(Prag_98603, ((NimStringDesc*) &TMP195985));
LA77: ;
if (!!((Prag_98603->Sup.len == 0))) goto LA80;
LOC82 = 0;
LOC82 = rawNewString(Prag_98603->Sup.len + 4);
appendString(LOC82, ((NimStringDesc*) &TMP195986));
appendString(LOC82, Prag_98603);
appendString(LOC82, ((NimStringDesc*) &TMP195987));
...
break;
default:
Localerror_48144((*N_97111).Info, ((NU8) 71), ((NimStringDesc*) &TMP195970));
Result_97262 = 0;
break;
}
return Result_97262;
...
appendString(LOC11, ((NimStringDesc*) &TMP195999));
...
appendString(LOC6, ((NimStringDesc*) &TMP196000));
...
break;
default:
Internalerror_48163(((NimStringDesc*) &TMP196013));
break;
}
Res_100053 += 1;
} LA2: ;
...
break;
default:
Internalerror_48163(((NimStringDesc*) &TMP196014));
(*A_99915) = 1;
Result_99917 = -1;
break;
}
...
appendString(LOC4, ((NimStringDesc*) &TMP196015));
...
Internalerror_48159((*(*A_99232).N).Info, ((NimStringDesc*) &TMP196073));
LA22: ;
if (!!(((*(*(*B_99233).N).KindU.S6.Sons->data[I_99279]).Kind == ((NU8) 3)))) goto LA25;
Internalerror_48159((*(*B_99233).N).Info, ((NimStringDesc*) &TMP196073));
LA25: ;
...
Internalerror_48163(((NimStringDesc*) &TMP196084));
LA5: ;
...
appendString(Result_97315, ((NimStringDesc*) &TMP195982));
LOC7 = 0;
...
Result_97315 = resizeString(Result_97315, 2);
appendString(Result_97315, ((NimStringDesc*) &TMP195971));
LA10: ;
Res_97426 += 1;
} LA3: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP195982));
...
break;
default:
Internalerror_48159((*N_97770).Info, ((NimStringDesc*) &TMP196274));
break;
}
BeforeRet: ;
return Result_97774;
