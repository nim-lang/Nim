...
NIM_CONST NU32 Checksoptions_44072 = IL64(4261609472);
STRING_LITERAL(TMP44087, "", 0);
STRING_LITERAL(TMP193652, "nimcache", 8);
STRING_LITERAL(TMP193658, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP193652));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP193652));
LOC7[2] = copyString(Head_44259);
Subdir_44273 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_44102) goto LA9;
TMP193657.prev = excHandler;
excHandler = &TMP193657;
TMP193657.status = setjmp(TMP193657.context);
if (TMP193657.status == 0) {
noscreateDir(Subdir_44273);
} else {
if ((TMP193657.exc->Sup.m_type == NTI422)) {
LOC11 = rawNewString(Subdir_44273->Sup.len + 25);
appendString(LOC11, ((NimStringDesc*) &TMP193658));
...
if (TMP193657.status != 0) { raiseException(TMP193657.exc, TMP193657.exc->name); }
LA9: ;
...
Write_3658(F_44288, ((NimStringDesc*) &TMP195492));
}
N_NOINLINE(void, optionsInit)(void) {
TY44349 LOC1;
Goptions_44075 = 1050280192;
Gglobaloptions_44077 = 134217728;
