...
STRING_LITERAL(TMP196652, "nimcache", 8);
STRING_LITERAL(TMP196664, "cannot create directory: ", 25);
STRING_LITERAL(TMP198502, "\012", 1);
NU32 Goptions_46075;
...
LOC6[1] = copyString(((NimStringDesc*) &TMP196652));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP196652));
LOC7[2] = copyString(Head_46259);
Subdir_46273 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_46102) goto LA9;
pushSafePoint(&TMP196663);
TMP196663.status = setjmp(TMP196663.context);
if (TMP196663.status == 0) {
...
appendString(LOC11, ((NimStringDesc*) &TMP196664));
appendString(LOC11, Subdir_46273);
Writeln_46285(stdout, LOC11);
exit(1);
TMP196663.status = 0;popCurrentException();}
}
if (TMP196663.status != 0) reraiseException();
LA9: ;
...
Write_3658(F_46288, ((NimStringDesc*) &TMP198502));
}
