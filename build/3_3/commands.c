...
STRING_LITERAL(TMP193649, "lib", 3);
STRING_LITERAL(TMP193650, "", 0);
STRING_LITERAL(TMP193659, "boehmgc", 7);
STRING_LITERAL(TMP193660, "nogc", 4);
extern NIM_CONST TY45494 Hintstostr_45493;
extern NIM_CONST TY45474 Warningstostr_45473;
STRING_LITERAL(TMP193661, "endb", 4);
STRING_LITERAL(TMP193662, "profiler", 8);
STRING_LITERAL(TMP193663, "guiapp", 6);
STRING_LITERAL(TMP193664, "library", 7);
STRING_LITERAL(TMP193668, "Advanced commands::\012  pretty                    pretty print th"
...
LOC1[2] = copyString(((NimStringDesc*) &TMP193649));
...
LA2: ;
Trunc_70415 = 0;
Trunc_70415 = nosChangeFileExt(Found_70414, ((NimStringDesc*) &TMP193650));
...
NU8 LOC24;
Id_70286 = 0;
Id_70286 = copyString(((NimStringDesc*) &TMP193650));
I_70287 = 0;
I_70287 = 0;
N_70288 = 0;
N_70288 = ((NU8) 222);
...
appendString(LOC6, ((NimStringDesc*) &TMP193668));
...
NIM_BOOL LOC2;
NIM_BOOL LOC7;
unsureAsgnRef((void**) &(*Cmd_70142), copyString(((NimStringDesc*) &TMP193650)));
I_70146 = 0;
I_70146 = 0;
...
unsureAsgnRef((void**) &(*Arg_70143), copyString(((NimStringDesc*) &TMP193650)));
goto LA12;
LA13: ;
...
Definesymbol_61053(((NimStringDesc*) &TMP193659));
break;
case ((NU8) 157):
Gglobaloptions_44077 &= ~(1 << ((NI32)(((NU8) 2)) % (sizeof(NI32)*8)));
Gglobaloptions_44077 |=(1<<((NI32)(((NU8) 3))%(sizeof(NI32)*8)));
...
goto LA13;
LA14: ;
Undefsymbol_61056(((NimStringDesc*) &TMP193661));
LA13: ;
break;
case ((NU8) 74):
