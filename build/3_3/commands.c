...
STRING_LITERAL(TMP193637, "lib", 3);
STRING_LITERAL(TMP193638, "", 0);
STRING_LITERAL(TMP193654, "boehmgc", 7);
STRING_LITERAL(TMP193655, "nogc", 4);
extern NIM_CONST TY46498 Hintstostr_46497;
extern NIM_CONST TY46478 Warningstostr_46477;
STRING_LITERAL(TMP193656, "endb", 4);
STRING_LITERAL(TMP193657, "profiler", 8);
STRING_LITERAL(TMP193658, "guiapp", 6);
STRING_LITERAL(TMP193659, "library", 7);
STRING_LITERAL(TMP193663, "Advanced commands:\012  compileToOC, oc           compile project "
...
LOC1[2] = copyString(((NimStringDesc*) &TMP193637));
...
LA2: ;
Trunc_72357 = 0;
Trunc_72357 = nosChangeFileExt(Found_72356, ((NimStringDesc*) &TMP193638));
...
NU8 LOC24;
Id_72229 = 0;
Id_72229 = copyString(((NimStringDesc*) &TMP193638));
I_72230 = 0;
I_72230 = 0;
N_72231 = 0;
N_72231 = ((NU8) 224);
...
appendString(LOC6, ((NimStringDesc*) &TMP193663));
...
NIM_BOOL LOC2;
NIM_BOOL LOC7;
unsureAsgnRef((void**) &(*Cmd_72086), copyString(((NimStringDesc*) &TMP193638)));
I_72090 = 0;
I_72090 = 0;
...
unsureAsgnRef((void**) &(*Arg_72087), copyString(((NimStringDesc*) &TMP193638)));
goto LA12;
LA13: ;
...
Definesymbol_63053(((NimStringDesc*) &TMP193654));
break;
case ((NU8) 157):
Gglobaloptions_45078 &= ~(1 << ((NI32)(((NU8) 2)) % (sizeof(NI32)*8)));
Gglobaloptions_45078 |=(1<<((NI32)(((NU8) 3))%(sizeof(NI32)*8)));
...
goto LA13;
LA14: ;
Undefsymbol_63056(((NimStringDesc*) &TMP193656));
LA13: ;
break;
case ((NU8) 74):
