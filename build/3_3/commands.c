...
STRING_LITERAL(TMP196649, "lib", 3);
STRING_LITERAL(TMP196650, "", 0);
STRING_LITERAL(TMP196666, "boehmgc", 7);
STRING_LITERAL(TMP196667, "nogc", 4);
extern NIM_CONST TY47494 Hintstostr_47493;
extern NIM_CONST TY47474 Warningstostr_47473;
STRING_LITERAL(TMP196668, "endb", 4);
STRING_LITERAL(TMP196669, "profiler", 8);
STRING_LITERAL(TMP196670, "guiapp", 6);
STRING_LITERAL(TMP196671, "library", 7);
STRING_LITERAL(TMP196675, "Advanced commands:\012  run                       run the project "
...
LOC1[2] = copyString(((NimStringDesc*) &TMP196649));
...
LA2: ;
Trunc_72415 = 0;
Trunc_72415 = nosChangeFileExt(Found_72414, ((NimStringDesc*) &TMP196650));
...
NU8 LOC24;
Id_72286 = 0;
Id_72286 = copyString(((NimStringDesc*) &TMP196650));
I_72287 = 0;
I_72287 = 0;
N_72288 = 0;
N_72288 = ((NU8) 222);
...
NIM_BOOL LOC2;
NIM_BOOL LOC7;
unsureAsgnRef((void**) &(*Cmd_72142), copyString(((NimStringDesc*) &TMP196650)));
I_72146 = 0;
I_72146 = 0;
...
unsureAsgnRef((void**) &(*Arg_72143), copyString(((NimStringDesc*) &TMP196650)));
goto LA12;
LA13: ;
...
Definesymbol_63053(((NimStringDesc*) &TMP196666));
break;
case ((NU8) 157):
Gglobaloptions_46077 &= ~(1 << ((NI32)(((NU8) 2)) % (sizeof(NI32)*8)));
Gglobaloptions_46077 |=(1<<((NI32)(((NU8) 3))%(sizeof(NI32)*8)));
...
goto LA13;
LA14: ;
Undefsymbol_63056(((NimStringDesc*) &TMP196668));
LA13: ;
break;
case ((NU8) 74):
