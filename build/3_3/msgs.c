...
Filenames_47634 = (TY39422*) setLengthSeq(&(Filenames_47634)->Sup, sizeof(NimStringDesc*), (NI32)(Result_47707 + 1));
...
I_48015 = 0;
HEX3Atmp_48021 = 0;
HEX3Atmp_48021 = (NI32)(Msgcontext_47652->Sup.len - 1);
Res_48023 = 0;
Res_48023 = 0;
while (1) {
...
Msgcontext_47652 = (TY47635*) setLengthSeq(&(Msgcontext_47652)->Sup, sizeof(TY47532), (NI32)(Length_47657 + 1));
Msgcontext_47652->data[Length_47657] = Info_47608;
}
N_NIMCALL(void, Popinfocontext_47609)(void) {
Msgcontext_47652 = (TY47635*) setLengthSeq(&(Msgcontext_47652)->Sup, sizeof(TY47532), (NI32)(Msgcontext_47652->Sup.len - 1));
}
N_NIMCALL(void, Addcheckpoint_47596)(TY47532 Info_47598) {
NI Length_47788;
Length_47788 = 0;
Length_47788 = Checkpoints_47784->Sup.len;
Checkpoints_47784 = (TY47635*) setLengthSeq(&(Checkpoints_47784)->Sup, sizeof(TY47532), (NI32)(Length_47788 + 1));
