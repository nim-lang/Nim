...
STRING_LITERAL(TMP196806, "rodwrite: module ID not set", 27);
STRING_LITERAL(TMP196808, " ", 1);
STRING_LITERAL(TMP196809, "symStack: module nil: ", 22);
STRING_LITERAL(TMP196810, "\012", 1);
STRING_LITERAL(TMP196811, "$1 $2\012", 6);
STRING_LITERAL(TMP196812, "{}", 2);
STRING_LITERAL(TMP196813, "+$1", 3);
STRING_LITERAL(TMP196814, "&$1", 3);
STRING_LITERAL(TMP196815, "^$1", 3);
STRING_LITERAL(TMP196816, "?$1,$2,$3", 9);
STRING_LITERAL(TMP196817, "*$1", 3);
STRING_LITERAL(TMP196818, "$$$1", 4);
STRING_LITERAL(TMP196819, "@$1", 3);
STRING_LITERAL(TMP196820, "()", 2);
STRING_LITERAL(TMP196821, "(", 1);
STRING_LITERAL(TMP196822, "?$1,$2", 6);
STRING_LITERAL(TMP196823, "?$1", 3);
STRING_LITERAL(TMP196824, "!$1", 3);
STRING_LITERAL(TMP196825, ")", 1);
STRING_LITERAL(TMP196826, "%$1", 3);
STRING_LITERAL(TMP196827, "`$1", 3);
STRING_LITERAL(TMP196828, "<$1>", 4);
STRING_LITERAL(TMP196829, "|$1", 3);
STRING_LITERAL(TMP196830, "[]", 2);
STRING_LITERAL(TMP196831, "encodeType: tyForward", 21);
STRING_LITERAL(TMP196832, "/$1", 3);
STRING_LITERAL(TMP196833, "=$1", 3);
STRING_LITERAL(TMP196834, "^()", 3);
STRING_LITERAL(TMP196835, "NIM:", 4);
STRING_LITERAL(TMP196836, "1012", 4);
STRING_LITERAL(TMP196837, "ID:", 3);
STRING_LITERAL(TMP196838, "CRC:", 4);
STRING_LITERAL(TMP196839, "OPTIONS:", 8);
STRING_LITERAL(TMP196840, "DEFINES:", 8);
STRING_LITERAL(TMP196841, "FILES(\012", 7);
STRING_LITERAL(TMP196842, ")\012", 2);
STRING_LITERAL(TMP196843, "INCLUDES(\012", 10);
STRING_LITERAL(TMP196844, "DEPS:", 5);
STRING_LITERAL(TMP196845, "INTERF(\012", 8);
STRING_LITERAL(TMP196846, "COMPILERPROCS(\012", 15);
STRING_LITERAL(TMP196847, "INDEX(\012", 7);
STRING_LITERAL(TMP196848, "IMPORTS(\012", 9);
STRING_LITERAL(TMP196849, "CONVERTERS:", 11);
STRING_LITERAL(TMP196850, "INIT(\012", 6);
STRING_LITERAL(TMP196851, "DATA(\012", 6);
STRING_LITERAL(TMP196852, "rod", 3);
STRING_LITERAL(TMP196853, "rodwrite.process", 16);
...
App_52036(&Result_111058, ((NimStringDesc*) &TMP196808));
LA6: ;
...
App_52036(&(*W_112069).R, ((NimStringDesc*) &TMP196810));
goto LA1;
LA2: ;
...
Appf_52071(&(*W_112069).R, ((NimStringDesc*) &TMP196811), LOC5, 2);
LA1: ;
...
Result_111303 = Torope_52046(((NimStringDesc*) &TMP196820));
goto BeforeRet;
LA2: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196816), LOC8, 3);
goto LA5;
LA6: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196822), LOC13, 2);
goto LA5;
LA11: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196823), LOC16, 1);
goto LA5;
LA14: ;
LA5: ;
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196824), LOC28, 1);
LA26: ;
break;
case ((NU8) 11) ... ((NU8) 13):
...
Appf_52071(&Result_111303, ((NimStringDesc*) &TMP196824), LOC32, 1);
LA30: ;
break;
case ((NU8) 14) ... ((NU8) 16):
...
App_52036(&Result_111303, ((NimStringDesc*) &TMP196825));
BeforeRet: ;
...
Appf_52071(&Result_111552, ((NimStringDesc*) &TMP196817), LOC8, 1);
LA6: ;
if (!!((Loc_111551.Flags == 0))) goto LA10;
memset((void*)&LOC12, 0, sizeof(LOC12));
LOC12[0] = Encodeint_93073(((NI64) (((int) (Loc_111551.Flags)))));
Appf_52071(&Result_111552, ((NimStringDesc*) &TMP196818), LOC12, 1);
LA10: ;
if (!!((Loc_111551.T == NIM_NIL))) goto LA14;
memset((void*)&LOC16, 0, sizeof(LOC16));
LOC16[0] = Encodeint_93073(((NI64) ((*Loc_111551.T).Sup.Id)));
Appf_52071(&Result_111552, ((NimStringDesc*) &TMP196815), LOC16, 1);
...
Appf_52071(&Result_111832, ((NimStringDesc*) &TMP196829), LOC1, 1);
memset((void*)&LOC2, 0, sizeof(LOC2));
LOC3 = 0;
LOC3 = Ropetostr_52063((*Lib_111830).Name);
LOC2[0] = Encodestr_111048(W_111829, LOC3);
Appf_52071(&Result_111832, ((NimStringDesc*) &TMP196829), LOC2, 1);
memset((void*)&LOC4, 0, sizeof(LOC4));
LOC4[0] = Encodenode_111298(W_111829, Info_111831, (*Lib_111830).Path);
Appf_52071(&Result_111832, ((NimStringDesc*) &TMP196829), LOC4, 1);
...
Result_111857 = Torope_52046(((NimStringDesc*) &TMP196812));
goto BeforeRet;
LA2: ;
...
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196813), LOC5, 1);
memset((void*)&LOC6, 0, sizeof(LOC6));
LOC6[0] = Encodestr_111048(W_111855, (*(*S_111856).Name).S);
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196814), LOC6, 1);
if (!!(((*S_111856).Typ == NIM_NIL))) goto LA8;
memset((void*)&LOC10, 0, sizeof(LOC10));
LOC10[0] = Encodeint_93073(((NI64) ((*(*S_111856).Typ).Sup.Id)));
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196815), LOC10, 1);
...
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196818), LOC27, 1);
LA25: ;
if (!!(((*S_111856).Magic == ((NU8) 0)))) goto LA29;
memset((void*)&LOC31, 0, sizeof(LOC31));
LOC31[0] = Encodeint_93073(((NI64) ((*S_111856).Magic)));
Appf_52071(&Result_111857, ((NimStringDesc*) &TMP196819), LOC31, 1);
LA29: ;
...
appendString(LOC9, ((NimStringDesc*) &TMP196809));
...
App_52036(&(*W_112085).Data, ((NimStringDesc*) &TMP196810));
...
Appf_52071(&(*W_112085).Interf, ((NimStringDesc*) &TMP196811), LOC19, 2);
LA17: ;
...
Appf_52071(&(*W_112085).Compilerprocs, ((NimStringDesc*) &TMP196811), LOC23, 2);
LA21: ;
if (!((*S_112088).Kind == ((NU8) 13))) goto LA25;
if (!!(((*W_112085).Converters == NIM_NIL))) goto LA28;
App_52036(&(*W_112085).Converters, ((NimStringDesc*) &TMP196808));
LA28: ;
LOC30 = 0;
...
Result_111663 = Torope_52046(((NimStringDesc*) &TMP196830));
goto BeforeRet;
LA2: ;
Result_111663 = NIM_NIL;
if (!((*T_111662).Kind == ((NU8) 30))) goto LA5;
Internalerror_47578(((NimStringDesc*) &TMP196831));
LA5: ;
LOC7 = 0;
...
Appf_52071(&Result_111663, ((NimStringDesc*) &TMP196813), LOC8, 1);
...
App_52036(&Result_111663, ((NimStringDesc*) &TMP196834));
goto LA45;
LA46: ;
memset((void*)&LOC48, 0, sizeof(LOC48));
LOC48[0] = Encodeint_93073(((NI64) ((*(*T_111662).Sons->data[I_111806]).Sup.Id)));
Appf_52071(&Result_111663, ((NimStringDesc*) &TMP196815), LOC48, 1);
...
App_52036(&(*W_112216).Data, ((NimStringDesc*) &TMP196810));
LA4: ;
I_112217 += 1;
} LA1: ;
...
Internalerror_47578(((NimStringDesc*) &TMP196806));
LA2: ;
W_112836 = 0;
...
Content_112347 = 0;
Content_112347 = Torope_52046(((NimStringDesc*) &TMP196835));
LOC1 = 0;
LOC1 = Torope_52046(((NimStringDesc*) &TMP196836));
App_52031(&Content_112347, LOC1);
App_52036(&Content_112347, ((NimStringDesc*) &TMP196810));
LOC2 = 0;
LOC2 = Torope_52046(((NimStringDesc*) &TMP196837));
...
App_52036(&Content_112347, ((NimStringDesc*) &TMP196810));
LOC4 = 0;
LOC4 = Torope_52046(((NimStringDesc*) &TMP196838));
...
App_52036(&Content_112347, ((NimStringDesc*) &TMP196810));
LOC6 = 0;
LOC6 = Torope_52046(((NimStringDesc*) &TMP196839));
...
App_52036(&Content_112347, ((NimStringDesc*) &TMP196810));
LOC8 = 0;
LOC8 = Torope_52046(((NimStringDesc*) &TMP196840));
App_52031(&Content_112347, LOC8);
App_52031(&Content_112347, (*W_111047).Defines);
App_52036(&Content_112347, ((NimStringDesc*) &TMP196810));
LOC9 = 0;
LOC9 = Torope_52046(((NimStringDesc*) &TMP196841));
...
App_52036(&(*W_111031).Moddeps, ((NimStringDesc*) &TMP196808));
LA2: ;
...
App_52036(&(*W_111035).Incldeps, ((NimStringDesc*) &TMP196808));
...
Internalerror_47574((*N_112408).Info, ((NimStringDesc*) &TMP196853));
LA8: ;
...
Internalerror_47574((*A_112568).Info, ((NimStringDesc*) &TMP196853));
LA24: ;
...
Internalerror_47574((*A_112632).Info, ((NimStringDesc*) &TMP196853));
LA33: ;
...
Internalerror_47574((*A_112696).Info, ((NimStringDesc*) &TMP196853));
LA42: ;
S_112751 = 0;
