...
STRING_LITERAL(TMP197223, "transformSym", 12);
STRING_LITERAL(TMP197224, "wrong AST for borrowed symbol", 29);
STRING_LITERAL(TMP197225, "transformSym: const", 19);
STRING_LITERAL(TMP197226, "transformLambda", 15);
STRING_LITERAL(TMP197227, ":tmpCl", 6);
STRING_LITERAL(TMP197228, "popTransCon", 11);
STRING_LITERAL(TMP197229, "transformFor", 12);
STRING_LITERAL(TMP197230, ":tmp", 4);
STRING_LITERAL(TMP197231, "not implemented: pass to var parameter", 38);
STRING_LITERAL(TMP197232, "inlineIter", 10);
STRING_LITERAL(TMP197233, "inlineIter: not nkVarTuple", 26);
STRING_LITERAL(TMP197234, "transformCase", 13);
STRING_LITERAL(TMP197235, "transform", 9);
...
Internalerror_47567((*N_188105).Info, ((NimStringDesc*) &TMP197223));
LA2: ;
Tc_188117 = 0;
...
case ((NU8) 16):
LOC15 = 0;
LOC15 = Skiptypes_96085((*(*B_188107).KindU.S4.Sym).Typ, IL64(47287796087390208));
...
Internalerror_47567((*B_188107).Info, ((NimStringDesc*) &TMP197225));
LA19: ;
LA16: ;
break;
default:
...
Internalerror_47571(((NimStringDesc*) &TMP197228));
LA2: ;
...
Internalerror_47567((*N_190014).Info, ((NimStringDesc*) &TMP197226));
LA2: ;
S_190063 = 0;
...
Param_190100 = 0;
LOC4 = 0;
LOC4 = Getident_54016(((NimStringDesc*) &TMP197227));
...
appendString(LOC4, ((NimStringDesc*) &TMP197230));
...
Result_189526 = 0;
LOC2 = 0;
LOC2 = Skiptypes_96085(Formal_189525, IL64(47287796087390208));
...
default:
LOC12 = 0;
LOC12 = Skiptypes_96085(Formal_189525, IL64(47287796087390208));
...
Result_188078 = 0;
LOC1 = 0;
LOC1 = Getident_54016(((NimStringDesc*) &TMP197230));
LOC2 = 0;
LOC2 = Getcurrowner_188058(C_188075);
Result_188078 = Newsym_55701(((NU8) 5), LOC1, LOC2);
(*Result_188078).Info = Info_188077;
asgnRef((void**) &(*Result_188078).Typ, Skiptypes_96085(Typ_188076, IL64(2251799813685248)));
...
LOC2 = 0;
LOC2 = Skiptypes_96085((*E_188491).Typ, IL64(2251799813685248));
...
Internalerror_47567((*It_188597).Info, ((NimStringDesc*) &TMP197232));
LA15: ;
Newvar_188661 = 0;
...
Internalerror_47567((*N_189583).Info, ((NimStringDesc*) &TMP197229));
LA2: ;
...
LA8: ;
if (!LOC7) goto LA9;
Internalerror_47567((*Call_189653).Info, ((NimStringDesc*) &TMP197229));
LA9: ;
...
Formal_189762 = 0;
LOC17 = 0;
LOC17 = Skiptypes_96085((*(*Newc_189640).Owner).Typ, IL64(47287796087390208));
...
break;
case ((NU8) 2):
Internalerror_47567((*Arg_189737).Info, ((NimStringDesc*) &TMP197231));
break;
}
Res_189797 += 1;
} LA15: ;
...
Internalerror_47567((*(*N_190194).KindU.S6.Sons->data[I_190197]).Info, ((NimStringDesc*) &TMP197234));
LA9: ;
Ifs_190330 = 0;
...
if (!(LOC12)) goto LA13;
LOC14 = 0;
LOC14 = Skiptypes_96085((*(*N_190194).KindU.S6.Sons->data[0]).Typ, IL64(47446125761789952));
...
Dest_189241 = 0;
Dest_189241 = Skiptypes_96085((*N_189215).Typ, IL64(47446125761789952));
Source_189254 = 0;
Source_189254 = Skiptypes_96085((*(*N_189215).KindU.S6.Sons->data[1]).Typ, IL64(47446125761789952));
...
LA13: ;
Dest_189241 = Skiptypes_96085((*N_189215).Typ, IL64(47428533575745536));
...
case ((NU8) 36) ... ((NU8) 39):
LOC23 = 0;
LOC23 = Skiptypes_96085((*N_189215).Typ, IL64(47428533575745536));
...
case ((NU8) 22):
case ((NU8) 21):
Dest_189241 = Skiptypes_96085(Dest_189241, IL64(47534086692012032));
Source_189254 = Skiptypes_96085(Source_189254, IL64(47534086692012032));
...
Internalerror_47567((*N_188095).Info, ((NimStringDesc*) &TMP197235));
LA12: ;
