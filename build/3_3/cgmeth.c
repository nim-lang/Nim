...
STRING_LITERAL(TMP194227, "cgmeth.genConv", 14);
STRING_LITERAL(TMP194228, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP194229, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP194763, "and", 3);
STRING_LITERAL(TMP194764, "is", 2);
...
while (1) {
Aa_155172 = Skiptypes_93085(Aa_155172, IL64(2251799813685248));
Bb_155173 = Skiptypes_93085(Bb_155173, IL64(2251799813685248));
...
Source_155021 = 0;
Diff_155022 = 0;
Dest_155020 = Skiptypes_93085(D_155017, IL64(47534086692012032));
Source_155021 = Skiptypes_93085((*N_155016).Typ, IL64(47534086692012032));
...
Internalerror_45567((*N_155016).Info, ((NimStringDesc*) &TMP194227));
LA7: ;
...
LOC2 = Skiptypes_93085(T_155405, IL64(2498090418307072));
...
if (!LOC4) goto LA5;
Aa_155436 = Skiptypes_93085((*(*A_155431).Typ).Sons->data[Col_155445], IL64(2498090418307072));
Bb_155437 = Skiptypes_93085((*(*B_155432).Typ).Sons->data[Col_155445], IL64(2498090418307072));
...
Ands_155515 = Getsyssym_98024(((NimStringDesc*) &TMP194763));
Iss_155516 = Getsyssym_98024(((NimStringDesc*) &TMP194764));
Meth_155537 = 0;
HEX3Atmp_155673 = 0;
