...
(*Result_47519).Length = (NI32)((*A_47017).Length + (*B_47018).Length);
...
Num_47725 = 0;
while (1) {
if (!(I_47721 <= (NI32)(Length_47724 - 1))) goto LA1;
...
J_47780 = 0;
while (1) {
J_47780 = (NI32)((NI32)((NI32)(J_47780 * 10) + ((NU8)(Frmt_47068->data[I_47721]))) - 48);
I_47721 += 1;
LOC7 = ((NI32)((NI32)(Length_47724 + 0) - 1) < I_47721);
if (LOC7) goto LA8;
...
Num_47725 = J_47780;
if (!((NI32)((Args_47070Len0-1) + 1) < J_47780)) goto LA12;
LOC14 = 0;
LOC15 = 0;
...
LA12: ;
App_47031(&Result_47720, Args_47070[(NI32)(J_47780 - 1)]);
break;
case 78:
case 110:
...
Start_47839 = I_47721;
while (1) {
if (!(I_47721 <= (NI32)(Length_47724 - 1))) goto LA17;
...
if (!(Start_47839 <= (NI32)(I_47721 - 1))) goto LA22;
LOC24 = 0;
LOC24 = copyStrLast(Frmt_47068, Start_47839, (NI32)(I_47721 - 1));
...
Result_47435 = 0;
L_47446 = 0;
L_47446 = (NI32)((*S_47434)->Sup.len - 1);
