...
Write_3458((*F_46658), (*C_46659).Data);
goto LA4;
LA5: ;
...
Write_3458((*F_46674), (*It_46715).Data);
} LA2: ;
framePtr = framePtr->prev;
}
N_NIMCALL(void, Writerope_46058)(TY46008* Head_46060, NimStringDesc* Filename_46061) {
...
LOC2 = Open_3417(&F_46751, Filename_46061, ((NU8) 1), -1);
if (!LOC2) goto LA3;
...
Readbytes_46939 = Readbuffer_3514((*Bin_46934), Buf_46935, (*R_46932).Length);
...
Result_46948 = Open_3417(&Bin_46949, F_46086, ((NU8) 0), -1);
...
LOC7 = Readbuffer_3514(Bin_46949, Buf_46951, 1024);
Result_46948 = (LOC7 == 0);
LA5: ;
...
Result_46477 = 0;
L_46488 = 0;
F.line = 1164;F.filename = "system.nim";
L_46488 = subInt((*S_46476)->Sup.len, 1);
F.line = 1165;F.filename = "system.nim";
