...
(*Result_48558).Length = (NI32)((*A_48017).Length + (*B_48018).Length);
...
Num_48770 = 0;
while (1) {
if (!(I_48766 <= (NI32)(Length_48768 - 1))) goto LA1;
...
J_48767 = 0;
while (1) {
J_48767 = (NI32)((NI32)((NI32)(J_48767 * 10) + ((NU8)(Frmt_48071->data[I_48766]))) - 48);
I_48766 += 1;
LOC7 = ((NI32)((NI32)(Length_48768 + 0) - 1) < I_48766);
if (LOC7) goto LA8;
...
Num_48770 = J_48767;
if (!((NI32)((Args_48073Len0-1) + 1) < J_48767)) goto LA12;
LOC14 = 0;
LOC15 = 0;
...
LA12: ;
App_48031(&Result_48765, Args_48073[(NI32)(J_48767 - 1)]);
break;
case 78:
case 110:
...
Start_48769 = I_48766;
while (1) {
if (!(I_48766 <= (NI32)(Length_48768 - 1))) goto LA17;
...
if (!(Start_48769 <= (NI32)(I_48766 - 1))) goto LA22;
LOC24 = 0;
LOC24 = copyStrLast(Frmt_48071, Start_48769, (NI32)(I_48766 - 1));
...
Result_48472 = 0;
L_48483 = 0;
L_48483 = (NI32)((*S_48471)->Sup.len - 1);
