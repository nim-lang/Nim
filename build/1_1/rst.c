...
N_NIMCALL(void, Getthing_144158)(TY144139* L_144161, TY144135* Tok_144163, TY21602 S_144164);
...
N_NIMCALL(TY42538, Tokinfo_144747)(TY144677* P_144749, TY144135* Tok_144750);
...
N_NIMCALL(void, Getcolumns_146994)(TY144677* P_146997, TY73281** Cols_146999);
...
NIM_CONST TY21602 Symchars_144130 = {
...
;
static NIM_CONST TY21602 TMP193101 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x07, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;static NIM_CONST TY21602 TMP193102 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193103, "\015\012", 2);
STRING_LITERAL(TMP193104, "#", 1);
static NIM_CONST TY21602 TMP193105 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193106, "ii", 2);
STRING_LITERAL(TMP193107, " a", 2);
STRING_LITERAL(TMP193108, "i", 1);
STRING_LITERAL(TMP193109, "ai", 2);
STRING_LITERAL(TMP193110, "::", 2);
STRING_LITERAL(TMP193111, "+", 1);
STRING_LITERAL(TMP193112, "*", 1);
STRING_LITERAL(TMP193113, "-", 1);
STRING_LITERAL(TMP193114, "|", 1);
STRING_LITERAL(TMP193115, "..", 2);
STRING_LITERAL(TMP193116, ":", 1);
STRING_LITERAL(TMP193117, "(e) ", 4);
STRING_LITERAL(TMP193118, "+a+", 3);
STRING_LITERAL(TMP193119, "-w", 2);
STRING_LITERAL(TMP193120, "--w", 3);
STRING_LITERAL(TMP193121, "/w", 2);
STRING_LITERAL(TMP193122, "//w", 3);
STRING_LITERAL(TMP193123, "e) ", 3);
STRING_LITERAL(TMP193124, "e. ", 3);
static NIM_CONST TY21602 TMP193125 = {
0x00, 0x00, 0x00, 0x00, 0x84, 0xA1, 0x00, 0x14,
0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x08,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193126, "\\", 1);
STRING_LITERAL(TMP193127, "**", 2);
static NIM_CONST TY21602 TMP193128 = {
0x00, 0x00, 0x00, 0x00, 0x86, 0xF2, 0x00, 0xCC,
0x00, 0x00, 0x00, 0xB0, 0x00, 0x00, 0x00, 0x20,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193129, "``", 2);
STRING_LITERAL(TMP193130, "\\\\", 2);
STRING_LITERAL(TMP193131, " ", 1);
STRING_LITERAL(TMP193132, "`", 1);
STRING_LITERAL(TMP193133, "_", 1);
STRING_LITERAL(TMP193134, ">", 1);
STRING_LITERAL(TMP193135, "<", 1);
STRING_LITERAL(TMP193136, ":w:", 3);
STRING_LITERAL(TMP193137, "idx", 3);
STRING_LITERAL(TMP193138, "literal", 7);
STRING_LITERAL(TMP193139, "strong", 6);
STRING_LITERAL(TMP193140, "emphasis", 8);
STRING_LITERAL(TMP193141, "sub", 3);
STRING_LITERAL(TMP193142, "subscript", 9);
STRING_LITERAL(TMP193143, "sup", 3);
STRING_LITERAL(TMP193144, "supscript", 9);
STRING_LITERAL(TMP193145, "//", 2);
STRING_LITERAL(TMP193146, ".", 1);
STRING_LITERAL(TMP193147, "getFieldValue (2): ", 19);
STRING_LITERAL(TMP193148, "\001\001", 2);
STRING_LITERAL(TMP193149, "\000\001\002", 3);
STRING_LITERAL(TMP193150, "Too many binary zeros in include file", 37);
STRING_LITERAL(TMP193151, "html", 4);
STRING_LITERAL(TMP193152, "file", 4);
STRING_LITERAL(TMP193153, "latex", 5);
STRING_LITERAL(TMP193154, " _", 2);
STRING_LITERAL(TMP193155, " |", 2);
STRING_LITERAL(TMP193156, "replace", 7);
STRING_LITERAL(TMP193157, " [", 2);
STRING_LITERAL(TMP193158, "]", 1);
NIM_CONST TY147779 Wildcards_147778 = {((NimStringDesc*) &TMP193117),
((NimStringDesc*) &TMP193123),
((NimStringDesc*) &TMP193124)}
;
...
STRING_LITERAL(TMP193159, "rst.parseSection()", 18);
...
N_NIMCALL(void, Initparser_144828)(TY144677* P_144831, TY144673* Sharedstate_144832) {
unsureAsgnRef((void**) &(*P_144831).Indentstack, (TY73281*) newSeq(NTI73281, 1));
...
(*L_144161).Col += (NI32)(Pos_144165 - (*L_144161).Bufpos);
...
if (!((NU8)(Buf_144242[(NI32)(Pos_144241 + 1)]) == (NU8)(10))) goto LA5;
Pos_144241 += 2;
goto LA4;
LA5: ;
Pos_144241 += 1;
...
case 9:
Pos_144241 += 1;
Result_144240 = (NI32)((NI32)(Result_144240 - (NI32)(Result_144240 % 8)) + 8);
break;
default:
goto LA18;
break;
...
(*Tok_144360).Ival = (((NI32)((*Tok_144360).Ival - (*L_144358).Baseindent) >= 0) ? (NI32)((*Tok_144360).Ival - (*L_144358).Baseindent) : 0);
LOC1 = 0;
LOC2 = 0;
LOC2 = nsuRepeatChar((*Tok_144360).Ival, 32);
LOC1 = rawNewString(LOC2->Sup.len + 2);
appendString(LOC1, ((NimStringDesc*) &TMP193103));
...
(*L_144204).Col += (NI32)(Pos_144207 - (*L_144204).Bufpos);
...
case 128 ... 255:
case 48 ... 57:
Getthing_144158(L_144378, Tok_144380, TMP193101);
break;
case 32:
case 9:
case 11:
case 12:
Getthing_144158(L_144378, Tok_144380, TMP193102);
...
(*Tok_144380).Col = (((NI32)((*Tok_144380).Col - (*L_144378).Baseindent) >= 0) ? (NI32)((*Tok_144380).Col - (*L_144378).Baseindent) : 0);
}
N_NIMCALL(void, Gettokens_144427)(NimStringDesc* Buffer_144429, NIM_BOOL Skippounds_144430, TY144137** Tokens_144432) {
TY144139 L_144433;
NI Length_144444;
...
Rawgettok_144375(&L_144433, &(*Tokens_144432)->data[(NI32)(Length_144444 - 1)]);
if (!((*Tokens_144432)->data[(NI32)(Length_144444 - 1)].Kind == ((NU8) 0))) goto LA20;
goto LA18;
LA20: ;
} LA18: ;
...
N_NIMCALL(TY42538, Tokinfo_144747)(TY144677* P_144749, TY144135* Tok_144750) {
TY42538 Result_144751;
memset((void*)&Result_144751, 0, sizeof(Result_144751));
Result_144751 = Newlineinfo_42712((*P_144749).Filename, (NI32)((*P_144749).Line + (*Tok_144750).Line), (NI32)((*P_144749).Col + (*Tok_144750).Col));
return Result_144751;
}
N_NIMCALL(void, Rstmessage_144752)(TY144677* P_144754, NU8 Msgkind_144755, NimStringDesc* Arg_144756) {
TY42538 LOC1;
LOC1 = Tokinfo_144747(P_144754, &(*P_144754).Tok->data[(*P_144754).Idx]);
Genericmessage_43154(LOC1, Msgkind_144755, Arg_144756);
}
N_NIMCALL(TY144077*, Findref_145098)(TY144677* P_145101, NimStringDesc* Key_145102) {
...
I_144935 = 0;
HEX3Atmp_144970 = 0;
HEX3Atmp_144970 = (NI32)((NI32)((*N_144911).Text->Sup.len + 0) - 1);
Res_144972 = 0;
Res_144972 = 0;
while (1) {
...
(*B_144915) = NIM_FALSE;
LA15: ;
(*R_144913) = addChar((*R_144913), ((NIM_CHAR) (((NI) ((NI32)((NI32)(((NU8)((*N_144911).Text->data[I_144935])) - 65) + 97))))));
break;
default:
...
N_NIMCALL(void, Pushind_144765)(TY144677* P_144768, NI Ind_144769) {
(*P_144768).Indentstack = (TY73281*) incrSeq(&((*P_144768).Indentstack)->Sup, sizeof(NI));
(*P_144768).Indentstack->data[(*P_144768).Indentstack->Sup.len-1] = Ind_144769;
}
N_NIMCALL(void, Popind_144788)(TY144677* P_144791) {
if (!(1 < (*P_144791).Indentstack->Sup.len)) goto LA2;
(*P_144791).Indentstack = (TY73281*) setLengthSeq(&((*P_144791).Indentstack)->Sup, sizeof(NI), (NI32)((*P_144791).Indentstack->Sup.len - 1));
LA2: ;
}
N_NIMCALL(NIM_BOOL, Match_145720)(TY144677* P_145722, NI Start_145723, NimStringDesc* Expr_145724) {
...
Last_145730 = 0;
Last_145730 = (NI32)((NI32)(Expr_145724->Sup.len + 0) - 1);
while (1) {
...
if (LOC2) goto LA3;
LOC2 = eqStrings((*P_145722).Tok->data[J_145727].Symbol, ((NimStringDesc*) &TMP193104));
LA3: ;
Result_145725 = LOC2;
...
break;
case 48 ... 57:
Result_145725 = Allcharsinset_24909((*P_145722).Tok->data[J_145727].Symbol, TMP193105);
break;
default:
break;
}
...
LOC4 = ((*P_146763).Tok->data[(NI32)((*P_146763).Idx - 1)].Kind == ((NU8) 1));
if (!(LOC4)) goto LA5;
LOC6 = Currind_144761(P_146763);
LOC4 = ((*P_146763).Tok->data[(NI32)((*P_146763).Idx - 1)].Ival == LOC6);
LA5: ;
Result_146764 = LOC4;
LA2: ;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*P_146752).Tok->data[J_146754].Symbol, ((NimStringDesc*) &TMP193114));
LA3: ;
LOC1 = LOC2;
if (LOC1) goto LA4;
...
Genericmessage_43154(LOC1, Msgkind_144760, (*P_144759).Tok->data[(*P_144759).Idx].Symbol);
}
N_NIMCALL(NIM_BOOL, Isdeflist_146780)(TY144677* P_146782) {
...
LOC1 = LOC2;
if (!(LOC1)) goto LA4;
LOC1 = !(eqStrings((*P_146782).Tok->data[(NI32)(J_146784 - 2)].Symbol, ((NimStringDesc*) &TMP193110)));
LA4: ;
Result_146783 = LOC1;
...
NIM_BOOL LOC3;
Result_146804 = 0;
LOC3 = Match_145720(P_146803, (*P_146803).Idx, ((NimStringDesc*) &TMP193119));
if (LOC3) goto LA4;
LOC3 = Match_145720(P_146803, (*P_146803).Idx, ((NimStringDesc*) &TMP193120));
LA4: ;
LOC2 = LOC3;
if (LOC2) goto LA5;
LOC2 = Match_145720(P_146803, (*P_146803).Idx, ((NimStringDesc*) &TMP193121));
LA5: ;
LOC1 = LOC2;
if (LOC1) goto LA6;
LOC1 = Match_145720(P_146803, (*P_146803).Idx, ((NimStringDesc*) &TMP193122));
LA6: ;
Result_146804 = LOC1;
...
case ((NU8) 4):
LOC2 = Match_145720(P_146807, (NI32)((*P_146807).Idx + 1), ((NimStringDesc*) &TMP193106));
if (!LOC2) goto LA3;
Result_146808 = ((NU8) 3);
goto LA1;
LA3: ;
LOC5 = Match_145720(P_146807, (NI32)((*P_146807).Idx + 1), ((NimStringDesc*) &TMP193107));
if (!LOC5) goto LA6;
Result_146808 = ((NU8) 29);
goto LA1;
LA6: ;
LOC8 = Match_145720(P_146807, (NI32)((*P_146807).Idx + 1), ((NimStringDesc*) &TMP193108));
if (!LOC8) goto LA9;
Result_146808 = ((NU8) 2);
goto LA1;
LA9: ;
...
LOC13 = Match_145720(P_146807, LOC12, ((NimStringDesc*) &TMP193109));
if (!LOC13) goto LA14;
Result_146808 = ((NU8) 1);
goto LA11;
LA14: ;
if (!eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193110))) goto LA16;
Result_146808 = ((NU8) 24);
goto LA11;
LA16: ;
LOC19 = Prednl_146761(P_146807);
if (!(LOC19)) goto LA20;
LOC22 = eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193111));
if (LOC22) goto LA23;
LOC22 = eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193112));
LA23: ;
LOC21 = LOC22;
if (LOC21) goto LA24;
LOC21 = eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193113));
LA24: ;
LOC19 = LOC21;
LA20: ;
LOC18 = LOC19;
if (!(LOC18)) goto LA25;
LOC18 = ((*P_146807).Tok->data[(NI32)((*P_146807).Idx + 1)].Kind == ((NU8) 2));
LA25: ;
if (!LOC18) goto LA26;
Result_146808 = ((NU8) 5);
goto LA11;
LA26: ;
LOC28 = eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193114));
if (!(LOC28)) goto LA29;
...
goto LA11;
LA30: ;
LOC32 = eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193115));
if (!(LOC32)) goto LA33;
...
goto LA11;
LA34: ;
LOC36 = eqStrings((*P_146807).Tok->data[(*P_146807).Idx].Symbol, ((NimStringDesc*) &TMP193116));
if (!(LOC36)) goto LA37;
...
goto LA11;
LA38: ;
LOC40 = Match_145720(P_146807, (*P_146807).Idx, ((NimStringDesc*) &TMP193117));
if (!LOC40) goto LA41;
Result_146808 = ((NU8) 7);
goto LA11;
LA41: ;
LOC43 = Match_145720(P_146807, (*P_146807).Idx, ((NimStringDesc*) &TMP193118));
if (!LOC43) goto LA44;
Result_146808 = ((NU8) 30);
Rstmessage_144757(P_146807, ((NU8) 185));
goto LA11;
LA44: ;
...
LOC54 = Match_145720(P_146807, LOC53, ((NimStringDesc*) &TMP193109));
if (!LOC54) goto LA55;
Result_146808 = ((NU8) 1);
goto LA52;
LA55: ;
...
goto LA52;
LA58: ;
LOC60 = Match_145720(P_146807, (*P_146807).Idx, ((NimStringDesc*) &TMP193123));
if (LOC60) goto LA61;
LOC60 = Match_145720(P_146807, (*P_146807).Idx, ((NimStringDesc*) &TMP193124));
LA61: ;
if (!LOC60) goto LA62;
Result_146808 = ((NU8) 7);
goto LA52;
...
appendString((*N_146625).Text, ((NimStringDesc*) &TMP193103));
LOC8 = 0;
LOC8 = nsuRepeatChar((NI32)((*P_146623).Tok->data[(*P_146623).Idx].Ival - Indent_146635), 32);
...
if (!((*P_147506).Tok->data[(NI32)((*P_147506).Idx + 1)].Kind == ((NU8) 2))) goto LA2;
Bullet_147517 = 0;
...
Pushind_144765(P_147506, (*P_147506).Tok->data[(NI32)((*P_147506).Idx + 2)].Col);
(*P_147506).Idx += 2;
while (1) {
Item_147531 = 0;
...
LOC7 = LOC8;
if (!(LOC7)) goto LA10;
LOC7 = eqStrings((*P_147506).Tok->data[(NI32)((*P_147506).Idx + 1)].Symbol, Bullet_147517);
LA10: ;
LOC6 = LOC7;
if (!(LOC6)) goto LA11;
LOC6 = ((*P_147506).Tok->data[(NI32)((*P_147506).Idx + 2)].Kind == ((NU8) 2));
LA11: ;
if (!LOC6) goto LA12;
(*P_147506).Idx += 3;
goto LA5;
...
if (!((*P_146821).Tok->data[(NI32)((*P_146821).Idx + 1)].Kind == ((NU8) 2))) goto LA2;
Col_146832 = 0;
Col_146832 = (*P_146821).Tok->data[(*P_146821).Idx].Col;
Result_146822 = Newrstnode_144094(((NU8) 26));
Pushind_144765(P_146821, (*P_146821).Tok->data[(NI32)((*P_146821).Idx + 2)].Col);
(*P_146821).Idx += 2;
while (1) {
Item_146845 = 0;
...
LOC7 = LOC8;
if (!(LOC7)) goto LA10;
LOC7 = eqStrings((*P_146821).Tok->data[(NI32)((*P_146821).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193114));
LA10: ;
LOC6 = LOC7;
if (!(LOC6)) goto LA11;
LOC6 = ((*P_146821).Tok->data[(NI32)((*P_146821).Idx + 2)].Kind == ((NU8) 2));
LA11: ;
if (!LOC6) goto LA12;
(*P_146821).Idx += 3;
goto LA5;
...
if (!(LOC2)) goto LA3;
LOC2 = ((*P_146222).Tok->data[(NI32)((*P_146222).Idx + 1)].Kind == ((NU8) 3));
LA3: ;
if (!LOC2) goto LA4;
J_146242 = 0;
...
if (!eqStrings((*P_146222).Tok->data[(*P_146222).Idx].Symbol, ((NimStringDesc*) &TMP193110))) goto LA8;
goto LA6;
LA8: ;
...
(*P_146222).Idx += 1;
LA11: ;
if (!eqStrings((*P_146222).Tok->data[(*P_146222).Idx].Symbol, ((NimStringDesc*) &TMP193110))) goto LA14;
(*P_146222).Idx += 1;
...
Result_146446 = 0;
I_146447 = 0;
I_146447 = Binarystrsearch_41149(Dirids_146426, 12, S_146445);
...
LOC5 = ((*P_145598).Idx == 0);
if (LOC5) goto LA6;
LOC5 = ((6 &(1<<(((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Kind)&7)))!=0);
LA6: ;
LOC4 = LOC5;
if (LOC4) goto LA7;
LOC4 = ((TMP193125[((NU8)((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol->data[0]))%8)))!=0);
LA7: ;
Result_145600 = LOC4;
if (!!(Result_145600)) goto LA9;
goto BeforeRet;
LA9: ;
Result_145600 = !(((7 &(1<<(((*P_145598).Tok->data[(NI32)((*P_145598).Idx + 1)].Kind)&7)))!=0));
if (!!(Result_145600)) goto LA12;
goto BeforeRet;
LA12: ;
if (!(0 < (*P_145598).Idx)) goto LA15;
if (!eqStrings((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol, ((NimStringDesc*) &TMP193126))) goto LA18;
Result_145600 = NIM_FALSE;
goto LA17;
LA18: ;
C_145644 = 0;
C_145644 = (*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol->data[0];
switch (((NU8)(C_145644))) {
case 39:
case 34:
D_145601 = C_145644;
...
Result_145600 = !(((NU8)((*P_145598).Tok->data[(NI32)((*P_145598).Idx + 1)].Symbol->data[0]) == (NU8)(D_145601)));
LA21: ;
LA17: ;
LA15: ;
BeforeRet: ;
...
goto BeforeRet;
LA2: ;
Result_145555 = !(((6 &(1<<(((*P_145553).Tok->data[(NI32)((*P_145553).Idx - 1)].Kind)&7)))!=0));
if (!!(Result_145555)) goto LA5;
goto BeforeRet;
LA5: ;
LOC7 = ((7 &(1<<(((*P_145553).Tok->data[(NI32)((*P_145553).Idx + 1)].Kind)&7)))!=0);
if (LOC7) goto LA8;
LOC7 = ((TMP193128[((NU8)((*P_145553).Tok->data[(NI32)((*P_145553).Idx + 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*P_145553).Tok->data[(NI32)((*P_145553).Idx + 1)].Symbol->data[0]))%8)))!=0);
LA8: ;
Result_145555 = LOC7;
...
LOC16 = !(eqStrings(Markup_145554, ((NimStringDesc*) &TMP193129)));
if (!(LOC16)) goto LA17;
LOC16 = eqStrings((*P_145553).Tok->data[(NI32)((*P_145553).Idx - 1)].Symbol, ((NimStringDesc*) &TMP193126));
LA17: ;
if (!LOC16) goto LA18;
...
TY144077* LOC10;
TY144077* LOC11;
if (!eqStrings((*P_145652).Tok->data[(*P_145652).Idx].Symbol, ((NimStringDesc*) &TMP193130))) goto LA2;
LOC4 = 0;
LOC4 = Newrstnode_144097(((NU8) 62), ((NimStringDesc*) &TMP193126));
Addson_144101(Father_145653, LOC4);
(*P_145652).Idx += 1;
goto LA1;
LA2: ;
if (!eqStrings((*P_145652).Tok->data[(*P_145652).Idx].Symbol, ((NimStringDesc*) &TMP193126))) goto LA5;
(*P_145652).Idx += 1;
...
case ((NU8) 1):
LOC10 = 0;
LOC10 = Newrstnode_144097(((NU8) 62), ((NimStringDesc*) &TMP193131));
Addson_144101(Father_146065, LOC10);
(*P_146064).Idx += 1;
if (!((*P_146064).Tok->data[(*P_146064).Idx].Kind == ((NU8) 1))) goto LA12;
Rstmessage_144752(&(*P_146064), ((NU8) 183), Postfix_146066);
goto LA1;
LA12: ;
break;
case ((NU8) 2):
LOC14 = 0;
LOC14 = Newrstnode_144097(((NU8) 62), ((NimStringDesc*) &TMP193131));
...
HEX3Atmp_145951 = (NI32)(LOC1 - 2);
Res_145953 = 0;
Res_145953 = HEX3Atmp_145951;
while (1) {
if (!(0 <= Res_145953)) goto LA2;
I_145925 = Res_145953;
if (!eqStrings((*(*N_145899).Sons->data[I_145925]).Text, ((NimStringDesc*) &TMP193135))) goto LA4;
Sep_145902 = I_145925;
goto LA2;
LA4: ;
Res_145953 -= 1;
...
LOC8 = (0 < Sep_145902);
if (!(LOC8)) goto LA9;
LOC8 = ((NU8)((*(*N_145899).Sons->data[(NI32)(Sep_145902 - 1)]).Text->data[0]) == (NU8)(32));
LA9: ;
if (!LOC8) goto LA10;
LOC6 = 2;
goto LA7;
...
I_145941 = 0;
HEX3Atmp_145954 = 0;
HEX3Atmp_145954 = (NI32)(Sep_145902 - Incr_145932);
Res_145956 = 0;
Res_145956 = 0;
while (1) {
...
HEX3Atmp_145957 = 0;
HEX3Atmp_145958 = 0;
HEX3Atmp_145957 = (NI32)(Sep_145902 + 1);
LOC12 = Rsonslen_144091(N_145899);
HEX3Atmp_145958 = (NI32)(LOC12 - 2);
Res_145960 = 0;
...
I_145082 = 0;
HEX3Atmp_145095 = 0;
HEX3Atmp_145095 = (NI32)(Length_145073 - 1);
Res_145097 = 0;
Res_145097 = 0;
while (1) {
...
Rstmessage_144752(&(*P_145060), ((NU8) 217), Key_145061);
goto BeforeRet;
LA3: ;
Res_145097 += 1;
} LA1: ;
(*(*P_145060).S).Refs = (TY144682*) setLengthSeq(&((*(*P_145060).S).Refs)->Sup, sizeof(TY144671), (NI32)(Length_145073 + 1));
...
LOC2 = Isinlinemarkupend_145551(&(*P_145964), ((NimStringDesc*) &TMP193133));
if (!LOC2) goto LA3;
(*P_145964).Idx += 1;
LOC6 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx - 2)].Symbol, ((NimStringDesc*) &TMP193132));
if (!(LOC6)) goto LA7;
LOC6 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx - 3)].Symbol, ((NimStringDesc*) &TMP193134));
LA7: ;
if (!LOC6) goto LA8;
A_145979 = 0;
...
goto LA1;
LA3: ;
LOC17 = Match_145720(&(*P_145964), (*P_145964).Idx, ((NimStringDesc*) &TMP193136));
if (!LOC17) goto LA18;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193137))) goto LA21;
(*N_145965).Kind = ((NU8) 56);
goto LA20;
LA21: ;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193138))) goto LA23;
(*N_145965).Kind = ((NU8) 60);
goto LA20;
LA23: ;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193139))) goto LA25;
(*N_145965).Kind = ((NU8) 58);
goto LA20;
LA25: ;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193140))) goto LA27;
(*N_145965).Kind = ((NU8) 57);
goto LA20;
LA27: ;
LOC29 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193141));
if (LOC29) goto LA30;
LOC29 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193142));
LA30: ;
if (!LOC29) goto LA31;
(*N_145965).Kind = ((NU8) 54);
goto LA20;
LA31: ;
LOC33 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193143));
if (LOC33) goto LA34;
LOC33 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193144));
LA34: ;
if (!LOC33) goto LA35;
...
Addson_144101(Result_145966, N_145965);
LOC37 = 0;
LOC37 = Newrstnode_144097(((NU8) 62), (*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol);
...
NIM_BOOL LOC3;
Result_146008 = 0;
LOC3 = eqStrings((*P_146006).Tok->data[(NI32)(I_146007 + 1)].Symbol, ((NimStringDesc*) &TMP193116));
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*P_146006).Tok->data[(NI32)(I_146007 + 2)].Symbol, ((NimStringDesc*) &TMP193145));
LA4: ;
LOC2 = LOC3;
if (!(LOC2)) goto LA5;
LOC2 = ((*P_146006).Tok->data[(NI32)(I_146007 + 3)].Kind == ((NU8) 3));
LA5: ;
LOC1 = LOC2;
if (!(LOC1)) goto LA6;
LOC1 = eqStrings((*P_146006).Tok->data[(NI32)(I_146007 + 4)].Symbol, ((NimStringDesc*) &TMP193146));
LA6: ;
Result_146008 = LOC1;
...
break;
case ((NU8) 5):
if (!!(((120 &(1<<(((*P_146021).Tok->data[(NI32)((*P_146021).Idx + 1)].Kind)&7)))!=0))) goto LA7;
goto LA5;
LA7: ;
break;
default:
...
(*P_146021).Idx += 1;
if (!eqStrings((*P_146021).Tok->data[(*P_146021).Idx].Symbol, ((NimStringDesc*) &TMP193133))) goto LA11;
...
case ((NU8) 5):
LOC2 = Isinlinemarkupstart_145596(&(*P_146140), ((NimStringDesc*) &TMP193127));
if (!LOC2) goto LA3;
(*P_146140).Idx += 1;
N_146154 = 0;
N_146154 = Newrstnode_144094(((NU8) 58));
Parseuntil_146061(P_146140, N_146154, ((NimStringDesc*) &TMP193127), NIM_TRUE);
Addson_144101(Father_146141, N_146154);
goto LA1;
LA3: ;
LOC5 = Isinlinemarkupstart_145596(&(*P_146140), ((NimStringDesc*) &TMP193112));
if (!LOC5) goto LA6;
(*P_146140).Idx += 1;
N_146167 = 0;
N_146167 = Newrstnode_144094(((NU8) 57));
Parseuntil_146061(P_146140, N_146167, ((NimStringDesc*) &TMP193112), NIM_TRUE);
Addson_144101(Father_146141, N_146167);
goto LA1;
LA6: ;
LOC8 = Isinlinemarkupstart_145596(&(*P_146140), ((NimStringDesc*) &TMP193129));
if (!LOC8) goto LA9;
(*P_146140).Idx += 1;
N_146180 = 0;
N_146180 = Newrstnode_144094(((NU8) 60));
Parseuntil_146061(P_146140, N_146180, ((NimStringDesc*) &TMP193129), NIM_FALSE);
Addson_144101(Father_146141, N_146180);
goto LA1;
LA9: ;
LOC11 = Isinlinemarkupstart_145596(&(*P_146140), ((NimStringDesc*) &TMP193132));
if (!LOC11) goto LA12;
(*P_146140).Idx += 1;
N_146193 = 0;
N_146193 = Newrstnode_144094(((NU8) 59));
Parseuntil_146061(P_146140, N_146193, ((NimStringDesc*) &TMP193132), NIM_TRUE);
N_146193 = Parsepostfix_145961(P_146140, N_146193);
Addson_144101(Father_146141, N_146193);
goto LA1;
LA12: ;
LOC14 = Isinlinemarkupstart_145596(&(*P_146140), ((NimStringDesc*) &TMP193114));
if (!LOC14) goto LA15;
(*P_146140).Idx += 1;
N_146206 = 0;
N_146206 = Newrstnode_144094(((NU8) 61));
Parseuntil_146061(P_146140, N_146206, ((NimStringDesc*) &TMP193114), NIM_FALSE);
...
Parseuntil_146061(P_146463, Fieldname_146478, ((NimStringDesc*) &TMP193116), NIM_FALSE);
Fieldbody_146479 = 0;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*P_146506).Tok->data[(NI32)((*P_146506).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193116));
LA3: ;
if (!LOC2) goto LA4;
Col_146517 = 0;
...
LOC9 = LOC10;
if (!(LOC9)) goto LA12;
LOC9 = eqStrings((*P_146506).Tok->data[(NI32)((*P_146506).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193116));
LA12: ;
if (!LOC9) goto LA13;
(*P_146506).Idx += 1;
goto LA8;
...
LOC20 = LOC21;
if (!(LOC20)) goto LA23;
LOC20 = eqStrings((*P_148021).Tok->data[(NI32)((*P_148021).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193116));
LA23: ;
if (!LOC20) goto LA24;
...
appendString(LOC7, ((NimStringDesc*) &TMP193147));
...
Result_146557 = copyString(((NimStringDesc*) &TMP193148));
LA16: ;
goto BeforeRet;
LA13: ;
Res_146600 += 1;
...
LOC11 = 0;
LOC11 = Readfile_3847(Path_148174);
Gettokens_144427(LOC11, NIM_FALSE, &Q_148175.Tok);
LOC13 = nsuFindStr(Q_148175.Tok->data[(Q_148175.Tok->Sup.len-1)].Symbol, ((NimStringDesc*) &TMP193149), 0);
if (!(0 < LOC13)) goto LA14;
Internalerror_43163(((NimStringDesc*) &TMP193150));
LA14: ;
...
TY144077* LOC8;
Filename_148248 = 0;
Filename_148248 = Getfieldvalue_144111((*Result_148245), ((NimStringDesc*) &TMP193152));
if (!(0 < Filename_148248->Sup.len)) goto LA2;
Path_148255 = 0;
Path_148255 = Findfile_41090(Filename_148248);
if (!(Path_148255->Sup.len == 0)) goto LA5;
Rstmessage_144752(&(*P_148243), ((NU8) 2), Filename_148248);
goto LA4;
LA5: ;
F_148260 = 0;
F_148260 = Readfile_3847(Path_148255);
...
LOC5 = nsuCmpIgnoreCase((*(*(*Result_148265).Sons->data[0]).Sons->data[0]).Text, ((NimStringDesc*) &TMP193151));
if (!(LOC5 == 0)) goto LA6;
Dirrawaux_148240(P_148264, &Result_148265, ((NU8) 48), Parseliteralblock_146620);
goto LA4;
LA6: ;
LOC8 = nsuCmpIgnoreCase((*(*(*Result_148265).Sons->data[0]).Sons->data[0]).Text, ((NimStringDesc*) &TMP193153));
if (!(LOC8 == 0)) goto LA9;
...
Filename_148189 = 0;
LOC1 = 0;
LOC1 = Getfieldvalue_144111(Result_148187, ((NimStringDesc*) &TMP193152));
Filename_148189 = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE);
if (!!(((Filename_148189) && (Filename_148189)->Sup.len == 0))) goto LA3;
Path_148190 = 0;
Path_148190 = Findfile_41090(Filename_148189);
...
LOC8 = 0;
LOC8 = Readfile_3847(Path_148190);
LOC9 = 0;
...
break;
default:
Rstmessage_144752(&(*P_145477), ((NU8) 183), Endstr_145478);
goto LA1;
break;
}
(*P_145477).Idx += 1;
...
goto LA1;
LA2: ;
Rstmessage_144752(&(*P_145537), ((NU8) 183), Tok_145538);
LA1: ;
}
N_NIMCALL(void, Setsub_145016)(TY144677* P_145019, NimStringDesc* Key_145020, TY144077* Value_145021) {
NI Length_145032;
...
I_145041 = 0;
HEX3Atmp_145054 = 0;
HEX3Atmp_145054 = (NI32)(Length_145032 - 1);
Res_145056 = 0;
Res_145056 = 0;
while (1) {
...
(*(*P_145019).S).Subs = (TY144682*) setLengthSeq(&((*(*P_145019).S).Subs)->Sup, sizeof(TY144671), (NI32)(Length_145032 + 1));
...
case ((NU8) 1):
case ((NU8) 0):
if (!((*P_146348).Tok->data[(NI32)((*P_146348).Idx + 1)].Kind == ((NU8) 1))) goto LA2;
(*P_146348).Idx += 1;
goto LA1;
LA2: ;
Indent_146371 = 0;
...
goto LA1;
LA2: ;
LOC5 = Match_145720(&(*P_146619), (*P_146619).Idx, ((NimStringDesc*) &TMP193154));
if (!LOC5) goto LA6;
(*P_146619).Idx += 2;
A_148316 = 0;
A_148316 = Getreferencename_145474(P_146619, ((NimStringDesc*) &TMP193116));
...
goto LA1;
LA6: ;
LOC12 = Match_145720(&(*P_146619), (*P_146619).Idx, ((NimStringDesc*) &TMP193155));
if (!LOC12) goto LA13;
(*P_146619).Idx += 2;
A_148351 = 0;
A_148351 = Getreferencename_145474(P_146619, ((NimStringDesc*) &TMP193114));
B_148352 = 0;
if (!((*P_146619).Tok->data[(*P_146619).Idx].Kind == ((NU8) 2))) goto LA16;
(*P_146619).Idx += 1;
LA16: ;
LOC19 = nsuCmpIgnoreStyle((*P_146619).Tok->data[(*P_146619).Idx].Symbol, ((NimStringDesc*) &TMP193156));
if (!(LOC19 == 0)) goto LA20;
(*P_146619).Idx += 1;
Expect_145534(P_146619, ((NimStringDesc*) &TMP193110));
...
goto LA1;
LA13: ;
LOC26 = Match_145720(&(*P_146619), (*P_146619).Idx, ((NimStringDesc*) &TMP193157));
if (!LOC26) goto LA27;
(*P_146619).Idx += 2;
A_148414 = 0;
A_148414 = Getreferencename_145474(P_146619, ((NimStringDesc*) &TMP193158));
...
(*P_147776).Idx += (NI32)(Wildpos_147783[(W_147788)-0] + 3);
J_147818 = 0;
...
LOC16 = LOC17;
if (!(LOC16)) goto LA19;
LOC16 = Match_145720(&(*P_147776), (NI32)((*P_147776).Idx + 1), Wildcards_147778[(W_147788)-0]);
LA19: ;
if (!LOC16) goto LA20;
(*P_147776).Idx += (NI32)(Wildpos_147783[(W_147788)-0] + 4);
goto LA15;
LA20: ;
goto LA14;
LA15: ;
...
LOC3 = LOC4;
if (!(LOC3)) goto LA9;
LOC3 = !(eqStrings((*P_147677).Tok->data[(NI32)(J_147679 - 1)].Symbol, ((NimStringDesc*) &TMP193110)));
LA9: ;
if (!LOC3) goto LA10;
Col_147695 = 0;
...
LOC15 = LOC16;
if (!(LOC15)) goto LA19;
LOC15 = !(eqStrings((*P_147677).Tok->data[(NI32)((*P_147677).Idx + 1)].Symbol, ((NimStringDesc*) &TMP193110)));
LA19: ;
LOC14 = LOC15;
if (!(LOC14)) goto LA20;
LOC14 = !(((3 &(1<<(((*P_147677).Tok->data[(NI32)((*P_147677).Idx + 1)].Kind)&7)))!=0));
LA20: ;
if (!LOC14) goto LA21;
...
LOC31 = LOC32;
if (!(LOC31)) goto LA36;
LOC31 = !(eqStrings((*P_147677).Tok->data[(NI32)(J_147679 - 1)].Symbol, ((NimStringDesc*) &TMP193110)));
LA36: ;
LOC30 = LOC31;
if (!(LOC30)) goto LA37;
LOC30 = !(((*P_147677).Tok->data[(NI32)(J_147679 + 1)].Kind == ((NU8) 1)));
LA37: ;
if (!LOC30) goto LA38;
goto LA29;
LA38: ;
...
C_146971 = 0;
C_146971 = (*P_146951).Tok->data[(NI32)((*P_146951).Idx + 1)].Symbol->data[0];
(*P_146951).Idx += 2;
...
if (!(LOC6 < (*P_147419).Tok->data[(NI32)((*P_147419).Idx - 1)].Ival)) goto LA7;
LOC9 = 0;
LOC9 = Newrstnode_144097(((NU8) 62), ((NimStringDesc*) &TMP193131));
...
NI Result_146991;
Result_146991 = 0;
Result_146991 = (NI32)((NI32)((*P_146990).Tok->data[(*P_146990).Idx].Col + (*P_146990).Tok->data[(*P_146990).Idx].Symbol->Sup.len) - 1);
...
while (1) {
L_147000 += 1;
(*Cols_146999) = (TY73281*) setLengthSeq(&((*Cols_146999))->Sup, sizeof(NI), L_147000);
(*Cols_146999)->data[(NI32)(L_147000 - 1)] = Tokend_146988(&(*P_146997));
(*P_146997).Idx += 1;
...
(*P_146997).Idx += 1;
LA9: ;
(*Cols_146999)->data[(NI32)(L_147000 - 1)] = 32000;
}
N_NIMCALL(TY144077*, Parsesimpletable_147101)(TY144677* P_147104) {
...
Cols_147106 = (TY73281*) newSeq(NTI73281, 0);
Row_147108 = (TY34021*) newSeq(NTI34021, 0);
A_147114 = NIM_NIL;
...
Row_147108 = (TY34021*) setLengthSeq(&(Row_147108)->Sup, sizeof(NimStringDesc*), Cols_147106->Sup.len);
if (!!((A_147114 == NIM_NIL))) goto LA9;
J_147211 = 0;
HEX3Atmp_147345 = 0;
LOC11 = Rsonslen_144091(A_147114);
HEX3Atmp_147345 = (NI32)(LOC11 - 1);
Res_147347 = 0;
Res_147347 = 0;
while (1) {
...
Q_147113.Line = (NI32)(Line_147111 - 1);
...
LOC7 = Match_145720(&(*P_147567), (*P_147567).Idx, ((NimStringDesc*) &TMP193122));
if (!LOC7) goto LA8;
(*P_147567).Idx += 1;
LA8: ;
while (1) {
...
LOC19 = (0 < J_147635);
if (!(LOC19)) goto LA20;
LOC19 = ((*P_147567).Tok->data[(NI32)(J_147635 - 1)].Kind == ((NU8) 1));
LA20: ;
LOC18 = LOC19;
if (!(LOC18)) goto LA21;
LOC22 = Currind_144761(&(*P_147567));
LOC18 = (LOC22 < (*P_147567).Tok->data[(NI32)(J_147635 - 1)].Ival);
LA21: ;
if (!LOC18) goto LA23;
Pushind_144765(P_147567, (*P_147567).Tok->data[(NI32)(J_147635 - 1)].Ival);
...
case ((NU8) 1):
if (!((*P_146881).Tok->data[(NI32)((*P_146881).Idx + 1)].Kind == ((NU8) 1))) goto LA3;
(*P_146881).Idx += 1;
goto LA1;
goto LA2;
LA3: ;
...
break;
case ((NU8) 5):
LOC13 = eqStrings((*P_146881).Tok->data[(*P_146881).Idx].Symbol, ((NimStringDesc*) &TMP193110));
if (!(LOC13)) goto LA14;
LOC13 = ((*P_146881).Tok->data[(NI32)((*P_146881).Idx + 1)].Kind == ((NU8) 1));
LA14: ;
LOC12 = LOC13;
if (!(LOC12)) goto LA15;
LOC16 = Currind_144761(&(*P_146881));
LOC12 = (LOC16 < (*P_146881).Tok->data[(NI32)((*P_146881).Idx + 1)].Ival);
LA15: ;
if (!LOC12) goto LA17;
LOC19 = 0;
LOC19 = Newrstnode_144097(((NU8) 62), ((NimStringDesc*) &TMP193116));
...
break;
case ((NU8) 62):
Rstmessage_144757(&(*P_146458), ((NU8) 187));
break;
case ((NU8) 4):
break;
case ((NU8) 9):
...
break;
default:
Internalerror_43163(((NimStringDesc*) &TMP193159));
break;
}
...
Rstmessage_144757(&(*P_147100), ((NU8) 186));
LA2: ;
...
Rawmessage_43045(((NU8) 2), Filename_144086);
LA2: ;
LOC4 = 0;
...
if (!(LOC7)) goto LA8;
LOC7 = ((NU8)(S_145243->data[(NI32)(Filename_145221->Sup.len + 0)]) == (NU8)(35));
LA8: ;
if (!LOC7) goto LA9;
...
Result_144657 = 0;
Result_144657 = (*N_144656).Sons->data[(NI32)((*N_144656).Sons->Sup.len - 1)];
...
H_145154 = 1;
while (1) {
H_145154 = (NI32)((NI32)(3 * H_145154) + 1);
if (!(N_145153 < H_145154)) goto LA3;
goto LA1;
LA3: ;
} LA1: ;
while (1) {
H_145154 = (NI32)(H_145154 / 3);
I_145167 = 0;
HEX3Atmp_145178 = 0;
HEX3Atmp_145178 = (NI32)(N_145153 - 1);
Res_145180 = 0;
Res_145180 = H_145154;
while (1) {
...
J_145169 = I_145167;
while (1) {
LOC8 = Cmpnodes_145116((*A_144125).Sons->data[(NI32)(J_145169 - H_145154)], V_145168);
if (!(0 <= LOC8)) goto LA7;
asgnRefNoCycle((void**) &(*A_144125).Sons->data[J_145169], (*A_144125).Sons->data[(NI32)(J_145169 - H_145154)]);
J_145169 = (NI32)(J_145169 - H_145154);
