...
Result_144751 = Newlineinfo_43581((*P_144749).Filename, (NI32)((*P_144749).Line + (*Tok_144750).Line), (NI32)((*P_144749).Col + (*Tok_144750).Col));
...
(*P_144791).Indentstack = (TY74281*) setLengthSeq(&((*P_144791).Indentstack)->Sup, sizeof(NI), (NI32)((*P_144791).Indentstack->Sup.len - 1));
LA2: ;
}
N_NIMCALL(NIM_BOOL, Match_145720)(TY144677* P_145722, NI Start_145723, NimStringDesc* Expr_145724) {
...
LOC1 = LOC2;
if (!(LOC1)) goto LA4;
LOC1 = !(eqStrings((*P_146782).Tok->data[(NI32)(J_146784 - 2)].Symbol, ((NimStringDesc*) &TMP194105)));
LA4: ;
Result_146783 = LOC1;
...
case ((NU8) 4):
LOC2 = Match_145720(P_146807, (NI32)((*P_146807).Idx + 1), ((NimStringDesc*) &TMP194101));
if (!LOC2) goto LA3;
Result_146808 = ((NU8) 3);
goto LA1;
LA3: ;
LOC5 = Match_145720(P_146807, (NI32)((*P_146807).Idx + 1), ((NimStringDesc*) &TMP194102));
if (!LOC5) goto LA6;
Result_146808 = ((NU8) 29);
goto LA1;
LA6: ;
LOC8 = Match_145720(P_146807, (NI32)((*P_146807).Idx + 1), ((NimStringDesc*) &TMP194103));
if (!LOC8) goto LA9;
Result_146808 = ((NU8) 2);
goto LA1;
LA9: ;
...
LOC7 = LOC8;
if (!(LOC7)) goto LA10;
LOC7 = eqStrings((*P_146821).Tok->data[(NI32)((*P_146821).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194109));
LA10: ;
LOC6 = LOC7;
if (!(LOC6)) goto LA11;
...
LOC4 = LOC5;
if (LOC4) goto LA7;
LOC4 = ((TMP194120[((NU8)((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol->data[0]))%8)))!=0);
LA7: ;
Result_145600 = LOC4;
...
if (!eqStrings((*P_145598).Tok->data[(NI32)((*P_145598).Idx - 1)].Symbol, ((NimStringDesc*) &TMP194121))) goto LA18;
...
if (LOC7) goto LA8;
LOC7 = ((TMP194123[((NU8)((*P_145553).Tok->data[(NI32)((*P_145553).Idx + 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*P_145553).Tok->data[(NI32)((*P_145553).Idx + 1)].Symbol->data[0]))%8)))!=0);
LA8: ;
Result_145555 = LOC7;
...
if (!(LOC16)) goto LA17;
LOC16 = eqStrings((*P_145553).Tok->data[(NI32)((*P_145553).Idx - 1)].Symbol, ((NimStringDesc*) &TMP194121));
LA17: ;
if (!LOC16) goto LA18;
...
if (!LOC2) goto LA3;
(*P_145964).Idx += 1;
LOC6 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx - 2)].Symbol, ((NimStringDesc*) &TMP194127));
if (!(LOC6)) goto LA7;
LOC6 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx - 3)].Symbol, ((NimStringDesc*) &TMP194129));
LA7: ;
if (!LOC6) goto LA8;
A_145979 = 0;
...
if (!LOC17) goto LA18;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194132))) goto LA21;
(*N_145965).Kind = ((NU8) 56);
goto LA20;
LA21: ;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194133))) goto LA23;
(*N_145965).Kind = ((NU8) 60);
goto LA20;
LA23: ;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194134))) goto LA25;
(*N_145965).Kind = ((NU8) 58);
goto LA20;
LA25: ;
if (!eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194135))) goto LA27;
(*N_145965).Kind = ((NU8) 57);
goto LA20;
LA27: ;
LOC29 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194136));
if (LOC29) goto LA30;
LOC29 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194137));
LA30: ;
if (!LOC29) goto LA31;
(*N_145965).Kind = ((NU8) 54);
goto LA20;
LA31: ;
LOC33 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194138));
if (LOC33) goto LA34;
LOC33 = eqStrings((*P_145964).Tok->data[(NI32)((*P_145964).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194139));
LA34: ;
if (!LOC33) goto LA35;
...
NIM_BOOL LOC3;
Result_146008 = 0;
LOC3 = eqStrings((*P_146006).Tok->data[(NI32)(I_146007 + 1)].Symbol, ((NimStringDesc*) &TMP194111));
if (!(LOC3)) goto LA4;
LOC3 = eqStrings((*P_146006).Tok->data[(NI32)(I_146007 + 2)].Symbol, ((NimStringDesc*) &TMP194140));
LA4: ;
LOC2 = LOC3;
if (!(LOC2)) goto LA5;
...
LOC1 = LOC2;
if (!(LOC1)) goto LA6;
LOC1 = eqStrings((*P_146006).Tok->data[(NI32)(I_146007 + 4)].Symbol, ((NimStringDesc*) &TMP194141));
LA6: ;
Result_146008 = LOC1;
...
if (!(LOC2)) goto LA3;
LOC2 = eqStrings((*P_146506).Tok->data[(NI32)((*P_146506).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194111));
LA3: ;
if (!LOC2) goto LA4;
Col_146517 = 0;
...
LOC9 = LOC10;
if (!(LOC9)) goto LA12;
LOC9 = eqStrings((*P_146506).Tok->data[(NI32)((*P_146506).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194111));
LA12: ;
if (!LOC9) goto LA13;
(*P_146506).Idx += 1;
goto LA8;
...
LOC20 = LOC21;
if (!(LOC20)) goto LA23;
LOC20 = eqStrings((*P_148021).Tok->data[(NI32)((*P_148021).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194111));
LA23: ;
if (!LOC20) goto LA24;
...
LOC3 = LOC4;
if (!(LOC3)) goto LA9;
LOC3 = !(eqStrings((*P_147677).Tok->data[(NI32)(J_147679 - 1)].Symbol, ((NimStringDesc*) &TMP194105)));
LA9: ;
if (!LOC3) goto LA10;
Col_147695 = 0;
...
LOC15 = LOC16;
if (!(LOC15)) goto LA19;
LOC15 = !(eqStrings((*P_147677).Tok->data[(NI32)((*P_147677).Idx + 1)].Symbol, ((NimStringDesc*) &TMP194105)));
LA19: ;
LOC14 = LOC15;
if (!(LOC14)) goto LA20;
...
LOC31 = LOC32;
if (!(LOC31)) goto LA36;
LOC31 = !(eqStrings((*P_147677).Tok->data[(NI32)(J_147679 - 1)].Symbol, ((NimStringDesc*) &TMP194105)));
LA36: ;
LOC30 = LOC31;
if (!(LOC30)) goto LA37;
