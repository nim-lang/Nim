...
TMP193655 = mulInt64((*B_22949), 10);TMP193656 = subInt(((NU8)(S_22947->data[I_22953])), 48);TMP193657 = subInt64((NI64)(TMP193655), ((NI64) ((NI32)(TMP193656))));(*B_22949) = (NI64)(TMP193657);
I_22953 = addInt(I_22953, 1);
while (1) {
...
TMP193659 = subInt(I_22953, Start_22950);Result_22951 = (NI32)(TMP193659);
LA7: ;
return Result_22951;
}
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* S_23044, NI64* Number_23046, NI Start_23047) {
