...
I_58151 = Res_58154;
(*X_55231).Data->data[I_58151].Key = (-2147483647 -1);
Res_58154 += 1;
} LA1: ;
}
N_NIMCALL(NI, Nexttry_55213)(NI H_55215, NI Maxhash_55216) {
NI Result_56868;
Result_56868 = 0;
Result_56868 = (NI32)((NI32)((NI32)(5 * H_55215) + 1) & Maxhash_55216);
return Result_56868;
}
N_NIMCALL(TY51547*, Strtableget_55069)(TY51529* T_55071, TY50011* Name_55072) {
...
Result_57507 = 0;
H_57508 = 0;
H_57508 = (NI32)((*Name_55072).H & ((*T_55071).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_55536 = 0;
LOC1 = ((NI32)(Length_55211 * 2) < (NI32)(Counter_55212 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI32)(Length_55211 - Counter_55212) < 4);
LA2: ;
Result_55536 = LOC1;
return Result_55536;
}
...
NimStringDesc* LOC5;
H_57316 = 0;
H_57316 = (NI32)((*(*N_57315).Name).H & ((*Data_57314)->Sup.len-1));
while (1) {
...
TY51527* LOC5;
N_57361 = 0;
N_57361 = (TY51527*) newSeq(NTI51527, (NI32)((*T_57360).Data->Sup.len * 2));
I_57391 = 0;
HEX3Atmp_57414 = 0;
...
Result_58161 = 0;
H_58162 = 0;
H_58162 = (NI32)(Key_58160 & (T_58159.Data->Sup.len-1));
while (1) {
if (!!((T_58159.Data->data[H_58162].Key == (-2147483647 -1)))) goto LA1;
...
NI H_58182;
H_58182 = 0;
H_58182 = (NI32)(Key_58180 & ((*Data_58179)->Sup.len-1));
while (1) {
if (!!(((*Data_58179)->data[H_58182].Key == (-2147483647 -1)))) goto LA1;
...
if (!LOC5) goto LA6;
N_58197 = (TY55221*) newSeq(NTI55221, (NI32)((*T_55239).Data->Sup.len * 2));
I_58241 = 0;
HEX3Atmp_58276 = 0;
...
I_58241 = Res_58278;
N_58197->data[I_58241].Key = (-2147483647 -1);
Res_58278 += 1;
} LA8: ;
I_58249 = 0;
HEX3Atmp_58282 = 0;
...
I_58249 = Res_58284;
if (!!(((*T_55239).Data->data[I_58249].Key == (-2147483647 -1)))) goto LA11;
...
Result_57782 = 0;
H_57783 = 0;
H_57783 = (NI32)(Key_57781 & (T_57780.Data->Sup.len-1));
while (1) {
...
NI H_57837;
H_57837 = 0;
H_57837 = (NI32)((*Key_57835).Id & ((*Data_57834)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_57870 = (TY51561*) newSeq(NTI51561, (NI32)((*T_55177).Data->Sup.len * 2));
I_57923 = 0;
HEX3Atmp_57959 = 0;
...
I_57636 = 0;
HEX3Atmp_57649 = 0;
HEX3Atmp_57649 = (NI32)(((NI) (Tab_55121.Tos)) - 1);
Res_57651 = 0;
...
H_57538 = 0;
Start_57539 = 0;
H_57538 = (NI32)((*Ti_55104).H & ((*Tab_55105).Data->Sup.len-1));
Start_57539 = H_57538;
...
Result_57971 = 0;
H_57972 = 0;
H_57972 = (NI32)((*Key_57970).Id & (T_57969.Data->Sup.len-1));
while (1) {
...
NI H_58001;
H_58001 = 0;
H_58001 = (NI32)((*Key_57999).Id & ((*Data_57998)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_58034 = (TY51567*) newSeq(NTI51567, (NI32)((*T_55191).Data->Sup.len * 2));
I_58087 = 0;
HEX3Atmp_58123 = 0;
...
(*Tab_55152).Stack = (TY55109*) setLengthSeq(&((*Tab_55152).Stack)->Sup, sizeof(TY51529), (NI32)(((NI) ((*Tab_55152).Tos)) + 1));
LA2: ;
...
NU8 Result_57691;
Result_57691 = 0;
Result_57691 = Symtabadduniqueat_55143(Tab_55141, E_55142, ((NI) ((NI32)(((NI) ((*Tab_55141).Tos)) - 1))));
return Result_57691;
}
...
Result_57608 = 0;
Result_57608 = Strtableget_55069(&Tab_55125.Stack->data[(NI32)(((NI) (Tab_55125.Tos)) - 1)], S_55126);
return Result_57608;
}
N_NIMCALL(void, Symtabadd_55127)(TY55107* Tab_55130, TY51547* E_55131) {
Strtableadd_55064(&(*Tab_55130).Stack->data[(NI32)(((NI) ((*Tab_55130).Tos)) - 1)], E_55131);
}
