...
LA2: ;
S_105023 = Inittabiter_56073(&It_105022, &(*Tab_105021).Stack->data[(NI32)(((NI) ((*Tab_105021).Tos)) - 1)]);
while (1) {
...
LA11: ;
LA5: ;
S_105023 = Nextiter_56078(&It_105022, &(*Tab_105021).Stack->data[(NI32)(((NI) ((*Tab_105021).Tos)) - 1)]);
} LA4: ;
