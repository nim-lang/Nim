...
Result_28646.Year = ((NI) (addInt((*Tm_28645).tm_year, ((NI32) 1900))));
...
Result_28655.tm_sec = ((NI32) ((*T_28654).Second));
F.line = 220;F.filename = "times.nim";
Result_28655.tm_min = ((NI32) ((*T_28654).Minute));
F.line = 221;F.filename = "times.nim";
Result_28655.tm_hour = ((NI32) ((*T_28654).Hour));
F.line = 222;F.filename = "times.nim";
Result_28655.tm_mday = ((NI32) ((*T_28654).Monthday));
F.line = 223;F.filename = "times.nim";
Result_28655.tm_mon = ((NI32) ((*T_28654).Month));
F.line = 224;F.filename = "times.nim";
Result_28655.tm_year = ((NI32) (subInt((*T_28654).Year, 1900)));
F.line = 225;F.filename = "times.nim";
Result_28655.tm_wday = ((NI32) (Weekdays_28656[((*T_28654).Weekday)-0]));
F.line = 226;F.filename = "times.nim";
Result_28655.tm_yday = ((NI32) ((*T_28654).Yearday));
...
Result_29267 = (((double) (((NI)chckRange64(Secs_29271, (-2147483647 -1), 2147483647)))) + (((double) (((NI)chckRange64(Subsecs_29272, (-2147483647 -1), 2147483647)))) * 1.00000e-07));
framePtr = framePtr->prev;
return Result_29267;
}
N_NIMCALL(NF, ntcpuTime)(void) {
