...
N_NIMCALL(TY48008*, Encodenode_108298)(TY108004* W_108300, TY43538 Finfo_108301, TY51526* N_108302);
...
N_NIMCALL(TY48008*, Encodelib_108827)(TY108004* W_108829, TY51544* Lib_108830, TY43538 Info_108831);
...
STRING_LITERAL(TMP194863, "rodwrite: module ID not set", 27);
STRING_LITERAL(TMP194865, " ", 1);
STRING_LITERAL(TMP194866, "symStack: module nil: ", 22);
STRING_LITERAL(TMP194867, "\012", 1);
STRING_LITERAL(TMP194868, "$1 $2\012", 6);
STRING_LITERAL(TMP194869, "{}", 2);
STRING_LITERAL(TMP194870, "+$1", 3);
STRING_LITERAL(TMP194871, "&$1", 3);
STRING_LITERAL(TMP194872, "^$1", 3);
STRING_LITERAL(TMP194873, "?$1,$2,$3", 9);
STRING_LITERAL(TMP194874, "*$1", 3);
STRING_LITERAL(TMP194875, "$$$1", 4);
STRING_LITERAL(TMP194876, "@$1", 3);
STRING_LITERAL(TMP194877, "()", 2);
STRING_LITERAL(TMP194878, "(", 1);
STRING_LITERAL(TMP194879, "?$1,$2", 6);
STRING_LITERAL(TMP194880, "?$1", 3);
STRING_LITERAL(TMP194881, "!$1", 3);
STRING_LITERAL(TMP194882, ")", 1);
STRING_LITERAL(TMP194883, "%$1", 3);
STRING_LITERAL(TMP194884, "`$1", 3);
STRING_LITERAL(TMP194885, "<$1>", 4);
STRING_LITERAL(TMP194886, "|$1", 3);
STRING_LITERAL(TMP194887, "[]", 2);
STRING_LITERAL(TMP194888, "encodeType: tyForward", 21);
STRING_LITERAL(TMP194889, "/$1", 3);
STRING_LITERAL(TMP194890, "=$1", 3);
STRING_LITERAL(TMP194891, "^()", 3);
STRING_LITERAL(TMP194892, "NIM:", 4);
STRING_LITERAL(TMP194893, "1012", 4);
STRING_LITERAL(TMP194894, "ID:", 3);
STRING_LITERAL(TMP194895, "CRC:", 4);
STRING_LITERAL(TMP194896, "OPTIONS:", 8);
STRING_LITERAL(TMP194897, "DEFINES:", 8);
STRING_LITERAL(TMP194898, "FILES(\012", 7);
STRING_LITERAL(TMP194899, ")\012", 2);
STRING_LITERAL(TMP194900, "INCLUDES(\012", 10);
STRING_LITERAL(TMP194901, "DEPS:", 5);
STRING_LITERAL(TMP194902, "INTERF(\012", 8);
STRING_LITERAL(TMP194903, "COMPILERPROCS(\012", 15);
STRING_LITERAL(TMP194904, "INDEX(\012", 7);
STRING_LITERAL(TMP194905, "IMPORTS(\012", 9);
STRING_LITERAL(TMP194906, "CONVERTERS:", 11);
STRING_LITERAL(TMP194907, "INIT(\012", 6);
STRING_LITERAL(TMP194908, "DATA(\012", 6);
STRING_LITERAL(TMP194909, "rod", 3);
STRING_LITERAL(TMP194910, "rodwrite.process", 16);
TY51895 Debugwritten_109082;
...
S_108061 = NIM_NIL;
S_108061 = Inittabiter_56073(&It_108059, &Gsymbols_60001);
Result_108058 = NIM_NIL;
while (1) {
if (!!((S_108061 == NIM_NIL))) goto LA1;
if (!((*S_108061).Position == 1)) goto LA3;
if (!!((Result_108058 == NIM_NIL))) goto LA6;
App_48036(&Result_108058, ((NimStringDesc*) &TMP194865));
LA6: ;
App_48036(&Result_108058, (*(*S_108061).Name).S);
LA3: ;
S_108061 = Nextiter_56078(&It_108059, &Gsymbols_60001);
} LA1: ;
...
Initiitable_56220(&(*Result_108148).Index.Tab);
Initiitable_56220(&(*Result_108148).Imports.Tab);
...
(*Result_108148).Options = Goptions_42082;
...
NI LOC2;
NI L_108285;
LOC2 = Iitableget_56224((*W_108271).Index.Tab, (*S_108272).Sup.Id);
...
App_48036(&(*W_109069).R, ((NimStringDesc*) &TMP194867));
goto LA1;
LA2: ;
...
Appf_48071(&(*W_109069).R, ((NimStringDesc*) &TMP194868), LOC5, 2);
LA1: ;
(*W_109069).Lastidxkey = Key_109070;
(*W_109069).Lastidxval = Val_109071;
Iitableput_56228(&(*W_109069).Tab, Key_109070, Val_109071);
}
N_NIMCALL(TY48008*, Encodestr_108048)(TY108004* W_108050, NimStringDesc* S_108051) {
...
NI LOC2;
NI L_108256;
LOC2 = Iitableget_56224((*W_108242).Index.Tab, (*T_108243).Sup.Id);
if (!(LOC2 == (-2147483647 -1))) goto LA3;
L_108256 = 0;
...
TY48008* LOC42;
Result_108303 = 0;
Result_108303 = NIM_NIL;
if (!(N_108302 == NIM_NIL)) goto LA2;
Result_108303 = Torope_48046(((NimStringDesc*) &TMP194877));
goto BeforeRet;
LA2: ;
Result_108303 = Torope_48046(((NimStringDesc*) &TMP194878));
LOC4 = 0;
...
LOC9 = 0;
LOC9 = Tofilename_43724((*N_108302).Info);
LOC10 = Fileidx_108089(W_108300, LOC9);
LOC8[2] = Encodeint_90073(((NI64) (LOC10)));
Appf_48071(&Result_108303, ((NimStringDesc*) &TMP194873), LOC8, 3);
goto LA5;
LA6: ;
...
Appf_48071(&Result_108303, ((NimStringDesc*) &TMP194879), LOC13, 2);
goto LA5;
LA11: ;
...
Appf_48071(&Result_108303, ((NimStringDesc*) &TMP194880), LOC16, 1);
goto LA5;
LA14: ;
LA5: ;
...
Appf_48071(&Result_108303, ((NimStringDesc*) &TMP194881), LOC28, 1);
LA26: ;
break;
case ((NU8) 11) ... ((NU8) 13):
...
Appf_48071(&Result_108303, ((NimStringDesc*) &TMP194881), LOC32, 1);
LA30: ;
break;
case ((NU8) 14) ... ((NU8) 16):
...
App_48036(&Result_108303, ((NimStringDesc*) &TMP194882));
BeforeRet: ;
...
Appf_48071(&Result_108832, ((NimStringDesc*) &TMP194886), LOC1, 1);
memset((void*)&LOC2, 0, sizeof(LOC2));
LOC3 = 0;
LOC3 = Ropetostr_48063((*Lib_108830).Name);
LOC2[0] = Encodestr_108048(W_108829, LOC3);
Appf_48071(&Result_108832, ((NimStringDesc*) &TMP194886), LOC2, 1);
memset((void*)&LOC4, 0, sizeof(LOC4));
LOC4[0] = Encodenode_108298(W_108829, Info_108831, (*Lib_108830).Path);
Appf_48071(&Result_108832, ((NimStringDesc*) &TMP194886), LOC4, 1);
...
Result_108857 = Torope_48046(((NimStringDesc*) &TMP194869));
goto BeforeRet;
LA2: ;
Result_108857 = NIM_NIL;
LOC4 = 0;
...
Appf_48071(&Result_108857, ((NimStringDesc*) &TMP194870), LOC5, 1);
memset((void*)&LOC6, 0, sizeof(LOC6));
LOC6[0] = Encodestr_108048(W_108855, (*(*S_108856).Name).S);
Appf_48071(&Result_108857, ((NimStringDesc*) &TMP194871), LOC6, 1);
if (!!(((*S_108856).Typ == NIM_NIL))) goto LA8;
memset((void*)&LOC10, 0, sizeof(LOC10));
LOC10[0] = Encodeint_90073(((NI64) ((*(*S_108856).Typ).Sup.Id)));
Appf_48071(&Result_108857, ((NimStringDesc*) &TMP194872), LOC10, 1);
...
Appf_48071(&Result_108857, ((NimStringDesc*) &TMP194875), LOC27, 1);
LA25: ;
if (!!(((*S_108856).Magic == ((NU8) 0)))) goto LA29;
memset((void*)&LOC31, 0, sizeof(LOC31));
LOC31[0] = Encodeint_90073(((NI64) ((*S_108856).Magic)));
Appf_48071(&Result_108857, ((NimStringDesc*) &TMP194876), LOC31, 1);
LA29: ;
if (!!(((*S_108856).Ast == NIM_NIL))) goto LA33;
LOC36 = Astneeded_102057(S_108856);
if (!!(LOC36)) goto LA37;
...
LOC3 = Iitableget_56224((*W_109085).Index.Tab, (*S_109088).Sup.Id);
if (!(LOC3 == (-2147483647 -1))) goto LA4;
M_109089 = Getmodule_56198(S_109088);
if (!(M_109089 == NIM_NIL)) goto LA7;
LOC9 = 0;
LOC9 = rawNewString((*(*S_109088).Name).S->Sup.len + 22);
appendString(LOC9, ((NimStringDesc*) &TMP194866));
...
App_48036(&(*W_109085).Data, ((NimStringDesc*) &TMP194867));
...
Appf_48071(&(*W_109085).Interf, ((NimStringDesc*) &TMP194868), LOC19, 2);
LA17: ;
...
Appf_48071(&(*W_109085).Compilerprocs, ((NimStringDesc*) &TMP194868), LOC23, 2);
LA21: ;
if (!((*S_109088).Kind == ((NU8) 13))) goto LA25;
if (!!(((*W_109085).Converters == NIM_NIL))) goto LA28;
App_48036(&(*W_109085).Converters, ((NimStringDesc*) &TMP194865));
LA28: ;
LOC30 = 0;
...
goto LA10;
LA13: ;
LOC31 = Iitableget_56224((*W_109085).Imports.Tab, (*S_109088).Sup.Id);
...
Result_108663 = Torope_48046(((NimStringDesc*) &TMP194887));
goto BeforeRet;
LA2: ;
Result_108663 = NIM_NIL;
if (!((*T_108662).Kind == ((NU8) 30))) goto LA5;
Internalerror_44212(((NimStringDesc*) &TMP194888));
LA5: ;
LOC7 = 0;
...
Appf_48071(&Result_108663, ((NimStringDesc*) &TMP194870), LOC8, 1);
if (!!(((*T_108662).N == NIM_NIL))) goto LA10;
LOC12 = Unknownlineinfo_43575();
LOC13 = 0;
...
App_48036(&Result_108663, ((NimStringDesc*) &TMP194891));
goto LA45;
LA46: ;
memset((void*)&LOC48, 0, sizeof(LOC48));
LOC48[0] = Encodeint_90073(((NI64) ((*(*T_108662).Sons->data[I_108806]).Sup.Id)));
Appf_48071(&Result_108663, ((NimStringDesc*) &TMP194872), LOC48, 1);
...
LOC3 = Iitableget_56224((*W_109216).Index.Tab, (*(*W_109216).Tstack->data[I_109217]).Sup.Id);
if (!(LOC3 == (-2147483647 -1))) goto LA4;
L_109234 = 0;
...
App_48036(&(*W_109216).Data, ((NimStringDesc*) &TMP194867));
LA4: ;
I_109217 += 1;
} LA1: ;
...
Result_109831 = 0;
W_109836 = 0;
Result_109831 = NIM_NIL;
if (!((*Module_109829).Sup.Id < 0)) goto LA2;
Internalerror_44212(((NimStringDesc*) &TMP194863));
LA2: ;
W_109836 = NIM_NIL;
...
Content_109347 = NIM_NIL;
Content_109347 = Torope_48046(((NimStringDesc*) &TMP194892));
LOC1 = 0;
LOC1 = Torope_48046(((NimStringDesc*) &TMP194893));
App_48031(&Content_109347, LOC1);
App_48036(&Content_109347, ((NimStringDesc*) &TMP194867));
LOC2 = 0;
LOC2 = Torope_48046(((NimStringDesc*) &TMP194894));
...
App_48036(&Content_109347, ((NimStringDesc*) &TMP194867));
LOC4 = 0;
LOC4 = Torope_48046(((NimStringDesc*) &TMP194895));
...
App_48036(&Content_109347, ((NimStringDesc*) &TMP194867));
LOC6 = 0;
LOC6 = Torope_48046(((NimStringDesc*) &TMP194896));
...
App_48036(&Content_109347, ((NimStringDesc*) &TMP194867));
LOC8 = 0;
LOC8 = Torope_48046(((NimStringDesc*) &TMP194897));
App_48031(&Content_109347, LOC8);
App_48031(&Content_109347, (*W_108047).Defines);
App_48036(&Content_109347, ((NimStringDesc*) &TMP194867));
LOC9 = 0;
LOC9 = Torope_48046(((NimStringDesc*) &TMP194898));
...
App_48036(&(*W_108031).Moddeps, ((NimStringDesc*) &TMP194865));
LA2: ;
...
App_48036(&(*W_108043).Init, ((NimStringDesc*) &TMP194867));
LOC3 = Unknownlineinfo_43575();
LOC4 = 0;
LOC4 = Encodenode_108298(W_108043, LOC3, N_108044);
App_48031(&(*W_108043).Data, LOC4);
App_48036(&(*W_108043).Data, ((NimStringDesc*) &TMP194867));
...
App_48036(&(*W_108035).Incldeps, ((NimStringDesc*) &TMP194865));
LOC3 = Crcfromfile_46029(Dep_108036);
LOC4 = 0;
LOC4 = Encodeint_90073(((NI64) (LOC3)));
App_48031(&(*W_108035).Incldeps, LOC4);
App_48036(&(*W_108035).Incldeps, ((NimStringDesc*) &TMP194867));
}
N_NIMCALL(TY51526*, Process_109405)(TY102002* C_109407, TY51526* N_109408) {
...
Internalerror_44208((*N_109408).Info, ((NimStringDesc*) &TMP194910));
LA8: ;
...
Internalerror_44208((*A_109568).Info, ((NimStringDesc*) &TMP194910));
LA24: ;
...
Internalerror_44208((*A_109632).Info, ((NimStringDesc*) &TMP194910));
LA33: ;
...
Internalerror_44208((*A_109696).Info, ((NimStringDesc*) &TMP194910));
LA42: ;
S_109751 = NIM_NIL;
...
Intsetinit_51919(&Debugwritten_109082);
}
