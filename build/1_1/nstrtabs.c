...
NI Result_39141;
Result_39141 = 0;
Result_39141 = (NI32)((NI32)((NI32)(5 * H_39139) + 1) & Maxhash_39140);
return Result_39141;
}
N_NIMCALL(NI, Rawget_39142)(TY39008* T_39144, NimStringDesc* Key_39145) {
NI Result_39146;
...
H_39147 = (NI32)(LOC1 & ((*T_39144).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_39126 = 0;
LOC1 = ((NI32)(Length_39124 * 2) < (NI32)(Counter_39125 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI32)(Length_39124 - Counter_39125) < 4);
LA2: ;
Result_39126 = LOC1;
return Result_39126;
}
...
H_39171 = (NI32)(LOC1 & ((*Data_39168)->Sup.len-1));
while (1) {
...
TY39006* LOC5;
N_39176 = 0;
N_39176 = (TY39006*) newSeq(NTI39006, (NI32)((*T_39175).Data->Sup.len * 2));
I_39221 = 0;
HEX3Atmp_39233 = 0;
...
Put_39024(Result_39061, Keyvaluepairs_39022[I_39089], Keyvaluepairs_39022[(NI32)(I_39089 + 1)]);
I_39089 += 2;
} LA1: ;
return Result_39061;
}
