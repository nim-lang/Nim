...
K_35297 = 0;
HEX3Atmp_35419 = 0;
HEX3Atmp_35419 = (NI32)((NI32)(J_35272 - I_35251) / 2);
Res_35421 = 0;
Res_35421 = 1;
while (1) {
...
if (!((NI32)((NI32)(J_35272 - I_35251) % 2) == 0)) goto LA15;
I_35251 = J_35272;
goto LA14;
LA15: ;
A_35252 = addChar(A_35252, 34);
I_35251 = (NI32)(J_35272 + 1);
LA14: ;
goto LA10;
LA11: ;
...
I_33351 = 0;
HEX3Atmp_33366 = 0;
HEX3Atmp_33366 = (NI32)(Path_33336->Sup.len - 1);
Res_33368 = 0;
...
unsureAsgnRef((void**) &(*Result).Head, copyStrLast(Path_33336, 0, (NI32)(Seppos_33341 - 1)));
unsureAsgnRef((void**) &(*Result).Tail, copyStr(Path_33336, (NI32)(Seppos_33341 + 1)));
goto LA5;
LA6: ;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_33460->data[(NI32)(Path_33460->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Path_33460->data[(NI32)(Path_33460->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_33498 = 0;
HEX3Atmp_33521 = 0;
HEX3Atmp_33521 = (NI32)(Path_33460->Sup.len - 1);
Res_33523 = 0;
...
unsureAsgnRef((void**) &(*Result).Dir, copyStrLast(Path_33460, 0, (NI32)(Seppos_33485 - 1)));
unsureAsgnRef((void**) &(*Result).Name, copyStrLast(Path_33460, (NI32)(Seppos_33485 + 1), (NI32)(Dotpos_33488 - 1)));
...
Result_34221 = copyStr(Environment_34038->data[I_34222], (NI32)(LOC4 + 1));
goto BeforeRet;
goto LA1;
LA2: ;
Env_34225 = 0;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_33530->data[(NI32)(Path_33530->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Path_33530->data[(NI32)(Path_33530->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_33440 = 0;
HEX3Atmp_33455 = 0;
HEX3Atmp_33455 = (NI32)(S_33429->Sup.len - 1);
Res_33457 = 0;
...
I_35214 = 0;
HEX3Atmp_35227 = 0;
HEX3Atmp_35227 = (NI32)(Dir_35203->Sup.len - 1);
Res_35229 = 0;
Res_35229 = 1;
while (1) {
...
LOC5 = 0;
LOC5 = copyStrLast(Dir_35203, 0, (NI32)(I_35214 - 1));
