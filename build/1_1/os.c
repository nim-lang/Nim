...
Environment_33238 = (TY4377*) incrSeq(&(Environment_33238)->Sup, sizeof(NimStringDesc*));
...
Result_34436 = (TY4377*) newSeq(NTI4377, 0);
I_34453 = 0;
...
Result_34436 = (TY4377*) incrSeq(&(Result_34436)->Sup, sizeof(NimStringDesc*));
...
LOC1 = 0;
LOC2 = 0;
LOC2 = Getenv_33425(((NimStringDesc*) &TMP73535));
LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP73536));
Result_35203 = LOC1;
goto BeforeRet;
BeforeRet: ;
framePtr = framePtr->prev;
...
asgnRefNoCycle((void**) &Environment_33238, (TY4377*) newSeq(NTI4377, 0));
framePtr = framePtr->prev;
}
