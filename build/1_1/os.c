...
K_34498 = 0;
HEX3Atmp_34622 = 0;
HEX3Atmp_34622 = (NI32)((NI32)(J_34474 - I_34453) / 2);
Res_34624 = 0;
Res_34624 = 1;
while (1) {
...
if (!((NI32)((NI32)(J_34474 - I_34453) % 2) == 0)) goto LA15;
I_34453 = J_34474;
goto LA14;
LA15: ;
A_34454 = addChar(A_34454, 34);
I_34453 = (NI32)(J_34474 + 1);
LA14: ;
goto LA10;
LA11: ;
...
LA2: ;
Result_35405 = (NI32)(Ownargv_35402->Sup.len - 1);
return Result_35405;
}
...
if (!(LOC11)) goto LA12;
LOC11 = ((NU8)(Path_30256->data[(NI32)(I_30407 + 1)]) == (NU8)(46));
LA12: ;
LOC10 = LOC11;
if (!(LOC10)) goto LA13;
LOC10 = ((NU8)(Path_30256->data[(NI32)(I_30407 + 2)]) == (NU8)(47));
LA13: ;
if (!LOC10) goto LA14;
...
I_32392 = 0;
HEX3Atmp_32408 = 0;
HEX3Atmp_32408 = (NI32)(Path_32377->Sup.len - 1);
Res_32410 = 0;
...
unsureAsgnRef((void**) &(*Result).Head, copyStrLast(Path_32377, 0, (NI32)(Seppos_32382 - 1)));
unsureAsgnRef((void**) &(*Result).Tail, copyStr(Path_32377, (NI32)(Seppos_32382 + 1)));
goto LA5;
LA6: ;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_32514->data[(NI32)(Path_32514->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Path_32514->data[(NI32)(Path_32514->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_32552 = 0;
HEX3Atmp_32574 = 0;
HEX3Atmp_32574 = (NI32)(Path_32514->Sup.len - 1);
Res_32576 = 0;
...
unsureAsgnRef((void**) &(*Result).Dir, copyStrLast(Path_32514, 0, (NI32)(Seppos_32539 - 1)));
unsureAsgnRef((void**) &(*Result).Name, copyStrLast(Path_32514, (NI32)(Seppos_32539 + 1), (NI32)(Dotpos_32542 - 1)));
...
goto LA1;
LA2: ;
if (!(((NU8)(Head_32203->data[(NI32)(Head_32203->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Head_32203->data[(NI32)(Head_32203->Sup.len - 1)])) == ((NU8)(47)))) goto LA4;
...
I_32491 = 0;
HEX3Atmp_32507 = 0;
HEX3Atmp_32507 = (NI32)(S_32480->Sup.len - 1);
Res_32509 = 0;
...
goto LA1;
LA2: ;
LOC7 = copyStrLast(Filename_32820, 0, (NI32)(Extpos_32823 - 1));
...
I_34413 = 0;
HEX3Atmp_34427 = 0;
HEX3Atmp_34427 = (NI32)(Dir_34403->Sup.len - 1);
Res_34429 = 0;
Res_34429 = 1;
while (1) {
...
LOC5 = copyStrLast(Dir_34403, 0, (NI32)(I_34413 - 1));
...
E_33247 = ((NCSTRING) ((NI32)(((NI) (Eend_33248)) + 1)));
...
Result_33428 = copyStr(Environment_33238->data[I_33429], (NI32)(LOC4 + 1));
goto BeforeRet;
goto LA1;
LA2: ;
Env_33432 = 0;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_32585->data[(NI32)(Path_32585->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(Path_32585->data[(NI32)(Path_32585->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
