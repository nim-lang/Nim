...
N_NIMCALL(NIM_BOOL, Matchtwochars_73679)(TY73267* L_73681, NIM_CHAR First_73682, TY22602 Second_73683);
...
N_NIMCALL(void, Matchunderscorechars_73621)(TY73267* L_73624, TY73263* Tok_73626, TY22602 Chars_73627);
...
NIM_CONST TY22602 Numchars_73002 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x07, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY22602 Symchars_73004 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x07, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
NIM_CONST TY22602 Symstartchars_73006 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0xFE, 0xFF, 0xFF, 0x07, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
NIM_CONST TY22602 Opchars_73008 = {
...
STRING_LITERAL(TMP193709, "_", 1);
static NIM_CONST TY22602 TMP193710 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193713, "getNumber", 9);
STRING_LITERAL(TMP193715, "\015\012", 2);
static NIM_CONST TY22602 TMP193716 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xEC, 0x00, 0xF0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;STRING_LITERAL(TMP193717, " (\\", 3);
STRING_LITERAL(TMP193723, "tokToStr", 8);
STRING_LITERAL(TMP193746, "pushInd", 7);
STRING_LITERAL(TMP195488, " ", 1);
NI Glinescompiled_73285;
TY50011* Dummyident_73557;
...
Info_73620 = Newlineinfo_43574((*L_73616).Filename, (*L_73616).Sup.Linenumber, (NI32)(Pos_73618 - (*L_73616).Sup.Linestart));
Limessage_43562(Info_73620, Msg_73617, Arg_73619);
}
N_NIMCALL(NI, Handlecrlf_74555)(TY73267* L_74558, NI Pos_74559) {
NI Result_74560;
NI LOC2;
...
LA2: ;
(*Tok_74381).Literal = resizeString((*Tok_74381).Literal, Tnl_47573->Sup.len + 0);
appendString((*Tok_74381).Literal, Tnl_47573);
(*L_74379).Sup.Bufpos += 1;
break;
case 114:
case 82:
...
break;
case 48 ... 57:
LOC5 = Matchtwochars_73679(&(*L_74379), 48, TMP193710);
if (!LOC5) goto LA6;
...
Buf_74575 = (*L_74570).Sup.Buf;
LOC14 = 0;
LOC14 = rawNewString((*Tok_74572).Literal->Sup.len + Tnl_47573->Sup.len + 0);
...
Lexmessage_73326(&(*L_74748), ((NU8) 12), ((NimStringDesc*) &TMP193709));
goto BeforeRet;
LA3: ;
break;
default:
...
unsureAsgnRef((void**) &(*Tok_74750).Ident, Getident_50023(((NCSTRING) (&(*L_74748).Sup.Buf[(*L_74748).Sup.Bufpos])), (NI32)(Pos_74752 - (*L_74748).Sup.Bufpos), H_74751));
...
Lexmessage_73326(&(*L_73624), ((NU8) 12), ((NimStringDesc*) &TMP193709));
goto LA1;
LA9: ;
...
Matchunderscorechars_73621(L_73748, Result, TMP193711);
...
Matchunderscorechars_73621(L_73748, Result, TMP193710);
...
(*L_73748).Sup.Bufpos = Pos_73750;
LA12: ;
pushSafePoint(&TMP193712);
TMP193712.status = setjmp(TMP193712.context);
if (TMP193712.status == 0) {
...
Lexmessage_73326(&(*L_73748), ((NU8) 12), ((NimStringDesc*) &TMP193709));
goto LA44;
LA46: ;
Pos_73750 += 1;
break;
...
Internalerror_43567(LOC56, ((NimStringDesc*) &TMP193713));
break;
}
...
Internalerror_43567(LOC57, ((NimStringDesc*) &TMP193713));
break;
}
goto LA39;
LA42: ;
...
Lexmessage_73326(&(*L_73748), ((NU8) 14), (*Result).Literal);
TMP193712.status = 0;popCurrentException();}
...
if (TMP193712.status != 0) reraiseException();
...
if (!LOC5) goto LA7;
LOC9 = 0;
LOC9 = rawNewString((*Tok_74954).Literal->Sup.len + 2);
appendString(LOC9, (*Tok_74954).Literal);
appendString(LOC9, ((NimStringDesc*) &TMP193715));
...
if (!((TMP193716[((NU8)(C_74854))/8] &(1<<(((NU8)(C_74854))%8)))!=0)) goto LA3;
...
unsureAsgnRef((void**) &(*Tok_74850).Ident, Getident_50023(((NCSTRING) (&(*L_74848).Sup.Buf[(*L_74848).Sup.Bufpos])), (NI32)(Pos_74851 - (*L_74848).Sup.Bufpos), H_74853));
...
break;
default:
if (!((TMP193716[((NU8)(C_75132))/8] &(1<<(((NU8)(C_75132))%8)))!=0)) goto LA44;
Getoperator_74845(L_73307, Tok_73309);
goto LA43;
LA44: ;
LOC46 = 0;
...
appendString(LOC47, ((NimStringDesc*) &TMP193717));
...
goto LA1;
LA2: ;
Internalerror_43571(((NimStringDesc*) &TMP193723));
...
goto LA1;
LA2: ;
Internalerror_43571(((NimStringDesc*) &TMP193746));
LA1: ;
}
...
Write_3658(F_73555, ((NimStringDesc*) &TMP193715));
}
N_NOINLINE(void, scannerInit)(void) {
asgnRefNoCycle((void**) &Dummyident_73557, Getident_50016(((NimStringDesc*) &TMP75463)));
}
