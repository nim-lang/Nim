...
if (!(LOC2)) goto LA3;
LOC2 = ((NU8)(Path_41213->data[(NI32)(Path_41213->Sup.len - 1)]) == (NU8)(92));
LA3: ;
if (!LOC2) goto LA4;
Result_41214 = copyStrLast(Path_41213, 0, (NI32)(Path_41213->Sup.len - 2));
goto LA1;
LA4: ;
...
Gimplicitmods_41131 = (TY34021*) setLengthSeq(&(Gimplicitmods_41131)->Sup, sizeof(NimStringDesc*), (NI32)(Length_41174 + 1));
