...
Result_60008 = (TY420*) newObj(NTI4262, sizeof(TY420));
...
F.line = 149;F.filename = "streams.nim";
Result_60331 = Endoffile_3638((*S_60330).F);
goto BeforeRet;
BeforeRet: ;
framePtr = framePtr->prev;
return Result_60331;
...
Setfilepos_3738((*S_60334).F, ((NI64) (Pos_60335)));
framePtr = framePtr->prev;
}
N_NIMCALL(NI, Fsgetposition_60336)(TY60323* S_60338) {
NI Result_60339;
...
F.line = 151;F.filename = "streams.nim";
LOC1 = Getfilepos_3742((*S_60338).F);
Result_60339 = ((NI)chckRange64(LOC1, (-2147483647 -1), 2147483647));
goto BeforeRet;
BeforeRet: ;
framePtr = framePtr->prev;
return Result_60339;
...
Result_60345 = Readbuffer_3714((*S_60342).F, Buffer_60343, Buflen_60344);
framePtr = framePtr->prev;
return Result_60345;
}
N_NIMCALL(void, Fswritedata_60346)(TY60323* S_60348, void* Buffer_60349, NI Buflen_60350) {
...
LOC2 = Writebuffer_3733((*S_60348).F, Buffer_60349, Buflen_60350);
...
LOC2 = Open_3617(&F_60378, Filename_60375, Mode_60376, -1);
if (!LOC2) goto LA3;
F.line = 175;F.filename = "streams.nim";
