...
STRING_LITERAL(TMP189625, "kernel32", 8);
STRING_LITERAL(TMP189626, "kernel32", 8);
static void* TMP189624;
TY27650 Dl_27649;
TY27580 Dl_27579;
TY27633 Dl_27632;
TY27562 Dl_27561;
...
if (!((TMP189624 = nimLoadLibrary((NimStringDesc*) &TMP189625))
)) nimLoadLibraryError((NimStringDesc*) &TMP189626);
Dl_27649 = (TY27650) nimGetProcAddr(TMP189624, "GetCommandLineA");
Dl_27579 = (TY27580) nimGetProcAddr(TMP189624, "GetModuleFileNameA");
Dl_27632 = (TY27633) nimGetProcAddr(TMP189624, "GetFileAttributesA");
Dl_27561 = (TY27562) nimGetProcAddr(TMP189624, "GetCurrentDirectoryA");
Dl_27547 = (TY27548) nimGetProcAddr(TMP189624, "GetLastError");
Dl_27549 = (TY27550) nimGetProcAddr(TMP189624, "FormatMessageA");
Dl_27558 = (TY27559) nimGetProcAddr(TMP189624, "LocalFree");
Dl_27568 = (TY27569) nimGetProcAddr(TMP189624, "CreateDirectoryA");
Dl_27644 = (TY27645) nimGetProcAddr(TMP189624, "GetEnvironmentStringsA");
Dl_27646 = (TY27647) nimGetProcAddr(TMP189624, "FreeEnvironmentStringsA");
Dl_27575 = (TY27576) nimGetProcAddr(TMP189624, "SetEnvironmentVariableA");
Dl_27612 = (TY27613) nimGetProcAddr(TMP189624, "FindFirstFileA");
Dl_27622 = (TY27623) nimGetProcAddr(TMP189624, "FindClose");
Dl_27537 = (TY27538) nimGetProcAddr(TMP189624, "GetStdHandle");
Dl_27502 = (TY27503) nimGetProcAddr(TMP189624, "CreateProcessA");
Dl_27475 = (TY27476) nimGetProcAddr(TMP189624, "CloseHandle");
Dl_27524 = (TY27525) nimGetProcAddr(TMP189624, "WaitForSingleObject");
Dl_27532 = (TY27533) nimGetProcAddr(TMP189624, "GetExitCodeProcess");
Dl_27494 = (TY27495) nimGetProcAddr(TMP189624, "CreatePipe");
Dl_27663 = (TY27664) nimGetProcAddr(TMP189624, "Sleep");
}
