...
STRING_LITERAL(TMP192625, "kernel32", 8);
STRING_LITERAL(TMP192626, "kernel32", 8);
static void* TMP192624;
TY28650 Dl_28649;
TY28580 Dl_28579;
TY28645 Dl_28644;
TY28647 Dl_28646;
...
if (!((TMP192624 = nimLoadLibrary((NimStringDesc*) &TMP192625))
)) nimLoadLibraryError((NimStringDesc*) &TMP192626);
Dl_28649 = (TY28650) nimGetProcAddr(TMP192624, "GetCommandLineA");
Dl_28579 = (TY28580) nimGetProcAddr(TMP192624, "GetModuleFileNameA");
Dl_28644 = (TY28645) nimGetProcAddr(TMP192624, "GetEnvironmentStringsA");
Dl_28646 = (TY28647) nimGetProcAddr(TMP192624, "FreeEnvironmentStringsA");
Dl_28612 = (TY28613) nimGetProcAddr(TMP192624, "FindFirstFileA");
Dl_28617 = (TY28618) nimGetProcAddr(TMP192624, "FindNextFileA");
Dl_28622 = (TY28623) nimGetProcAddr(TMP192624, "FindClose");
Dl_28632 = (TY28633) nimGetProcAddr(TMP192624, "GetFileAttributesA");
Dl_28561 = (TY28562) nimGetProcAddr(TMP192624, "GetCurrentDirectoryA");
Dl_28547 = (TY28548) nimGetProcAddr(TMP192624, "GetLastError");
Dl_28549 = (TY28550) nimGetProcAddr(TMP192624, "FormatMessageA");
Dl_28558 = (TY28559) nimGetProcAddr(TMP192624, "LocalFree");
Dl_28568 = (TY28569) nimGetProcAddr(TMP192624, "CreateDirectoryA");
Dl_28575 = (TY28576) nimGetProcAddr(TMP192624, "SetEnvironmentVariableA");
Dl_28537 = (TY28538) nimGetProcAddr(TMP192624, "GetStdHandle");
Dl_28502 = (TY28503) nimGetProcAddr(TMP192624, "CreateProcessA");
Dl_28475 = (TY28476) nimGetProcAddr(TMP192624, "CloseHandle");
Dl_28524 = (TY28525) nimGetProcAddr(TMP192624, "WaitForSingleObject");
Dl_28532 = (TY28533) nimGetProcAddr(TMP192624, "GetExitCodeProcess");
Dl_28494 = (TY28495) nimGetProcAddr(TMP192624, "CreatePipe");
Dl_28663 = (TY28664) nimGetProcAddr(TMP192624, "Sleep");
}
