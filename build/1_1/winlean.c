...
STRING_LITERAL(TMP193625, "kernel32", 8);
STRING_LITERAL(TMP193626, "kernel32", 8);
static void* TMP193624;
TY28650 Dl_28649;
TY28580 Dl_28579;
TY28645 Dl_28644;
TY28647 Dl_28646;
...
if (!((TMP193624 = nimLoadLibrary((NimStringDesc*) &TMP193625))
)) nimLoadLibraryError((NimStringDesc*) &TMP193626);
Dl_28649 = (TY28650) nimGetProcAddr(TMP193624, "GetCommandLineA");
Dl_28579 = (TY28580) nimGetProcAddr(TMP193624, "GetModuleFileNameA");
Dl_28644 = (TY28645) nimGetProcAddr(TMP193624, "GetEnvironmentStringsA");
Dl_28646 = (TY28647) nimGetProcAddr(TMP193624, "FreeEnvironmentStringsA");
Dl_28612 = (TY28613) nimGetProcAddr(TMP193624, "FindFirstFileA");
Dl_28617 = (TY28618) nimGetProcAddr(TMP193624, "FindNextFileA");
Dl_28622 = (TY28623) nimGetProcAddr(TMP193624, "FindClose");
Dl_28632 = (TY28633) nimGetProcAddr(TMP193624, "GetFileAttributesA");
Dl_28561 = (TY28562) nimGetProcAddr(TMP193624, "GetCurrentDirectoryA");
Dl_28547 = (TY28548) nimGetProcAddr(TMP193624, "GetLastError");
Dl_28549 = (TY28550) nimGetProcAddr(TMP193624, "FormatMessageA");
Dl_28558 = (TY28559) nimGetProcAddr(TMP193624, "LocalFree");
Dl_28568 = (TY28569) nimGetProcAddr(TMP193624, "CreateDirectoryA");
Dl_28575 = (TY28576) nimGetProcAddr(TMP193624, "SetEnvironmentVariableA");
Dl_28537 = (TY28538) nimGetProcAddr(TMP193624, "GetStdHandle");
Dl_28502 = (TY28503) nimGetProcAddr(TMP193624, "CreateProcessA");
Dl_28475 = (TY28476) nimGetProcAddr(TMP193624, "CloseHandle");
Dl_28524 = (TY28525) nimGetProcAddr(TMP193624, "WaitForSingleObject");
Dl_28532 = (TY28533) nimGetProcAddr(TMP193624, "GetExitCodeProcess");
Dl_28494 = (TY28495) nimGetProcAddr(TMP193624, "CreatePipe");
Dl_28663 = (TY28664) nimGetProcAddr(TMP193624, "Sleep");
}
