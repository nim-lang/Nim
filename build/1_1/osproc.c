...
A_63222 = Dl_27481((*S_63216).Handle, Buffer_63217, ((NI32) (Buflen_63218)), &Br_63220, NIM_NIL);
...
A_63236 = Dl_27489((*S_63231).Handle, Buffer_63232, ((NI32) (Buflen_63233)), &Byteswritten_63234, NIM_NIL);
...
Piinheritablepipe_63341.Nlength = ((NI32) (((NI)sizeof(TY27432))));
...
Si_63364.Cb = ((NI32) (((NI)sizeof(TY27434))));
...
(*Result_63363).Inputhandle = ((NI32) (Hi_63367));
F.line = 311;F.filename = "osproc.nim";
(*Result_63363).Outputhandle = ((NI32) (Ho_63368));
F.line = 312;F.filename = "osproc.nim";
(*Result_63363).Errorhandle = ((NI32) (He_63369));
goto LA1;
LA2: ;
...
(*Result_63363).Inputhandle = ((NI32) (Si_63364.Hstdinput));
F.line = 318;F.filename = "osproc.nim";
(*Result_63363).Outputhandle = ((NI32) (Si_63364.Hstdoutput));
F.line = 319;F.filename = "osproc.nim";
(*Result_63363).Errorhandle = ((NI32) (Si_63364.Hstderror));
LA1: ;
Cmdl_63413 = 0;
...
Si_63613.Cb = ((NI32) (((NI)sizeof(TY27434))));
