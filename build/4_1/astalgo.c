...
STRING_LITERAL(TMP194058, "getSymFromList", 14);
STRING_LITERAL(TMP194140, "null", 4);
STRING_LITERAL(TMP194141, " ", 1);
STRING_LITERAL(TMP194142, "(", 1);
STRING_LITERAL(TMP194143, ", ", 2);
STRING_LITERAL(TMP194144, ")", 1);
STRING_LITERAL(TMP194683, "lookupInRecord", 14);
STRING_LITERAL(TMP194684, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP194685, "lookupInRecord()", 16);
...
Internalerror_45567((*List_57199).Info, ((NimStringDesc*) &TMP194058));
LA4: ;
...
Result_58414 = Torope_50046(((NimStringDesc*) &TMP194140));
goto LA1;
LA2: ;
...
App_50036(&Result_58414, ((NimStringDesc*) &TMP194144));
LA11: ;
LA1: ;
return Result_58414;
}
...
break;
default:
Internalerror_45567((*N_57204).Info, ((NimStringDesc*) &TMP194685));
break;
}
BeforeRet: ;
return Result_57246;
...
Write_3658(F_58815, ((NimStringDesc*) &TMP195495));
}
