...
STRING_LITERAL(TMP198051, "getSymFromList", 14);
STRING_LITERAL(TMP198729, "lookupInRecord", 14);
STRING_LITERAL(TMP198730, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP198731, "lookupInRecord()", 16);
...
Internalerror_49208((*List_61191).Info, ((NimStringDesc*) &TMP198051));
LA4: ;
...
break;
default:
Internalerror_49208((*N_61196).Info, ((NimStringDesc*) &TMP198731));
break;
}
BeforeRet: ;
return Result_61238;
