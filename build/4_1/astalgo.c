...
STRING_LITERAL(TMP196059, "getSymFromList", 14);
STRING_LITERAL(TMP196678, "lookupInRecord", 14);
STRING_LITERAL(TMP196679, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP196680, "lookupInRecord()", 16);
...
Internalerror_47574((*List_60196).Info, ((NimStringDesc*) &TMP196059));
LA4: ;
...
break;
default:
Internalerror_47574((*N_60201).Info, ((NimStringDesc*) &TMP196680));
break;
}
BeforeRet: ;
return Result_60243;
