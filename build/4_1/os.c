...
STRING_LITERAL(TMP196649, "/proc/", 6);
STRING_LITERAL(TMP196650, "/file", 5);
STRING_LITERAL(TMP196653, "unknown OS error", 16);
STRING_LITERAL(TMP196726, "HOME", 4);
STRING_LITERAL(TMP196727, "/.config/", 9);
...
appendString(LOC1, ((NimStringDesc*) &TMP196649));
appendString(LOC1, LOC3);
appendString(LOC1, ((NimStringDesc*) &TMP196650));
Result_42203 = Getapplaux_41801(LOC1);
return Result_42203;
}
...
asgnRefNoCycle((void**) &(*E_36821).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP196653)));
...
LOC1 = 0;
LOC2 = 0;
LOC2 = Getenv_39625(((NimStringDesc*) &TMP196726));
LOC1 = rawNewString(LOC2->Sup.len + 9);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP196727));
Result_41403 = LOC1;
goto BeforeRet;
BeforeRet: ;
return Result_41403;
