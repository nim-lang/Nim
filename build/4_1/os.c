...
STRING_LITERAL(TMP45197, "/proc/", 6);
STRING_LITERAL(TMP45198, "/file", 5);
STRING_LITERAL(TMP45222, "unknown OS error", 16);
...
F.len = 0;
Result_41203 = 0;
F.line = 1190;F.filename = "os.nim";
LOC1 = 0;
LOC2 = getpid();
LOC3 = 0;
LOC3 = nimIntToStr(LOC2);
LOC1 = rawNewString(LOC3->Sup.len + 11);
appendString(LOC1, ((NimStringDesc*) &TMP45197));
appendString(LOC1, LOC3);
appendString(LOC1, ((NimStringDesc*) &TMP45198));
Result_41203 = Getapplaux_40801(LOC1);
framePtr = framePtr->prev;
return Result_41203;
}
...
F.line = 1279;F.filename = "system.nim";
asgnRefNoCycle((void**) &(*E_35821).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP45222)));
