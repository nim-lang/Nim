...
STRING_LITERAL(TMP197637, "/proc/", 6);
STRING_LITERAL(TMP197638, "/file", 5);
STRING_LITERAL(TMP197641, "HOME", 4);
STRING_LITERAL(TMP197642, "/", 1);
STRING_LITERAL(TMP197646, "unknown OS error", 16);
STRING_LITERAL(TMP197720, "/.config/", 9);
...
appendString(LOC1, ((NimStringDesc*) &TMP197637));
appendString(LOC1, LOC3);
appendString(LOC1, ((NimStringDesc*) &TMP197638));
Result_42403 = Getapplaux_42001(LOC1);
return Result_42403;
}
...
LOC1 = 0;
LOC2 = 0;
LOC2 = Getenv_39818(((NimStringDesc*) &TMP197641));
LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP197642));
Result_41433 = LOC1;
goto BeforeRet;
BeforeRet: ;
return Result_41433;
...
asgnRefNoCycle((void**) &(*E_36821).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP197646)));
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP197720));
Result_41603 = LOC1;
goto BeforeRet;
BeforeRet: ;
return Result_41603;
