...
NI Result_46148;
Result_46148 = 0;
Result_46148 = (NI32)((NI32)((NI32)(5 * H_46146) + 1) & Maxhash_46147);
return Result_46148;
}
N_NIMCALL(NI, Rawget_46149)(TY46008* T_46151, NimStringDesc* Key_46152) {
NI Result_46153;
...
H_46154 = (NI32)(LOC1 & ((*T_46151).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_46127 = 0;
LOC1 = ((NI32)(Length_46125 * 2) < (NI32)(Counter_46126 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI32)(Length_46125 - Counter_46126) < 4);
LA2: ;
Result_46127 = LOC1;
return Result_46127;
}
...
H_46177 = (NI32)(LOC1 & ((*Data_46174)->Sup.len-1));
while (1) {
...
N_46181 = 0;
N_46181 = NIM_NIL;
N_46181 = (TY46006*) newSeq(NTI46006, (NI32)((*T_46180).Data->Sup.len * 2));
I_46227 = 0;
HEX3Atmp_46238 = 0;
...
Put_46024(Result_46061, Keyvaluepairs_46022[I_46089], Keyvaluepairs_46022[(NI32)(I_46089 + 1)]);
I_46089 += 2;
} LA1: ;
return Result_46061;
}
...
goto LA1;
LA2: ;
Result_46159 = copyString(((NimStringDesc*) &TMP197672));
LA1: ;
return Result_46159;
}
