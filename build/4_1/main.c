...
STRING_LITERAL(TMP197876, "nim", 3);
STRING_LITERAL(TMP197929, "handleSymbolFile should have set the module\'s ID", 48);
STRING_LITERAL(TMP197931, "c", 1);
STRING_LITERAL(TMP197932, "cc", 2);
STRING_LITERAL(TMP197933, "compile", 7);
STRING_LITERAL(TMP197934, "compiletoc", 10);
STRING_LITERAL(TMP197935, "compiletocpp", 12);
STRING_LITERAL(TMP197936, "oc", 2);
STRING_LITERAL(TMP197937, "compiletooc", 11);
STRING_LITERAL(TMP197938, "run", 3);
STRING_LITERAL(TMP197939, "js", 2);
STRING_LITERAL(TMP197940, "compiletoecmascript", 19);
STRING_LITERAL(TMP197941, "compiletollvm", 13);
STRING_LITERAL(TMP197942, "pretty", 6);
STRING_LITERAL(TMP197943, "doc", 3);
STRING_LITERAL(TMP197944, "rst2html", 8);
STRING_LITERAL(TMP197945, "rst2tex", 7);
STRING_LITERAL(TMP197946, "gendepend", 9);
STRING_LITERAL(TMP197947, "dump", 4);
STRING_LITERAL(TMP197948, "check", 5);
STRING_LITERAL(TMP197949, "parse", 5);
STRING_LITERAL(TMP197950, "scan", 4);
STRING_LITERAL(TMP197951, "i", 1);
STRING_LITERAL(TMP197952, "idetools", 8);
STRING_LITERAL(TMP197953, "command line", 12);
STRING_LITERAL(TMP197954, "", 0);
STRING_LITERAL(TMP198907, "system", 6);
STRING_LITERAL(TMP198925, ".cpp", 4);
STRING_LITERAL(TMP198926, ".m", 2);
STRING_LITERAL(TMP199134, "pretty.nim", 10);
STRING_LITERAL(TMP199135, "nimdoc.cfg", 10);
STRING_LITERAL(TMP199538, "nimdoc.tex.cfg", 14);
STRING_LITERAL(TMP199546, "dot -Tpng -o", 12);
STRING_LITERAL(TMP199547, "png", 3);
STRING_LITERAL(TMP199548, "dot", 3);
STRING_LITERAL(TMP199552, "Beware: Indentation tokens depend on the parser\'s state!", 56);
STRING_LITERAL(TMP199553, "stdin", 5);
...
Rd_193357 = NIM_NIL;
F_193358 = NIM_NIL;
F_193358 = nosaddFileExt(Filename_193322, ((NimStringDesc*) &TMP197876));
...
LOC4 = Newlineinfo_48718(((NimStringDesc*) &TMP197953), 1, 1);
Fatal_49183(LOC4, ((NU8) 182), ((NimStringDesc*) &TMP197954));
LA2: ;
}
N_NIMCALL(void, Semanticpasses_193408)(void) {
TY106006 LOC1;
...
TY56548* LOC5;
LOC1 = 0;
LOC1 = nosaddFileExt(((NimStringDesc*) &TMP198907), ((NimStringDesc*) &TMP197876));
LOC2 = 0;
LOC2 = nosJoinPath(Libpath_47117, LOC1);
LOC3 = 0;
LOC3 = Compilemodule_193320(LOC2, NIM_FALSE, NIM_TRUE);
LOC4 = 0;
LOC4 = nosaddFileExt(Filename_193407, ((NimStringDesc*) &TMP197876));
LOC5 = 0;
...
LOC6 = 0;
LOC6 = nosChangeFileExt(Filename_193418, ((NimStringDesc*) &TMP197954));
...
LOC1 = 0;
LOC1 = nosaddFileExt(Filename_193645, ((NimStringDesc*) &TMP197876));
Module_193646 = Parsefile_93031(LOC1);
if (!!((Module_193646 == NIM_NIL))) goto LA3;
LOC5 = 0;
LOC5 = Getoutfile_47167(Filename_193645, ((NimStringDesc*) &TMP199134));
...
LOC3 = 0;
LOC4 = 0;
LOC4 = nosChangeFileExt(Filename_193412, ((NimStringDesc*) &TMP199547));
LOC5 = 0;
LOC5 = nosChangeFileExt(Filename_193412, ((NimStringDesc*) &TMP199548));
LOC3 = rawNewString(LOC4->Sup.len + LOC5->Sup.len + 13);
appendString(LOC3, ((NimStringDesc*) &TMP199546));
...
Tok_193675 = 0;
F_193661 = NIM_NIL;
F_193661 = nosaddFileExt(Filename_193660, ((NimStringDesc*) &TMP197876));
...
LOC5 = 0;
LOC5 = nosaddFileExt(((NimStringDesc*) &TMP198907), ((NimStringDesc*) &TMP197876));
LOC6 = 0;
LOC6 = nosJoinPath(Libpath_47117, LOC5);
LOC7 = 0;
LOC7 = Compilemodule_193320(LOC6, NIM_FALSE, NIM_TRUE);
M_193630 = NIM_NIL;
M_193630 = Newmodule_193287(((NimStringDesc*) &TMP199553));
(*M_193630).Sup.Id = Getid_56694();
(*M_193630).Flags |=(1<<((NI32)(((NU8) 15))%(sizeof(NI32)*8)));
LOC8 = 0;
LOC8 = Llstreamopenstdin_76230();
Processmodule_106035(M_193630, ((NimStringDesc*) &TMP199553), LOC8, NIM_NIL);
}
N_NIMCALL(void, Commandsuggest_193704)(NimStringDesc* Filename_193706) {
Gerrormax_48568 = 2147483647;
Semanticpasses_193408();
...
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197937))) goto LA8;
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197952))) goto LA22;
break;
case 2: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197947))) goto LA17;
break;
case 4: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197949))) goto LA19;
break;
case 7: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197944))) goto LA14;
break;
case 9: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197938))) goto LA9;
break;
case 10: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197932))) goto LA6;
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197948))) goto LA18;
break;
case 11: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197946))) goto LA16;
break;
case 13: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197943))) goto LA13;
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197945))) goto LA15;
break;
case 14: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197936))) goto LA8;
break;
case 15: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197951))) goto LA21;
break;
case 16: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197934))) goto LA6;
break;
case 19: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197935))) goto LA7;
break;
case 23: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197940))) goto LA10;
break;
case 25: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197931))) goto LA6;
break;
case 26: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197942))) goto LA12;
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197950))) goto LA20;
break;
case 27: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197939))) goto LA10;
break;
case 28: 
if (eqStrings(LOC5, ((NimStringDesc*) &TMP197941))) goto LA11;
break;
}
goto LA23;
LA6: ;
...
goto LA24;
LA8: ;
asgnRefNoCycle((void**) &Cext_71342, copyString(((NimStringDesc*) &TMP198926)));
Gcmd_47089 = ((NU8) 3);
Wantfile_193707(Filename_193204);
Commandcompiletoc_193416(Filename_193204);
goto LA24;
...
LA13: ;
Gcmd_47089 = ((NU8) 8);
Loadspecialconfig_81007(((NimStringDesc*) &TMP199135));
Wantfile_193707(Filename_193204);
...
LA15: ;
Gcmd_47089 = ((NU8) 17);
Loadspecialconfig_81007(((NimStringDesc*) &TMP199538));
Wantfile_193707(Filename_193204);
...
Wantfile_193707(Filename_193204);
LOC26 = 0;
LOC26 = nosaddFileExt(Filename_193204, ((NimStringDesc*) &TMP197876));
LOC27 = 0;
...
Msgwriteln_48794(((NimStringDesc*) &TMP199552));
goto LA24;
LA21: ;
Gcmd_47089 = ((NU8) 18);
