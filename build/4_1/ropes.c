...
STRING_LITERAL(TMP193893, "", 0);
STRING_LITERAL(TMP194233, "$", 1);
STRING_LITERAL(TMP194234, "ropes: invalid format string $", 30);
TY50008* Cache_50126;
NI Misses_50127;
NI Hits_50128;
TY50008* N_50129;
...
Result_50539 = copyString(((NimStringDesc*) &TMP193893));
goto LA1;
LA2: ;
...
case 36:
App_50036(&Result_50765, ((NimStringDesc*) &TMP194233));
I_50766 += 1;
break;
case 35:
I_50766 += 1;
...
appendString(LOC14, ((NimStringDesc*) &TMP194234));
...
appendString(LOC16, ((NimStringDesc*) &TMP194234));
