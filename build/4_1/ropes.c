...
STRING_LITERAL(TMP196901, "", 0);
STRING_LITERAL(TMP197242, "$", 1);
STRING_LITERAL(TMP197243, "ropes: invalid format string $", 30);
...
Result_52539 = copyString(((NimStringDesc*) &TMP196901));
goto LA1;
LA2: ;
...
(*Result_52558).Length = (NI32)((*A_52017).Length + (*B_52018).Length);
...
Num_52770 = 0;
while (1) {
if (!(I_52766 <= (NI32)(Length_52768 - 1))) goto LA1;
if (!((NU8)(Frmt_52071->data[I_52766]) == (NU8)(36))) goto LA3;
I_52766 += 1;
switch (((NU8)(Frmt_52071->data[I_52766]))) {
case 36:
App_52036(&Result_52765, ((NimStringDesc*) &TMP197242));
I_52766 += 1;
break;
case 35:
I_52766 += 1;
...
J_52767 = 0;
while (1) {
J_52767 = (NI32)((NI32)((NI32)(J_52767 * 10) + ((NU8)(Frmt_52071->data[I_52766]))) - 48);
I_52766 += 1;
LOC7 = ((NI32)((NI32)(Length_52768 + 0) - 1) < I_52766);
if (LOC7) goto LA8;
...
Num_52770 = J_52767;
if (!((NI32)((Args_52073Len0-1) + 1) < J_52767)) goto LA12;
LOC14 = 0;
LOC15 = 0;
LOC15 = nimIntToStr(J_52767);
LOC14 = rawNewString(LOC15->Sup.len + 30);
appendString(LOC14, ((NimStringDesc*) &TMP197243));
appendString(LOC14, LOC15);
Internalerror_47571(LOC14);
LA12: ;
App_52031(&Result_52765, Args_52073[(NI32)(J_52767 - 1)]);
break;
case 78:
case 110:
...
appendString(LOC16, ((NimStringDesc*) &TMP197243));
...
Start_52769 = I_52766;
while (1) {
if (!(I_52766 <= (NI32)(Length_52768 - 1))) goto LA17;
...
if (!(Start_52769 <= (NI32)(I_52766 - 1))) goto LA22;
LOC24 = 0;
LOC24 = copyStrLast(Frmt_52071, Start_52769, (NI32)(I_52766 - 1));
...
Result_52472 = 0;
L_52483 = 0;
L_52483 = (NI32)((*S_52471)->Sup.len - 1);
