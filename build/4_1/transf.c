...
STRING_LITERAL(TMP194216, "transformSym", 12);
STRING_LITERAL(TMP194217, "wrong AST for borrowed symbol", 29);
STRING_LITERAL(TMP194218, "transformSym: const", 19);
STRING_LITERAL(TMP194219, "transformLambda", 15);
STRING_LITERAL(TMP194220, ":tmpCl", 6);
STRING_LITERAL(TMP194221, "popTransCon", 11);
STRING_LITERAL(TMP194222, "transformFor", 12);
STRING_LITERAL(TMP194223, ":tmp", 4);
STRING_LITERAL(TMP194224, "not implemented: pass to var parameter", 38);
STRING_LITERAL(TMP194225, "inlineIter", 10);
STRING_LITERAL(TMP194226, "inlineIter: not nkVarTuple", 26);
STRING_LITERAL(TMP194227, "transformCase", 13);
STRING_LITERAL(TMP194228, "transform", 9);
...
Internalerror_45567((*N_185105).Info, ((NimStringDesc*) &TMP194217));
LA8: ;
...
Internalerror_45567((*B_185107).Info, ((NimStringDesc*) &TMP194218));
LA19: ;
LA16: ;
break;
default:
...
Internalerror_45571(((NimStringDesc*) &TMP194221));
LA2: ;
...
Internalerror_45567((*N_187014).Info, ((NimStringDesc*) &TMP194219));
LA2: ;
S_187063 = 0;
...
Param_187100 = 0;
LOC4 = Getident_52016(((NimStringDesc*) &TMP194220));
...
appendString(LOC4, ((NimStringDesc*) &TMP194223));
...
TY53545* LOC2;
Result_185078 = 0;
LOC1 = Getident_52016(((NimStringDesc*) &TMP194223));
...
Internalerror_45567((*It_185597).Info, ((NimStringDesc*) &TMP194226));
LA19: ;
L_185744 = 0;
...
Internalerror_45567((*N_186583).Info, ((NimStringDesc*) &TMP194222));
LA2: ;
...
LA8: ;
if (!LOC7) goto LA9;
Internalerror_45567((*Call_186653).Info, ((NimStringDesc*) &TMP194222));
LA9: ;
...
break;
case ((NU8) 2):
Internalerror_45567((*Arg_186737).Info, ((NimStringDesc*) &TMP194224));
break;
}
Res_186797 += 1;
} LA15: ;
...
Internalerror_45567((*(*N_187194).KindU.S6.Sons->data[I_187197]).Info, ((NimStringDesc*) &TMP194227));
LA9: ;
Ifs_187330 = 0;
...
Internalerror_45567((*N_185095).Info, ((NimStringDesc*) &TMP194228));
LA12: ;
