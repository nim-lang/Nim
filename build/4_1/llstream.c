...
break;
case ((NU8) 1):
Result_74212 = ((Buflen_74047 <= (NI32)((*S_74045).S->Sup.len - (*S_74045).Rd)) ? Buflen_74047 : (NI32)((*S_74045).S->Sup.len - (*S_74045).Rd));
if (!(0 < Result_74212)) goto LA2;
memcpy(Buf_74046, ((void*) (&(*S_74045).S->data[(NI32)(0 + (*S_74045).Rd)])), Result_74212);
...
break;
default:
Result_74235 = addChar(Result_74235, (*S_74050).S->data[(NI32)((*S_74050).Rd + 0)]);
(*S_74050).Rd += 1;
break;
}
} LA1: ;
