...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP197695, "", 0);
STRING_LITERAL(TMP197696, ">>> ", 4);
STRING_LITERAL(TMP197697, "... ", 4);
STRING_LITERAL(TMP197698, "\012", 1);
STRING_LITERAL(TMP197699, "\"\"\"", 3);
static NIM_CONST TY22602 TMP197852 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
Result_76406 = 0;
I_76409 = 0;
I_76409 = (NI32)(X_76403->Sup.len - 1);
while (1) {
LOC2 = (0 <= I_76409);
if (!(LOC2)) goto LA3;
...
asgnRefNoCycle((void**) &(*S_76466).S, copyString(((NimStringDesc*) &TMP197695)));
(*S_76466).Rd = 0;
while (1) {
LOC2 = 0;
if (!((*S_76466).S->Sup.len == 0)) goto LA4;
LOC2 = copyString(((NimStringDesc*) &TMP197696));
goto LA3;
LA4: ;
LOC2 = copyString(((NimStringDesc*) &TMP197697));
LA3: ;
...
appendString((*S_76466).S, ((NimStringDesc*) &TMP197698));
LOC6 = Contains_26284(Line_76470, ((NimStringDesc*) &TMP197699));
if (!LOC6) goto LA7;
...
Result_76469 = ((Buflen_76468 <= (NI32)((*S_76466).S->Sup.len - (*S_76466).Rd)) ? Buflen_76468 : (NI32)((*S_76466).S->Sup.len - (*S_76466).Rd));
...
break;
case ((NU8) 1):
Result_76519 = ((Buflen_76239 <= (NI32)((*S_76237).S->Sup.len - (*S_76237).Rd)) ? Buflen_76239 : (NI32)((*S_76237).S->Sup.len - (*S_76237).Rd));
if (!(0 < Result_76519)) goto LA2;
memcpy(Buf_76238, ((void*) (&(*S_76237).S->data[(NI32)(0 + (*S_76237).Rd)])), Result_76519);
...
switch ((*S_76242).Kind) {
case ((NU8) 0):
Result_76544 = copyString(((NimStringDesc*) &TMP197695));
break;
case ((NU8) 1):
Result_76544 = copyString(((NimStringDesc*) &TMP197695));
while (1) {
if (!((*S_76242).Rd < (*S_76242).S->Sup.len)) goto LA1;
switch (((NU8)((*S_76242).S->data[(NI32)((*S_76242).Rd + 0)]))) {
case 13:
(*S_76242).Rd += 1;
if (!((NU8)((*S_76242).S->data[(NI32)((*S_76242).Rd + 0)]) == (NU8)(10))) goto LA3;
(*S_76242).Rd += 1;
LA3: ;
goto LA1;
break;
...
break;
default:
Result_76544 = addChar(Result_76544, (*S_76242).S->data[(NI32)((*S_76242).Rd + 0)]);
(*S_76242).Rd += 1;
break;
}
} LA1: ;
...
Result_76446 = 0;
Result_76446 = Endswith_76401(X_76445, TMP197852);
return Result_76446;
}
...
Llstreamwrite_76246(S_76261, ((NimStringDesc*) &TMP197698));
}
...
asgnRefNoCycle((void**) &(*Result_76346).S, copyString(((NimStringDesc*) &TMP197695)));
