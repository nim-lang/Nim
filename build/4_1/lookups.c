...
STRING_LITERAL(TMP195928, "lookUp", 6);
STRING_LITERAL(TMP196117, "CloseScope", 10);
STRING_LITERAL(TMP196143, "AddInterfaceDeclAux", 19);
STRING_LITERAL(TMP196170, "addOverloadableSymAt", 20);
N_NIMCALL(TY55548*, Lookup_108245)(TY107012* C_108247, TY55526* N_108248) {
...
break;
default:
Internalerror_47574((*N_108248).Info, ((NimStringDesc*) &TMP195928));
break;
}
...
Internalerror_47574((*Sym_108146).Info, ((NimStringDesc*) &TMP196143));
LA5: ;
...
Internalerror_47574((*Fn_108199).Info, ((NimStringDesc*) &TMP196170));
LA2: ;
Check_108212 = 0;
