...
STRING_LITERAL(TMP193927, "lookUp", 6);
STRING_LITERAL(TMP194116, "CloseScope", 10);
STRING_LITERAL(TMP194146, "AddInterfaceDeclAux", 19);
STRING_LITERAL(TMP194173, "addOverloadableSymAt", 20);
N_NIMCALL(TY53545*, Lookup_104049)(TY103012* C_104051, TY53523* N_104052) {
...
break;
default:
Internalerror_45567((*N_104052).Info, ((NimStringDesc*) &TMP193927));
break;
}
...
Internalerror_45567((*Sym_104201).Info, ((NimStringDesc*) &TMP194146));
LA5: ;
...
Internalerror_45567((*Fn_104038).Info, ((NimStringDesc*) &TMP194173));
LA2: ;
Check_104267 = 0;
