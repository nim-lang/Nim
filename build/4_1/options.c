...
STRING_LITERAL(TMP197647, "nimcache", 8);
STRING_LITERAL(TMP197659, "cannot create directory: ", 25);
...
LOC6[1] = copyString(((NimStringDesc*) &TMP197647));
...
LOC7[1] = copyString(((NimStringDesc*) &TMP197647));
LOC7[2] = copyString(Head_47250);
Subdir_47262 = nosJoinPathOpenArray(LOC7, 3);
if (!Createsubdir_47109) goto LA9;
pushSafePoint(&TMP197658);
TMP197658.status = setjmp(TMP197658.context);
if (TMP197658.status == 0) {
...
appendString(LOC11, ((NimStringDesc*) &TMP197659));
appendString(LOC11, Subdir_47262);
Writeln_47266(stdout, LOC11);
exit(1);
TMP197658.status = 0;popCurrentException();}
}
if (TMP197658.status != 0) reraiseException();
LA9: ;
...
Write_3866(F_47269, ((NimStringDesc*) &TMP199566));
}
