...
STRING_LITERAL(TMP196182, "nim", 3);
STRING_LITERAL(TMP196183, "getModuleFile()", 15);
STRING_LITERAL(TMP196184, "", 0);
STRING_LITERAL(TMP196185, "importAllSymbols: ", 18);
STRING_LITERAL(TMP196186, "rawImportSymbol", 15);
STRING_LITERAL(TMP196188, "importSymbol", 12);
STRING_LITERAL(TMP196189, "importSymbol: 2", 15);
STRING_LITERAL(TMP196190, "importSymbol: 3", 15);
...
Result_110020 = 0;
LOC1 = 0;
LOC1 = nosaddFileExt(Modulename_110019, ((NimStringDesc*) &TMP196182));
...
break;
default:
Internalerror_47574((*N_110015).Info, ((NimStringDesc*) &TMP196183));
Result_110024 = copyString(((NimStringDesc*) &TMP196184));
break;
}
...
Internalerror_47574((*S_110064).Info, ((NimStringDesc*) &TMP196186));
LA18: ;
...
appendString(LOC11, ((NimStringDesc*) &TMP196185));
...
Internalerror_47574((*Ident_110216).Info, ((NimStringDesc*) &TMP196189));
LA11: ;
...
Internalerror_47574((*Ident_110216).Info, ((NimStringDesc*) &TMP196190));
LA15: ;
