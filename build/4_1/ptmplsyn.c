...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP195831, "", 0);
STRING_LITERAL(TMP195832, "subschar", 8);
STRING_LITERAL(TMP195833, "metachar", 8);
STRING_LITERAL(TMP195834, "emit", 4);
STRING_LITERAL(TMP195835, "result.add", 10);
STRING_LITERAL(TMP195836, "conc", 4);
STRING_LITERAL(TMP195837, " & ", 3);
STRING_LITERAL(TMP195838, "tostring", 8);
STRING_LITERAL(TMP195839, "$", 1);
STRING_LITERAL(TMP195840, "\012", 1);
STRING_LITERAL(TMP195842, "end", 3);
STRING_LITERAL(TMP195843, "#end", 4);
STRING_LITERAL(TMP195844, "\"", 1);
STRING_LITERAL(TMP195845, "(\"", 2);
STRING_LITERAL(TMP195846, "\\x", 2);
STRING_LITERAL(TMP195847, "\\\\", 2);
STRING_LITERAL(TMP195848, "\\\'", 2);
STRING_LITERAL(TMP195849, "\\\"", 2);
STRING_LITERAL(TMP195850, "}", 1);
STRING_LITERAL(TMP195851, "\\n\"", 3);
N_NIMCALL(void, Newline_91030)(TY91009* P_91033) {
NimStringDesc* LOC1;
NimStringDesc* LOC8;
LOC1 = 0;
...
P_91459.Outp = Llstreamopen_75217(((NimStringDesc*) &TMP195831));
P_91459.Inp = Stdin_91003;
P_91459.Subschar = Chararg_90014(Call_91005, ((NimStringDesc*) &TMP195832), 1, 36);
P_91459.Nimdirective = Chararg_90014(Call_91005, ((NimStringDesc*) &TMP195833), 2, 35);
P_91459.Emit = Strarg_90020(Call_91005, ((NimStringDesc*) &TMP195834), 3, ((NimStringDesc*) &TMP195835));
P_91459.Conc = Strarg_90020(Call_91005, ((NimStringDesc*) &TMP195836), 4, ((NimStringDesc*) &TMP195837));
P_91459.Tostr = Strarg_90020(Call_91005, ((NimStringDesc*) &TMP195838), 5, ((NimStringDesc*) &TMP195839));
while (1) {
