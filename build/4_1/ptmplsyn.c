...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP193824, "", 0);
STRING_LITERAL(TMP193825, "subschar", 8);
STRING_LITERAL(TMP193826, "metachar", 8);
STRING_LITERAL(TMP193827, "emit", 4);
STRING_LITERAL(TMP193828, "result.add", 10);
STRING_LITERAL(TMP193829, "conc", 4);
STRING_LITERAL(TMP193830, " & ", 3);
STRING_LITERAL(TMP193831, "tostring", 8);
STRING_LITERAL(TMP193832, "$", 1);
STRING_LITERAL(TMP193833, "\012", 1);
static NIM_CONST TY21602 TMP193834 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP193835, "end", 3);
STRING_LITERAL(TMP193836, "#end", 4);
STRING_LITERAL(TMP193837, "\"", 1);
STRING_LITERAL(TMP193838, "(\"", 2);
STRING_LITERAL(TMP193839, "\\x", 2);
STRING_LITERAL(TMP193840, "\\\\", 2);
STRING_LITERAL(TMP193841, "\\\'", 2);
STRING_LITERAL(TMP193842, "\\\"", 2);
STRING_LITERAL(TMP193843, "}", 1);
STRING_LITERAL(TMP193844, "\\n\"", 3);
N_NIMCALL(void, Newline_90030)(TY90009* P_90033) {
NimStringDesc* LOC1;
NimStringDesc* LOC8;
LOC1 = 0;
...
Llstreamwrite_74054((*P_90033).Outp, ((NimStringDesc*) &TMP193833));
LA3: ;
...
LOC5 = (0 <= I_90132);
if (!(LOC5)) goto LA6;
LOC5 = ((TMP193834[((NU8)((*P_90128).X->data[I_90132]))/8] &(1<<(((NU8)((*P_90128).X->data[I_90132]))%8)))!=0);
LA6: ;
if (!LOC5) goto LA7;
...
D_90177 = J_90178;
Keyw_90180 = copyString(((NimStringDesc*) &TMP193824));
while (1) {
...
Limessage_46566((*P_90176).Info, ((NU8) 160), ((NimStringDesc*) &TMP193835));
LA14: ;
LOC17 = 0;
...
Llstreamwrite_74054((*P_90176).Outp, ((NimStringDesc*) &TMP193833));
LOC24 = 0;
...
switch (((NU8)((*P_90176).X->data[J_90178]))) {
case 0:
Limessage_46566((*P_90176).Info, ((NU8) 184), ((NimStringDesc*) &TMP193843));
break;
case 123:
J_90178 += 1;
Curly_90179 += 1;
...
LA40: ;
(*P_90176).Info.Col = ((NI16) (J_90178));
Limessage_46566((*P_90176).Info, ((NU8) 165), ((NimStringDesc*) &TMP193832));
LA39: ;
break;
}
goto LA28;
...
Llstreamwrite_74054((*P_90176).Outp, ((NimStringDesc*) &TMP193844));
LA2: ;
}
...
P_90486.Outp = Llstreamopen_74025(((NimStringDesc*) &TMP193824));
P_90486.Inp = Stdin_90003;
P_90486.Subschar = Chararg_89014(Call_90005, ((NimStringDesc*) &TMP193825), 1, 36);
P_90486.Nimdirective = Chararg_89014(Call_90005, ((NimStringDesc*) &TMP193826), 2, 35);
P_90486.Emit = Strarg_89020(Call_90005, ((NimStringDesc*) &TMP193827), 3, ((NimStringDesc*) &TMP193828));
P_90486.Conc = Strarg_89020(Call_90005, ((NimStringDesc*) &TMP193829), 4, ((NimStringDesc*) &TMP193830));
P_90486.Tostr = Strarg_89020(Call_90005, ((NimStringDesc*) &TMP193831), 5, ((NimStringDesc*) &TMP193832));
while (1) {
