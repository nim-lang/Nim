...
STRING_LITERAL(TMP193761, " (invalid data!)", 16);
STRING_LITERAL(TMP193864, "cannot retrieve file position", 29);
STRING_LITERAL(TMP193865, "cannot set file position", 24);
STRING_LITERAL(TMP195482, "[GC] total memory: ", 19);
STRING_LITERAL(TMP195483, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP195484, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP195485, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP195486, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP195487, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP195488, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP195489, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP195490, "\012[GC] max stack size: ", 22);
...
appendString(LOC4, ((NimStringDesc*) &TMP193761));
Result_18181 = LOC4;
LA1: ;
return Result_18181;
}
...
asgnRefNoCycle((void**) &(*E_4309).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193864)));
...
asgnRefNoCycle((void**) &(*E_4286).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193865)));
...
FILE* F_4058;
TSafePoint TMP193863;
NIM_BOOL LOC2;
NI64 volatile Len_4060;
NI LOC9;
Result_4057 = 0;
F_4058 = 0;
TMP193863.prev = excHandler;
excHandler = &TMP193863;
TMP193863.status = setjmp(TMP193863.context);
if (TMP193863.status == 0) {
...
if ((TMP193863.exc->Sup.m_type == NTI420)) {
Result_4057 = copyString(NIM_NIL);
TMP193863.status = 0;}
}
excHandler = excHandler->prev;
if (TMP193863.status != 0) { raiseException(TMP193863.exc, TMP193863.exc->name); }
return Result_4057;
}
N_NIMCALL(void, Genericassignaux_17968)(void* Dest_17970, void* Src_17971, TNimNode* N_17973) {
NI D_17974;
