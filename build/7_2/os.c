...
STRING_LITERAL(TMP196650, "/path/a.out", 11);
...
NI Result_41630;
Result_41630 = 0;
Result_41630 = (NI64)(((NI) (cmdCount)) - 1);
goto BeforeRet;
BeforeRet: ;
return Result_41630;
}
...
I_38592 = 0;
HEX3Atmp_38608 = 0;
HEX3Atmp_38608 = (NI64)(Path_38577->Sup.len - 1);
Res_38610 = 0;
...
unsureAsgnRef((void**) &(*Result).Head, copyStrLast(Path_38577, 0, (NI64)(Seppos_38582 - 1)));
unsureAsgnRef((void**) &(*Result).Tail, copyStr(Path_38577, (NI64)(Seppos_38582 + 1)));
goto LA5;
LA6: ;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_38714->data[(NI64)(Path_38714->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Path_38714->data[(NI64)(Path_38714->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
I_38752 = 0;
HEX3Atmp_38774 = 0;
HEX3Atmp_38774 = (NI64)(Path_38714->Sup.len - 1);
Res_38776 = 0;
...
unsureAsgnRef((void**) &(*Result).Dir, copyStrLast(Path_38714, 0, (NI64)(Seppos_38739 - 1)));
unsureAsgnRef((void**) &(*Result).Name, copyStrLast(Path_38714, (NI64)(Seppos_38739 + 1), (NI64)(Dotpos_38742 - 1)));
...
Result_41804 = mnewString((NI64)(Len_41805 + 1));
...
I_38691 = 0;
HEX3Atmp_38707 = 0;
HEX3Atmp_38707 = (NI64)(S_38680->Sup.len - 1);
Res_38709 = 0;
...
LOC6 = 0;
LOC7 = 0;
LOC7 = copyStrLast(Filename_39020, 0, (NI64)(Extpos_39023 - 1));
LOC8 = 0;
...
I_40613 = 0;
HEX3Atmp_40627 = 0;
HEX3Atmp_40627 = (NI64)(Dir_40603->Sup.len - 1);
Res_40629 = 0;
Res_40629 = 1;
while (1) {
...
LOC5 = 0;
LOC5 = copyStrLast(Dir_40603, 0, (NI64)(I_40613 - 1));
...
Result_39628 = copyStr(Environment_39439->data[I_39629], (NI64)(LOC4 + 1));
goto BeforeRet;
goto LA1;
LA2: ;
Env_39632 = 0;
...
if (LOC2) goto LA3;
LOC2 = (((NU8)(Path_38785->data[(NI64)(Path_38785->Sup.len - 1)])) == ((NU8)(47)) || ((NU8)(Path_38785->data[(NI64)(Path_38785->Sup.len - 1)])) == ((NU8)(47)));
LA3: ;
if (!LOC2) goto LA4;
...
A_42407.tv_sec = ((NI) ((NI64)(Milsecs_42406 / 1000)));
A_42407.tv_nsec = (NI64)((NI64)(Milsecs_42406 % 1000) * 1000);
