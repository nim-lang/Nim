...
STRING_LITERAL(TMP197224, "transformSym", 12);
STRING_LITERAL(TMP197225, "wrong AST for borrowed symbol", 29);
STRING_LITERAL(TMP197226, "transformSym: const", 19);
STRING_LITERAL(TMP197227, "transformLambda", 15);
STRING_LITERAL(TMP197228, ":tmpCl", 6);
STRING_LITERAL(TMP197229, "popTransCon", 11);
STRING_LITERAL(TMP197230, "transformFor", 12);
STRING_LITERAL(TMP197231, ":tmp", 4);
STRING_LITERAL(TMP197232, "not implemented: pass to var parameter", 38);
STRING_LITERAL(TMP197233, "inlineIter", 10);
STRING_LITERAL(TMP197234, "inlineIter: not nkVarTuple", 26);
STRING_LITERAL(TMP197235, "transformCase", 13);
STRING_LITERAL(TMP197236, "transform", 9);
...
Internalerror_47567((*N_188105).Info, ((NimStringDesc*) &TMP197224));
LA2: ;
Tc_188117 = 0;
...
Internalerror_47567((*B_188107).Info, ((NimStringDesc*) &TMP197226));
LA19: ;
LA16: ;
break;
default:
...
Internalerror_47571(((NimStringDesc*) &TMP197229));
LA2: ;
...
Internalerror_47567((*N_190014).Info, ((NimStringDesc*) &TMP197227));
LA2: ;
S_190063 = 0;
...
Param_190100 = 0;
LOC4 = 0;
LOC4 = Getident_54016(((NimStringDesc*) &TMP197228));
...
appendString(LOC4, ((NimStringDesc*) &TMP197231));
...
Result_188078 = 0;
LOC1 = 0;
LOC1 = Getident_54016(((NimStringDesc*) &TMP197231));
LOC2 = 0;
...
Internalerror_47567((*It_188597).Info, ((NimStringDesc*) &TMP197233));
LA15: ;
Newvar_188661 = 0;
...
J_188752 = 0;
HEX3Atmp_188895 = 0;
HEX3Atmp_188895 = (NI64)(L_188744 - 3);
Res_188897 = 0;
Res_188897 = 0;
while (1) {
...
asgnRefNoCycle((void**) &(*It_188597).KindU.S6.Sons->data[(NI64)(L_188744 - 1)], Transform_188092(C_188563, (*It_188597).KindU.S6.Sons->data[(NI64)(L_188744 - 1)]));
LA11: ;
LA7: ;
Res_188903 += 1;
} LA6: ;
...
Internalerror_47567((*N_189583).Info, ((NimStringDesc*) &TMP197230));
LA2: ;
Result_189584 = Newnodei_55737(((NU8) 101), (*N_189583).Info);
Length_189594 = 0;
Length_189594 = Sonslen_55803(N_189583);
asgnRefNoCycle((void**) &(*N_189583).KindU.S6.Sons->data[(NI64)(Length_189594 - 1)], Transformcontinue_188338(C_189582, (*N_189583).KindU.S6.Sons->data[(NI64)(Length_189594 - 1)]));
V_189619 = 0;
V_189619 = Newnodei_55737(((NU8) 87), (*N_189583).Info);
I_189627 = 0;
HEX3Atmp_189789 = 0;
HEX3Atmp_189789 = (NI64)(Length_189594 - 3);
Res_189791 = 0;
Res_189791 = 0;
while (1) {
...
Call_189653 = 0;
Call_189653 = (*N_189583).KindU.S6.Sons->data[(NI64)(Length_189594 - 2)];
LOC7 = !(((*Call_189653).Kind == ((NU8) 21)));
if (LOC7) goto LA8;
LOC7 = !(((*(*Call_189653).KindU.S6.Sons->data[0]).Kind == ((NU8) 3)));
LA8: ;
if (!LOC7) goto LA9;
Internalerror_47567((*Call_189653).Info, ((NimStringDesc*) &TMP197230));
LA9: ;
...
break;
case ((NU8) 2):
Internalerror_47567((*Arg_189737).Info, ((NimStringDesc*) &TMP197232));
break;
}
Res_189797 += 1;
} LA15: ;
...
Internalerror_47567((*(*N_190194).KindU.S6.Sons->data[I_190197]).Info, ((NimStringDesc*) &TMP197235));
LA9: ;
Ifs_190330 = 0;
Ifs_190330 = Newnodei_55737(((NU8) 82), (*(*N_190194).KindU.S6.Sons->data[(NI64)(I_190197 + 1)]).Info);
Elsen_190331 = 0;
Elsen_190331 = Newnodei_55737(((NU8) 78), (*Ifs_190330).Info);
J_190339 = 0;
HEX3Atmp_190468 = 0;
HEX3Atmp_190469 = 0;
HEX3Atmp_190468 = (NI64)(I_190197 + 1);
HEX3Atmp_190469 = (NI64)(Length_190196 - 1);
Res_190471 = 0;
...
(*N_190194).KindU.S6.Sons = (TY55519*) setLengthSeq(&((*N_190194).KindU.S6.Sons)->Sup, sizeof(TY55525*), (NI64)(I_190197 + 2));
Addson_55823(Elsen_190331, Ifs_190330);
asgnRefNoCycle((void**) &(*N_190194).KindU.S6.Sons->data[(NI64)(I_190197 + 1)], Elsen_190331);
goto LA4;
LA5: ;
LOC12 = !(((*(*N_190194).KindU.S6.Sons->data[(NI64)(Length_190196 - 1)]).Kind == ((NU8) 78)));
if (!(LOC12)) goto LA13;
LOC14 = 0;
...
Internalerror_47567((*N_188095).Info, ((NimStringDesc*) &TMP197236));
LA12: ;
