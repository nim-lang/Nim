...
STRING_LITERAL(TMP194117, "owner is nil", 12);
STRING_LITERAL(TMP194119, "popOwner", 8);
STRING_LITERAL(TMP194127, "makeVarType", 11);
...
Limessage_46566((*Sym_106068).Info, ((NU8) 26), ((NimStringDesc*) &TMP194099));
LA2: ;
...
Internalerror_46575(((NimStringDesc*) &TMP194117));
LA2: ;
...
Internalerror_46575(((NimStringDesc*) &TMP194119));
LA2: ;
Gowners_106131 = (TY54527*) setLengthSeq(&(Gowners_106131)->Sup, sizeof(TY54547*), (NI64)(Length_106168 - 1));
}
...
Internalerror_46575(((NimStringDesc*) &TMP194127));
LA2: ;
...
I_106315 = 0;
HEX3Atmp_106330 = 0;
HEX3Atmp_106330 = (NI64)(L_106292 - 1);
Res_106332 = 0;
Res_106332 = 0;
while (1) {
...
(*C_106060).Converters = (TY54527*) setLengthSeq(&((*C_106060).Converters)->Sup, sizeof(TY54547*), (NI64)(L_106292 + 1));
...
Internalerror_46575(((NimStringDesc*) &TMP194206));
LA2: ;
