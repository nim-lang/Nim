...
STRING_LITERAL(TMP197907, "", 0);
STRING_LITERAL(TMP198280, "$", 1);
STRING_LITERAL(TMP198281, "ropes: invalid format string $", 30);
...
Result_53500 = copyString(((NimStringDesc*) &TMP197907));
goto LA1;
LA2: ;
...
case 36:
App_53036(&Result_53704, ((NimStringDesc*) &TMP198280));
I_53705 += 1;
break;
case 35:
I_53705 += 1;
...
appendString(LOC14, ((NimStringDesc*) &TMP198281));
...
appendString(LOC16, ((NimStringDesc*) &TMP198281));
