...
STRING_LITERAL(TMP195863, "parser to implement", 19);
...
LOC5 = LOC6;
if (!(LOC5)) goto LA8;
LOC5 = Identeq_54028((*(*N_92378).KindU.S6.Sons->data[0]).KindU.S5.Ident, ((NimStringDesc*) &TMP195740));
LA8: ;
if (!LOC5) goto LA9;
I_92468 = 0;
Res_92536 = 0;
...
break;
case ((NU8) 2):
Internalerror_48163(((NimStringDesc*) &TMP195863));
