...
STRING_LITERAL(TMP195860, "parser to implement", 19);
...
LOC5 = LOC6;
if (!(LOC5)) goto LA8;
LOC5 = Identeq_54028((*(*N_92378).KindU.S6.Sons->data[0]).KindU.S5.Ident, ((NimStringDesc*) &TMP195737));
LA8: ;
if (!LOC5) goto LA9;
I_92470 = 0;
Res_92538 = 0;
...
break;
case ((NU8) 2):
Internalerror_47578(((NimStringDesc*) &TMP195860));
break;
}
return Result_92067;
}
