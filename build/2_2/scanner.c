...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;STRING_LITERAL(TMP195705, "getNumber", 9);
STRING_LITERAL(TMP195707, "\012", 1);
static NIM_CONST TY22602 TMP195708 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xEC, 0x00, 0xF0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;STRING_LITERAL(TMP195709, " (\\", 3);
STRING_LITERAL(TMP195715, "tokToStr", 8);
STRING_LITERAL(TMP195738, "pushInd", 7);
STRING_LITERAL(TMP197497, " ", 1);
...
Lexmessage_77326(&(*L_78751), ((NU8) 12), ((NimStringDesc*) &TMP195701));
goto LA1;
LA3: ;
break;
default:
...
Lexmessage_77326(&(*L_77636), ((NU8) 12), ((NimStringDesc*) &TMP195701));
goto LA1;
LA9: ;
...
(*L_77757).Sup.Bufpos = Pos_77759;
LA12: ;
pushSafePoint(&TMP195704);
TMP195704.status = setjmp(TMP195704.context);
if (TMP195704.status == 0) {
...
Lexmessage_77326(&(*L_77757), ((NU8) 12), ((NimStringDesc*) &TMP195701));
goto LA44;
LA46: ;
Pos_77759 += 1;
break;
...
Internalerror_48159(LOC56, ((NimStringDesc*) &TMP195705));
break;
}
...
Internalerror_48159(LOC57, ((NimStringDesc*) &TMP195705));
break;
}
goto LA39;
LA42: ;
...
Lexmessage_77326(&(*L_77757), ((NU8) 14), (*Result).Literal);
TMP195704.status = 0;popCurrentException();}
...
if (TMP195704.status != 0) reraiseException();
...
appendString(LOC9, ((NimStringDesc*) &TMP195707));
...
break;
case 48 ... 57:
LOC5 = Matchtwochars_77690(&(*L_78388), 48, TMP195703);
if (!LOC5) goto LA6;
...
if (!((TMP195708[((NU8)(C_78849))/8] &(1<<(((NU8)(C_78849))%8)))!=0)) goto LA3;
...
break;
default:
if (!((TMP195708[((NU8)(C_79126))/8] &(1<<(((NU8)(C_79126))%8)))!=0)) goto LA49;
Getoperator_78840(L_77307, Tok_77309);
goto LA48;
LA49: ;
LOC51 = 0;
...
appendString(LOC52, ((NimStringDesc*) &TMP195709));
...
goto LA1;
LA2: ;
Internalerror_48163(((NimStringDesc*) &TMP195715));
...
goto LA1;
LA2: ;
Internalerror_48163(((NimStringDesc*) &TMP195738));
LA1: ;
}
...
Write_3866(stdout, ((NimStringDesc*) &TMP197497));
LOC1 = 0;
...
Write_3866(F_77555, ((NimStringDesc*) &TMP195707));
}
