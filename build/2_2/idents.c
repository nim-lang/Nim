...
Result_55169 = (NI64)(((NU8)(Aa_55170)) - ((NU8)(Bb_55171)));
LOC3 = !((Result_55169 == 0));
if (LOC3) goto LA4;
...
LA6: ;
if (!LOC5) goto LA7;
Aa_55048 = ((NIM_CHAR) (((NI) ((NI64)(((NU8)(Aa_55048)) + 32)))));
LA7: ;
...
LA11: ;
if (!LOC10) goto LA12;
Bb_55049 = ((NIM_CHAR) (((NI) ((NI64)(((NU8)(Bb_55049)) + 32)))));
LA12: ;
Result_55047 = (NI64)(((NU8)(Aa_55048)) - ((NU8)(Bb_55049)));
...
I_55311 = 0;
HEX3Atmp_55326 = 0;
HEX3Atmp_55326 = (NI64)((NI64)(Length_55026 + 0) - 1);
Res_55328 = 0;
Res_55328 = 0;
while (1) {
if (!(Res_55328 <= HEX3Atmp_55326)) goto LA12;
I_55311 = Res_55328;
(*Result_55239).S->data[I_55311] = Identifier_55025[(NI64)(I_55311 - 0)];
Res_55328 += 1;
} LA12: ;
asgnRefNoCycle((void**) &(*Result_55239).Next, Buckets_55041[(Idx_55240)-0]);
asgnRefNoCycle((void**) &Buckets_55041[(Idx_55240)-0], Result_55239);
...
Wordcounter_55233 += 1;
(*Result_55239).Sup.Id = ((NI64)-(Wordcounter_55233));
goto LA13;
LA14: ;
