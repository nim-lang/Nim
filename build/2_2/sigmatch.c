...
STRING_LITERAL(TMP198030, "forward type in typeRel()", 25);
STRING_LITERAL(TMP198031, "tupleRel", 8);
STRING_LITERAL(TMP198032, "typeRel: tyGenericInvokation -> tyGenericInvokation", 51);
STRING_LITERAL(TMP198033, "wrong instantiated type!", 24);
STRING_LITERAL(TMP198034, "has constraints: ", 17);
STRING_LITERAL(TMP198035, "typeRel(", 8);
STRING_LITERAL(TMP198046, "getInstantiatedType", 19);
STRING_LITERAL(TMP198047, "implicitConv", 12);
STRING_LITERAL(TMP198048, "x.state is not csMatch", 22);
STRING_LITERAL(TMP198049, "", 0);
STRING_LITERAL(TMP198068, "matches", 7);
STRING_LITERAL(TMP198247, ": ", 2);
STRING_LITERAL(TMP198248, ", ", 2);
STRING_LITERAL(TMP198249, "\012", 1);
...
if (!(LOC8)) goto LA9;
LOC8 = ((IL64(32212254720) &(IL64(1)<<((K_127351)&IL64(63))))!=0);
LA9: ;
if (!LOC8) goto LA10;
Result_127340 = ((NU8) 2);
goto LA5;
...
Internalerror_49208((*(*F_127491).N).Info, ((NimStringDesc*) &TMP198031));
LA19: ;
if (!!(((*(*(*A_127492).N).KindU.S6.Sons->data[I_127547]).Kind == ((NU8) 3)))) goto LA22;
Internalerror_49208((*(*A_127492).N).Info, ((NimStringDesc*) &TMP198031));
LA22: ;
X_127614 = NIM_NIL;
...
goto LA52;
LA57: ;
if (!((5632 &(IL64(1)<<(((*(*F_127307).Sons->data[0]).Kind)&IL64(63))))!=0)) goto LA59;
...
break;
case ((NU8) 30):
Internalerror_49212(((NimStringDesc*) &TMP198030));
break;
case ((NU8) 5):
...
Internalerror_49212(((NimStringDesc*) &TMP198032));
LA206: ;
...
I_128323 = Res_128440;
LOC232 = 0;
LOC232 = Idtableget_61158((*Mapping_127306), &(*(*F_127307).Sons->data[0]).Sons->data[(NI64)(I_128323 - 1)]->Sup);
...
appendString(LOC266, ((NimStringDesc*) &TMP198035));
...
Internalerror_49208((*Arg_128455).Info, ((NimStringDesc*) &TMP198046));
LA6: ;
...
Internalerror_49208((*Arg_128485).Info, ((NimStringDesc*) &TMP198047));
LA6: ;
...
I_128527 = 0;
HEX3Atmp_128563 = 0;
HEX3Atmp_128563 = (NI64)((*C_128502).Converters->Sup.len - 1);
Res_128565 = 0;
Res_128565 = 0;
while (1) {
...
NI Result_127113;
Result_127113 = 0;
Result_127113 = (NI64)((*A_127111).Exactmatches - (*B_127112).Exactmatches);
if (!!((Result_127113 == 0))) goto LA2;
goto BeforeRet;
LA2: ;
Result_127113 = (NI64)((*A_127111).Genericmatches - (*B_127112).Genericmatches);
if (!!((Result_127113 == 0))) goto LA5;
goto BeforeRet;
LA5: ;
Result_127113 = (NI64)((*A_127111).Subtypematches - (*B_127112).Subtypematches);
if (!!((Result_127113 == 0))) goto LA8;
goto BeforeRet;
LA8: ;
Result_127113 = (NI64)((*A_127111).Intconvmatches - (*B_127112).Intconvmatches);
if (!!((Result_127113 == 0))) goto LA11;
goto BeforeRet;
LA11: ;
Result_127113 = (NI64)((*A_127111).Convmatches - (*B_127112).Convmatches);
BeforeRet: ;
...
Internalerror_49208((*Arg_128719).Info, ((NimStringDesc*) &TMP198048));
LA28: ;
Result_128720 = NIM_NIL;
goto LA19;
LA25: ;
...
HEX3Atmp_127100 = ((LOC4 <= (NI64)(LOC5 - 1)) ? LOC4 : (NI64)(LOC5 - 1));
Res_127102 = 0;
Res_127102 = 1;
while (1) {
...
Formaltypeparam_127098 = (*(*Typeparams_127059).KindU.S6.Sons->data[(NI64)(I_127085 - 1)]).Typ;
LOC7 = 0;
...
(*Father_128936).KindU.S6.Sons = (TY56520*) setLengthSeq(&((*Father_128936).KindU.S6.Sons)->Sup, sizeof(TY56526*), (NI64)(At_128937 + 1));
LA3: ;
...
Localerror_49193((*(*N_128980).KindU.S6.Sons->data[A_128986]).Info, ((NU8) 155), ((NimStringDesc*) &TMP198049));
...
Setson_128934((*M_128982).Call, (NI64)((*Formal_129001).Position + 1), Container_129000);
if (!!((F_128985 == (NI64)(Formallen_128987 - 1)))) goto LA24;
Container_129000 = NIM_NIL;
LA24: ;
goto LA20;
LA21: ;
Setson_128934((*M_128982).Call, (NI64)((*Formal_129001).Position + 1), Arg_129167);
LA20: ;
goto LA4;
LA5: ;
...
Internalerror_49208((*(*N_128980).KindU.S6.Sons->data[A_128986]).Info, ((NimStringDesc*) &TMP198068));
LA50: ;
...
Setson_128934((*M_128982).Call, (NI64)((*Formal_129001).Position + 1), LOC62);
if (!!((F_128985 == (NI64)(Formallen_128987 - 1)))) goto LA64;
Container_129000 = NIM_NIL;
LA64: ;
goto LA59;
LA60: ;
Setson_128934((*M_128982).Call, (NI64)((*Formal_129001).Position + 1), Arg_129413);
LA59: ;
LA26: ;
LA4: ;
A_128986 += 1;
...
Setson_128934((*M_129488).Call, (NI64)((*Formal_129530).Position + 1), LOC17);
LA10: ;
LA8: ;
F_129501 += 1;
} LA4: ;
...
appendString(Result_127179, ((NimStringDesc*) &TMP198247));
LA4: ;
LOC7 = 0;
...
if (!!((I_127188 == (NI64)(LOC9 - 1)))) goto LA10;
Result_127179 = resizeString(Result_127179, 2);
...
Candidates_127248 = copyString(((NimStringDesc*) &TMP198049));
...
appendString(Candidates_127248, ((NimStringDesc*) &TMP198249));
LA14: ;
...
appendString(LOC20, ((NimStringDesc*) &TMP198249));
