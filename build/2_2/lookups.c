...
STRING_LITERAL(TMP195989, "lookUp", 6);
STRING_LITERAL(TMP196120, "CloseScope", 10);
STRING_LITERAL(TMP196149, "AddInterfaceDeclAux", 19);
STRING_LITERAL(TMP196176, "addOverloadableSymAt", 20);
N_NIMCALL(TY55548*, Lookup_108245)(TY107012* C_108247, TY55526* N_108248) {
...
break;
default:
Internalerror_48159((*N_108248).Info, ((NimStringDesc*) &TMP195989));
break;
}
...
Internalerror_48163(((NimStringDesc*) &TMP196120));
LA2: ;
...
Internalerror_48159((*Sym_108146).Info, ((NimStringDesc*) &TMP196149));
LA5: ;
...
Internalerror_48159((*Fn_108199).Info, ((NimStringDesc*) &TMP196176));
LA2: ;
Check_108212 = 0;
