...
;
STRING_LITERAL(TMP198022, "sug", 3);
STRING_LITERAL(TMP198023, "getSymFromList", 14);
STRING_LITERAL(TMP198069, "con", 3);
STRING_LITERAL(TMP198070, "def", 3);
...
TSafePoint TMP197963;
Result_130919 = 0;
Result_130919 = NIM_NIL;
pushSafePoint(&TMP197963);
TMP197963.status = setjmp(TMP197963.context);
if (TMP197963.status == 0) {
...
TMP197963.status = 0;popCurrentException();}
}
if (TMP197963.status != 0) reraiseException();
...
if (!LOC4) goto LA5;
LOC7 = 0;
LOC7 = Symtostr_130008(It_130447, (1 < I_130444), ((NimStringDesc*) &TMP198022));
...
if (!LOC2) goto LA3;
LOC5 = 0;
LOC5 = Symtostr_130008(S_130074, NIM_TRUE, ((NimStringDesc*) &TMP198022));
...
Internalerror_49208((*List_130082).Info, ((NimStringDesc*) &TMP198023));
LA4: ;
...
if (!LOC4) goto LA6;
LOC8 = 0;
LOC8 = Symtostr_130008(It_130420, (1 < I_130417), ((NimStringDesc*) &TMP198022));
...
if (!LOC14) goto LA15;
LOC17 = 0;
LOC17 = Symtostr_130008(It_130529, NIM_FALSE, ((NimStringDesc*) &TMP198022));
...
if (!LOC20) goto LA21;
LOC23 = 0;
LOC23 = Symtostr_130008(It_130544, NIM_FALSE, ((NimStringDesc*) &TMP198022));
...
if (!LOC4) goto LA8;
LOC10 = 0;
LOC10 = Symtostr_130008(It_130349, (1 < I_130346), ((NimStringDesc*) &TMP198069));
...
LOC46 = 0;
LOC46 = Symtostr_130008((*N_131208).KindU.S4.Sym, NIM_FALSE, ((NimStringDesc*) &TMP198070));
