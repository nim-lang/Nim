...
STRING_LITERAL(TMP198858, "rodwrite: module ID not set", 27);
STRING_LITERAL(TMP198860, " ", 1);
STRING_LITERAL(TMP198861, "symStack: module nil: ", 22);
STRING_LITERAL(TMP198862, "\012", 1);
STRING_LITERAL(TMP198863, "$1 $2\012", 6);
STRING_LITERAL(TMP198864, "{}", 2);
STRING_LITERAL(TMP198865, "+$1", 3);
STRING_LITERAL(TMP198866, "&$1", 3);
STRING_LITERAL(TMP198867, "^$1", 3);
STRING_LITERAL(TMP198868, "?$1,$2,$3", 9);
STRING_LITERAL(TMP198869, "*$1", 3);
STRING_LITERAL(TMP198870, "$$$1", 4);
STRING_LITERAL(TMP198871, "@$1", 3);
STRING_LITERAL(TMP198872, "()", 2);
STRING_LITERAL(TMP198873, "(", 1);
STRING_LITERAL(TMP198874, "?$1,$2", 6);
STRING_LITERAL(TMP198875, "?$1", 3);
STRING_LITERAL(TMP198876, "!$1", 3);
STRING_LITERAL(TMP198877, ")", 1);
STRING_LITERAL(TMP198878, "%$1", 3);
STRING_LITERAL(TMP198879, "`$1", 3);
STRING_LITERAL(TMP198880, "<$1>", 4);
STRING_LITERAL(TMP198881, "|$1", 3);
STRING_LITERAL(TMP198882, "[]", 2);
STRING_LITERAL(TMP198883, "encodeType: tyForward", 21);
STRING_LITERAL(TMP198884, "/$1", 3);
STRING_LITERAL(TMP198885, "=$1", 3);
STRING_LITERAL(TMP198886, "^()", 3);
STRING_LITERAL(TMP198887, "NIM:", 4);
STRING_LITERAL(TMP198888, "1012", 4);
STRING_LITERAL(TMP198889, "ID:", 3);
STRING_LITERAL(TMP198890, "CRC:", 4);
STRING_LITERAL(TMP198891, "OPTIONS:", 8);
STRING_LITERAL(TMP198892, "DEFINES:", 8);
STRING_LITERAL(TMP198893, "FILES(\012", 7);
STRING_LITERAL(TMP198894, ")\012", 2);
STRING_LITERAL(TMP198895, "INCLUDES(\012", 10);
STRING_LITERAL(TMP198896, "DEPS:", 5);
STRING_LITERAL(TMP198897, "INTERF(\012", 8);
STRING_LITERAL(TMP198898, "COMPILERPROCS(\012", 15);
STRING_LITERAL(TMP198899, "INDEX(\012", 7);
STRING_LITERAL(TMP198900, "IMPORTS(\012", 9);
STRING_LITERAL(TMP198901, "CONVERTERS:", 11);
STRING_LITERAL(TMP198902, "INIT(\012", 6);
STRING_LITERAL(TMP198903, "DATA(\012", 6);
STRING_LITERAL(TMP198904, "rod", 3);
STRING_LITERAL(TMP198905, "rodwrite.process", 16);
...
App_53036(&Result_112058, ((NimStringDesc*) &TMP198860));
LA6: ;
...
(*W_112271).Sstack = (TY56528*) setLengthSeq(&((*W_112271).Sstack)->Sup, sizeof(TY56548*), (NI64)(L_112285 + 1));
...
TY53008* LOC4;
TY179695 LOC5;
if (!((NI64)(Key_113070 - (*W_113069).Lastidxkey) == 1)) goto LA2;
LOC4 = 0;
LOC4 = Encodeint_94073(((NI64) ((NI64)(Val_113071 - (*W_113069).Lastidxval))));
App_53031(&(*W_113069).R, LOC4);
App_53036(&(*W_113069).R, ((NimStringDesc*) &TMP198862));
goto LA1;
LA2: ;
memset((void*)&LOC5, 0, sizeof(LOC5));
LOC5[0] = Encodeint_94073(((NI64) ((NI64)(Key_113070 - (*W_113069).Lastidxkey))));
LOC5[1] = Encodeint_94073(((NI64) ((NI64)(Val_113071 - (*W_113069).Lastidxval))));
Appf_53071(&(*W_113069).R, ((NimStringDesc*) &TMP198863), LOC5, 2);
LA1: ;
...
(*W_112242).Tstack = (TY56550*) setLengthSeq(&((*W_112242).Tstack)->Sup, sizeof(TY56552*), (NI64)(L_112256 + 1));
...
(*W_112091).Files = (TY39221*) setLengthSeq(&((*W_112091).Files)->Sup, sizeof(NimStringDesc*), (NI64)(Result_112093 + 1));
...
Result_112303 = Torope_53046(((NimStringDesc*) &TMP198872));
goto BeforeRet;
LA2: ;
...
Appf_53071(&Result_112303, ((NimStringDesc*) &TMP198868), LOC8, 3);
goto LA5;
LA6: ;
...
Appf_53071(&Result_112303, ((NimStringDesc*) &TMP198874), LOC13, 2);
goto LA5;
LA11: ;
...
Appf_53071(&Result_112303, ((NimStringDesc*) &TMP198875), LOC16, 1);
goto LA5;
LA14: ;
LA5: ;
...
Appf_53071(&Result_112303, ((NimStringDesc*) &TMP198876), LOC28, 1);
LA26: ;
break;
case ((NU8) 11) ... ((NU8) 13):
...
Appf_53071(&Result_112303, ((NimStringDesc*) &TMP198876), LOC32, 1);
LA30: ;
break;
case ((NU8) 14) ... ((NU8) 16):
...
App_53036(&Result_112303, ((NimStringDesc*) &TMP198877));
BeforeRet: ;
...
Appf_53071(&Result_112552, ((NimStringDesc*) &TMP198869), LOC8, 1);
LA6: ;
if (!!(((*Loc_112551).Flags == 0))) goto LA10;
memset((void*)&LOC12, 0, sizeof(LOC12));
LOC12[0] = Encodeint_94073(((NI64) (((int) ((*Loc_112551).Flags)))));
Appf_53071(&Result_112552, ((NimStringDesc*) &TMP198870), LOC12, 1);
LA10: ;
if (!!(((*Loc_112551).T == NIM_NIL))) goto LA14;
memset((void*)&LOC16, 0, sizeof(LOC16));
LOC16[0] = Encodeint_94073(((NI64) ((*(*Loc_112551).T).Sup.Id)));
Appf_53071(&Result_112552, ((NimStringDesc*) &TMP198867), LOC16, 1);
...
Appf_53071(&Result_112832, ((NimStringDesc*) &TMP198881), LOC1, 1);
memset((void*)&LOC2, 0, sizeof(LOC2));
LOC3 = 0;
LOC3 = Ropetostr_53063((*Lib_112830).Name);
LOC2[0] = Encodestr_112048(W_112829, LOC3);
Appf_53071(&Result_112832, ((NimStringDesc*) &TMP198881), LOC2, 1);
memset((void*)&LOC4, 0, sizeof(LOC4));
LOC4[0] = Encodenode_112298(W_112829, Info_112831, (*Lib_112830).Path);
Appf_53071(&Result_112832, ((NimStringDesc*) &TMP198881), LOC4, 1);
...
Result_112857 = Torope_53046(((NimStringDesc*) &TMP198864));
goto BeforeRet;
LA2: ;
Result_112857 = NIM_NIL;
LOC4 = 0;
...
Appf_53071(&Result_112857, ((NimStringDesc*) &TMP198865), LOC5, 1);
memset((void*)&LOC6, 0, sizeof(LOC6));
LOC6[0] = Encodestr_112048(W_112855, (*(*S_112856).Name).S);
Appf_53071(&Result_112857, ((NimStringDesc*) &TMP198866), LOC6, 1);
if (!!(((*S_112856).Typ == NIM_NIL))) goto LA8;
memset((void*)&LOC10, 0, sizeof(LOC10));
LOC10[0] = Encodeint_94073(((NI64) ((*(*S_112856).Typ).Sup.Id)));
Appf_53071(&Result_112857, ((NimStringDesc*) &TMP198867), LOC10, 1);
...
Appf_53071(&Result_112857, ((NimStringDesc*) &TMP198870), LOC27, 1);
LA25: ;
if (!!(((*S_112856).Magic == ((NU8) 0)))) goto LA29;
memset((void*)&LOC31, 0, sizeof(LOC31));
LOC31[0] = Encodeint_94073(((NI64) ((*S_112856).Magic)));
Appf_53071(&Result_112857, ((NimStringDesc*) &TMP198871), LOC31, 1);
LA29: ;
...
appendString(LOC9, ((NimStringDesc*) &TMP198861));
...
App_53036(&(*W_113085).Data, ((NimStringDesc*) &TMP198862));
...
Appf_53071(&(*W_113085).Interf, ((NimStringDesc*) &TMP198863), LOC19, 2);
LA17: ;
...
Appf_53071(&(*W_113085).Compilerprocs, ((NimStringDesc*) &TMP198863), LOC23, 2);
LA21: ;
if (!((*S_113088).Kind == ((NU8) 13))) goto LA25;
if (!!(((*W_113085).Converters == NIM_NIL))) goto LA28;
App_53036(&(*W_113085).Converters, ((NimStringDesc*) &TMP198860));
LA28: ;
LOC30 = 0;
...
Result_112663 = Torope_53046(((NimStringDesc*) &TMP198882));
goto BeforeRet;
LA2: ;
Result_112663 = NIM_NIL;
if (!((*T_112662).Kind == ((NU8) 30))) goto LA5;
Internalerror_49212(((NimStringDesc*) &TMP198883));
LA5: ;
LOC7 = 0;
...
Appf_53071(&Result_112663, ((NimStringDesc*) &TMP198865), LOC8, 1);
...
App_53036(&Result_112663, ((NimStringDesc*) &TMP198886));
goto LA45;
LA46: ;
memset((void*)&LOC48, 0, sizeof(LOC48));
LOC48[0] = Encodeint_94073(((NI64) ((*(*T_112662).Sons->data[I_112806]).Sup.Id)));
Appf_53071(&Result_112663, ((NimStringDesc*) &TMP198867), LOC48, 1);
...
App_53036(&(*W_113216).Data, ((NimStringDesc*) &TMP198862));
LA4: ;
I_113217 += 1;
} LA1: ;
...
Internalerror_49212(((NimStringDesc*) &TMP198858));
LA2: ;
W_113836 = NIM_NIL;
...
Content_113347 = Torope_53046(((NimStringDesc*) &TMP198887));
LOC1 = 0;
LOC1 = Torope_53046(((NimStringDesc*) &TMP198888));
App_53031(&Content_113347, LOC1);
App_53036(&Content_113347, ((NimStringDesc*) &TMP198862));
LOC2 = 0;
LOC2 = Torope_53046(((NimStringDesc*) &TMP198889));
...
App_53036(&Content_113347, ((NimStringDesc*) &TMP198862));
LOC4 = 0;
LOC4 = Torope_53046(((NimStringDesc*) &TMP198890));
...
App_53036(&Content_113347, ((NimStringDesc*) &TMP198862));
LOC6 = 0;
LOC6 = Torope_53046(((NimStringDesc*) &TMP198891));
...
App_53036(&Content_113347, ((NimStringDesc*) &TMP198862));
LOC8 = 0;
LOC8 = Torope_53046(((NimStringDesc*) &TMP198892));
App_53031(&Content_113347, LOC8);
App_53031(&Content_113347, (*W_112047).Defines);
App_53036(&Content_113347, ((NimStringDesc*) &TMP198862));
LOC9 = 0;
LOC9 = Torope_53046(((NimStringDesc*) &TMP198893));
...
App_53036(&(*W_112031).Moddeps, ((NimStringDesc*) &TMP198860));
LA2: ;
...
App_53036(&(*W_112035).Incldeps, ((NimStringDesc*) &TMP198860));
LOC3 = Crcfromfile_51029(Dep_112036);
LOC4 = 0;
LOC4 = Encodeint_94073(((NI64) (LOC3)));
App_53031(&(*W_112035).Incldeps, LOC4);
App_53036(&(*W_112035).Incldeps, ((NimStringDesc*) &TMP198862));
}
N_NIMCALL(TY56526*, Process_113405)(TY106002* C_113407, TY56526* N_113408) {
...
Internalerror_49208((*N_113408).Info, ((NimStringDesc*) &TMP198905));
LA8: ;
...
Internalerror_49208((*A_113568).Info, ((NimStringDesc*) &TMP198905));
LA24: ;
...
Internalerror_49208((*A_113632).Info, ((NimStringDesc*) &TMP198905));
LA33: ;
...
Internalerror_49208((*A_113696).Info, ((NimStringDesc*) &TMP198905));
LA42: ;
S_113751 = NIM_NIL;
