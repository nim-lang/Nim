...
STRING_LITERAL(TMP196986, "int", 3);
STRING_LITERAL(TMP196987, "int8", 4);
STRING_LITERAL(TMP196988, "int16", 5);
STRING_LITERAL(TMP196989, "int32", 5);
STRING_LITERAL(TMP196990, "int64", 5);
STRING_LITERAL(TMP196991, "float", 5);
STRING_LITERAL(TMP196992, "float32", 7);
STRING_LITERAL(TMP196993, "float64", 7);
STRING_LITERAL(TMP196994, "bool", 4);
STRING_LITERAL(TMP196995, "char", 4);
STRING_LITERAL(TMP196996, "string", 6);
STRING_LITERAL(TMP196997, "cstring", 7);
STRING_LITERAL(TMP196998, "pointer", 7);
STRING_LITERAL(TMP196999, "request for typekind: ", 22);
STRING_LITERAL(TMP197000, "wanted: ", 8);
STRING_LITERAL(TMP197001, " got: ", 6);
STRING_LITERAL(TMP197002, "type not found: ", 16);
...
appendString(LOC4, ((NimStringDesc*) &TMP196999));
...
appendString(LOC12, ((NimStringDesc*) &TMP197002));
