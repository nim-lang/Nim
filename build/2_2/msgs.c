...
STRING_LITERAL(TMP196677, "Error: $1", 9);
STRING_LITERAL(TMP196678, "Warning: $1", 11);
STRING_LITERAL(TMP196679, "Hint: $1", 8);
STRING_LITERAL(TMP197255, "$1($2, $3) Checkpoint: ", 23);
...
LOC11 = 0;
LOC11 = nsuFormatOpenArray(((NimStringDesc*) &TMP197255), LOC10, 3);
...
Write_3658(F_47844, ((NimStringDesc*) &TMP198502));
}
