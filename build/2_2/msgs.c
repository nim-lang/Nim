...
STRING_LITERAL(TMP197668, "Error: $1", 9);
STRING_LITERAL(TMP197669, "Warning: $1", 11);
STRING_LITERAL(TMP197670, "Hint: $1", 8);
STRING_LITERAL(TMP199564, "\012", 1);
NU32 Gnotes_48564;
...
Write_3866(F_48792, ((NimStringDesc*) &TMP199564));
}
