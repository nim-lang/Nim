...
STRING_LITERAL(TMP193665, "Error: $1", 9);
STRING_LITERAL(TMP193666, "Warning: $1", 11);
STRING_LITERAL(TMP193667, "Hint: $1", 8);
STRING_LITERAL(TMP194241, "$1($2, $3) Checkpoint: ", 23);
...
LOC11 = 0;
LOC11 = nsuFormatOpenArray(((NimStringDesc*) &TMP194241), LOC10, 3);
...
Write_3658(F_46845, ((NimStringDesc*) &TMP195502));
}
