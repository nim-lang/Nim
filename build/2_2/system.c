...
STRING_LITERAL(TMP193643, "", 0);
STRING_LITERAL(TMP193654, "no exception to reraise", 23);
STRING_LITERAL(TMP193756, " (invalid data!)", 16);
STRING_LITERAL(TMP193860, "cannot retrieve file position", 29);
STRING_LITERAL(TMP193861, "cannot set file position", 24);
STRING_LITERAL(TMP195491, "[GC] total memory: ", 19);
STRING_LITERAL(TMP195492, "\012[GC] occupied memory: ", 23);
STRING_LITERAL(TMP195493, "\012[GC] stack scans: ", 19);
STRING_LITERAL(TMP195494, "\012[GC] stack cells: ", 19);
STRING_LITERAL(TMP195495, "\012[GC] cycle collections: ", 25);
STRING_LITERAL(TMP195496, "\012[GC] max threshold: ", 21);
STRING_LITERAL(TMP195497, "\012[GC] zct capacity: ", 20);
STRING_LITERAL(TMP195498, "\012[GC] max cycle table size: ", 28);
STRING_LITERAL(TMP195499, "\012[GC] max stack size: ", 22);
...
Result_3806 = 0;
Result_3806 = copyString(((NimStringDesc*) &TMP193643));
...
asgnRefNoCycle((void**) &(*E_5234).Sup.Sup.message, copyString(((NimStringDesc*) &TMP193654)));
...
appendString(LOC4, ((NimStringDesc*) &TMP193756));
Result_19357 = LOC4;
LA1: ;
return Result_19357;
}
...
asgnRefNoCycle((void**) &(*E_4301).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193860)));
...
asgnRefNoCycle((void**) &(*E_4278).Sup.Sup.Sup.message, copyString(((NimStringDesc*) &TMP193861)));
...
FILE* F_4058;
TSafePoint TMP193859;
NIM_BOOL LOC2;
NI64 volatile Len_4060;
NI LOC9;
Result_4057 = 0;
F_4058 = 0;
pushSafePoint(&TMP193859);
TMP193859.status = setjmp(TMP193859.context);
if (TMP193859.status == 0) {
...
Result_4057 = copyString(NIM_NIL);
TMP193859.status = 0;popCurrentException();}
}
if (TMP193859.status != 0) reraiseException();
return Result_4057;
}
N_NIMCALL(void, Genericassignaux_19168)(void* Dest_19170, void* Src_19171, TNimNode* N_19173) {
NI D_19174;
