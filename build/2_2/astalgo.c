...
STRING_LITERAL(TMP197065, "getSymFromList", 14);
STRING_LITERAL(TMP197148, "null", 4);
STRING_LITERAL(TMP197149, " ", 1);
STRING_LITERAL(TMP197150, "(", 1);
STRING_LITERAL(TMP197151, ", ", 2);
STRING_LITERAL(TMP197152, ")", 1);
STRING_LITERAL(TMP197690, "lookupInRecord", 14);
STRING_LITERAL(TMP197691, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP197692, "lookupInRecord()", 16);
...
I_62151 = Res_62154;
(*X_59231).Data->data[I_62151].Key = (IL64(-9223372036854775807) - IL64(1));
Res_62154 += 1;
} LA1: ;
}
N_NIMCALL(NI, Nexttry_59213)(NI H_59215, NI Maxhash_59216) {
NI Result_60868;
Result_60868 = 0;
Result_60868 = (NI64)((NI64)((NI64)(5 * H_59215) + 1) & Maxhash_59216);
return Result_60868;
}
N_NIMCALL(TY55547*, Strtableget_59069)(TY55529* T_59071, TY54011* Name_59072) {
...
Result_61507 = 0;
H_61508 = 0;
H_61508 = (NI64)((*Name_59072).H & ((*T_59071).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_59536 = 0;
LOC1 = ((NI64)(Length_59211 * 2) < (NI64)(Counter_59212 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI64)(Length_59211 - Counter_59212) < 4);
LA2: ;
Result_59536 = LOC1;
return Result_59536;
}
...
NimStringDesc* LOC5;
H_61316 = 0;
H_61316 = (NI64)((*(*N_61315).Name).H & ((*Data_61314)->Sup.len-1));
while (1) {
...
TY55527* LOC5;
N_61361 = 0;
N_61361 = (TY55527*) newSeq(NTI55527, (NI64)((*T_61360).Data->Sup.len * 2));
I_61391 = 0;
HEX3Atmp_61414 = 0;
...
Result_62161 = 0;
H_62162 = 0;
H_62162 = (NI64)(Key_62160 & (T_62159.Data->Sup.len-1));
while (1) {
if (!!((T_62159.Data->data[H_62162].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
NI H_62182;
H_62182 = 0;
H_62182 = (NI64)(Key_62180 & ((*Data_62179)->Sup.len-1));
while (1) {
if (!!(((*Data_62179)->data[H_62182].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
if (!LOC5) goto LA6;
N_62197 = (TY59221*) newSeq(NTI59221, (NI64)((*T_59239).Data->Sup.len * 2));
I_62241 = 0;
HEX3Atmp_62276 = 0;
...
I_62241 = Res_62278;
N_62197->data[I_62241].Key = (IL64(-9223372036854775807) - IL64(1));
Res_62278 += 1;
} LA8: ;
I_62249 = 0;
HEX3Atmp_62282 = 0;
...
I_62249 = Res_62284;
if (!!(((*T_59239).Data->data[I_62249].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA11;
...
Result_61782 = 0;
H_61783 = 0;
H_61783 = (NI64)(Key_61781 & (T_61780.Data->Sup.len-1));
while (1) {
...
NI H_61837;
H_61837 = 0;
H_61837 = (NI64)((*Key_61835).Id & ((*Data_61834)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_61870 = (TY55561*) newSeq(NTI55561, (NI64)((*T_59177).Data->Sup.len * 2));
I_61923 = 0;
HEX3Atmp_61959 = 0;
...
goto LA1;
LA2: ;
Result_62172 = (IL64(-9223372036854775807) - IL64(1));
LA1: ;
return Result_62172;
}
...
I_61636 = 0;
HEX3Atmp_61649 = 0;
HEX3Atmp_61649 = (NI64)(((NI) (Tab_59121.Tos)) - 1);
Res_61651 = 0;
...
H_61538 = 0;
Start_61539 = 0;
H_61538 = (NI64)((*Ti_59104).H & ((*Tab_59105).Data->Sup.len-1));
Start_61539 = H_61538;
...
Result_61971 = 0;
H_61972 = 0;
H_61972 = (NI64)((*Key_61970).Id & (T_61969.Data->Sup.len-1));
while (1) {
...
NI H_62001;
H_62001 = 0;
H_62001 = (NI64)((*Key_61999).Id & ((*Data_61998)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_62034 = (TY55567*) newSeq(NTI55567, (NI64)((*T_59191).Data->Sup.len * 2));
I_62087 = 0;
HEX3Atmp_62123 = 0;
...
Internalerror_47567((*List_59199).Info, ((NimStringDesc*) &TMP197065));
LA4: ;
...
(*Tab_59152).Stack = (TY59109*) setLengthSeq(&((*Tab_59152).Stack)->Sup, sizeof(TY55529), (NI64)(((NI) ((*Tab_59152).Tos)) + 1));
LA2: ;
...
NU8 Result_61691;
Result_61691 = 0;
Result_61691 = Symtabadduniqueat_59143(Tab_59141, E_59142, ((NI) ((NI64)(((NI) ((*Tab_59141).Tos)) - 1))));
return Result_61691;
}
...
Result_60414 = Torope_52046(((NimStringDesc*) &TMP197148));
goto LA1;
LA2: ;
...
App_52036(&Result_60414, ((NimStringDesc*) &TMP197152));
LA11: ;
LA1: ;
return Result_60414;
}
...
Result_61608 = 0;
Result_61608 = Strtableget_59069(&Tab_59125.Stack->data[(NI64)(((NI) (Tab_59125.Tos)) - 1)], S_59126);
return Result_61608;
}
N_NIMCALL(void, Symtabadd_59127)(TY59107* Tab_59130, TY55547* E_59131) {
Strtableadd_59064(&(*Tab_59130).Stack->data[(NI64)(((NI) ((*Tab_59130).Tos)) - 1)], E_59131);
}
...
break;
default:
Internalerror_47567((*N_59204).Info, ((NimStringDesc*) &TMP197692));
break;
}
BeforeRet: ;
return Result_59246;
...
Write_3658(F_60815, ((NimStringDesc*) &TMP198504));
}
