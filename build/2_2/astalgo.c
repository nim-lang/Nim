...
I_60151 = Res_60154;
(*X_57231).Data->data[I_60151].Key = (IL64(-9223372036854775807) - IL64(1));
Res_60154 += 1;
} LA1: ;
}
N_NIMCALL(NI, Nexttry_57213)(NI H_57215, NI Maxhash_57216) {
NI Result_58868;
Result_58868 = 0;
Result_58868 = (NI64)((NI64)((NI64)(5 * H_57215) + 1) & Maxhash_57216);
return Result_58868;
}
N_NIMCALL(TY53545*, Strtableget_57069)(TY53527* T_57071, TY52011* Name_57072) {
...
Result_59507 = 0;
H_59508 = 0;
H_59508 = (NI64)((*Name_57072).H & ((*T_57071).Data->Sup.len-1));
while (1) {
...
NIM_BOOL LOC1;
Result_57536 = 0;
LOC1 = ((NI64)(Length_57211 * 2) < (NI64)(Counter_57212 * 3));
if (LOC1) goto LA2;
LOC1 = ((NI64)(Length_57211 - Counter_57212) < 4);
LA2: ;
Result_57536 = LOC1;
return Result_57536;
}
...
NimStringDesc* LOC5;
H_59316 = 0;
H_59316 = (NI64)((*(*N_59315).Name).H & ((*Data_59314)->Sup.len-1));
while (1) {
...
TY53525* LOC5;
N_59361 = 0;
N_59361 = (TY53525*) newSeq(NTI53525, (NI64)((*T_59360).Data->Sup.len * 2));
I_59391 = 0;
HEX3Atmp_59414 = 0;
...
Result_60161 = 0;
H_60162 = 0;
H_60162 = (NI64)(Key_60160 & (T_60159.Data->Sup.len-1));
while (1) {
if (!!((T_60159.Data->data[H_60162].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
NI H_60182;
H_60182 = 0;
H_60182 = (NI64)(Key_60180 & ((*Data_60179)->Sup.len-1));
while (1) {
if (!!(((*Data_60179)->data[H_60182].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA1;
...
if (!LOC5) goto LA6;
N_60197 = (TY57221*) newSeq(NTI57221, (NI64)((*T_57239).Data->Sup.len * 2));
I_60241 = 0;
HEX3Atmp_60276 = 0;
...
I_60241 = Res_60278;
N_60197->data[I_60241].Key = (IL64(-9223372036854775807) - IL64(1));
Res_60278 += 1;
} LA8: ;
I_60249 = 0;
HEX3Atmp_60282 = 0;
...
I_60249 = Res_60284;
if (!!(((*T_57239).Data->data[I_60249].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA11;
...
Result_59782 = 0;
H_59783 = 0;
H_59783 = (NI64)(Key_59781 & (T_59780.Data->Sup.len-1));
while (1) {
...
NI H_59837;
H_59837 = 0;
H_59837 = (NI64)((*Key_59835).Id & ((*Data_59834)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_59870 = (TY53559*) newSeq(NTI53559, (NI64)((*T_57177).Data->Sup.len * 2));
I_59923 = 0;
HEX3Atmp_59959 = 0;
...
goto LA1;
LA2: ;
Result_60172 = (IL64(-9223372036854775807) - IL64(1));
LA1: ;
return Result_60172;
}
...
I_59636 = 0;
HEX3Atmp_59649 = 0;
HEX3Atmp_59649 = (NI64)(((NI) (Tab_57121.Tos)) - 1);
Res_59651 = 0;
...
H_59538 = 0;
Start_59539 = 0;
H_59538 = (NI64)((*Ti_57104).H & ((*Tab_57105).Data->Sup.len-1));
Start_59539 = H_59538;
...
Result_59971 = 0;
H_59972 = 0;
H_59972 = (NI64)((*Key_59970).Id & (T_59969.Data->Sup.len-1));
while (1) {
...
NI H_60001;
H_60001 = 0;
H_60001 = (NI64)((*Key_59999).Id & ((*Data_59998)->Sup.len-1));
while (1) {
...
if (!LOC5) goto LA6;
N_60034 = (TY53565*) newSeq(NTI53565, (NI64)((*T_57191).Data->Sup.len * 2));
I_60087 = 0;
HEX3Atmp_60123 = 0;
...
(*Tab_57152).Stack = (TY57109*) setLengthSeq(&((*Tab_57152).Stack)->Sup, sizeof(TY53527), (NI64)(((NI) ((*Tab_57152).Tos)) + 1));
LA2: ;
...
NU8 Result_59691;
Result_59691 = 0;
Result_59691 = Symtabadduniqueat_57143(Tab_57141, E_57142, ((NI) ((NI64)(((NI) ((*Tab_57141).Tos)) - 1))));
return Result_59691;
}
...
Result_59608 = 0;
Result_59608 = Strtableget_57069(&Tab_57125.Stack->data[(NI64)(((NI) (Tab_57125.Tos)) - 1)], S_57126);
return Result_59608;
}
N_NIMCALL(void, Symtabadd_57127)(TY57107* Tab_57130, TY53545* E_57131) {
Strtableadd_57064(&(*Tab_57130).Stack->data[(NI64)(((NI) ((*Tab_57130).Tos)) - 1)], E_57131);
}
