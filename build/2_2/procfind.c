...
STRING_LITERAL(TMP197180, "equalGenericParams", 18);
N_NIMCALL(NIM_BOOL, Equalgenericparams_120014)(TY55525* Proca_120016, TY55525* Procb_120017) {
...
Internalerror_47567((*Proca_120016).Info, ((NimStringDesc*) &TMP197180));
LA17: ;
if (!!(((*(*Procb_120017).KindU.S6.Sons->data[I_120076]).Kind == ((NU8) 3)))) goto LA20;
Internalerror_47567((*Procb_120017).Info, ((NimStringDesc*) &TMP197180));
LA20: ;
