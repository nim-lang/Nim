...
goto BeforeRet;
LA2: ;
if (!(N_98218 < (NI64)(2 * K_98219))) goto LA5;
Result_98220 = Binom_98216(N_98218, (NI64)(N_98218 - K_98219));
goto BeforeRet;
LA5: ;
...
I_98247 = Res_98250;
Result_98220 = (NI64)((NI64)(Result_98220 * (NI64)((NI64)(N_98218 + 1) - I_98247)) / I_98247);
Res_98250 += 1;
} LA7: ;
BeforeRet: ;
return Result_98220;
...
I_98264 = Res_98267;
Result_98256 = (NI64)(Result_98256 * I_98264);
Res_98267 += 1;
} LA1: ;
return Result_98256;
}
...
Result_98273 = 0;
Result_98273 = ((NI64)(X_98272 & ((NI64)-(X_98272))) == X_98272);
goto BeforeRet;
BeforeRet: ;
return Result_98273;
}
...
NI Result_98279;
Result_98279 = 0;
Result_98279 = (NI64)(X_98278 - 1);
Result_98279 = (NI64)(Result_98279 | (NI64)((NU64)(Result_98279) >> (NU64)(32)));
Result_98279 = (NI64)(Result_98279 | (NI64)((NU64)(Result_98279) >> (NU64)(16)));
Result_98279 = (NI64)(Result_98279 | (NI64)((NU64)(Result_98279) >> (NU64)(8)));
Result_98279 = (NI64)(Result_98279 | (NI64)((NU64)(Result_98279) >> (NU64)(4)));
Result_98279 = (NI64)(Result_98279 | (NI64)((NU64)(Result_98279) >> (NU64)(2)));
Result_98279 = (NI64)(Result_98279 | (NI64)((NU64)(Result_98279) >> (NU64)(1)));
Result_98279 += 1;
return Result_98279;
}
N_NIMCALL(NI, Countbits32_98413)(int N_98415) {
...
Result_98605 = 0;
LOC1 = rand();
Result_98605 = (NI64)(((NI) (LOC1)) % Max_98528);
goto BeforeRet;
BeforeRet: ;
return Result_98605;
}
...
Result_98833 = ((*S_98832).News / ((double) ((NI64)((*S_98832).N - 1))));
LA2: ;
return Result_98833;
}
N_NIMCALL(NF, Standarddeviation_98836)(TY98802* S_98838) {
