...
proc bundleNimbleExe(latest: bool, args: string) =
  ...
  nimCompile("dist/nimble/src/nimble.nim",
             options = "-d:release --mm:refc --undef:nimPreviewSlimSystem --useVersion:1.6 --noNimblePath " & args)
...
when isMainModule:
  ...
  while true:
    ...
    of cmdArgument:
      ...
      of "doc", "docs": buildDocs(op.cmdLineRest & paCode & " --undef:nimPreviewSlimSystem", localDocsOnly, localDocsOut)
      of "doc0", "docs0":
