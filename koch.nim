...
proc runCI(cmd: string) =
  ...
  if getEnv("NIM_TEST_PACKAGES", "false") == "true":
    ...
    execFold("Run nimdoc tests", "nim c -r nimdoc/tester_nimdoc.nim")
    execFold("Run nimpretty tests", "nim c -r nimpretty/tester_nimpretty.nim")
    when defined(posix):
      execFold("Run nimsuggest tests", "nim c -r nimsuggest/tester_nimsuggest.nim")
