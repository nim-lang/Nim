...
build/2_2/parseopt.o || exit 1
  ...
  powerpc64)
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_3/ast.c -o build/3_3/ast.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/crc.c -o build/2_2/crc.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/crc.c -o build/2_2/crc.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/ropes.c -o build/3_2/ropes.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/ropes.c -o build/3_2/ropes.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_3/rodwrite.c -o build/3_3/rodwrite.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_3/passes.c -o build/2_3/passes.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_3/passes.c -o build/2_3/passes.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/types.c -o build/3_3/types.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/types.c -o build/3_3/types.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/trees.c -o build/2_2/trees.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/trees.c -o build/2_2/trees.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/math.c -o build/2_2/math.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/math.c -o build/2_2/math.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_3/importer.c -o build/3_3/importer.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/lookups.c -o build/3_3/lookups.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/lookups.c -o build/3_3/lookups.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/semdata.c -o build/3_2/semdata.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/semdata.c -o build/3_2/semdata.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/treetab.c -o build/2_2/treetab.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/treetab.c -o build/2_2/treetab.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_3/evals.c -o build/3_3/evals.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/semfold.c -o build/3_3/semfold.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/semfold.c -o build/3_3/semfold.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/procfind.c -o build/3_2/procfind.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/procfind.c -o build/3_2/procfind.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/pragmas.c -o build/3_3/pragmas.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/pragmas.c -o build/3_3/pragmas.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/suggest.c -o build/3_2/suggest.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/suggest.c -o build/3_2/suggest.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/docgen.c -o build/3_2/docgen.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/docgen.c -o build/3_2/docgen.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_3/cgen.c -o build/3_3/cgen.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/ccgutils.c -o build/3_2/ccgutils.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/ccgutils.c -o build/3_2/ccgutils.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/cgmeth.c -o build/3_3/cgmeth.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/cgmeth.c -o build/3_3/cgmeth.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_3/ecmasgen.c -o build/3_3/ecmasgen.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_3/ecmasgen.c -o build/3_3/ecmasgen.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/interact.c -o build/2_2/interact.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/interact.c -o build/2_2/interact.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/3_2/passaux.c -o build/3_2/passaux.o"
    $CC $COMP_FLAGS -Ibuild -c build/3_2/passaux.c -o build/3_2/passaux.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/3_3/transf.c -o build/3_3/transf.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/parseopt.c -o build/2_2/parseopt.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/parseopt.c -o build/2_2/parseopt.o || exit 1
    echo "$LINKER $LINK_FLAGS -o bin/nimrod  \
build/3_2/nim__dat.o \
...
build/2_2/parseopt.o || exit 1
  ...
  powerpc64)
    ...
    $CC $COMP_FLAGS -Ibuild -c build/4_3/ast.c -o build/4_3/ast.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/crc.c -o build/2_2/crc.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/crc.c -o build/2_2/crc.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/ropes.c -o build/4_2/ropes.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/ropes.c -o build/4_2/ropes.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/4_3/rodwrite.c -o build/4_3/rodwrite.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_3/passes.c -o build/2_3/passes.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_3/passes.c -o build/2_3/passes.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/types.c -o build/4_3/types.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/types.c -o build/4_3/types.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/trees.c -o build/2_2/trees.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/trees.c -o build/2_2/trees.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/math.c -o build/2_2/math.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/math.c -o build/2_2/math.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/4_3/importer.c -o build/4_3/importer.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/lookups.c -o build/4_3/lookups.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/lookups.c -o build/4_3/lookups.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/semdata.c -o build/4_2/semdata.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/semdata.c -o build/4_2/semdata.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/treetab.c -o build/2_2/treetab.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/treetab.c -o build/2_2/treetab.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/4_3/evals.c -o build/4_3/evals.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/semfold.c -o build/4_3/semfold.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/semfold.c -o build/4_3/semfold.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/procfind.c -o build/4_2/procfind.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/procfind.c -o build/4_2/procfind.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/pragmas.c -o build/4_3/pragmas.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/pragmas.c -o build/4_3/pragmas.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/suggest.c -o build/4_2/suggest.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/suggest.c -o build/4_2/suggest.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/docgen.c -o build/4_2/docgen.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/docgen.c -o build/4_2/docgen.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/4_3/cgen.c -o build/4_3/cgen.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/ccgutils.c -o build/4_2/ccgutils.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/ccgutils.c -o build/4_2/ccgutils.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/cgmeth.c -o build/4_3/cgmeth.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/cgmeth.c -o build/4_3/cgmeth.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_3/ecmasgen.c -o build/4_3/ecmasgen.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_3/ecmasgen.c -o build/4_3/ecmasgen.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/interact.c -o build/2_2/interact.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/interact.c -o build/2_2/interact.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/4_2/passaux.c -o build/4_2/passaux.o"
    $CC $COMP_FLAGS -Ibuild -c build/4_2/passaux.c -o build/4_2/passaux.o || exit 1
    ...
    $CC $COMP_FLAGS -Ibuild -c build/4_3/transf.c -o build/4_3/transf.o || exit 1
    echo "$CC $COMP_FLAGS -Ibuild -c build/2_2/parseopt.c -o build/2_2/parseopt.o"
    $CC $COMP_FLAGS -Ibuild -c build/2_2/parseopt.c -o build/2_2/parseopt.o || exit 1
    echo "$LINKER $LINK_FLAGS -o bin/nimrod  \
build/4_2/nim__dat.o \
