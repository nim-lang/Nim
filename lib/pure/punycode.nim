...
runnableExamples:
  static:
    block:
      ...
      assert encode("London") == "London-"
      assert encode("Lloyd-Atkinson") == "Lloyd-Atkinson-"
      assert encode("This has spaces") == "This has spaces-"
      assert encode("ü") == "tda"
      assert encode("München") == "Mnchen-3ya"
      assert encode("Mnchen-3ya") == "Mnchen-3ya-"
      assert encode("München-Ost") == "Mnchen-Ost-9db"
      assert encode("Bahnhof München-Ost") == "Bahnhof Mnchen-Ost-u6b"
    block:
      assert decode("") == ""
      assert decode("a-") ==  "a"
      assert decode("A-") == "A"
      ...
      assert decode("London-") == "London"
      assert decode("Lloyd-Atkinson-") == "Lloyd-Atkinson"
      assert decode("This has spaces-") == "This has spaces"
      assert decode("tda") == "ü"
      assert decode("Mnchen-3ya") == "München"
      assert decode("Mnchen-3ya-") == "Mnchen-3ya"
      assert decode("Mnchen-Ost-9db") == "München-Ost"
      assert decode("Bahnhof Mnchen-Ost-u6b") == "Bahnhof München-Ost"
