...
func bitsliced*[T: SomeInteger](v: T; slice: Slice[int]): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    assert 0b10111.bitsliced(2 .. 4) == 0b101
    assert 0b11100.bitsliced(0 .. 2) == 0b100
    assert 0b11100.bitsliced(0 ..< 3) == 0b100
...
func toMask*[T: SomeInteger](slice: Slice[int]): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    assert toMask[int32](1 .. 3) == 0b1110'i32
    assert toMask[int32](0 .. 3) == 0b1111'i32
...
proc masked*[T: SomeInteger](v, mask :T): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    ...
    assert v.masked(0b0000_1010'u8) == 0b0000_0010'u8
...
func masked*[T: SomeInteger](v: T; slice: Slice[int]): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    ...
    assert v.masked(1 .. 3) == 0b0000_1010'u8
...
func setMasked*[T: SomeInteger](v, mask :T): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    let v = 0b0000_0011'u8
    assert v.setMasked(0b0000_1010'u8) == 0b0000_1011'u8
...
func setMasked*[T: SomeInteger](v: T; slice: Slice[int]): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    let v = 0b0000_0011'u8
    assert v.setMasked(2 .. 3) == 0b0000_1111'u8
...
func clearMasked*[T: SomeInteger](v, mask :T): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    let v = 0b0000_0011'u8
    assert v.clearMasked(0b0000_1010'u8) == 0b0000_0001'u8
...
func clearMasked*[T: SomeInteger](v: T; slice: Slice[int]): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    let v = 0b0000_0011'u8
    assert v.clearMasked(1 .. 3) == 0b0000_0001'u8
...
func flipMasked*[T: SomeInteger](v, mask :T): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    let v = 0b0000_0011'u8
    assert v.flipMasked(0b0000_1010'u8) == 0b0000_1001'u8
...
func flipMasked*[T: SomeInteger](v: T; slice: Slice[int]): T {.inline, since: (1, 3).} =
  ...
  runnableExamples:
    let v = 0b0000_0011'u8
    assert v.flipMasked(1 .. 3) == 0b0000_1101'u8
...
func countSetBits*(x: SomeInteger): int {.inline.} =
  ...
  runnableExamples:
    assert countSetBits(0b0000_0011'u8) == 2
    assert countSetBits(0b1010_1010'u8) == 4
...
func parityBits*(x: SomeInteger): int {.inline.} =
  ...
  runnableExamples:
    assert parityBits(0b0000_0000'u8) == 0
    assert parityBits(0b0101_0001'u8) == 1
    assert parityBits(0b0110_1001'u8) == 0
    assert parityBits(0b0111_1111'u8) == 1
...
func firstSetBit*(x: SomeInteger): int {.inline.} =
  ...
  runnableExamples:
    assert firstSetBit(0b0000_0001'u8) == 1
    assert firstSetBit(0b0000_0010'u8) == 2
    assert firstSetBit(0b0000_0100'u8) == 3
    assert firstSetBit(0b0000_1000'u8) == 4
    assert firstSetBit(0b0000_1111'u8) == 1
...
func fastLog2*(x: SomeInteger): int {.inline.} =
  ...
  ## otherwise the result is undefined.
  runnableExamples:
    assert fastLog2(0b0000_0001'u8) == 0
    assert fastLog2(0b0000_0010'u8) == 1
    assert fastLog2(0b0000_0100'u8) == 2
    assert fastLog2(0b0000_1000'u8) == 3
    assert fastLog2(0b0000_1111'u8) == 3
...
func countLeadingZeroBits*(x: SomeInteger): int {.inline.} =
  ...
  runnableExamples:
    assert countLeadingZeroBits(0b0000_0001'u8) == 7
    assert countLeadingZeroBits(0b0000_0010'u8) == 6
    assert countLeadingZeroBits(0b0000_0100'u8) == 5
    assert countLeadingZeroBits(0b0000_1000'u8) == 4
    assert countLeadingZeroBits(0b0000_1111'u8) == 4
...
func countTrailingZeroBits*(x: SomeInteger): int {.inline.} =
  ...
  runnableExamples:
    assert countTrailingZeroBits(0b0000_0001'u8) == 0
    assert countTrailingZeroBits(0b0000_0010'u8) == 1
    assert countTrailingZeroBits(0b0000_0100'u8) == 2
    assert countTrailingZeroBits(0b0000_1000'u8) == 3
    assert countTrailingZeroBits(0b0000_1111'u8) == 0
...
func rotateLeftBits*[T: SomeUnsignedInt](value: T, shift: range[0..(sizeof(T) * 8)]): T {.inline.} =
  ## Left-rotate bits in a `value`.
  runnableExamples:
    assert rotateLeftBits(0b0110_1001'u8, 4) == 0b1001_0110'u8
    assert rotateLeftBits(0b00111100_11000011'u16, 8) ==
      0b11000011_00111100'u16
    assert rotateLeftBits(0b0000111111110000_1111000000001111'u32, 16) ==
      0b1111000000001111_0000111111110000'u32
    assert rotateLeftBits(0b00000000111111111111111100000000_11111111000000000000000011111111'u64, 32) ==
...
func rotateRightBits*[T: SomeUnsignedInt](value: T, shift: range[0..(sizeof(T) * 8)]): T {.inline.} =
  ## Right-rotate bits in a `value`.
  runnableExamples:
    assert rotateRightBits(0b0110_1001'u8, 4) == 0b1001_0110'u8
    assert rotateRightBits(0b00111100_11000011'u16, 8) ==
      0b11000011_00111100'u16
    assert rotateRightBits(0b0000111111110000_1111000000001111'u32, 16) ==
      0b1111000000001111_0000111111110000'u32
    assert rotateRightBits(0b00000000111111111111111100000000_11111111000000000000000011111111'u64, 32) ==
      0b11111111000000000000000011111111_00000000111111111111111100000000'u64
  when nimvm:
...
func reverseBits*[T: SomeUnsignedInt](x: T): T =
  ...
  runnableExamples:
    assert reverseBits(0b10100100'u8) == 0b00100101'u8
    assert reverseBits(0xdd'u8) == 0xbb'u8
    assert reverseBits(0xddbb'u16) == 0xddbb'u16
    assert reverseBits(0xdeadbeef'u32) == 0xf77db57b'u32
