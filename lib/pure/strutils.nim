...
proc wordWrap*(s: string, maxLineWidth = 80,
  ...
  ##
  ## .. code-block:: nim
  ##   assert "1234567890".repeat(2).wordWrap() == "12345678901234567890"
  ##   assert "1234567890".repeat(3).wordWrap(20) == "12345678901234567890\n1234567890"
  ##   assert "Hello Bob. Hello John.".wordWrap(13, false) == "Hello Bob.\nHello John."
  ##   assert "Hello Bob. Hello John.".wordWrap(13, true, {';'}) == "Hello Bob. He\nllo John."
