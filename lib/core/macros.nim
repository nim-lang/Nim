...
proc kind*(n: NimNode): TNimrodNodeKind {.magic: "NKind", noSideEffect.}
...
proc expectKind*(n: NimNode, k: TNimrodNodeKind) {.compileTime.} =
...
proc expectKind*(n: NimNode; k: set[TNimrodNodeKind]) {.compileTime.} =
