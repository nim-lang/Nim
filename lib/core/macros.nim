...
when defined(nimSymKind):
  ...
  proc symId*(symbol: NimNode): int {.magic: "NSymId", noSideEffect.}
    ## Retrieve the ID of a symbol. This ID is generated by the nim
    ## compiler and truely unique accross all symbols in on
    ## compilation run.  But it is not stable across multiple
    ## compilation runs.  Use with caution.  Expects
    ## `symbol` to be of kind ``nnkSym``.
