...
template assert*(cond: untyped, msg = "") =
  ...
  ##
  ## .. code-block:: nim
  ##   static: assert 1 == 9, "This assertion passes when not built with -d:danger or --assertions:off"
...
template doAssert*(cond: untyped, msg = "") =
  ...
  ##
  ## .. code-block:: nim
  ##   static: doAssert 1 == 9, "This assertion passes when built with/without -d:danger or --assertions:off"
  const expr = astToStr(cond)
