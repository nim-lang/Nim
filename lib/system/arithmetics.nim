proc succ*[T: Ordinal](x: T, y: SomeInteger = 1): T {.magic: "Succ", noSideEffect.} =
...
proc pred*[T: Ordinal](x: T, y: SomeInteger = 1): T {.magic: "Pred", noSideEffect.} =
...
proc inc*[T: Ordinal](x: var T, y: SomeInteger = 1) {.magic: "Inc", noSideEffect.} =
...
proc dec*[T: Ordinal](x: var T, y: SomeInteger = 1) {.magic: "Dec", noSideEffect.} =
