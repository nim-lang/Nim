...
type
  TSpecialWord* = enum
    ...
    wNoSideEffect = "noSideEffect", wMemSafe = "memSafe", wMemUnsafe = "memUnsafe", wGcSafe = "gcsafe",
    wNoreturn = "noreturn", wNosinks = "nosinks", wMerge = "merge", wLib = "lib", wDynlib = "dynlib",
