...
proc evalOp(m: TMagic, n, a, b, c: PNode; g: ModuleGraph): PNode =
  ...
  of mMaxI:
    ...
    result = newIntNodeT(if argA > argB: argA else: argB, n, g)
  of mShlI:
    let valueB = getInt64(b) and (n.typ.size * 8 - 1)
    case skipTypes(n.typ, abstractRange).kind
    of tyInt8: result = newIntNodeT(toInt8(getInt(a)) shl valueB, n, g)
    of tyInt16: result = newIntNodeT(toInt16(getInt(a)) shl valueB, n, g)
    of tyInt32: result = newIntNodeT(toInt32(getInt(a)) shl valueB, n, g)
    of tyInt64: result = newIntNodeT(toInt64(getInt(a)) shl valueB, n, g)
    of tyInt:
      if g.config.target.intSize == 4:
        result = newIntNodeT(toInt128(toInt32(getInt(a)) shl valueB), n, g)
      else:
        result = newIntNodeT(toInt128(toInt64(getInt(a)) shl valueB), n, g)
    of tyUInt8: result = newIntNodeT(toInt128(toUInt8(getInt(a)) shl valueB), n, g)
    of tyUInt16: result = newIntNodeT(toInt128(toUInt16(getInt(a)) shl valueB), n, g)
    of tyUInt32: result = newIntNodeT(toInt128(toUInt32(getInt(a)) shl valueB), n, g)
    of tyUInt64: result = newIntNodeT(toInt128(toUInt64(getInt(a)) shl valueB), n, g)
    of tyUInt:
      if g.config.target.intSize == 4:
        result = newIntNodeT(BiggestInt(toUInt32(getInt(a)) shl valueB), n, g)
      else:
        result = newIntNodeT(toInt128(toUInt64(getInt(a)) shl valueB), n, g)
  ...
  of mAshrI:
    let valueB = getInt64(b) and (n.typ.size * 8 - 1)
    case skipTypes(n.typ, abstractRange).kind
    of tyInt8: result = newIntNodeT(ashr(int8(getInt64(a)), valueB), n, g)
    of tyInt16: result = newIntNodeT(ashr(int16(getInt64(a)), valueB), n, g)
    of tyInt32: result = newIntNodeT(ashr(int32(getInt64(a)), valueB), n, g)
    of tyInt64, tyInt:
