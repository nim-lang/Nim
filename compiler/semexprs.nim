...
proc semExpr(c: PContext, n: PNode, flags: TExprFlags = {}): PNode =
  ...
  of nkObjectTy:
    if c.inTypeContext > 0:
      # Skip semantic checking here and wait for the semantic
      # checking, when the type expression is complete.  This is a
      # hack to allow the body of a type to be generated by a macro.
      result = n
    else:
      localError(c.config, n.info, " not in type context: " &
