...
type
  TMsgKind* = enum
    ...
    warnUnsafeSetLen,
    warnUnsafeDefault,
    warnProveInit, warnProveField, warnProveIndex, warnTrailingElse,
...
const
  MsgKindToStr*: array[TMsgKind, string] = [
    ...
    warnTrailingElse: "trailing else, all cases are already covered",
...
const
  WarningsToStr* = ["CannotOpenFile", "OctalEscape",
    ...
    "ProveInit", "ProveField", "ProveIndex", "TrailingElse",
