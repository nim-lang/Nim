...
import
  ast, strutils, hashes, options, lexer, astalgo, trees, treetab, wordrecg,
  compiler_ropes, msgs, os, condsyms, idents, renderer, types, platform,
  math, magicsys, parser, nversion, nimsets, semfold, modulepaths, importer,
