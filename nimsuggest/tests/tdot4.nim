...
sug;;skFunc;;mstrutils.replace;;proc (s: string, sub: string, by: string): string{.raises: <inferred> [], noSideEffect, gcsafe.};;*fixtures/mstrutils.nim;;9;;5;;"this is a test version of strutils.replace, it simply returns `by`";;100;;None
"""
