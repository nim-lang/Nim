...
outline	skMacro	tv3_outline.m	macro (arg: untyped): untyped{.raises: <inferred> [], noSideEffect, gcsafe.}	$file	10	6	""	100	10	40
outline	skTemplate	tv3_outline.t	template (arg: untyped): untyped	$file	11	9	""	100	11	43
outline	skProc	tv3_outline.p	proc (){.raises: <inferred> [], noSideEffect, gcsafe.}	$file	12	5	""	100	12	24
outline	skConverter	tv3_outline.c	converter (s: string): int{.raises: <inferred> [], noSideEffect, gcsafe.}	$file	14	10	""	100	14	37
outline	skFunc	tv3_outline.f	proc (){.raises: <inferred> [], noSideEffect, gcsafe.}	$file	16	5	""	100	16	24
outline	skConst	tv3_outline.con	int literal(2)	$file	20	6	""	100	20	13
outline	skProc	tv3_outline.outer	proc (){.raises: <inferred> [], noSideEffect, gcsafe.}	$file	22	5	""	100	23	24
outline	skProc	tv3_outline.outer.inner	proc (){.raises: <inferred> [], noSideEffect, gcsafe.}	$file	23	7	""	100	23	24
outline	skProc	tv3_outline.procWithLocal	proc (){.raises: <inferred> [], noSideEffect, gcsafe.}	$file	25	5	""	100	26	16
"""
