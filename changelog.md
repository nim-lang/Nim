...
- Methods now support implementations based on vtable by using `--experimental:vtables`. methods are confined in the same module where the type has been defined.
