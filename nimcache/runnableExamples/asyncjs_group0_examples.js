...
function nsuFindChar(s_989857380, sub_989857381, start_989857382, last_989857383) {
    var Temporary1;
  ...
  BeforeRet: {
    ...
    F.line = 1969;
    if ((last_989857383 < 0)) {
    Temporary1 = (s_989857380).length - 1;
    }
    else {
    Temporary1 = last_989857383;
    }
    ...
    Label2: {
      ...
      F.line = 1972;
      F.filename = "strutils.nim";
      colontmp__973078647 = start_989857382;
      F.line = 96;
      F.filename = "iterators_1.nim";
      ...
      Label3: {
        F.line = 97;
          Label4: while (true) {
          if (!(res_973078648 <= last_989857385)) break Label4;
            F.line = 1986;
            F.filename = "strutils.nim";
            iHEX60gensym176_989857399 = res_973078648;
            if ((s_989857380[chckIndx(iHEX60gensym176_989857399, 0, (s_989857380).length - 1)] == sub_989857381)) {
            F.line = 1974;
...
function nsuFindStrA(a_989857360, s_989857361, sub_989857362, start_989857363, last_989857364) {
    var Temporary1;
  ...
  BeforeRet: {
    ...
    F.filename = "strutils.nim";
    if ((last_989857364 < 0)) {
    Temporary1 = (s_989857361).length - 1;
    }
    else {
    Temporary1 = last_989857364;
    }
    
    var last_989857366 = Temporary1;
    F.line = 1929;
    var subLast_989857367 = subInt((sub_989857362).length, 1);
    if ((subLast_989857367 == (-1))) {
    F.line = 1934;
    result_989857365 = start_989857363;
    break BeforeRet;
    }
    ...
    result_989857365 = (-1);
    F.line = 1939;
    var skip_989857368 = start_989857363;
    Label2: {
      F.line = 1941;
        Label3: while (true) {
        if (!(subLast_989857367 <= subInt(last_989857366, skip_989857368))) break Label3;
          ...
          Label4: {
            F.line = 1943;
              Label5: while (true) {
              if (!(s_989857361[chckIndx(addInt(skip_989857368, i_989857369), 0, (s_989857361).length - 1)] == sub_989857362[chckIndx(i_989857369, 0, (sub_989857362).length - 1)])) break Label5;
                if ((i_989857369 == 0)) {
                F.line = 1945;
          ...
          F.line = 1947;
          skip_989857368 = addInt(skip_989857368, a_989857360[chckIndx(s_989857361[chckIndx(addInt(skip_989857368, subLast_989857367), 0, (s_989857361).length - 1)], 0, (a_989857360).length - 1)]);
        }
    };
  };
  framePtr = F.prev;
...
function nsuInitNewSkipTable(sub_989857357) {
  ...
  framePtr = F;
    F.line = 1914;
    F.filename = "strutils.nim";
    nsuInitSkipTable(result_989857358[0], sub_989857357);
  framePtr = F.prev;
...
function nsuFindStr(s_989857417, sub_989857418, start_989857419, last_989857420) {
  var result_989857421 = 0;

  var F = {procname: "strutils.find", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    if ((subInt((s_989857417).length, start_989857419) < (sub_989857418).length)) {
    F.line = 2026;
    F.filename = "strutils.nim";
    result_989857421 = (-1);
    break BeforeRet;
    ...
    if (((sub_989857418).length == 1)) {
    F.line = 2027;
    result_989857421 = nsuFindChar(s_989857417, sub_989857418[chckIndx(0, 0, (sub_989857418).length - 1)], start_989857419, last_989857420);
    break BeforeRet;
    }
    
    F.line = 2030;
    result_989857421 = nsuFindStrA(nsuInitNewSkipTable(sub_989857418), s_989857417, sub_989857418, start_989857419, last_989857420);
  };
  framePtr = F.prev;
...
function contains_989857551(s_989857552, sub_989857553) {
  ...
  BeforeRet: {
    F.line = 2184;
    F.filename = "strutils.nim";
    result_989857554 = (0 <= nsuFindStr(s_989857552, sub_989857553, 0, (-1)));
    break BeforeRet;
  };
  framePtr = F.prev;
...
function HEX3Aanonymous_973078602(r_973078603) {
  ...
  BeforeRet: {
    ...
    if (!(contains_989857551(cstrToNimstr(reason_973078562.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 251;
