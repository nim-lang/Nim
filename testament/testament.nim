...
Experimental: Environment variable `NIM_TESTAMENT_REMOTE_NETWORKING` controls whether tests
involving remote networking are enabled. It is accessed while tests are compiled.
""" % resultsFile
