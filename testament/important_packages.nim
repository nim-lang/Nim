...
pkg "nimes", "nimble install sdl2@#HEAD;nim c src/nimes.nim"
...
pkg "nimquery"
pkg "nimsl", "nimble install variant@#HEAD;nimble test"
pkg "nimsvg"
...
pkg "unpack"
pkg "weave", "nimble install cligen synthesis;nimble test_gc_arc"
