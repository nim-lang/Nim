...
pkg "protobuf", "nimble uninstall -i -y protobuf; nimble install -y https://github.com/metagn/combparser@#HEAD; nimble install --depsOnly -y; nim c -o:protobuff -r src/protobuf.nim"
pkg "rbtree"
